...
Map.addLayer(imagepre.mean().clip(geometry), {bands: ['B4', 'B3', 'B2'], min: 0, max: 2000}, 'Agosto 2020');
Map.addLayer(imagepost.mean().clip(geometry), {bands: ['B4', 'B3', 'B2'], min: 0, max: 2000}, 'Agosto 2021');
