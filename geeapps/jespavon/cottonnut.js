var imageVisParam = {"opacity":1,"bands":["Nit"],"min":2.3741142729018327,"max":2.4846431630363797,"palette":["ff0303","ffcd5e","98ff64","40afff","153cff"]},
    ...
    imageVisParam2 = {"opacity":1,"bands":["Nit"],"min":2.4163145655273293,"max":2.555699265415933,"palette":["ff0303","ffcd5e","98ff64","40afff","153cff"]};
...
Map.addLayer(ghslPop,imageVisParam2,'May15-June01(%)')
...
var NDVIChart = ui.Chart.image.series(Col_cosntr2.select('Nit'), point.buffer(10), ee.Reducer.mean(), 10);
  NDVIChart.setOptions({
    title: 'Leaf N (%)',
    vAxis: {title: 'N (%)', maxValue: 2.5, minValue: 2.2},
