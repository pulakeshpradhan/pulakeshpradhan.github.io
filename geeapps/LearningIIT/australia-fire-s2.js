...
//////////////////////////////////////////////////////////////////////////////////
// Demonstrates before/after imagery comparison using sentinel 8 .
// These images track the major flooding in Odhisha due to Fani cyclone in 2019
var images = {
  //'2019-03-14': sentinelComposite('2019-03-14'),
  'Reference Imageries October': sentinelComposite('2019-10-1'),
   '2019-12-1': sentinelComposite('2019-10-1'),
  '2019-12-8': sentinelComposite('2019-12-08'),
  '2019-12-15': sentinelComposite('2019-12-15'),
  '2019-12-22': sentinelComposite('2019-12-22'),
  '2019-12-29': sentinelComposite('2019-12-29'),
  // '2019-07-28': sentinelComposite('2019-07-28'),
  // //'2019-05-16': sentinelComposite('2019-05-16'), 
};
...
function sentinelComposite(date) {
  ...
  var sentinel1 = ee.ImageCollection('COPERNICUS/S2')
                      .filterDate(date, date.advance(1, 'month')).filter(ee.Filter.lt('CLOUDY_PIXEL_PERCENTAGE', 50)).median()
                      ;
...
leftMap.setCenter(150.0069, -33.2162, 12);