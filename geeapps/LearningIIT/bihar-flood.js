var geometry = ui.import && ui.import("geometry", "geometry", {
    ...
    ee.Geometry.Polygon(
        [[[86.5348329640443, 26.954429806694677],
          [86.5348329640443, 21.302721924118657],
          [94.57682515154428, 21.302721924118657],
          [94.57682515154428, 26.954429806694677]]], null, false),
...
var before_start= '2020-03-1';
var before_end='2020-03-15';
// Now set the same parameters for AFTER the flood.
var after_start='2020-07-01';
var after_end='2020-07-31';
/********************************************************************************************
...
var difference_threshold = 1.1; /*threshodl to be applied on the difference image (after flood
...
var aoi=table
.filter(ee.Filter.eq('stname', 'BIHAR'));
...
// Produced by...
var text7 = ui.Label('Script produced by:Sachchidanand using UN-SPIDER Code', subTextVis)
...
var palette =['#0000FF', '#30b21c', 'violet'];
// name of the legend
