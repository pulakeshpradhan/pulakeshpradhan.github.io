var table = ui.import && ui.import("table", "table", {
    ...
    table3 = ui.import && ui.import("table3", "table", {
      "id": "users/estimacionesmagyp/INTENSIVOS/inverlaplata"
    }) || ee.FeatureCollection("users/estimacionesmagyp/INTENSIVOS/inverlaplata");
Map.setOptions("HYBRID")
Map.setCenter(-58.014, -34.9463, 12);
//////////////////////////////////////////////////////////////////////////////////////////////
...
Map.addLayer(outline, {palette: '#FFEC00 '}, 'Invernáculos');
//////////////////////////////////////////////////////////////////////////////////////////////
// Create an empty image into which to paint the features, cast to byte.
...
legend.add(makeRow('FFEC00', 'Invernáculos'));
Map.add(legend);
