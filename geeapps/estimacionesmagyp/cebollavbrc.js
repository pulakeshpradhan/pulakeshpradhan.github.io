var table = ui.import && ui.import("table", "table", {
    ...
    table3 = ui.import && ui.import("table3", "table", {
      "id": "users/estimacionesmagyp/INTENSIVOS/cebolla"
    }) || ee.FeatureCollection("users/estimacionesmagyp/INTENSIVOS/cebolla");
Map.setOptions("HYBRID")
Map.setCenter(-62.633, -39.5401, 10);
//////////////////////////////////////////////////////////////////////////////////////////////
...
Map.addLayer(outline, {palette: '#E3BD6F '}, 'Cebolla');
//////////////////////////////////////////////////////////////////////////////////////////////
// Create an empty image into which to paint the features, cast to byte.
...
Map.addLayer(outline, {palette: '#FDFEFE'}, 'Deptos');
// Add the maps and title to the ui.root.
//ui.root.widgets().reset([title, mapGrid]);
//ui.root.setLayout(ui.Panel.Layout.Flow('vertical'));
Map.add(ui.Label(
    'Mapa: Cultivo de Cebolla 18/19 VBRC' 
...
legend.add(makeRow('E3BD6F', 'Cebolla'));
Map.add(legend);
...
var l8 = ee.ImageCollection("COPERNICUS/S2")
        .filterDate('2018-05-01', '2019-05-30')
    ...
    var branding = ui.Thumbnail({image:logo,params:{bands:['b1','b2','b3'],min:0,max:255},style:{width:'200px',height:'60px'}});
        panel.add(branding);
    var intro = ui.Panel([
      ui.Label({value: 'NDVI Campaña 18/19',
