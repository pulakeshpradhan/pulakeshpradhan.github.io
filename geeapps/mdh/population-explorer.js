// An example interactive app that displays global population density and
// population totals by country in chart or table form.
...
///////////////////////////////////////////////////////////////////////////////
// The main map and layers.
///////////////////////////////////////////////////////////////////////////////
// Constants used to visualize the data on the map.
var POPULATION_STYLE = {min:0, max:1, palette:['ffffde', '509b92', '03008d']};
...
function updateChart() {
  var chart = chartTypeToggleButton.value(getSelectedCountries());
...
function handleAdminRegionSelect(location) {
  selectedPoints.push([location.lon, location.lat]);
  updateOverlay();
  updateChart();
}
Map.onClick(handleAdminRegionSelect);
...
// the minimim, middle, and maximum values.
function makeLegend() {
  var labelPanel = ui.Panel([
    ui.Label(undoColorStretch(0), {margin: '4px 8px'}),
    ui.Label(undoColorStretch(0.5),
...
Map.add(ui.Panel([
  ui.Label('Population Density', LEGEND_TITLE_STYLE),
  makeLegend(),
  ui.Label('(thousands of people per square kilometer)', LEGEND_FOOTNOTE_STYLE),
