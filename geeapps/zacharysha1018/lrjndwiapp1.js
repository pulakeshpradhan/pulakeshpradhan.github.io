...
var everGreen = ndwi.where(ndwi.gt(0.3),1).where(ndwi.lt(0.3),0);
var patchsize1  = everGreen.toInt32().connectedPixelCount(8);
var myim2 = everGreen.toInt32().where(patchsize1.lt(8),0);
Map.setCenter(116, 40, 12);
Map.addLayer(dataset.median(), rgbVis, 'RGB');
Map.addLayer(ndwi.clip(table), {min: 0, max: 1}, 'NDVI');
