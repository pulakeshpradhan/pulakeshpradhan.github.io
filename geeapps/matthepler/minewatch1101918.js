...
var SentinalToa = ee.ImageCollection('COPERNICUS/S2')
    ...
    Map.addLayer(lastImage, imageVisParam); 
    var shown = true; // true or false, 1 or 0 
    var opacity = 0.3; // number [0-1]
    var visParams = {color: 'pink'}; // dictionary: 
Map.addLayer(MineFeature, visParams,'1101905',shown,opacity); 
