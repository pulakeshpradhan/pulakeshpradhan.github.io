...
var MineFeature1 = ee.FeatureCollection("users/matthepler/M1101914"),
    ...
    imageVisParam = {"opacity":1,"bands":["B8","B4","B3"],"min":753.9000000000001,"max":3729.1,"gamma":1},
    geometry = /* color: #d63000 */ee.Geometry.MultiPoint(),
    MineFeature4 = ee.FeatureCollection("users/matthepler/ailey"),
    imageVisParam2 = {"opacity":1,"bands":["B4","B3","B2"],"min":525.5,"max":1393.5,"gamma":1};
...
Map.addLayer(MineFeature, visParams,'Ailey Mine Boundary',shown,opacity); 
  ...
  var label2 = ui.Label('True Color Satelite Imagery')
  Map.add(label); 
  Map.add(label2);
