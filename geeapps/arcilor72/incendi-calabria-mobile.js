...
function addLayerSelector(mapToChange, defaultValue, position) {
  ...
  label.style().set({color:'black',fontFamily :'serif',padding: '0px',margin: '0 0 0px 0',stretch: 'horizontal',border: '1px solid blue',fontSize : '8px',textAlign :'center'});
  ...
  select.style().set({color:'red',fontFamily :'serif',stretch: 'horizontal',border: '1px solid blue',fontSize : '8px',textAlign :'center'});
  var controlPanel =
      ui.Panel({widgets: [label, select], style: {position: position}});
  mapToChange.add(controlPanel);
}
var rightSelector = addLayerSelector(rightMap, 0, 'top-right','6px','serif');
...
var fireName = ui.Label("Mappatura degli incendi avvenuti in Calabria nell'Estate 2021", {fontWeight:'italic', fontSize:'6px',fontFamily: 'serif'});
var fireExplorerLabel = ui.Label('Fire Explorer', {fontWeight:'italic', fontSize:'6px',fontFamily: 'serif'});
...
*/
var autore  = ui.Label('Realizzazione a cura di Lorenzo Arcidiaco', {fontWeight:'italic', fontSize:'6px',fontFamily: 'serif',color:'green'});
autore.setUrl('https://twitter.com/larcidiaco');
var infoPanel = ui.Panel([fireName, autore], null, {position: 'top-left',width: '150px',padding: '1px', margin: '0 0 0 0'});
//var infoPanel1 = ui.Panel(['ANNO 2020'], null, {position: 'top-left'});
var title = ui.Label('ESTATE 2020');
title.style().set({position: 'bottom-left', width: '80px',color:'red',fontFamily :'serif',stretch: 'horizontal',border: '1px solid blue',fontSize : '10px',textAlign :'center'});
var titler = ui.Label('ESTATE 2021');
titler.style().set({position: 'bottom-right', width: '80px',color:'red',fontFamily :'serif',stretch: 'horizontal',border: '1px solid blue',fontSize : '10px',textAlign :'center'});
ui.root.clear();
leftMap.add(title);
rightMap.add(titler);
...
//rightMap.setControlVisibility({Layers:true});
