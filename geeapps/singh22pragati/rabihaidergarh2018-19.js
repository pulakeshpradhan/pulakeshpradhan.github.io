var imageCollection = ee.ImageCollection("LANDSAT/LC08/C01/T1_RT"),
    aoi = ee.FeatureCollection("users/singh22pragati/haidergarhprojectarea");
...
var bare = ndvi.gt(0.3).and(ndvi.lt(0.53));
...
print(ndvi);
Map.addLayer(ndvi,  {palette: ['red', 'green', 'blue']})
...
legend.add(panel);
var ima =stat;
var inspector = ui.Panel([ui.Label('Click to get Rabi Cropped Area')]);
Map.add(inspector);
