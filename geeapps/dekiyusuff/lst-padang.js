var Indonesia = ui.import && ui.import("Indonesia", "table", {
      "id": "users/dekiyusuff/Indonesia"
    }) || ee.FeatureCollection("users/dekiyusuff/Indonesia"),
    geometry = ui.import && ui.import("geometry", "geometry", {
      ...
      "shown": true,
      "locked": false
    }) || /* color: #23cba7 */ee.Geometry.Point([100.39983555018594, -0.9779086387302379]);
//####################### Import SHP #######################
var countries = Indonesia //Import SHP DIVA GIS
var Nama_Kota = ['Padang'] //Mendefinisikan nama kota Padang
...
Map.centerObject(area, 11);//zoom ke area yang telah ditentukan dengan tingkat zoom 8
//####################### Perhitungan LST #######################
//Cloud masking
...
function chartLSTTimeSeries() {
 ...
 title: 'Time Series Suhu Permukaan di Padang',
 hAxis: {title: 'Date'},
