...
var geometry3 = /* color: #d63000 */ee.Geometry.Polygon(
    ...
    geometry4 = ee.FeatureCollection("users/tarsilaandrade/area_caceres"),
    geometry = ee.FeatureCollection("users/tarsilaandrade/area_corumba");
...
function init (){
  ...
  options.geometry = ee.FeatureCollection("users/tarsilaandrade/area_corumba")
    .geometry();
