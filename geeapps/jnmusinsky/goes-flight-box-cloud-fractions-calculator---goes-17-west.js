...
var AOPsites = ee.FeatureCollection('users/jnmusinsky/P1_Flight_Box_Complete/P1flightboxesAllSitesV2west').sort('siteID')
...
var goes16col = ee.ImageCollection('NOAA/GOES/17/FDCF') 
