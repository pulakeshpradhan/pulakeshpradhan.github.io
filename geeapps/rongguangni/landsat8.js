var geometry = ui.import && ui.import("geometry", "geometry", {
    ...
    /* shown: false */
    ee.Geometry.Polygon(
        [[[109.5994018725586, 21.61647314133159],
          [109.5994018725586, 21.53729558158702],
          [109.68557588378907, 21.53729558158702],
          [109.68557588378907, 21.61647314133159]]], null, false);
...
app.createPanels = function() {
  ...
  app.filters = {
    ...
    startDate: ui.Textbox('YYYY-MM-DD', '2019-01-01'),
    endDate: ui.Textbox('YYYY-MM-DD', '2019-12-31'),
...
app.boot = function() {
  ...
  Map.setCenter(109.66017, 21.57242,12); 
