var table2 = ui.import && ui.import("table2", "table", {
    ...
    table3 = ui.import && ui.import("table3", "table", {
      "id": "users/rongguangni/pop_provience"
    }) || ee.FeatureCollection("users/rongguangni/pop_provience"),
    table = ui.import && ui.import("table", "table", {
      "id": "users/rongguangni/chinaprovience"
    }) || ee.FeatureCollection("users/rongguangni/chinaprovience");
...
var countries =table3;
// print(countries)
// Export.table.toCloudStorage(countries,"countriesPop");
/*
...
Map.addLayer(colorStretch(ghslPop.unmask(0).updateMask(1)).clip(table), POPULATION_STYLE);
Map.addLayer(table.style(COUNTRIES_STYLE));
// Create the application title bar.
Map.add(ui.Label(
    '中国人口展示', {fontWeight: 'bold', fontSize: '24px'}));
/*
...
Map.add(ui.Panel(
    [
      ui.Label('人口密度', LEGEND_TITLE_STYLE), makeLegend(),
      ui.Label(
          '(千人/平方公里)', LEGEND_FOOTNOTE_STYLE),
    ],
