...
var images = {
  '1992': getWeeklySentinelComposite('1992'),
  '1995': getWeeklySentinelComposite('1995'),
  '1998': getWeeklySentinelComposite('1998'),
  '2000': getWeeklySentinelComposite('2000'),
  '2005': getWeeklySentinelComposite('2005'),
  '2010': getWeeklySentinelComposite('2010'),
...
function getWeeklySentinelComposite(date) {
  ...
  // var polarization = 'VV';
  var sentinel1 = ee.ImageCollection('NOAA/DMSP-OLS/NIGHTTIME_LIGHTS').select('stable_lights')
                      ...
                      // .select(polarization)
                      .mean();
  return sentinel1.visualize({min: 0,
      max: 63,
...
leftMap.setCenter(120.1685, 31.2175, 7);
