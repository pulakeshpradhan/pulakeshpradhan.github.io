...
var L8coll = ee.ImageCollection('COPERNICUS/S2')
.filterBounds(punto_interes);
// Load Rodrigo Principe's cloud masking module
var cloud_masks = require('users/fitoprincipe/geetools:cloud_masks');
var maskClouds = cloud_masks.sentinel2();
var landsatCollection =ee.ImageCollection(L8coll).map(maskClouds);
Map.addLayer( landsatCollection.sort('CLOUD_COVER').first().clip(rnj),{},'Lago Chinchaycocha');
