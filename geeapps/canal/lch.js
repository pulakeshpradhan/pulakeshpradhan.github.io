...
collectionLCFinal.evaluate(function(){
  Map.addLayer( collectionLCFinal.sort('CLOUD_COVER').first().clip(rnj).select('NDVI'),{},'Lago Chinchaycocha');
 // var lch_1 = ee.Geometry.Point(-76.2279, -10.964675);
  // Map.addLayer(lch_1,{color: 'ff0000 '},'LCH_1');
   // var lch_2 = ee.Geometry.Point(-76.156207,	-10.977551);
   //Map.addLayer(lch_2,{color: 'ff0000 '},'LCH_2');
    //var lch_3 = ee.Geometry.Point(-76.168105,	-11.008114);
   //Map.addLayer(lch_3,{color: 'ff0000 '},'LCH_3');
    //var lch_4 = ee.Geometry.Point(-76.078339	-10.988453);
   //Map.addLayer(lch_4,{color: 'ff0000 '},'LCH_4');
    //var lch_5 = ee.Geometry.Point(-76.110512	,-10.994332);
   //Map.addLayer(lch_5,{color: 'ff0000 '},'LCH_5');
   // var lch_6 = ee.Geometry.Point(-76.105356,	-11.022862);
  // Map.addLayer(lch_6,{color: 'ff0000 '},'LCH_6');
   // var lch_7 = ee.Geometry.Point(-76.138636,	-11.030045);
   //Map.addLayer(lch_7,{color: 'ff0000 '},'LCH_7');
   // var lch_8 = ee.Geometry.Point(-76.068075,	-11.020084);
   //Map.addLayer(lch_8,{color: 'ff0000 '},'LCH_8');
   // var lch_9 = ee.Geometry.Point(-76.099138,	-11.058855);
   //Map.addLayer(lch_9,{color: 'ff0000 '},'LCH_9');
   // var lch_10 = ee.Geometry.Point(-76.064877,	-11.052142);
   //Map.addLayer(lch_10,{color: 'ff0000 '},'LCH_10');
});
