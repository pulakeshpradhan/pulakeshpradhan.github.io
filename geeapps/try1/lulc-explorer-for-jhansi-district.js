...
Map.addLayer(image, vis4, "Jhansi_img_2020");
//-------------------------------------------------------------------------------2020 classify--------
...
Map.addLayer(classified, {min: 0, max: 3, palette: ['0000ff', 'ff0000', 'ffff00', '00ff00']}, '2020'); 
...
//Map.addLayer(outline, {}, 'sample_shp',false);
var vis4 = {"opacity":1,"bands":["B8","B4","B3"],"min":0.098,"max":0.2473,"gamma":1.37};
Map.addLayer(image2019, vis4, "Jhansi_img_2019");
//------------------------------------------2019 classify-----------------------------------
// Merge the hand-drawn features into a single FeatureCollection.
...
Map.addLayer(classified2019, {min: 0, max: 3, palette: ['0000ff', 'ff0000', 'ffff00', '00ff00']}, '2019'); 
// var palette = ee.List(['blue', 'red', 'yellow', 'green'])
// var landcover = ee.List([0, 1, 2, 3])
