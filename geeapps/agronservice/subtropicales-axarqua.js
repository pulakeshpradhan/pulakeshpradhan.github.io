...
var composite = s2
  ...
  .filterDate ('2020-07-12','2020-07-14')
  .mosaic()
  .divide(10000)
  .clip(geometry_s);
var composite1 = s2
...
var vcultivo = {
  '03/02/2020': ndvi.visualize({min: -0.5, max: 0.9, palette: ndviPalette}),
  '04/03/2020': ndvi1.visualize({min: -0.5, max: 0.9, palette: ndviPalette}),
};
var ehidrico = {
  '03/02/2020': ndwi.visualize({min: -0.2, max: 0.5, palette: ndwiPalette}),
  '04/03/2020': ndwi1.visualize({min: -0.2, max: 0.5, palette: ndwiPalette}),
};
/////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//Add text to the map
var label3 = ui.Label('Subtropicales en la Axarquía');
  label3.style().set({
    position:('top-center'),
    fontFamily:('monospace'),
    color:('#000000'),
...
//Add text to the map
var label4 = ui.Label('Subtropicales en la Axarquía');
  label4.style().set({
    position:('top-center'),
    fontFamily:('monospace'),
    color:('#000000'),
...
leftMap.setCenter(-4.1087488, 36.784542, 12);
