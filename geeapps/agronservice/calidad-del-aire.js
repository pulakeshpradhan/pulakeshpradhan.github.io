var Europa = ui.import && ui.import("Europa", "table", {
      "id": "users/agronservice/Europa"
    }) || ee.FeatureCollection("users/agronservice/Europa");
////////////////////////////////////////////////////////////////////////
//                                                                    //
//                            VIZ                                     //
//                                                                    //
...
var un_dia = '1 día atrás';
var cinco_dias = '5 días atrás';
var diez_dias = '10 días atrás';
var quince_dias = '15 días atrás';
var rangoSeleccionado = quince_dias;
...
var Clouds15 = ee.ImageCollection('COPERNICUS/S5P/NRTI/L3_CLOUD').map(clip)
  .select('cloud_fraction')
  .filterDate(now.advance(-15, 'day'), now);
...
var Clouds10 = ee.ImageCollection('COPERNICUS/S5P/NRTI/L3_CLOUD').map(clip)
  .select('cloud_fraction')
  .filterDate(now.advance(-10, 'day'), now);
...
var Clouds1 = ee.ImageCollection('COPERNICUS/S5P/NRTI/L3_CLOUD').map(clip)
  .select('cloud_fraction')
  .filterDate(now.advance(-2, 'day'), now);
...
//                                                                    //
////////////////////////////////////////////////////////////////////////
var Ranges = ['15 días atrás','10 días atrás','5 días atrás', '1 día atrás'];
var Layers15 = {
...
//selectRange.setValue(quince_dias, true);
...
// Map.addLayer(outline4, {palette: '#262626'}, 'Europa', false);