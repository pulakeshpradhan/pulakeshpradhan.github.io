...
var periode1 = ee.ImageCollection('COPERNICUS/S5P/OFFL/L3_NO2')
                .filterDate('2020-03-20','2020-04-27')
                .mean()
                .select('NO2_column_number_density')
                .clip(batas)
                .visualize({min:0.0000,max:0.0003,palette:"lightblue,yellow,orange,red,purple"});
var periode2 = ee.ImageCollection('COPERNICUS/S5P/OFFL/L3_NO2')
                .filterDate('2020-04-28','2020-05-11')
                .mean()
                .select('NO2_column_number_density')
                .clip(batas)
                .visualize({min:0.0000,max:0.0003,palette:"lightblue,yellow,orange,red,purple"});
var periode3 = ee.ImageCollection('COPERNICUS/S5P/OFFL/L3_NO2')
                .filterDate('2020-05-12','2020-05-25')
                .mean()
                .select('NO2_column_number_density')
                .clip(batas)
                .visualize({min:0.0000,max:0.0003,palette:"lightblue,yellow,orange,red,purple"});
var periode4 = ee.ImageCollection('COPERNICUS/S5P/OFFL/L3_NO2')
                .filterDate('2020-05-26','2020-06-08')
                .mean()
                .select('NO2_column_number_density')
                .clip(batas)
                .visualize({min:0.0000,max:0.0003,palette:"lightblue,yellow,orange,red,purple"});
var periode5 = ee.ImageCollection('COPERNICUS/S5P/OFFL/L3_NO2')
...
var images = {
      'Konsentrasi NO2 Sebelum PSBB': periode1,
      'Konsentrasi NO2 PSBB Jilid I': periode2,
      'Konsentrasi NO2 PSBB Jilid II': periode3,
      'Konsentrasi NO2 PSBB Jilid III': periode4,
      'Konsentrasi NO2 PSBB Transisi': periode5,
};
...
var header1 = ui.Label('PETA SPLIT PANEL NO2 DI JAWA TIMUR',  
...
var text_1 = ui.Label( 
'Peta ini menyajikan perbandingan antara konsentrasi NO2 rata-rata di setiap perubahan kebijakan PSBB selama pandemi COVID-19. Data konsentrasi rata-rata NO2 yang digunakan, yaitu:', 
...
var viz = {min:0.0000,max:0.0003,palette:"lightblue,yellow,orange,red,purple"}; 
var legend = ui.Panel({ 
style: { 
