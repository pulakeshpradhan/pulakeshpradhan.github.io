...
var legend1 = createLegend.makeColorBar(viz_dry, 'Lignin/Cellulose Absorption Index','90%','25%','top-center','16px');
var legend2 = createLegend.makeColorBar(viz_ndvi, 'Greenness (MSAVI)','90%','25%','top-center','16px');  
