...
*/
// Sum the values of forest loss pixels in Japan.
...
print('pixels representing loss: ', stats.get('loss'), 'in square meters');
//----------------------------------------------------------------------
...
print('Loss by year', statsDictionary);
