var SceneMaskForClipping = /* color: #48ce26 */ee.Geometry({
    ...
    CoastlineVectorMask = /* color: #fff702 */ee.Geometry.Polygon(
        [[[30.612012773624087, 36.84271646893233],
          [30.61621847735944, 36.84017493466294],
          [30.644798456534204, 36.861980034492625],
          [30.64291018138772, 36.86503586255361],
          [30.640485428705347, 36.86400583580039],
          [30.638232408865747, 36.86270108359016],
          [30.627503572806177, 36.855043881411156],
          [30.626217186786334, 36.85324154522459],
          [30.625466168262165, 36.85255474695263],
          [30.62379246983687, 36.85161897437581],
          [30.622253722051937, 36.85073186474998],
          [30.62070876965936, 36.84956426568474],
          [30.61495811353143, 36.84406944244007]]]);
      ...
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [ [
          [ 30.601148151681627,36.8281036243223],  //starting/ending vertex 0
          [30.61831428937694,36.82480585256688 ],  //vertex 1
          [30.648183368966784, 36.86079883324304], //vertex 2
          [30.611276172921862,36.88840028308135],  //vertex 3
          [30.572309040353502,36.85626629878486]   //vertex 4
              ]],
          "evenOdd": true
        },
        {
          "type": "Point",
          "coordinates": [30.610205195875324,36.856314374878906]}
          ],
      "coordinates": []}),
    CoastlineVectorMask = /* color: #fff702 */ee.Geometry.Polygon([[
          [30.612012773624087, 36.84271646893233], //starting/ending vertex 0
          [30.61621847735944, 36.84017493466294],  //vertex 1
          [30.644798456534204, 36.861980034492625],//vertex 2
          [30.64291018138772, 36.86503586255361],  //vertex 3
          [30.640485428705347, 36.86400583580039], //vertex 4
          [30.638232408865747, 36.86270108359016], //vertex 5
          [30.627503572806177, 36.855043881411156],//vertex 6
          [30.626217186786334, 36.85324154522459], //vertex 7
          [30.625466168262165, 36.85255474695263], //vertex 8
          [30.62379246983687, 36.85161897437581],  //vertex 9
          [30.622253722051937, 36.85073186474998], //vertex 10
          [30.62070876965936, 36.84956426568474],  //vertex 11
          [30.61495811353143, 36.84406944244007]   //vertex 12
          ]]);
...
var image2013 = ee.Image('LANDSAT/LC08/C01/T1_TOA/LC08_178034_20130918');
var image2016 = ee.Image('LANDSAT/LC08/C01/T1_TOA/LC08_178034_20160926');
var image2019 = ee.Image('LANDSAT/LC08/C01/T1_TOA/LC08_178034_20190919');
...
var myCollection = ee.ImageCollection([image2013, image2016, image2019]);
//print('My collection: ', myCollection);
//Crearea indicelui de vegetatie diferentiat si indicelui de apa diferentiat
//Creation of NDVI and NDWI layer
var ndvi2013 = image2013.normalizedDifference(['B5', 'B4']);
var ndwi2013 = image2013.normalizedDifference(['B3', 'B5']);
var ndvi2016 = image2016.normalizedDifference(['B5', 'B4']);
var ndwi2016 = image2016.normalizedDifference(['B3', 'B5']);
var ndvi2019 = image2019.normalizedDifference(['B3', 'B5']);
var ndwi2019 = image2019.normalizedDifference(['B3', 'B5']);
//NDVI stack
...
//Crearea layer-ului binar
//Creation of binary layer
var ndBIN2013 = ee.Image(ndvi2013.lt(1).and(ndwi2013.lt(0)));
var ndBIN2016 = ee.Image(ndvi2016.lt(1).and(ndwi2016.lt(0)));
var ndBIN2019 = ee.Image(ndvi2019.lt(1).and(ndwi2019.lt(0)));
//Binary stacks
...
//Crearea layer-ului de detectare a marginilor
//Creation of edge detection layer 
var edgeDetect2013 = ee.Algorithms.CannyEdgeDetector(ndBIN2013, 1 );
var edgeDetect2016 = ee.Algorithms.CannyEdgeDetector(ndBIN2016, 1 );
var edgeDetect2019 = ee.Algorithms.CannyEdgeDetector(ndBIN2019, 1 );
//Edge detect stacks
...
//Crearea de masca ca poligon
//Mask creation as polygon
var mask = ee.Geometry.Polygon([
  ...
  30.611276172921862 , 36.88840028308135, //vertex 3
  30.572309040353502 , 36.85626629878486, //vertex 4
  30.601148151681627 , 36.8281036243223   //vertex 5
  ]);
var coastlineMask = ee.Geometry.Polygon([
  30.612012773624087,36.84271646893233,  //starting/ending vertex 0
  30.61621847735944,36.84017493466294,   //vertex 1
  30.644798456534204,36.861980034492625, //vertex 2
  30.64291018138772,36.86503586255361,   //vertex 3
  30.640485428705347,36.86400583580039,  //vertex 4
  30.640485428705347,36.86400583580039,  //vertex 5
  30.638232408865747,36.86270108359016,  //vertex 6
  30.627503572806177,36.855043881411156, //vertex 7 
  30.626217186786334,36.85324154522459,  //vertex 8
  30.625466168262165,36.85255474695263,  //vertex 9
  30.62379246983687,36.85161897437581,   //vertex 10
  30.622253722051937,36.85073186474998,  //vertex 12
  30.62070876965936,36.84956426568474,   //vertex 13
  30.61495811353143,36.84406944244007,   //vertex 14
  30.612012773624087,36.84271646893233   //vertex 15
  ]);
 //Adaugarea (afisarea) de layere + masca + customizare paleta de la 0-1 + denumire layer SI zoom de 13 pe pinpoint
 //Add (display) masked layers + palette setted + rename of the layer AND center the map to the pinpoint with a 13 zoom value
//Map.addLayer(ndBIN.clip(mask), {palette: ['#12b2ff' , '#ffce45']}, 'Binary Layer')                <--- saved for late
// Map.addLayer(edgeDetect.clip(mask), {palette: ['#12b2ff' , '#ffce45']}, 'Edge Detected Layer')   <--- saved for late
// Map.addLayer(edgeDetect.updateMask(edgeDetect).clip(mask),{palette: ['Black']}, 'Edge of area')  <--- saved for late
 //Map.addLayer(edgeDetect2013.updateMask(edgeDetect2013).clip(coastlineMask), {palette: ['Black']}, 'Coastline2013')
 //Map.addLayer(edgeDetect2016.updateMask(edgeDetect2016).clip(coastlineMask), {palette: ['Red']}, 'Coastline2016')
//Map.addLayer(edgeDetect2019.updateMask(edgeDetect2019).clip(coastlineMask), {palette: ['Green']}, 'Coastline2019')
 //The big code
      ...
      var yearSelect11 = ui.Select({
        items: [
          ...
          onChange: function(value){
            //Spring - March - Years
            if (value == 2013) {
               Map.addLayer(emarch2013.updateMask(emarch2013).clip(coastlineMask), {palette: ['Black']}, 'Coastline March 2013')
            } else if (value == 2014) {
              Map.addLayer(emarch2014.updateMask(emarch2014).clip(coastlineMask), {palette: ['Black']}, 'Coastline March 2014')
            } else if (value == 2015) {
              Map.addLayer(emarch2015.updateMask(emarch2015).clip(coastlineMask), {palette: ['Black']}, 'Coastline March 2015')
            } else if (value == 2016) {
              Map.addLayer(emarch2016.updateMask(emarch2016).clip(coastlineMask), {palette: ['Black']}, 'Coastline March 2016')
            } else if (value == 2017) {
              Map.addLayer(emarch2017.updateMask(emarch2017).clip(coastlineMask), {palette: ['Black']}, 'Coastline March 2017')
            } else if (value == 2018) {
              Map.addLayer(emarch2018.updateMask(emarch2018).clip(coastlineMask), {palette: ['Black']}, 'Coastline March 2018')
            } else if (value == 2019) {
              Map.addLayer(emarch2019.updateMask(emarch2019).clip(coastlineMask), {palette: ['Black']}, 'Coastline March 2019')
            }
          }
      });
      ...
      var yearSelect12 = ui.Select({
        items: [
          ...
          onChange: function(value){
            //Spring - April - Years
            if (value == 2013) {
              Map.addLayer(eapril2013.updateMask(eapril2013).clip(coastlineMask), {palette: ['Black']}, 'Coastline April 2013')
            } else if (value == 2014) {
              Map.addLayer(eapril2014.updateMask(eapril2014).clip(coastlineMask), {palette: ['Black']}, 'Coastline April 2014')
            } else if (value == 2015) {
              Map.addLayer(eapril2015.updateMask(eapril2015).clip(coastlineMask), {palette: ['Black']}, 'Coastline April 2015')
            } else if (value == 2016) {
              Map.addLayer(eapril2016.updateMask(eapril2016).clip(coastlineMask), {palette: ['Black']}, 'Coastline April 2016')
            } else if (value == 2017) {
              Map.addLayer(eapril2017.updateMask(eapril2017).clip(coastlineMask), {palette: ['Black']}, 'Coastline April 2017')
            } else if (value == 2018) {
              Map.addLayer(eapril2018.updateMask(eapril2018).clip(coastlineMask), {palette: ['Black']}, 'Coastline April 2018')
            } else if (value == 2019) {
              Map.addLayer(eapril2019.updateMask(eapril2019).clip(coastlineMask), {palette: ['Black']}, 'Coastline April 2019')
            }
          }
      });
      ...
      var yearSelect13 = ui.Select({
        items: [
          ...
          onChange: function(value){
            //Spring - May - Years
            if (value == 2013) {
              Map.addLayer(emay2013.updateMask(emay2013).clip(coastlineMask), {palette: ['Black']}, 'Coastline May 2013')
            } else if (value == 2014) {
              Map.addLayer(emay2014.updateMask(emay2014).clip(coastlineMask), {palette: ['Black']}, 'Coastline May 2014')
            } else if (value == 2015) {
              Map.addLayer(emay2015.updateMask(emay2015).clip(coastlineMask), {palette: ['Black']}, 'Coastline May 2015')
            } else if (value == 2016) {
              Map.addLayer(emay2016.updateMask(emay2016).clip(coastlineMask), {palette: ['Black']}, 'Coastline May 2016')
            } else if (value == 2017) {
              Map.addLayer(emay2017.updateMask(emay2017).clip(coastlineMask), {palette: ['Black']}, 'Coastline May 2017')
            } else if (value == 2018) {
              Map.addLayer(emay2018.updateMask(emay2018).clip(coastlineMask), {palette: ['Black']}, 'Coastline May 2018')
            } else if (value == 2019) {
              Map.addLayer(emay2019.updateMask(emay2019).clip(coastlineMask), {palette: ['Black']}, 'Coastline May 2019')
            } 
          }
      });
      ...
      var yearSelect21 = ui.Select({
        items: [
          ...
          onChange: function(value){
            //Summer - June - Years
            if (value == 2013) {
              Map.addLayer(ejune2013.updateMask(ejune2013).clip(coastlineMask), {palette: ['Black']}, 'Coastline June 2013')
            } else if (value == 2014) {
              Map.addLayer(ejune2014.updateMask(ejune2014).clip(coastlineMask), {palette: ['Black']}, 'Coastline June 2014')
            } else if (value == 2015) {
              Map.addLayer(ejune2015.updateMask(ejune2015).clip(coastlineMask), {palette: ['Black']}, 'Coastline June 2015')
            } else if (value == 2016) {
              Map.addLayer(ejune2016.updateMask(ejune2016).clip(coastlineMask), {palette: ['Black']}, 'Coastline June 2016')
            } else if (value == 2017) {
              Map.addLayer(ejune2017.updateMask(ejune2017).clip(coastlineMask), {palette: ['Black']}, 'Coastline June 2017')
            } else if (value == 2018) {
              Map.addLayer(ejune2018.updateMask(ejune2018).clip(coastlineMask), {palette: ['Black']}, 'Coastline June 2018')
            } else if (value == 2019) {
              Map.addLayer(ejune2019.updateMask(ejune2019).clip(coastlineMask), {palette: ['Black']}, 'Coastline June 2019')
            }
          }
      });
      ...
      var yearSelect22 = ui.Select({
        items: [
          ...
          onChange: function(value){
            //Summer - July - Years
            if (value == 2013) {
              Map.addLayer(ejuly2013.updateMask(ejuly2013).clip(coastlineMask), {palette: ['Black']}, 'Coastline July 2013')
            } else if (value == 2014) {
              Map.addLayer(ejuly2014.updateMask(ejuly2014).clip(coastlineMask), {palette: ['Black']}, 'Coastline July 2014')
            } else if (value == 2015) {
              Map.addLayer(ejuly2015.updateMask(ejuly2015).clip(coastlineMask), {palette: ['Black']}, 'Coastline July 2015')
            } else if (value == 2016) {
              Map.addLayer(ejuly2016.updateMask(ejuly2016).clip(coastlineMask), {palette: ['Black']}, 'Coastline July 2016')
            } else if (value == 2017) {
              Map.addLayer(ejuly2017.updateMask(ejuly2017).clip(coastlineMask), {palette: ['Black']}, 'Coastline July 2017')
            } else if (value == 2018) {
              Map.addLayer(ejuly2018.updateMask(ejuly2018).clip(coastlineMask), {palette: ['Black']}, 'Coastline July 2018')
            } else if (value == 2019) {
              Map.addLayer(ejuly2019.updateMask(ejuly2019).clip(coastlineMask), {palette: ['Black']}, 'Coastline July 2019')
            }
          }
      });
      ...
      var yearSelect23 = ui.Select({
        items: [
          ...
          onChange: function(value){
            //Summer - August - Years
            if (value == 2013) {
              Map.addLayer(eaugust2013.updateMask(eaugust2013).clip(coastlineMask), {palette: ['Black']}, 'Coastline August 2013')
            } else if (value == 2014) {
              Map.addLayer(eaugust2014.updateMask(eaugust2014).clip(coastlineMask), {palette: ['Black']}, 'Coastline August 2014')
            } else if (value == 2015) {
              Map.addLayer(eaugust2015.updateMask(eaugust2015).clip(coastlineMask), {palette: ['Black']}, 'Coastline August 2015')
            } else if (value == 2016) {
              Map.addLayer(eaugust2016.updateMask(eaugust2016).clip(coastlineMask), {palette: ['Black']}, 'Coastline August 2016')
            } else if (value == 2017) {
              Map.addLayer(eaugust2017.updateMask(eaugust2017).clip(coastlineMask), {palette: ['Black']}, 'Coastline August 2017')
            } else if (value == 2018) {
              Map.addLayer(eaugust2018.updateMask(eaugust2018).clip(coastlineMask), {palette: ['Black']}, 'Coastline August 2018')
            } else if (value == 2019) {
              Map.addLayer(eaugust2019.updateMask(eaugust2019).clip(coastlineMask), {palette: ['Black']}, 'Coastline August 2019')
            }
          }
      });
      ...
      var yearSelect31 = ui.Select({
        items: [
          ...
          onChange: function(value){
            ...
            if (value == 2013) {
              Map.addLayer(eseptember2013.updateMask(eseptember2013).clip(coastlineMask), {palette: ['Black']}, 'Coastline September 2013')
            } else if (value == 2014) {
              Map.addLayer(eseptember2014.updateMask(eseptember2014).clip(coastlineMask), {palette: ['Black']}, 'Coastline September 2014')
            } else if (value == 2015) {
              Map.addLayer(eseptember2015.updateMask(eseptember2015).clip(coastlineMask), {palette: ['Black']}, 'Coastline September 2015')
            } else if (value == 2016) {
              Map.addLayer(eseptember2016.updateMask(eseptember2016).clip(coastlineMask), {palette: ['Black']}, 'Coastline September 2016')
            } else if (value == 2017) {
              Map.addLayer(eseptember2017.updateMask(eseptember2017).clip(coastlineMask), {palette: ['Black']}, 'Coastline September 2017')
            } else if (value == 2018) {
              Map.addLayer(eseptember2018.updateMask(eseptember2018).clip(coastlineMask), {palette: ['Black']}, 'Coastline September 2018')
            } else if (value == 2019) {
              Map.addLayer(eseptember2019.updateMask(eseptember2019).clip(coastlineMask), {palette: ['Black']}, 'Coastline September 2019')
            }
          }
      });
      ...
      var yearSelect32 = ui.Select({
        items: [
          ...
          onChange: function(value){
            ...
            if (value == 2013) {
              Map.addLayer(eoctober2013.updateMask(eoctober2013).clip(coastlineMask), {palette: ['Black']}, 'Coastline October 2013')
            } else if (value == 2014) {
              Map.addLayer(eoctober2014.updateMask(eoctober2014).clip(coastlineMask), {palette: ['Black']}, 'Coastline October 2014')
            } else if (value == 2015) {
              Map.addLayer(eoctober2015.updateMask(eoctober2015).clip(coastlineMask), {palette: ['Black']}, 'Coastline October 2015')
            } else if (value == 2016) {
              Map.addLayer(eoctober2016.updateMask(eoctober2016).clip(coastlineMask), {palette: ['Black']}, 'Coastline October 2016')
            } else if (value == 2017) {
              Map.addLayer(eoctober2017.updateMask(eoctober2017).clip(coastlineMask), {palette: ['Black']}, 'Coastline October 2017')
            } else if (value == 2018) {
              Map.addLayer(eoctober2018.updateMask(eoctober2018).clip(coastlineMask), {palette: ['Black']}, 'Coastline October 2018')
            } else if (value == 2019) {
              Map.addLayer(eoctober2019.updateMask(eoctober2019).clip(coastlineMask), {palette: ['Black']}, 'Coastline October 2019')
            }
          }
      });
      ...
      var yearSelect33 = ui.Select({
        items: [
          ...
          onChange: function(value){
            ...
            if (value == 2013) {
              Map.addLayer(enovember2013.updateMask(enovember2013).clip(coastlineMask), {palette: ['Black']}, 'Coastline November 2013')
            } else if (value == 2014) {
              Map.addLayer(enovember2014.updateMask(enovember2014).clip(coastlineMask), {palette: ['Black']}, 'Coastline November 2014')
            } else if (value == 2015) {
              Map.addLayer(enovember2015.updateMask(enovember2015).clip(coastlineMask), {palette: ['Black']}, 'Coastline November 2015')
            } else if (value == 2016) {
              Map.addLayer(enovember2016.updateMask(enovember2016).clip(coastlineMask), {palette: ['Black']}, 'Coastline November 2016')
            } else if (value == 2017) {
              Map.addLayer(enovember2017.updateMask(enovember2017).clip(coastlineMask), {palette: ['Black']}, 'Coastline November 2017')
            } else if (value == 2018) {
              Map.addLayer(enovember2018.updateMask(enovember2018).clip(coastlineMask), {palette: ['Black']}, 'Coastline November 2018')
            } else if (value == 2019) {
              Map.addLayer(enovember2019.updateMask(enovember2019).clip(coastlineMask), {palette: ['Black']}, 'Coastline November 2019')
            }
          }
      });
      ...
      var yearSelect41 = ui.Select({
        items: [
          ...
          onChange: function(value){
            ...
            if (value == 2013) {
              Map.addLayer(edecember2013.updateMask(edecember2013).clip(coastlineMask), {palette: ['Black']}, 'Coastline December 2013')
            } else if (value == 2014) {
              Map.addLayer(edecember2014.updateMask(edecember2014).clip(coastlineMask), {palette: ['Black']}, 'Coastline December 2014')
            } else if (value == 2015) {
              Map.addLayer(edecember2015.updateMask(edecember2015).clip(coastlineMask), {palette: ['Black']}, 'Coastline December 2015')
            } else if (value == 2016) {
              Map.addLayer(edecember2016.updateMask(edecember2016).clip(coastlineMask), {palette: ['Black']}, 'Coastline December 2016')
            } else if (value == 2017) {
              Map.addLayer(edecember2017.updateMask(edecember2017).clip(coastlineMask), {palette: ['Black']}, 'Coastline December 2017')
            } else if (value == 2018) {
              Map.addLayer(edecember2018.updateMask(edecember2018).clip(coastlineMask), {palette: ['Black']}, 'Coastline December 2018')
            } else if (value == 2019) {
              Map.addLayer(edecember2019.updateMask(edecember2019).clip(coastlineMask), {palette: ['Black']}, 'Coastline December 2019')
            }
          }
      });
      ...
      var yearSelect42 = ui.Select({
        items: [
          ...
          onChange: function(value){
            ...
            if (value == 2013) {
              Map.addLayer(ejanuary2013.updateMask(ejanuary2013).clip(coastlineMask), {palette: ['Black']}, 'Coastline January 2013')
            } else if (value == 2014) {
              Map.addLayer(ejanuary2014.updateMask(ejanuary2014).clip(coastlineMask), {palette: ['Black']}, 'Coastline January 2014')
            } else if (value == 2015) {
              Map.addLayer(ejanuary2015.updateMask(ejanuary2015).clip(coastlineMask), {palette: ['Black']}, 'Coastline January 2015')
            } else if (value == 2016) {
              Map.addLayer(ejanuary2016.updateMask(ejanuary2016).clip(coastlineMask), {palette: ['Black']}, 'Coastline January 2016')
            } else if (value == 2017) {
              Map.addLayer(ejanuary2017.updateMask(ejanuary2017).clip(coastlineMask), {palette: ['Black']}, 'Coastline January 2017')
            } else if (value == 2018) {
              Map.addLayer(ejanuary2018.updateMask(ejanuary2018).clip(coastlineMask), {palette: ['Black']}, 'Coastline January 2018')
            } else if (value == 2019) {
              Map.addLayer(ejanuary2019.updateMask(ejanuary2019).clip(coastlineMask), {palette: ['Black']}, 'Coastline January 2019')
            }
          }
      });
      ...
      var yearSelect43 = ui.Select({
        items: [
          ...
          onChange: function(value){
            ...
            if (value == 2013) {
              Map.addLayer(efebruary2013.updateMask(efebruary2013).clip(coastlineMask), {palette: ['Black']}, 'Coastline February 2013')
            } else if (value == 2014) {
              Map.addLayer(efebruary2014.updateMask(efebruary2014).clip(coastlineMask), {palette: ['Black']}, 'Coastline February 2014')
            } else if (value == 2015) {
              Map.addLayer(efebruary2015.updateMask(efebruary2015).clip(coastlineMask), {palette: ['Black']}, 'Coastline February 2015')
            } else if (value == 2016) {
              Map.addLayer(efebruary2016.updateMask(efebruary2016).clip(coastlineMask), {palette: ['Black']}, 'Coastline February 2016')
            } else if (value == 2017) {
              Map.addLayer(efebruary2017.updateMask(efebruary2017).clip(coastlineMask), {palette: ['Black']}, 'Coastline February 2017')
            } else if (value == 2018) {
              Map.addLayer(efebruary2018.updateMask(efebruary2018).clip(coastlineMask), {palette: ['Black']}, 'Coastline February 2018')
            } else if (value == 2019) {
              Map.addLayer(efebruary2019.updateMask(efebruary2019).clip(coastlineMask), {palette: ['Black']}, 'Coastline February 2019')
            }
          }
      });
...
Map.setCenter(30.610205195875324,36.856314374878906 , 14)