        ...
        items: [
          ...
          onChange: function(value){
            ...
            if (value == 2013) {
              ...
              var histo131 = ui.Chart.image.histogram(bmay2013, poly , 1)
               panel.add(histogram131)
            } else if (value == 2014) {
              Map.addLayer(emay2014.updateMask(emay2014).clip(poly), {palette: ['Black']}, 'Coastline May 2014')
              var histo132 = ui.Chart.image.histogram(bmay2014, poly , 1)
               panel.add(histogram132)
            } else if (value == 2015) {
              Map.addLayer(emay2015.updateMask(emay2015).clip(poly), {palette: ['Black']}, 'Coastline May 2015')
              var histo133 = ui.Chart.image.histogram(bmay2015, poly , 1)
               panel.add(histogram133)
            } else if (value == 2016) {
              Map.addLayer(emay2016.updateMask(emay2016).clip(poly), {palette: ['Black']}, 'Coastline May 2016')
              var histo134 = ui.Chart.image.histogram(bmay2016, poly , 1)
               panel.add(histogram134)
            } else if (value == 2017) {
              Map.addLayer(emay2017.updateMask(emay2017).clip(poly), {palette: ['Black']}, 'Coastline May 2017')
              var histo135 = ui.Chart.image.histogram(bmay2017, poly , 1)
               panel.add(histogram135)
            } else if (value == 2018) {
              Map.addLayer(emay2018.updateMask(emay2018).clip(poly), {palette: ['Black']}, 'Coastline May 2018')
              var histo136 = ui.Chart.image.histogram(bmay2018, poly , 1)
               panel.add(histogram136)
            } else if (value == 2019) {
              Map.addLayer(emay2019.updateMask(emay2019).clip(poly), {palette: ['Black']}, 'Coastline May 2019')
              var histo137 = ui.Chart.image.histogram(bmay2018, poly , 1)
               panel.add(histogram137)
            } 
          }
      });
