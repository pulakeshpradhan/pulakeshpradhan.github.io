...
var decoy = 0
var label3 = ui.Label('Student: Raul DEATCU ', {position:'bottom-right',fontSize:'6px'});
Map.add(label3);
var label2 = ui.Label('Coordinator: Doç.Dr. BEKİR TANER SAN ', {position:'bottom-right',fontSize:'6px'});
Map.add(label2);
var label1 = ui.Label('Interactive application for bands analysis of Hyperion dataset in GEE using Javascript ', {position:'bottom-right',fontSize:'6px'});
Map.add(label1);
var panel = ui.Panel();
panel.style().set({
  width: '120px',
