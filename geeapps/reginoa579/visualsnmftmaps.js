...
//Agregar utilidades
var constantes = require('users/infonamonitoreo/SSMT:tools/constantes');
var funciones = require('users/infonamonitoreo/SSMT:tools/funciones');
//----------------------------Interfaz de usuario
...
var titulo = ui.Label('Mapas de Cambios en la Cobertura Forestal', {'fontWeight': 'bold',fontSize: '16px', color: '0b1176',backgroundColor: 'white'});
...
var texto = ui.Label(
    'Sistema Nacional de Monitoreo Forestal - Sistema de Monitoreo de Bosques',
...
// Interfaz de Usuario
panel.add(ui.Label('Elegir Mapa de Cobertura Forestal', {'fontWeight': 'bold','font-size': '14px',color: '0b1176',backgroundColor: 'white'}));
