var geometry = ui.import && ui.import("geometry", "geometry", {
    ...
    ee.Geometry.Polygon(
        [[[-55.120014179502704, -10.792760967594567],
          [-55.120014179502704, -14.394701748521213],
          [-48.967670429502704, -14.394701748521213],
          [-48.967670429502704, -10.792760967594567]]], null, false);
...
var AREA_GRAFICO =  ui.Panel({
    ...
    widgets:[ui.Label({
      ...
      'Dados de Evapotranspiração da coleção MOD16A2.006: Terra Net Evapotranspiration 8-Day Global 500m.',
      style:{fontSize: '16px',}
...
var modis_et = ee.ImageCollection("MODIS/006/MOD16A2")
.filterBounds(aoi)
.select('ET');
var byAnual_ET = ee.ImageCollection.fromImages(
      years.map(function (y) {
        return modis_et.filter(ee.Filter.calendarRange(y, y, 'year'))
                    .sum()
                    .multiply(0.1)
                    .set('year', y)
                    .clip(area_de_estudo)
