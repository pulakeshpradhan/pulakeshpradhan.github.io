var Jakarta = ui.import && ui.import("Jakarta", "table", {
      "id": "users/syefiarahania/SHP_Kota_Jakarta"
    }) || ee.FeatureCollection("users/syefiarahania/SHP_Kota_Jakarta"),
...
var aoi = ee.FeatureCollection(Jakarta);
...
//Membuat Judul
var title = ui.Label({
  value: 'Analisis Dampak Bencana Banjir Jakarta 2020',
  style:{
  fontWeight: 'bold',
  fontSize: '25px'
  }});
