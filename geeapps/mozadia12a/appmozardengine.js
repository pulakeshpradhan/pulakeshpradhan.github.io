...
var geometry = ee.FeatureCollection('projects/ee-mozadia12a/assets/VraiLimite_Niayes');
...
*/
var geometry = ee.FeatureCollection('projects/ee-mozadia12a/assets/VraiLimite_Niayes');
Map.addLayer(geometry, {}, 'limite niayes');
...
Map.addLayer(ls.median().clip(geometry), vis, 'NDVI');
// Configure the map.
