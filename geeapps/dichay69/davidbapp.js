var table = ui.import && ui.import("table", "table", {
      "id": "projects/ee-dichay69/assets/WheatCoPantagar"
    }) || ee.FeatureCollection("projects/ee-dichay69/assets/WheatCoPantagar");
//Sentinel 2 Explorer 
...
app.createPanels = function() {
  ...
  app.filters = {
    ...
    endDate: ui.Textbox('YYYY-MM-DD', '2021-12-23'),
  ...
  app.VIS_OPTIONS = {
    'NDVI (B8-B4/B8+B4)': {
      description: 'Vegetation index  ' +
                   '',
      visParams:  {min: 0.1, max: 0.9,  bands: ['nd'], palette: 'FF0000, FFFF00, 00FF00, 0000FF'}
    },
...
app.boot = function() {
  ...
  Map.setCenter(34.664, 31.33278, 9); 
