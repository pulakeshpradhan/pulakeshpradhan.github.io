...
var ts_title = ui.Label("Nhập các thông số thời gian để tính ngập-lụt trên ảnh vệ tinh Sentinel-1",titleTextVis);
...
////////////////////////////////////////////////////////DATE SET UP//////////////////////////
   ...
   var lastMonth = dateNow.advance(-3, 'month').format ("YYYY-MM-dd");
...
//Today-12m´s date as the default end date of the regression. 
   var lastMonth1 = dateNow.advance(-6, 'month').format ("YYYY-MM-dd");
   var lastMonth2 = dateNow.advance(-9, 'month').format ("YYYY-MM-dd");
...
var title = ui.Label('Kết quả'+ " - " + title_tinh.getValue(), titleTextVis);
...
// Produced by...
var text7 = ui.Label('Mã nguồn: UN-SPIDER December 2019 và được VTGEO-IGS (ntthanh@igsvn.vast.vn) hiệu chỉnh theo lãnh thổ Việt Nam', subTextVis)
