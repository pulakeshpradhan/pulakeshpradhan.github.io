...
var lastDay = dateNow.advance(-2, 'day').format ("YYYY-MM-dd");
...
var precip_mean = precipitation.reduce(ee.Reducer.sum())
...
var conditionA1 = precip_mean.gt(20);
...
var conditionA12 = slope_per.updateMask(conditionA2).and(slope_per.updateMask(conditionA3)).and(precip_mean.updateMask(conditionA1));                                                           
...
var filter = ee.Filter.gt('count',1000);
...
var mua_all = ui.Button({
  ...
  onClick: function() {
    Map.clear();
conditionA1 = precip_mean.gt(20);
conditionA2 = slope_per.gt(14);
conditionA3 = slope_per.lt(26);
//var conditionA12 = image0.updateMask(conditionA1).add(slope_per.updateMask(conditionA2).and(slope_per.updateMask(conditionA3)));
conditionA12 = slope_per.updateMask(conditionA2).and(slope_per.updateMask(conditionA3)).and(precip_mean.updateMask(conditionA1));                                                           
...
//var selector = ui.Select(dates)
    ...
    selector.onChange(function(anh){
     ...
     var image0 = ee.Image(anh)
             ...
             .clip(vn)
             .rename('jaxa');
conditionA1 = image0.gt(5);
conditionA2 = slope_per.gt(14);
conditionA3 = slope_per.lt(26);
//var conditionA12 = image0.updateMask(conditionA1).add(slope_per.updateMask(conditionA2).and(slope_per.updateMask(conditionA3)));
conditionA12 = slope_per.updateMask(conditionA2).and(slope_per.updateMask(conditionA3)).and(image0.updateMask(conditionA1));                                                           
...
var txttitle = ui.Label({
  value: 'CẢNH BÁO TRƯỢT LỞ DO MƯA - ' +nowStr,
