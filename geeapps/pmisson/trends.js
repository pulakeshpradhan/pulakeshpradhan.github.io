var imageCollection = ui.import && ui.import("imageCollection", "imageCollection", {
    ...
    imageCollection2 = ui.import && ui.import("imageCollection2", "imageCollection", {
      "id": "MODIS/MCD43B3"
    }) || ee.ImageCollection("MODIS/MCD43B3");
...
var albedoS = ee.ImageCollection([albedo02,albedo12,albedo22,albedo32,albedo42,albedo52,albedo62,albedo72,albedo82,albedo92]).median();
print(albedoS);
...
var collectionS = ee.ImageCollection([collection02,collection12,collection22,collection32,collection42,collection52,collection62,collection72,collection82,collection92]);
var collectionSX = ee.ImageCollection([collection021,collection121,collection221,collection321,collection421,collection521,collection621,collection721,collection821,collection921]);
