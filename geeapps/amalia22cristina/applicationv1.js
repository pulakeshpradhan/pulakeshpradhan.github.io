var sentinel2 = ui.import && ui.import("sentinel2", "imageCollection", {
    ...
    s2 = ui.import && ui.import("s2", "image", {
      "id": "COPERNICUS/S2/20150828T110656_20160412T015159_T30SVG"
    }) || ee.Image("COPERNICUS/S2/20150828T110656_20160412T015159_T30SVG"),
    sentinel1 = ui.import && ui.import("sentinel1", "imageCollection", {
      "id": "COPERNICUS/S2"
    }) || ee.ImageCollection("COPERNICUS/S2"),
    table = ui.import && ui.import("table", "table", {
      "id": "users/amalia22cristina/exampleAssetId"
    }) || ee.FeatureCollection("users/amalia22cristina/exampleAssetId"),
    app = ui.import && ui.import("app", "imageVisParam", {
      "params": {}
    }) || {},
    table2 = ui.import && ui.import("table2", "table", {
      "id": "users/amalia22cristina/InputData"
    }) || ee.FeatureCollection("users/amalia22cristina/InputData"),
    elevation = ui.import && ui.import("elevation", "image", {
      "id": "CGIAR/SRTM90_V4"
    }) || ee.Image("CGIAR/SRTM90_V4"),
    temperature = ui.import && ui.import("temperature", "imageCollection", {
      "id": "MODIS/006/MOD11A1"
    }) || ee.ImageCollection("MODIS/006/MOD11A1"),
    teritory = ui.import && ui.import("teritory", "table", {
      "id": "USDOS/LSIB_SIMPLE/2017"
    }) || ee.FeatureCollection("USDOS/LSIB_SIMPLE/2017"),
    precipitations = ui.import && ui.import("precipitations", "imageCollection", {
    ...
    table3 = ui.import && ui.import("table3", "table", {
      "id": "users/amalia22cristina/PointName"
    }) || ee.FeatureCollection("users/amalia22cristina/PointName"),
    geometry = ui.import && ui.import("geometry", "geometry", {
      ...
      "shown": true,
      "locked": false
    }) || /* color: #9999ff */ee.Geometry.Polygon(
...
function addPointToTable(){
  var features = ee.Feature(null, {"name": point_name.getValue(), "longitude": long_coords.getValue()});
  print('features ', features);            
  //return f;
  ee.batch.Export.table.toDrive({
    collection: features,
    description:'myObservableDescription',
    fileFormat: 'CSV',
    folder: 'Data'
  });
}
