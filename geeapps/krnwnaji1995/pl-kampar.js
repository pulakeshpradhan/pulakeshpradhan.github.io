var geometry = ui.import && ui.import("geometry", "table", {
      "id": "users/krnwnaji1995/Riau_Prov"
    }) || ee.FeatureCollection("users/krnwnaji1995/Riau_Prov"),
    titikHotspot = ui.import && ui.import("titikHotspot", "table", {
      "id": "users/krnwnaji1995/titik_MODIS_med"
    }) || ee.FeatureCollection("users/krnwnaji1995/titik_MODIS_med");
//===========================================================================================
...
var prefire_start = '2021-12-01';   
var prefire_end = '2022-01-01';
// Now set the same parameters for AFTER the fire.
var postfire_start = '2022-02-20';
var postfire_end = '2022-03-07';
//*******************************************************************************************
