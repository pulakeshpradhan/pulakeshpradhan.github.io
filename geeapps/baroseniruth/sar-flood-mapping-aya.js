var geometry = ui.import && ui.import("geometry", "geometry", {
    ...
    /* shown: false */
    ee.Geometry.Polygon(
        [[[100.19127799326753, 14.204273989846778],
          [100.25994254404878, 14.124381592897281],
          [100.50438834483003, 14.081760839126405],
          [100.85595084483003, 14.182972100783742],
          [100.85045768076753, 14.292123064195895],
          [100.82848502451753, 14.45973952426073],
          [100.81200553233003, 14.584704505897154],
          [100.71038199717378, 14.653803656299472],
          [100.54833365733003, 14.720224605215495],
          [100.43847037608003, 14.683031360012254],
          [100.37804557139253, 14.595336558539602],
          [100.32036734873628, 14.54748828108399],
          [100.19677115733003, 14.518242559334682],
          [100.15282584483003, 14.363974075707391],
          [100.15282584483003, 14.246871751854156]]]),
    tambon = ui.import && ui.import("tambon", "table", {
      "id": "users/baroseniruth/SubDistrict_AYA"
    }) || ee.FeatureCollection("users/baroseniruth/SubDistrict_AYA");
/*===========================================================================================
...
var geometry = ee.FeatureCollection(tambon)
...
Map.add(legend);
Map.addLayer(tambon.draw("green"),{},"ตำบลในจังหวัดพระนครศรีอยุธยา");