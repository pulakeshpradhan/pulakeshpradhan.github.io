var admin2 = ui.import && ui.import("admin2", "table", {
      "id": "FAO/GAUL_SIMPLIFIED_500m/2015/level2"
    }) || ee.FeatureCollection("FAO/GAUL_SIMPLIFIED_500m/2015/level2"),
    gswYearly = ui.import && ui.import("gswYearly", "imageCollection", {
...
var filtered = admin2.filter(ee.Filter.eq('ADM1_NAME', 'Greater Accra'))
...
var authorLabel = ui.Label('App for GEE class')
authorPanel.add(authorLabel)
ui.root.add(authorPanel);
Map.setCenter(-0.1,5.5, 8)
