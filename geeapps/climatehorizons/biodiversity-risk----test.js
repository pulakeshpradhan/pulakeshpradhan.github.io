 ...
 * Updated on: 4/3/2020.
 */
var loadingPanel = ui.Panel([ui.Label('Loading...')])
ui.root.add(loadingPanel);
/**
...
var thumbnailTim = ui.Chart(
  [
    ['<img src=https://i.ibb.co/zV04vwN/Timing-thumbnail.png height=250px>'],
  ],
  'Table', {allowHtml: true});
var thumbnailMag = ui.Chart(
  [
    ['<img src=https://i.ibb.co/rdfbdRk/Magnitude-thumbnail.png height=250px>'],
  ],
  'Table', {allowHtml: true});
var thumbnailAbr = ui.Chart(
  [
    ['<img src=https://i.ibb.co/1R0RrFL/Abruptness-thumbnail.png height=250px>'],
  ],
  'Table', {allowHtml: true});
