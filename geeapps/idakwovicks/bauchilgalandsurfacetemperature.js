var table = ui.import && ui.import("table", "table", {
      "id": "users/idakwovicks/Bauchi_LGA"
    }) || ee.FeatureCollection("users/idakwovicks/Bauchi_LGA");
//cloud mask
...
//median
{
var ndvi = clipped.normalizedDifference(['B5', 
'B4']).rename('NDVI');
...
var thermal= clipped.select('B10').multiply(0.1);
