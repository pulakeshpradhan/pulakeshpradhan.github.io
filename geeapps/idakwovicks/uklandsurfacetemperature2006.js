var table = ui.import && ui.import("table", "table", {
      "id": "users/idakwovicks/England"
    }) || ee.FeatureCollection("users/idakwovicks/England");
// Import country boundaries feature collection.
var dataset = ee.FeatureCollection('USDOS/LSIB_SIMPLE/2017');
// Apply filter where country name equals Uganda.
var ugandaBorder = dataset.filter(ee.Filter.eq('country_na', 'United Kingdom'));
...
var clippedLSTc = modLSTc.mean().clip(table);
