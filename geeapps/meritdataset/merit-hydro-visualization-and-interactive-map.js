...
panel.add(ui.Label('Terrain layer with "Elevation" and "Hand" (Height above the nearest drainage).',
      {margin:'4px 4px 0 12px'}));
panel.add(ui.Label('Source Code for the APP:', {fontWeight: 'bold', fontSize:'16px', margin:'24px 0 0 8px'}));
panel.add(ui.Label('https://github.com/google/earthengine-', {margin:'2px 0px 0 12px', color: 'blue'}));
panel.add(ui.Label('community/blob/master/datasets/', {margin:'2px 0px 0 12px', color: 'blue'}));
panel.add(ui.Label('scripts/Hydro_Visualization.js', {margin:'2px 0px 0 12px', color: 'blue'}));
