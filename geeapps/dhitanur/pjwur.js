var geometry = ui.import && ui.import("geometry", "table", {
      "id": "users/dhitanur/JAKARTA_PROV"
    }) || ee.FeatureCollection("users/dhitanur/JAKARTA_PROV");
//Menentukan periode sebelum banjir
var before_start= '2019-12-15';
var before_end='2019-12-31';
//Menentukan waktu setelah banjir
var after_start='2020-01-01';
var after_end='2020-01-20';
...
// Diolah oleh...
var text7 = ui.Label('Script dasar dibuat oleh: UN-SPIDER pada Desember 2019 dan dimodifikasi oleh Dhita Nur Savitri pada November 2021 untuk Analisis Banjir DKI Jakarta 2020', subTextVis)
...
Map.add(legend);
//Export Peta Emisi NO2 Sesudah Kebakaran ke GDrive dalam, format CSV
Export.table.toDrive({
  collection: ee.FeatureCollection(collection),
  description: 'AnalisisDampakBanjirDKIJakarta2020',
  fileFormat: 'CSV'
})