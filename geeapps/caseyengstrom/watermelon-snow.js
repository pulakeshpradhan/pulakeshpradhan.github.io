var forestPath = ui.import && ui.import("forestPath", "table", {
      "id": "projects/ee-caseyengstrom/assets/globalSnowAlgae/2_trainDat/trainclean2_trees"
    }) || ee.FeatureCollection("projects/ee-caseyengstrom/assets/globalSnowAlgae/2_trainDat/trainclean2_trees"),
    algaeMap = ui.import && ui.import("algaeMap", "imageCollection", {
      "id": "projects/ee-caseyengstrom/assets/globalSnowAlgae/3_algaeMaps2/aaatrainclean2T"
    }) || ee.ImageCollection("projects/ee-caseyengstrom/assets/globalSnowAlgae/3_algaeMaps2/aaatrainclean2T"),
    validationFinal = ui.import && ui.import("validationFinal", "table", {
      "id": "projects/ee-caseyengstrom/assets/globalSnowAlgae/validation_final"
    }) || ee.FeatureCollection("projects/ee-caseyengstrom/assets/globalSnowAlgae/validation_final"),
    threshImage = ui.import && ui.import("threshImage", "image", {
      "id": "projects/ee-caseyengstrom/assets/globalSnowAlgae/threshImage"
    }) || ee.Image("projects/ee-caseyengstrom/assets/globalSnowAlgae/threshImage"),
    na2019 = ui.import && ui.import("na2019", "imageCollection", {
      "id": "projects/ee-caseyengstrom/assets/globalSnowAlgae/3_algaeMaps4/2019"
    }) || ee.ImageCollection("projects/ee-caseyengstrom/assets/globalSnowAlgae/3_algaeMaps4/2019"),
    na2020 = ui.import && ui.import("na2020", "imageCollection", {
      "id": "projects/ee-caseyengstrom/assets/globalSnowAlgae/3_algaeMaps4/2020"
    }) || ee.ImageCollection("projects/ee-caseyengstrom/assets/globalSnowAlgae/3_algaeMaps4/2020"),
    na2021 = ui.import && ui.import("na2021", "imageCollection", {
      "id": "projects/ee-caseyengstrom/assets/globalSnowAlgae/3_algaeMaps4/2021"
    }) || ee.ImageCollection("projects/ee-caseyengstrom/assets/globalSnowAlgae/3_algaeMaps4/2021"),
    na2022 = ui.import && ui.import("na2022", "imageCollection", {
      "id": "projects/ee-caseyengstrom/assets/globalSnowAlgae/3_algaeMaps4/2022"
    }) || ee.ImageCollection("projects/ee-caseyengstrom/assets/globalSnowAlgae/3_algaeMaps4/2022"),
    glacierImage = ui.import && ui.import("glacierImage", "image", {
      "id": "projects/ee-caseyengstrom/assets/globalSnowAlgae/1_glacierImages2/northAmerica_4"
    }) || ee.Image("projects/ee-caseyengstrom/assets/globalSnowAlgae/1_glacierImages2/northAmerica_4");
/*
POTENTIAL PROBLEMS:
TO DO:
...
*/
// var pp = ee.Geometry.Point([-149.804774037823,60.154160101675195]) //ganey et al 2017 point
// // Map.addLayer(pp)
// Map.layers().set(8, ui.Map.Layer(validationFinal, {}, "val")); 
// var mypt = validationFinal.filter(ee.Filter.eq('pt_id',202))
// print(mypt)
// Map.centerObject(mypt)
...
// add the new 10 m north american distribution to the global map -------------------------------
var naThresh = 0.27
na2022 = na2022.mosaic().select('CLASS_PROB')
na2021 = na2021.mosaic().select('CLASS_PROB')
na2020 = na2020.mosaic().select('CLASS_PROB')
na2019 = na2019.mosaic().select('CLASS_PROB')
var naProb = ee.ImageCollection([na2022,na2021,na2020,na2019])
  .max()
var naAlgae = naProb.gt(naThresh).selfMask().rename('CLASS')
  .addBands(naProb)
validationFinal = validationFinal.filter(ee.Filter.inList('region',
  ['alaskaPeninsula','cascades','alaskaRange','coastNorth','coastSouth','northAmerica','interiorNorth','interiorSouth']))
//--------------------------------------------------------------------------
...
var getImages = function(roi){
  ...
  var classifiedMosaics = weeklyMosaics.map(function(image){
    ...
    var classification = probability.gt(naThresh); // masked by RGND, a binary image
...
Map.addLayer(naAlgae.select('CLASS_PROB'), {palette:palettes.matplotlib.viridis[7]}, "Occurrence probability (all yrs)", false); // layer 0
Map.addLayer(naAlgae.select('CLASS'),{min:0, max:1, palette:['white','red']},"Occurrence range (all yrs)")
...
var panel = ui.Panel({style: {width: '500px'}})
  .insert(0, ui.Label({
      value: "Red snow on glaciers",
      style: {fontSize: '24px', color: '000000'}
    }))
  .insert(1, ui.Label("User guide").setUrl("https://drive.google.com/file/d/1Yok10BhjEZ6VQwD6S_PPAuetJM6dc8jT/view?usp=drive_link"))
  .insert(2, ui.Label("citation: Engstrom and Quarmby (in revision) Satellite mapping of red \
        snow on North American glaciers"))
  .insert(3, ui.Label({
      value: "Map validation grid cells:",
      style: {fontSize: '18px', color: '000000'}
  }))
  .insert(4, ui.Label("Points ordered from high to low probability"))
