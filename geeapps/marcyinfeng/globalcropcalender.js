...
var title = ui.Label('Global Crop Calendar', 
      {whiteSpace: 'pre',  
      position: 'top-center',
      fontFamily: 'Sans-serif',
      fontSize:  '24px',
...
function addPanel(list){  
  ...
  var controlPanel = ui.Panel({
    ...
    ui.Label('2. Click on the colored regions to check the planting and harvesting dates.',
      ...
      ui.Label('This App is based on the Crop Calendar Dataset developed by Sacks, W.J., etc. from Center for Sustainability and the Global Environment (SAGE) University of Wisconsin-Madison. For more information about it, please refer to:', 
        {//whiteSpace: 'pre',  
        position: 'bottom-left',
        fontFamily: 'Sans-serif',
        border: 1,
    ...
    ui.Label({
        value:"Sacks, W.J., D. Deryng, J.A. Foley, and N. Ramankutty (2010). Crop planting dates: an analysis of global patterns. Global Ecology and Biogeography 19, 607-620. DOI: 10.1111/j.1466-8238.2010.00551.x",
        style:{
        position: 'bottom-left',
        fontFamily: 'Sans-serif',
        // fontSize:  '24px',
