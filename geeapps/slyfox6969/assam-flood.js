...
var geometry = ee.FeatureCollection("users/slyfox6969/NAME_1_Assam");
/***** End of imports. If edited, may not auto-convert in the playground. *****/
var before_start= '2022-02-10';
var before_end='2022-02-20';
// Now set the same parameters for AFTER the flood.
var after_start='2022-05-10';
var after_end='2022-05-23';
/********************************************************************************************
...
var crop_area_ha = crop_stats
  ...
  .divide(10000)
  .round();
Map.setCenter(91.322, 26.4075,10)
//------------------------------  DISPLAY PRODUCTS  ----------------------------------//
...
var title = ui.Label('Flood Mapping and Damage Assesment in Assam', titleTextVis);
...
var text6 = ui.Label('Assam Flood 2020.',subTextVis)
var text7 = ui.Label('Developed by Souvik Sankar Mitra, Research Scientist, Indian Institute of Remote Sensing', textVis)
