...
Map.add(ui.Label(
    'Explorador de la Población Mundial', {fontWeight: 'bold', fontSize: '24px'}));
/*
...
function makeResultsBarChart(countries) {
  ...
  chart.setOptions({
    title: 'Comparación de la Población',
    vAxis: {title: null},
    hAxis: {title: 'Población Aproximada en 2015', minValue: 0}
  });
...
function clearResults() {
  ...
  var instructionsLabel = ui.Label('Seleccionar regiones para comparar la población.');
...
var chartTypeToggleButton = ToggleButton(
    [
      {
        label: 'Visualizar resultados en forma de tabla',
        value: makeResultsBarChart,
      },
      {
        label: 'Visualizar los resultados en forma de gráfico',
...
Map.add(ui.Panel(
    [
      ...
      ui.Label(
          '(miles de personas por kilómetro cuadrado)', LEGEND_FOOTNOTE_STYLE),
      ui.Label(
          'Fuente: Global Human Settlement Layer (JRC)', LEGEND_FOOTNOTE_STYLE),
      ui.Label('Límites de los países fuente: USDOS LSIB', LEGEND_FOOTNOTE_STYLE)
    ],
