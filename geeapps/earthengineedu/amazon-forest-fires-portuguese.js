...
Map.addLayer(Amazonia, {}, 'Frontière Amazonienne')
Map.addLayer(august2019Fires, {palette: ['bd0026']}, 'Incendies d\'août 2019');
Map.addLayer(august2015, {palette: ['f03b20']}, 'Incendies d\'août 2015');
Map.addLayer(august2010, {palette: ['fd8d3c']}, 'Incendies d\'août 2010');
Map.addLayer(august2005, {palette: ['fecc5c']}, 'Incendies d\'août 2005');
var panel = ui.Panel()
panel.style().set({
  maxHeight: '700px',
  maxWidth: '450px',
...
var title = ui.Label({
  value: 'Application de Cartographie des Incendies Amazon',
...
var text = ui.Label({
  value: 'Utilisez cette application pour cartographier et tracer les changements dans l\'étendue des incendies de forêt dans la forêt amazonienne au cours de la dernière décennie, '+
  'et comparer l\'emplacement des feux de forêt à la répartition de la déforestation dans la région. ',
  style: {fontSize: '14px',
    fontWeight: 'bold',
    color: '#9E9E9E',
    padding: '8px',
...
var hansenText = ui.Label({
  value: 'Cette carte montre la répartition de la déforestation en Amazonie de 2000 à 2019. Considérer le chevauchement spatial entre les régions de déforestation et les points chauds de feu. Les cartes ont été acquises à partir de l\'ensemble de données Hansen Global Forest Change v1.6. ',
  style: {fontSize: '14px',
    fontWeight: 'bold',
    color: '#9E9E9E',
    padding: '8px',
...
Map.addLayer(hansenForestChange, {palette: '00FFFF'}, 'Étendue de la déforestation 2000-2019')
var index4 = 4
var check4 = ui.Checkbox('Étendue de la déforestation 2000-2019', true);
