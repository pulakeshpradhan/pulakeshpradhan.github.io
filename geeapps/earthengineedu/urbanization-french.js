...
var title = ui.Label({
  value: 'Explorateur d\'Urbanisation',
...
var text = ui.Label({
  value: 'La Terre connaît actuellement la plus grande période d\'urbanisation de son histoire, dont une grande partie en Afrique et en Asie. Les données des lumieres nocturnes sont considérées comme une approximation des établissements humains et peuvent être utilisées pour modéliser l\'urbanisation, l\'activité économique et les changements d\'utilisation des terres à l\'échelle mondiale. Cette application fournit des visualisations locales à mondiales pertinentes des changements de l\'éclairage nocturne au fil du temps dans plusieurs des villes qui connaissent la croissance la plus rapide sur Terre.',
  style: {fontSize: '14px',
    fontWeight: 'bold',
    color: '#9E9E9E',
    padding: '8px',
...
var directionsRCPSelection = ui.Label({
  value: 'Sélectionnez une ville à afficher.', 
  style: {fontSize: '14px',
    fontWeight: 'bold',
    color: '#9E9E9E',
    padding: '8px',
...
var directionsClickingPoints = ui.Label({
  value: 'Cliquez sur un point pour tracer l\'évolution de l\'intensité lumineuse dans le temps.', 
  style: {fontSize: '14px',
    fontWeight: 'bold',
    color: '#9E9E9E',
    padding: '8px',
...
var label = ui.Label('Intensité lumineuse pour l\'année');
...
.setOptions({
  title: 'Nightlights Série Chronologique 1992-2017',
  colors: ['FF0000'],
  hAxis: {title:'Année'}, 
  vAxis: {title: 'Intensité Lumineuse'},
