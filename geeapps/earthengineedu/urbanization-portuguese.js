...
var title = ui.Label({
  value: 'Explorador de Urbanização',
...
var text = ui.Label({
  value: 'Atualmente, a Terra está passando pelo maior período de urbanização da história, muito do qual acontece na África e na Ásia. Os dados de luzes noturnas são considerados uma proxy para assentamentos humanos e podem ser usados ​​para modelar a urbanização, a atividade econômica e as mudanças no uso da terra em escala global. Este aplicativo fornece visualizações relevantes em escala local para global das mudanças nas luzes noturnas ao longo do tempo em várias das cidades que mais crescem na Terra. ',
  style: {fontSize: '14px',
    fontWeight: 'bold',
    color: '#9E9E9E',
    padding: '8px',
...
var directionsRCPSelection = ui.Label({
  value: 'Selecione uma cidade para visualizar.', 
  style: {fontSize: '14px',
    fontWeight: 'bold',
    color: '#9E9E9E',
    padding: '8px',
...
var directionsClickingPoints = ui.Label({
  value: 'Clique em um ponto para plotar mudanças em intensidade de luz. ', 
  style: {fontSize: '14px',
    fontWeight: 'bold',
    color: '#9E9E9E',
    padding: '8px',
...
var label = ui.Label('Intensidade de Luz por Ano');
...
.setOptions({
  title: 'Luzes Nocturnas Série Cronológica 1992-2013',
  colors: ['FF0000'],
  hAxis: {title:'Ano'}, 
  vAxis: {title: 'Intensidade de Luz'},
