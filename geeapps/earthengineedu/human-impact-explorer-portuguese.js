...
var legendTitle = ui.Label({
  value: 'Lenda das Luzes Nocturnas',
  style: {
    fontWeight: 'bold',
    fontSize: '12px',
    margin: '0 0 4px 0',
...
// Name of each legend value
var names2 = ['Baixo', 'Moderado', 'Alto', 'Muito alto'];
// Add color and and names to legend
for (var i = 0; i < 4; i++) {
...
// Create legend title
var legendTitle = ui.Label({
  value: 'Superfícies Impermeáveis Legenda',
  style: {
    fontWeight: 'bold',
    fontSize: '12px',
    margin: '0 0 4px 0',
...
// Name of each legend value
var names2 = ['Não construído', 'Construído até 1975 época', 'Criada de 1975 a 1990', 'Criada de 1990 a 2000', 'Criada de 2000 a 2014'];
// Add color and and names to legend
for (var i = 0; i < 5; i++) {
...
// Create legend title
var legendTitle = ui.Label({
  value: 'Legenda da densidade populacional',
  style: {
    fontWeight: 'bold',
    fontSize: '12px',
    margin: '0 0 4px 0',
...
// Name of each legend value
var names2 = ['0 pessoas/km²', '', '', '', '650 pessoas/km²'];
// Add color and and names to legend
for (var i = 0; i < 5; i++) {
...
// Create legend title
var legendTitle = ui.Label({
  value: 'Lenda da Modificação Humana Global',
  style: {
    fontWeight: 'bold',
    fontSize: '12px',
    margin: '0 0 4px 0',
...
var title = ui.Label({ 
  value: 'Mapeamento Global da Influência Humana',
...
var text = ui.Label({
  value: 'O impacto antropogênico na Terra ocorre de várias formas, através da infraestrutura de transporte ao crescimento da população. O Mapa Global de Modificações Humanas (Global Human Modification Map - gHM) quantificou o impacto humano acumulado em todas as áreas terrestres da Terra. Explore o mapa gHM e as suas layers individuais de impacto humano em escala global.',
  style: {fontSize: '14px',
    fontWeight: 'bold',
    color: '#9E9E9E',
    padding: '8px',
...
var HUMANMOD = 'Modificação Humana Global'
var POPDENSITY = 'Densidade Populacional'
var BUILTUP= 'Superfícies Impermeáveis'
var AGRICULTURE = 'Agricultura'
var ROADS = 'Estradas'
var NIGHTLIGHTS = 'Luzes Nocturnas'
...
panel.add(text);
panel.add(ui.Label({
  value: 'Experimente com os seguintes seletores para visualizar e comparar os mapas de influência humana à esquerda.',
  style: {
      // border: BORDER_STYLE,
      padding: '10px',
      margin: '5px',
...
panel.add(ui.Label({
  value: 'Clique em um país para calcular estatísticas nacionais usando o mapa global de modificação humana. ',
  style: {
      // border: BORDER_STYLE,
      padding: '10px',
      margin: '5px',
...
var gHMLevelsChart = ui.Chart.feature.byProperty(
   feature, ['Baixo', 'Médio', 'Elevado', 'Muito Elevado']
   );
   gHMLevelsChart.setChartType('PieChart');
   gHMLevelsChart.setOptions({
    title: 'Proporção de área em níveis de modificação humana' ,
