var aconcagua_cuenca = ui.import && ui.import("aconcagua_cuenca", "table", {
    ...
    snowyearly = ui.import && ui.import("snowyearly", "imageCollection", {
      "id": "users/observatorionieves/Landsat/Snow_Yearly"
    }) || ee.ImageCollection("users/observatorionieves/Landsat/Snow_Yearly");
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
var images = {
  '1989'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/1989')),
  '1990'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/1990')),
  '1991'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/1991')),
  '1992'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/1992')),
  '1993'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/1993')),
  '1994'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/1994')),
  '1995'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/1995')),
  '1996'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/1996')),
  '1997'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/1997')),
  '1998'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/1998')),
  '1999'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/1999')),
  '2000'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2000')),
  '2001'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2001')),
  '2002'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2002')),
  '2003'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2003')),
  '2004'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2004')),
  '2005'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2005')),
  '2006'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2006')),
  '2007'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2007')),
  '2008'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2008')),
  '2009'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2009')),
  '2010'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2010')),
  '2011'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2011')),
  '2012'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2012')),
  '2013'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2013')),
  '2014'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2014')),
  '2015'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2015')),
  '2016'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2016')),
  '2017'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2017')),
  '2018'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2018')),
  '2019'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2019')),
  '2020'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Yearly/2020')),
};
var landsat = ee.Image('users/observatorionieves/Landsat/Snow_Yearly/1989')
//------------------------------------------------------------------------------------------------------------------------------------------
///////////////////////////////////////////////// Split panel //////////////////////////////////////////////////////////////////////////////
//------------------------------------------------------------------------------------------------------------------------------------------
...
///////////////////////////////////////////Gráficos//////////////////////////////////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------------------------------------------------------------------------------------
// Serie de tiempo mensual /Timelapses 1989-2020 
var chartbyYear = 
  ui.Chart.image.series({
    imageCollection: snowyearly,
    region: subsubcuencas_ms,
    reducer: ee.Reducer.mean(),
    scale: 500,
    xProperty:'year'
  }).setSeriesNames(["NDSI Landsat"])
    .setOptions({
    title: 'Promedio anual NDSI sobre las subcuencas media y alta del Rio Aconcagua, usando Landsat. 1989-2020',
...
var subtitle = ui.Label('En base a imágenes satelitales fusionadas de Landsat 4, 5 , 7 y 8'+
