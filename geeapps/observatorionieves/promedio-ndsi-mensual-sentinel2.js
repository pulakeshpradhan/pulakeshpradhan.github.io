var aconcagua_cuenca = ui.import && ui.import("aconcagua_cuenca", "table", {
    ...
    snow_monthly = ui.import && ui.import("snow_monthly", "imageCollection", {
      "id": "users/observatorionieves/Sentinel/Snow_Monthly"
    }) || ee.ImageCollection("users/observatorionieves/Sentinel/Snow_Monthly");
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
print('Colecciones de imagenes mensuales', snow_monthly);
var images = {
  'enero'      : styleImg(ee.Image('users/observatorionieves/Sentinel/Snow_Monthly/Sentinel_Snow_Monthly_01')),
  'febrero'    : styleImg(ee.Image('users/observatorionieves/Sentinel/Snow_Monthly/Sentinel_Snow_Monthly_02')),
  'marzo'      : styleImg(ee.Image('users/observatorionieves/Sentinel/Snow_Monthly/Sentinel_Snow_Monthly_03')),
  'abril'      : styleImg(ee.Image('users/observatorionieves/Sentinel/Snow_Monthly/Sentinel_Snow_Monthly_04')),
  'mayo'       : styleImg(ee.Image('users/observatorionieves/Sentinel/Snow_Monthly/Sentinel_Snow_Monthly_05')),
  'junio'      : styleImg(ee.Image('users/observatorionieves/Sentinel/Snow_Monthly/Sentinel_Snow_Monthly_06')),
  'julio'      : styleImg(ee.Image('users/observatorionieves/Sentinel/Snow_Monthly/Sentinel_Snow_Monthly_07')),
  'agosto'     : styleImg(ee.Image('users/observatorionieves/Sentinel/Snow_Monthly/Sentinel_Snow_Monthly_08')),
  'septiembre' : styleImg(ee.Image('users/observatorionieves/Sentinel/Snow_Monthly/Sentinel_Snow_Monthly_09')),
  'octubre'    : styleImg(ee.Image('users/observatorionieves/Sentinel/Snow_Monthly/Sentinel_Snow_Monthly_10')),
  'noviembre'  : styleImg(ee.Image('users/observatorionieves/Sentinel/Snow_Monthly/Sentinel_Snow_Monthly_11')),
  'diciembre'  : styleImg(ee.Image('users/observatorionieves/Sentinel/Snow_Monthly/Sentinel_Snow_Monthly/12')),
};
var enero = ee.Image('users/observatorionieves/Sentinel/Snow_Monthly/01');
//------------------------------------------------------------------------------------------------------------------------------------------
///////////////////////////////////////////////// Split panel //////////////////////////////////////////////////////////////////////////////
//------------------------------------------------------------------------------------------------------------------------------------------
...
function addLayerSelector(mapToChange, defaultValue, position) {
  var label = ui.Label('Seleccione un mes');
...
var chartbyMonth = 
  ui.Chart.image.series({
    ...
    .setOptions({
    title: 'Promedio mensual NDSI sobre las subcuencas media y alta del Rio Aconcagua, usando Sentinel-2, 2015-2020',
    vAxis: {title:'Promedio (%)'},
    hAxis: {title:'Meses',format:0},
    curveType: 'function',
}); 
//------------------------------------------------------------------------------------------------------------------------------------------
///////////////////////////////////////////UI Gráficos/////////////////////////////////////////////////////////////////////////////////////
