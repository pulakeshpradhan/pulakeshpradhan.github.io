var aconcagua_cuenca = ui.import && ui.import("aconcagua_cuenca", "table", {
    ...
    LandsatMonthly = ui.import && ui.import("LandsatMonthly", "imageCollection", {
      "id": "users/observatorionieves/Landsat/Snow_Monthly"
    }) || ee.ImageCollection("users/observatorionieves/Landsat/Snow_Monthly");
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
// Autoras: Daniela González, Yael Aguirre, Marcela Ortiz 
// Actualizado 02/09/21
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------------
...
var images = {
  'enero'      : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Monthly/01')),
  'febrero'    : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Monthly/02')),
  'marzo'      : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Monthly/03')),
  'abril'      : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Monthly/04')),
  'mayo'       : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Monthly/05')),
  'junio'      : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Monthly/06')),
  'julio'      : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Monthly/07')),
  'agosto'     : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Monthly/08')),
  'septiembre' : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Monthly/09')),
  'octubre'    : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Monthly/10')),
  'noviembre'  : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Monthly/11')),
  'diciembre'  : styleImg(ee.Image('users/observatorionieves/Landsat/Snow_Monthly/12')),
};
var enero = ee.Image('users/observatorionieves/Landsat/Snow_Monthly/01');
//------------------------------------------------------------------------------------------------------------------------------------------
///////////////////////////////////////////////// Split panel //////////////////////////////////////////////////////////////////////////////
//------------------------------------------------------------------------------------------------------------------------------------------
...
var chartbyMonth = 
  ui.Chart.image.series({
    imageCollection: LandsatMonthly,
    ...
    .setOptions({
    title: 'Promedio mensual NDSI sobre las subcuencas media y alta del Rio Aconcagua, usando Landsat. 1989-2020',
