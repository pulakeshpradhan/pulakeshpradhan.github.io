...
var area = Numancia.map(buff).union()
//Función de corte. Área rectangular
var corte = function (image){
  return image.clipToCollection(area);
}
...
var rad_solar = ee.ImageCollection("ECMWF/ERA5_LAND/MONTHLY")
                      ...
                      .map(corte)
////////APAR PREMANEJO
var pre_manejo = EVI_I.filterDate('2001-01-01', '2009-12-31')
...
/////////////////////////////////////////////
var rad_solar_pre = rad_solar.filterDate('2001-01-01', '2009-12-31')
...
////////APAR POSTMANEJO
var post_manejo = EVI_I.filterDate('2011-01-01', '2020-12-31')
//////NDVI PROMEDIO MENSUAL
// make a list with months
...
//print(fpar_image,"fpar_image")
/////////////////////////////////////////////
var rad_solar_post = rad_solar.filterDate('2011-01-01', '2020-12-31')
...
var rfaa_pre_mask = RFAA_pre_anual.gt(0).and(RFAA_pre_anual.lt(1350))
var rfaa_pre_maskf = RFAA_pre_anual.updateMask(rfaa_pre_mask)
var rfaa_post_mask = RFAA_post_anual.gt(0).and(RFAA_post_anual.lt(1350))
...
var opciones_pre = { 
  title: "Histograma Numancia " +
         "pre-manejo (2001-2009)",
  fontSize: 14,
