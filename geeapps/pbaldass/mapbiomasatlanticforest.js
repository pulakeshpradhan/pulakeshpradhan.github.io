...
for (var year_id in year_list){
  ...
  Map.addLayer(classification, vis, 'Atlantic_Forest_'+year+"_col.1", false);
}
var classified2 = ee.Image("projects/mapbiomas_af_trinacional/public/mapbiomas_atlantic_forest_collection1_integration_v0")
                 .select(19)
Map.addLayer(classified2, vis, "Atlantic_Forest_2019_col.1", true); 
...
var legendTitle1 = ui.Label({
  value: 'MapBiomas Atlantic Forest Colección 1',
  style: {
    fontWeight: 'bold',
    fontSize: '16px',
    margin: '0 0 4px 0',
