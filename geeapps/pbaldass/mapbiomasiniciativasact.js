...
var panamazonia = ee.Image('projects/mapbiomas-raisg/public/collection2/mapbiomas_raisg_panamazonia_collection2_integration_v2')
                  .select(19)
Map.addLayer(panamazonia, vis, 'Panamazonia_col.2');
...
Map.addLayer(MapBiomas_Brasil.select('classification_'+yearbrasil), vis2, 'Brasil_'+yearbrasil+"_col.6");
...
Map.addLayer(MapbiomasPampa.select('classification_2019'), vis, "Pampa_col.1")
//////////////////////LEYENDA///////////////////////////////  
var colors = [
              "006400",//3
              "32cd32",//4
