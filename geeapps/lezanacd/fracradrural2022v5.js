var table = ui.import && ui.import("table", "table", {
      "id": "users/lezanacd/frac_22"
    }) || ee.FeatureCollection("users/lezanacd/frac_22"),
    table2 = ui.import && ui.import("table2", "table", {
      "id": "users/lezanacd/Depto22"
    }) || ee.FeatureCollection("users/lezanacd/Depto22"),
    table3 = ui.import && ui.import("table3", "table", {
      "id": "users/lezanacd/pais2220u"
    }) || ee.FeatureCollection("users/lezanacd/pais2220u"),
    table4 = ui.import && ui.import("table4", "table", {
      "id": "users/lezanacd/pais2220_ctro"
    }) || ee.FeatureCollection("users/lezanacd/pais2220_ctro");
var opacity_frac = {
  Opacity: 80
};
var opacity_rad = {
...
var rad_style =  {width:3, color: 'CB0312', fillColor: ' #E74C3C22'};
var catastro_style = {width:2 , color: '#E7D40A', fillColor: '#CCD1D1'};
/*
Departamentos 
*/
print(table2);
...
var dicobjetos = {
  select:{
    dptos: ui.Select({
    items: Object.keys(dic_Deptos).sort(), 
    placeholder:'Seleccione Departamento', 
    onChange: function(k){
    ...
    frac: ui.Select({
    items: Object.keys(dic_fraccion).sort(), 
   ...
   //Map.centerObject(table.filter(ee.Filter.inList('FRAC', [i])), 10)
    ...
    rad: ui.Select({
    items: Object.keys(dic_radio).sort(),
...
-----------------------------------
*/
var boton = ui.Button({label:'ver depto', onClick:function(k){
...
//dicobjetos.label,
//dicobjetos.label2,
boton, boton2,boton3,boton5, boton4], layout: ui.Panel.Layout.Flow('vertical'), style: {backgroundColor: '00005555', position: 'bottom-right'}})
Map.add(panel)
