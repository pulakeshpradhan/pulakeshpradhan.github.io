...
var geometry = 
    /* color: #d63000 */
    /* shown: false */
    ee.Geometry.Point([113.2738565937687, -7.8657804067647765]);
/***** End of imports. If edited, may not auto-convert in the playground. *****/
var shp = ee.FeatureCollection('users/anitadwi91/shp_probolinggo')
Map.addLayer(shp)
//Menentukan periode sebelum banjir
var before_start= '2021-02-01';
var before_end='2021-02-28';
//Menentukan waktu setelah banjir
var after_start='2021-03-01';
var after_end='2021-03-31';
...
var difference_threshold = 1; /* ambang batas ini didapatkan dari proses trial and error, jika pada wilayah studi terlihat kesalahan, anda bisa mengubah nilai ini*/
//Mengubah nama geometry 
var aoi = ee.FeatureCollection(shp);
...
//Membuat Judul
var title = ui.Label({
  value: 'Analisis Dampak Bencana Banjir Kabupaten Probolinggo Tahun 2021',
  style:{
  fontWeight: 'bold',
  fontSize: '25px'
  }});
...
// Diolah oleh...
var text7 = ui.Label('Script dasar dibuat oleh: UN-SPIDER pada Desember 2019 dan dimodifikasi oleh Anita, Eva, dan Galindayu pada Desember 2021 untuk Analisis Banjir Kab. Probolinggo', subTextVis)
