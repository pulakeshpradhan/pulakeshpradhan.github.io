var jrc = ui.import && ui.import("jrc", "image", {
    ...
    arcticDEM = ui.import && ui.import("arcticDEM", "image", {
      "id": "UMN/PGC/ArcticDEM/V3/2m_mosaic"
    }) || ee.Image("UMN/PGC/ArcticDEM/V3/2m_mosaic");
// Create header
// Imports
...
var style_text_h = { textAlign: 'center', backgroundColor: 'white', fontWeight: 'bold', fontSize: '100%', width: '95%', padding: '7px 1px 0 1px', margin: '1px' };
var style_link_text = {
  textAlign: 'center',
  //backgroundColor:'#eeeeee',
...
// EDITS here
var style_link_text = { textAlign: 'center', backgroundColor: 'NavajoWhite', width: '95%', padding: '7px', margin: '15px 5px 1px 5px', fontWeight: 'bold', color: '#000000', border: '1px solid SaddleBrown' };
var style_note = { textAlign: 'left', width: '95%', padding: '1px', margin: '1px 5px 7px 5px', fontWeight: 'normal', color: 'grey', fontSize: '80%' };
var label_TSviewerLink = ui.Label('Open Image Time-Series', style_link_text); // make bold + red/green BG color test
var label_TSviewerLink_description = ui.Label('1. Switch "Plot Time-Series" on; 2. click a location on the map to the right; 3. click the button above (opens in a new window).', style_note);
...
panel_TStoggle.add(label_TSviewerLink_description)
// Description Panel
...
panel_description.add(ui.Label('Author', style_text_h));
panel_description.add(ui.Label('Ingmar Nitze', style_text));
panel_description.add(ui.Label('Version', style_text_h));
panel_description.add(ui.Label('0.4.1', style_text));
panel_description.add(label_Github)
panel_description.add(ui.Label('Data Period', style_text_h));
panel_description.add(ui.Label('2000-2019', style_text));
panel_description.add(ui.Label('Credits', style_text_h));
panel_description.add(ui.Label('DEM Viz style by G. Donchyts', style_text));
panel_description.add(ui.Label('Acknowledgements', style_text_h));
panel_description.add(ui.Label('This work has been funded through the following research projects: ', style_text));
var label_project_1 = ui.Label('Arctic PASSION', style_text).setUrl('https://arcticpassion.eu/');
var label_project_2 = ui.Label('Permafrost Discovery Gateway', style_text).setUrl('https://arcticdata.io/catalog/portals/permafrost');
var label_project_3 = ui.Label('ESA CCI Permafrost', style_text).setUrl('https://climate.esa.int/en/projects/permafrost/');
var label_project_4 = ui.Label('PETA-CARB', style_text).setUrl('https://cordis.europa.eu/project/id/338335/de');
panel_description.add(label_project_1);
panel_description.add(label_project_2);
panel_description.add(label_project_3);
panel_description.add(label_project_4);
