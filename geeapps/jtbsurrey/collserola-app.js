var table = ui.import && ui.import("table", "table", {
      "id": "users/jtbsurrey/Collserola"
    }) || ee.FeatureCollection("users/jtbsurrey/Collserola");
var AOI = table
// Initialize the UI. 
...
print(NDVI_annual_recl)
 ...
 mapPanel.addLayer(NDVI_annual_recl.select("slope").clip(AOI),BandCompViz, 'NDVI trends');
  }
});
