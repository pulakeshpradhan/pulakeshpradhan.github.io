var table = ui.import && ui.import("table", "table", {
      "id": "users/deinaphi214/EWKH"
    }) || ee.FeatureCollection("users/deinaphi214/EWKH");
/*===========================================================================================
...
var title = ui.Label('SENTINEL I FLOOD INFORMATION', titleTextVis);
...
// Produced by...
var text7 = ui.Label('MEGHALAYA', titleTextVis)
...
var mapTitle = ui.Label({
  value: 'FLOOD MAP:EASTERN WEST KHASI HILLS ',
  style: {
    fontWeight: 'bold',
    fontSize: '24px',
    margin: '0 0 4px 0',
