var table = ui.import && ui.import("table", "table", {
      "id": "users/armkhudinyan/2020ArmAzClashes"
    }) || ee.FeatureCollection("users/armkhudinyan/2020ArmAzClashes");
...
// Define map title
var left_title = ui.Label('2020 July Armenian–Azerbaijani clashes: Tavush/Tovuz front' ,{fontWeight: 'bold', fontSize: '14px' })
var right_title = ui.Label('2020 July Armenian–Azerbaijani clashes: Tavush/Tovuz front' ,{fontWeight: 'bold', fontSize: '14px' })
/*
...
var S2_3 = ee.Image('COPERNICUS/S2/20200720T074619_20200720T075210_T38TNL')
var S2_4 = ee.Image('COPERNICUS/S2/20200730T074619_20200730T075504_T38TNL') 
// var S2_ = ee.Image('COPERNICUS/S2/20200804T074621_20200804T074946_T38TNL')
var S2_5 = ee.Image('COPERNICUS/S2/20200809T074619_20200809T075801_T38TNL')
var S2_6 = ee.Image('COPERNICUS/S2/20200918T074619_20200918T075214_T38TNL')
...
var images = {
  'Sentinel2 2020-07-05': S2_1.visualize(vis_param_Sentinel),
  'Sentinel2 2020-07-15': S2_2.visualize(vis_param_Sentinel),
  'Sentinel2 2020-07-20': S2_3.visualize(vis_param_Sentinel),
  'Sentinel2 2020-07-30': S2_4.visualize(vis_param_Sentinel),
...
// leftMap.setCenter(45.55, 40.9, 11);
leftMap.centerObject(table,  14)