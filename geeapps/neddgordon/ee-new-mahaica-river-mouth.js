...
var composite7 = dataset.filterMetadata('CLOUD_COVERAGE_ASSESSMENT','less_than',5)
                  ...
                  .filterBounds(aoi)
                  .select(['B2','B3','B4','B8']);
var composite8 = dataset.filterMetadata('CLOUD_COVERAGE_ASSESSMENT','less_than',35)
...
var uct8 = composite8.filterMetadata('MGRS_TILE','equals','21NUH');
var lasting8 = uct8.limit(8,'system:time_start', false).first();
var date8 = ee.Date(lasting8.get('system:time_start'));
// print(uct)
...
var ext2022 = ui.Map.Layer(lasting8.clip(aoi), vizParams, 'FCC8',false)
Map.add(ext2015);
Map.add(ext2016);
Map.add(ext2017);
Map.add(ext2018);
...
var FCC2022 = ui.Checkbox('2022').setValue(false);
//4.3) Create legends
...
var doCheckbox22 = function() {
  FCC2022.onChange(function(checked){
...
var end = ui.Panel([
  ...
  ui.Label({
    value:'Copyrights:'+
    'This ongoing project benefits from Greater Guyana Initiative 2022 support of the Catchment-Coastal Observatory Project of Professor Temitope Oyedotun of the Department of Geography, Faculty of Earth and Environmental Sciences, University of Guyana. The support of the 2022 Commonwealth Climate Resilience Challenge Grants awarded to Professor Temitope Oyedotun is also acknowledged and appreciated. ',
    style: {fontSize: '15px'}
  })
  ]);
//Add this new panel to the larger panel we created 
