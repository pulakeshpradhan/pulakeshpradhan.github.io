...
var START_TIME =  END_TIME.advance(-1, 'day')
var TIME_ZONE = 'America/Los_Angeles';
var coll_16 = ee.ImageCollection('NOAA/GOES/16/FDCF')
  .filterDate(ee.Date(START_TIME, TIME_ZONE), ee.Date(END_TIME, TIME_ZONE)).max()
var coll_17 = ee.ImageCollection('NOAA/GOES/17/FDCF')
  .filterDate(ee.Date(START_TIME, TIME_ZONE), ee.Date(END_TIME, TIME_ZONE)).max()
...
Map.setCenter(-122.0448, 37.5105, 8)