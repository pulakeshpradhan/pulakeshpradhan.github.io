...
var images = {
  '2020-01-08': getWeeklySentinelComposite('2020-01-08'),
  '2020-01-15': getWeeklySentinelComposite('2020-01-15'),
};
...
function getWeeklySentinelComposite(date) {
  ...
  var sentinel1 = ee.ImageCollection('COPERNICUS/S1_GRD')
                      ...
                      .select(polarization)
                      .mean();
  return sentinel1.visualize({min: -25, max: 0, });
}
/*
...
leftMap.setCenter(121.00063781738277,14.01103944827424, 12);