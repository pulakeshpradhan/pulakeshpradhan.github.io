...
var rajaampat = 
    ...
    ee.Geometry.Polygon(
        [[[129.424149, -2.371696],
          [131.044962, -2.348222],
          [131.484048,  0.720263],
          [129.825086,  0.730002]]], null, false),
    manokwari = 
    /* color: #ffc82d */
    /* displayProperties: [
      {
    ...
    ee.Geometry.Polygon(
        [[[132.894823, -2.344932],
          [134.813309, -2.346722],
          [134.820719, -0.317274],
          [132.918534, -0.213150]]], null, false),
    fakfak = ee.Geometry.Polygon(
        [[[131.810996, -4.210429],
          [133.739768, -4.218010],
          [133.870957, -2.496810],
          [131.893372, -2.554509]]], null, false);
// Define labels for each study region.
var RAJAAMPAT = 'Kabupaten Raja Ampat',
...
var selectAoi = ui.Select({
  items:[RAJAAMPAT,MANOKWARI,FAKFAK],
...
function setAreaOfInterest(){
  ...
  if (aoi == RAJAAMPAT){
      areaOfInterest = rajaampat;
  }//sets the area to nile river delta
  else if(aoi == MANOKWARI){
      areaOfInterest = manokwari;
  }//sets the area of interest to
  else if (aoi == FAKFAK){
      areaOfInterest = fakfak;
  }
}
setAreaOfInterest();
