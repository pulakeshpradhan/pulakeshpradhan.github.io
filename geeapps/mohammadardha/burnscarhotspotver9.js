var table = ui.import && ui.import("table", "table", {
      "id": "users/mohammadardha/PROJECT_CBI"
    }) || ee.FeatureCollection("users/mohammadardha/PROJECT_CBI"),
    pulauSumatera = ui.import && ui.import("pulauSumatera", "table", {
      "id": "users/anisa/shp-per-pulau/PulauSumatra"
    }) || ee.FeatureCollection("users/anisa/shp-per-pulau/PulauSumatra"),
...
// Location
var area = ee.FeatureCollection(pulauSumatera);
...
Map.addLayer(table.filterBounds(pulauSumatera), {
 palette: ['ff0202']
},'Titik Kebakaran');
...
Export.image.toDrive({image: classified.updateMask(classified), scale: 100, description: id, fileNamePrefix: 'hotspot',
