...
app.createPanels = function() {
  ...
  app.intro = {
    panel: ui.Panel([
      ui.Label({
        value: 'Landsat 7 Explorer',
        style: {fontWeight: 'bold', fontSize: '24px', margin: '10px 5px'}
      }),
      ui.Label('This app allows you to filter and export images for Lake Atitlan, Guatemala' +
  ...
  app.filters = {
    ...
    startDate: ui.Textbox('YYYY-MM-DD', '2008-10-01'),
    endDate: ui.Textbox('YYYY-MM-DD', '2010-05-30'),
...
app.createConstants = function() {
  app.COLLECTION_ID = 'LANDSAT/LE07/C01/T1';
...
app.boot = function() {
  ...
  Map.setCenter(-91.1962, 14.7081, 12);
