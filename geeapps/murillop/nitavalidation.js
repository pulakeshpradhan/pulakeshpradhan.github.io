var mag_vis = {"opacity":1,"bands":["b1"],"min":-0.8956479430198669,"max":-0.07354098558425903,"palette":["ff0000","ffac44","4cfeff"]},
    date_vis = {"opacity":1,"bands":["b1"],"min":1999366.25,"max":2018109.5,"palette":["ff2805","ffb819","29ff0f","11ffde","0781ff","a413ff","ff50a0"]},
    date_bfast = ee.Image("users/murillop/date_filtered_0"),
    mag_bfast = ee.Image("users/murillop/magnitude_0"),
    wrs = ee.FeatureCollection("ft:1_RZgjlcqixp-L9hyS6NYGqLaKOlnhSC35AB5M5Ll"),
    value_vis = {"opacity":1,"bands":["b1"],"min":-0.5697118639945984,"max":-0.05,"palette":["ff5725","ffc933","11ff65","11fff4","1f3aff","ffffff"]},
    table = ee.FeatureCollection("users/murillop/COL_cartography/municipios"),
    departamentos = ee.FeatureCollection("users/murillop/COL_cartography/departamentos"),
    sentinel = ee.Image("users/murillop/Amazon-Andes/sentinel2018"),
    VIS = {"opacity":1,"bands":["yod"],"min":2000,"max":2018,"palette":["ff792b","d4ff2b","3cff66","348eff","f22bff","ff2154"]},
    dates = ee.Image("users/murillop/Amazon-Andes/date_full"),
    landtrendr_1987_2018 = ee.Image("users/murillop/LandTrendR/pica_lt_1987-2018"),
    coded = ee.Image("users/murillop/CODED/picatinimaca_1987_2018"),
    landtrendr_1990_2018_ndmi = ee.Image("users/murillop/LandTrendR/lt_disturbance_amazon_NDMI_1990_2018"),
    PA5 = ee.FeatureCollection("users/murillop/COL_cartography/PA_5"),
    nita_date = ee.Image("users/murillop/NITA/distdate_AMEN_"),
    nita_mag = ee.Image("users/murillop/NITA/dist_mag_AMEN_");
var Aubergine= 
[
  {
