// DisasterMapper v1.0 JavaScript Source Code; Release Date 22 August 2022
// Rajan Kumar Singh - Researcher (Orbitx India Aerospace (P) Ltd
// contact: rajansingh5264@gmail.com
//
///// RESEARCH ONLY LICENSE ///// 
// DisasterMapper
// Copyright © 2022 Rajan Kumar Singh. All rights reserved.
// 
...
var title = ui.Label({
  value: 'Hazard Mapper, By: Rajan Singh ',
  style: {fontSize: "20px", border: '1px solid black'}, 
  targetUrl: 'https://rajansingh5264.maps.arcgis.com/home/index.html'
});
...
var exportData = function() {
  ...
  downloadArgs.name = 'DisasterMapperSRTM';
  ...
  Export.image.toDrive({
    image: exportNDVI,
    description: 'DisasterMapperNDVI',
    scale: datasetScale,
    //region: viewBounds.toGeoJSONString(),
    folder: "GEE_Exports",
    fileFormat: 'GeoTIFF'
  ...
  Export.image.toDrive({
    image: gpc3bandPre,
    description: 'DisasterMapperGPCpre',
    scale: datasetScale,
    //region: viewBounds.toGeoJSONString(),
    folder: "GEE_Exports",
    fileFormat: 'GeoTIFF'
  ...
  Export.image.toDrive({
    image: gpc3bandPost,
    description: 'DisasterMapperGPCpost',
    scale: datasetScale,
    //region: viewBounds.toGeoJSONString(),
    folder: "GEE_Exports",
    fileFormat: 'GeoTIFF'
...
// Example url: https://cmscheip.users.earthengine.app/view/DisasterMappertester#lon=-83.5180;lat=35.6924067;zoom=12.5;dataset=1;eventDate=20161209;prewindow=12;postwindow=9;maxCloudCover=30;slopeThreshold=0;
