...
var classes21lyr = ui.Map.Layer(classes21.selfMask(),
  {palette:['292929','ffffff','007dff','ff7d00','f000f0','00f000','999999','ad7d52','000000','404040','ebebeb'],min:1,max:11},'classes 99-21')
...
classLegend.add(makeRow('007dff','Water gain       4'))
classLegend.add(makeRow('ff7d00','Water loss       5'))
classLegend.add(makeRow('f000f0','Dry period       6'))
classLegend.add(makeRow('00f000','Wet period       8'))
classLegend.add(makeRow('ad7d52','High frequency   9'))
...
var title = ui.Panel([//ui.Thumbnail(ee.Image('users/ahudson2/gladLogo'),{dimensions:'50', bands:['b1','b2','b3']}),
  ui.Label({
    value: 'Global Surface Water Dynamics 1999-'+LASTYEARstr,
    style: {fontSize: '20px', fontWeight: 'bold', backgroundColor: bgColor}
  }),
  ui.Label("Rajan Kumar Singh, Researcher - Orbitx Aerospace (P) Ltd).",{margin: '0px 0px 8px 8px',backgroundColor: bgColor}),
  ui.Label("https://rajansingh5264.maps.arcgis.com/home/index.html",{backgroundColor: bgColor, margin: '0px 0px 8px 8px'},"https://doi.org/10.1016/j.rse.2020.111792"),
