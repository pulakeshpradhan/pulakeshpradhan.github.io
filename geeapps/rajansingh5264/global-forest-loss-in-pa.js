...
var intro = ui.Panel([
  ui.Label({
    value: 'Global Forest loss in PA  , By Rajan Kumar Singh',
    style: {fontSize: '24px', fontWeight: 'bold'}
  }),
  ui.Label('An application to visualize forest canopy loss within PA. Developed for "NASA SPACE APPS CHALLENGE-2022')
]);
