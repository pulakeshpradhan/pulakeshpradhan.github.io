...
var gadm36_DEU_0 = ee.FeatureCollection("users/rutgerhofste/drought_app_v01/gadm36_DEU_0");
var gadm36_DEU_1 = ee.FeatureCollection("users/rutgerhofste/drought_app_v01/gadm36_DEU_1");
var gadm36_DEU_2 = ee.FeatureCollection("users/rutgerhofste/drought_app_v01/gadm36_DEU_2");
//remove Bodensee since these are not provinces. 
function removeNonProvince(fc){
  var fc_out = fc
  fc_out = fc_out.filterMetadata("TYPE_2","not_equals","Water body")
  fc_out = fc_out.filterMetadata("NAME_1","not_equals","Zeeuwse meren")
  return fc_out
}
gadm36_DEU_1 = removeNonProvince(gadm36_DEU_1)
gadm36_DEU_2 = removeNonProvince(gadm36_DEU_2)
...
var fc_greenness_diff_gadm36_DEU_1 = ee.FeatureCollection(gadm36_DEU_1.map(reduceRegionsGreenness))
var fc_greenness_diff_gadm36_DEU_2 = ee.FeatureCollection(gadm36_DEU_2.map(reduceRegionsGreenness))
// ------------- UI stuff  --------------
// Control/Info panel
var title = ui.Label("Extreme Drought in Germany")
...
var description = ui.Label("This app compares Satellite imagery of July 2018 with the July's in recent history (2014-2017).") 
var description2 = ui.Label("Move the line in the middle to inspect the differences. You can click on the map for more details.")
var description3 = ui.Label("You can see the dramatic effect on the landscape. What effects of the drought can you find? Please note that some pixels are missing due to missing data.")
...
var center = {lon: 12.05, lat: 51, zoom: 10};
// Create two maps.
...
//var right_layer0 = ui.Map.Layer(s2_composite_post,ivp_s2,"Sentinel2 July 2018",1,1)
//rightMap.layers().set(0,right_layer0)
...
gadm36_DEU_2 = gadm36_DEU_2.map(setStyle)
var left_layer1 = ui.Map.Layer(gadm36_DEU_2.style({styleProperty: "style"}),{},"gadm36_DEU_2")
leftMap.layers().set(1,left_layer1)
var right_layer1 = ui.Map.Layer(gadm36_DEU_2.style({styleProperty: "style"}),{},"gadm36_DEU_2")
...
function inspect(coords){
  ...
  var fc_sel = gadm36_DEU_2.filterBounds(point);
  ...
  feature_out = feature_out.set("rank",fc_greenness_diff_gadm36_DEU_2.filter(ee.Filter.lte("greenness_diff",greennessDiff)).size());
