var mada1995 = ui.import && ui.import("mada1995", "image", {
      "id": "users/WWFDE/Madagascar/Mada_SR_1995_Comp"
    }) || ee.Image("users/WWFDE/Madagascar/Mada_SR_1995_Comp"),
    mada2000 = ui.import && ui.import("mada2000", "image", {
      "id": "users/WWFDE/Madagascar/Mada_SR_2000_Comp"
    }) || ee.Image("users/WWFDE/Madagascar/Mada_SR_2000_Comp"),
    mada2010 = ui.import && ui.import("mada2010", "image", {
      "id": "users/WWFDE/Madagascar/Mada_SR_2010_Comp"
    }) || ee.Image("users/WWFDE/Madagascar/Mada_SR_2010_Comp"),
    mada2015 = ui.import && ui.import("mada2015", "image", {
      "id": "users/WWFDE/Madagascar/Mada_SR_2015_Comp"
    }) || ee.Image("users/WWFDE/Madagascar/Mada_SR_2015_Comp"),
    mada2018 = ui.import && ui.import("mada2018", "image", {
      "id": "users/WWFDE/Madagascar/Mada_SR_2018_Comp"
    }) || ee.Image("users/WWFDE/Madagascar/Mada_SR_2018_Comp"),
    point = ui.import && ui.import("point", "geometry", {
      ...
      "shown": true,
      "locked": false
    }) || /* color: #d63000 */ee.Geometry.Point([46.4038518135834, -15.878031351344687]),
    dem = ui.import && ui.import("dem", "image", {
      "id": "JAXA/ALOS/AW3D30_V1_1"
    }) || ee.Image("JAXA/ALOS/AW3D30_V1_1"),
    mada2005 = ui.import && ui.import("mada2005", "image", {
      "id": "users/WWFDE/Madagascar/Mada_SR_2005_Comp"
    }) || ee.Image("users/WWFDE/Madagascar/Mada_SR_2005_Comp"),
    mang2000 = ui.import && ui.import("mang2000", "image", {
      "id": "users/WWFDE/Madagascar/Mada_mangroves_filt_2000"
    }) || ee.Image("users/WWFDE/Madagascar/Mada_mangroves_filt_2000"),
    mang2005 = ui.import && ui.import("mang2005", "image", {
      "id": "users/WWFDE/Madagascar/Mada_mangroves_filt_2005"
    }) || ee.Image("users/WWFDE/Madagascar/Mada_mangroves_filt_2005"),
    mang2010 = ui.import && ui.import("mang2010", "image", {
      "id": "users/WWFDE/Madagascar/Mada_mangroves_filt_2010"
    }) || ee.Image("users/WWFDE/Madagascar/Mada_mangroves_filt_2010"),
    mang2015 = ui.import && ui.import("mang2015", "image", {
      "id": "users/WWFDE/Madagascar/Mada_mangroves_filt_2015"
    }) || ee.Image("users/WWFDE/Madagascar/Mada_mangroves_filt_2015"),
    mang2018 = ui.import && ui.import("mang2018", "image", {
      "id": "users/WWFDE/Madagascar/Mada_mangroves_filt_2018"
    }) || ee.Image("users/WWFDE/Madagascar/Mada_mangroves_filt_2018"),
    viz1995 = ui.import && ui.import("viz1995", "imageVisParam", {
      "params": {
        "opacity": 1,
        "bands": [
          "mangrove"
    ...
    }) || {"opacity":1,"bands":["mangrove"],"palette":["ffb5a4"]},
    viz2000 = ui.import && ui.import("viz2000", "imageVisParam", {
      "params": {
        "opacity": 1,
        "bands": [
          "mangrove"
    ...
    }) || {"opacity":1,"bands":["mangrove"],"palette":["e06c52"]},
    viz2005 = ui.import && ui.import("viz2005", "imageVisParam", {
      "params": {
        "opacity": 1,
        "bands": [
          "mangrove"
    ...
    }) || {"opacity":1,"bands":["mangrove"],"palette":["e04637"]},
    viz2010 = ui.import && ui.import("viz2010", "imageVisParam", {
      "params": {
        "opacity": 1,
        "bands": [
          "mangrove"
    ...
    }) || {"opacity":1,"bands":["mangrove"],"palette":["b82a13"]},
    viz2015 = ui.import && ui.import("viz2015", "imageVisParam", {
      "params": {
        "opacity": 1,
        "bands": [
          "mangrove"
    ...
    }) || {"opacity":1,"bands":["mangrove"],"palette":["70190b"]},
    viz2018 = ui.import && ui.import("viz2018", "imageVisParam", {
      "params": {
        "opacity": 1,
        "bands": [
          "mangrove"
    ...
    }) || {"opacity":1,"bands":["mangrove"],"palette":["2a7013"]},
    mang1995 = ui.import && ui.import("mang1995", "image", {
      "id": "users/WWFDE/Madagascar/Mada_mangroves_filt_1995"
    }) || ee.Image("users/WWFDE/Madagascar/Mada_mangroves_filt_1995"),
    anom = ui.import && ui.import("anom", "image", {
      "id": "users/WWFDE/Madagascar/Mada_NDVI_Anomaly"
    }) || ee.Image("users/WWFDE/Madagascar/Mada_NDVI_Anomaly"),
    WDPA = ui.import && ui.import("WDPA", "table", {
      "id": "WCMC/WDPA/current/polygons"
    }) || ee.FeatureCollection("WCMC/WDPA/current/polygons"),
    bounds = ui.import && ui.import("bounds", "table", {
      "id": "users/WWFDE/Madagascar/mada_mangrove_bounds"
    }) || ee.FeatureCollection("users/WWFDE/Madagascar/mada_mangrove_bounds");
