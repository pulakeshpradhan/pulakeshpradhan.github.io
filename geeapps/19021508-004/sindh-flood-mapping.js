var GSW = ui.import && ui.import("GSW", "image", {
      "id": "JRC/GSW1_3/GlobalSurfaceWater"
    }) || ee.Image("JRC/GSW1_3/GlobalSurfaceWater"),
    Hydro_DEM = ui.import && ui.import("Hydro_DEM", "image", {
      "id": "WWF/HydroSHEDS/03VFDEM"
    }) || ee.Image("WWF/HydroSHEDS/03VFDEM"),
    Shapefile = ui.import && ui.import("Shapefile", "table", {
      "id": "FAO/GAUL/2015/level2"
    }) || ee.FeatureCollection("FAO/GAUL/2015/level2"),
    collection = ui.import && ui.import("collection", "imageCollection", {
      "id": "COPERNICUS/S1_GRD"
    }) || ee.ImageCollection("COPERNICUS/S1_GRD"),
    Shapefile1 = ui.import && ui.import("Shapefile1", "table", {
      "id": "FAO/GAUL/2015/level1"
    }) || ee.FeatureCollection("FAO/GAUL/2015/level1"),
    Shp = ui.import && ui.import("Shp", "table", {
      "id": "users/19021508-004/PAK_adm3"
    }) || ee.FeatureCollection("users/19021508-004/PAK_adm3");
// Flood dates
var before_start = '2022-07-20';
var before_end = '2022-07-29';
var after_start = '2022-08-18';
var after_end = '2022-08-28';
var polarization = "VH"; 
var pass_direction = "DESCENDING"; 
var difference_threshold = 1.25; 
//var relative_orbit = 79; 
// Shapefile
var Larkana = Shapefile1.filter(ee.Filter.eq('ADM1_NAME', 'Sindh'));
var geometry = Larkana.geometry();
print ('Sindh Area', geometry.area().divide(10000))
Map.addLayer(geometry, {color :'silver'}, 'Sindh');
...
var collection= ee.ImageCollection('COPERNICUS/S1_GRD')
  ...
  .filterBounds(Larkana)
  .select(polarization);
// Select images by predefined dates
var before_collection = collection.filterDate(before_start, before_end);
var after_collection = collection.filterDate(after_start,after_end);
Map.centerObject(Larkana,8);
...
var before = before_collection.mosaic().clip(Larkana);
var after = after_collection.mosaic().clip(Larkana);
...
var population_count = ee.Image('JRC/GHSL/P2016/POP_GPW_GLOBE_V1/2015').clip(Larkana);
...
// Affected urban
//Map.addLayer(urban_affected, urbanVis, 'Urban Area'); 
//---------------------------------- MAP PRODUCTION --------------------------------//
...
// Disclaimer
var text6 = ui.Label('Disclaimer: This product has been derived automatically without validation data. All geographic information has limitations due to the scale, resolution, date and interpretation of the original source materials.',subTextVis)
// Produced by...
var text7 = ui.Label('Creator : Ahmed Yaseen Ghouri, Shaheer Panwanr, Adeeba Iftikhar, Hammad ur Rasool, Shahzada Tabasum', subTextVis)
...
var palette =['#0000FF', '#30b21c', 'white'];
// name of the legend
