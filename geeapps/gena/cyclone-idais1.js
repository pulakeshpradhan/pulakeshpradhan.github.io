...
Map.add(panel)
//throw(0)
// Map.setCenter(34.86041700316662, -19.840295179831738, 14)
Map.setCenter(34.890515, -19.835301, 16)
/*
//var animation = require('users/gena/packages:animation')
// animation.animate(images, {vis: {min: 10, max: [100, 100, 100], gamma: 1.4, bands: ['b4', 'b4', 'b3']}})
var imagesWater = images.map(function(i) {
  var water = i.normalizedDifference(['b3', 'b4'])
  water = water.updateMask(water.unitScale(0.05, 0.3)).visualize({min: 0, max: 0.3, palette: ['000000', '00ffff']})
  var black = ee.Image(0).visualize({ palette: ['000000'], opacity: 0.4})
  return black.blend(water)
})
animation.animate(imagesWater, {position: 'bottom-center', preload: false})  
*/