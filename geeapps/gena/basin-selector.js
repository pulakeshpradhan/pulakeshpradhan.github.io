...
Map.addLayer(HydroBASINSimage.select('PFAF_12').randomVisualizer(), {}, 'raw (PFAF_12)', true, 0.5)
var level = 12
...
Map.addLayer(rivers.filter(ee.Filter.gt('UP_CELLS', 1000)).style({ color: 'ffffff', width: 2 }), {}, 'rivers')
