var g3 = ui.import && ui.import("g3", "geometry", {
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [
    ...
    ee.Geometry.Polygon(
        [[[95.75868532846388, 24.41451793106226],
          ...
          [96.92323610971388, 24.41451793106226]]], null, false),
    ...
    ee.Geometry.Polygon(
        [[[95.36126130326876, 24.904426792501074],
          ...
          [97.55852692826876, 24.904426792501074]]], null, false);
Map.centerObject(g3,13);
//Map.addLayer(roi,{},'roi',0);
//var bufferG = g3.buffer(1000,100);
//Map.addLayer(bufferG, {color : '#00ff19'},'buffer',0);
Map.setOptions('Satellite');
Map.style().set('cursor', 'crosshair');
var S1 = ee.ImageCollection('COPERNICUS/S1_GRD')
  .filterBounds(g3)//change to geometry
  .filterDate('2018-7-01','2018-09-30')
  .filter(ee.Filter.listContains('transmitterReceiverPolarisation', 'VV'))
//Add first image to map to get an idea of what a SAR image looks like  
Map.addLayer(S1.first(),{bands: 'VV',min: -18, max: 0}, 'SAR image', 1)
...
// name of the legend
var names = ['TaungTwinGyi Site','Buffer Area ','Water Bodies'];
