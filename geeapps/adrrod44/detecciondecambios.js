...
var hasta2 = ui.Label('hasta', {fontSize: '14px', margin: '8px 8px 4px 8px'});
tiempo2.add(ui.Panel([tiempo[2], hasta2, tiempo[3]],ui.Panel.Layout.Flow('horizontal')));
    tiempo[4] = ui.Textbox({
        placeholder: 'YYYY-MM-DD',
        style:{textAlign: 'center',width:'100px'},
        onChange: function(pre) {
...
var hasta3 = ui.Label('hasta', {fontSize: '14px', margin: '8px 8px 4px 8px'});
tiempo3.add(ui.Panel([tiempo[4], hasta3, tiempo[5]],ui.Panel.Layout.Flow('horizontal')));
//Boton ejecutar
var crear = ui.Panel([
    ui.Button({
      label: 'Ejecutar',
...
//--------------------------------------------------------------------------
  ...
  map.addLayer(img_mul_t, {}, "imagen multitemporal");
  // Creamos un titulo
