...
Map.add(ui.Label(
    'Peta Kepadatan Penduduk dan Perbandingan Jumlah Populasi', {fontWeight: 'bold', fontSize: '14px'}));
/*
...
function makeResultsBarChart(countries) {
  ...
  chart.setOptions({
    title: 'Perbandingan Jumlah Penduduk',
    vAxis: {title: null},
...
function clearResults() {
  ...
  var instructionsLabel = ui.Label('Pilih Negara untuk membandingkan Jumlah Penduduk');
...
Map.add(ui.Panel(
    [
      ui.Label('Kepadatan Penduduk', LEGEND_TITLE_STYLE), makeLegend(),
      ui.Label(
          'Oleh: Muhammad Syukril', LEGEND_FOOTNOTE_STYLE),
      ui.Label(
          'Jumlah penduduk (skala ribu)               dalam 1 Km bujur sangkar', LEGEND_FOOTNOTE_STYLE),
      ui.Label(
