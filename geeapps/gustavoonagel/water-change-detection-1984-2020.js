...
var intro = ui.Panel([
  ui.Label({
    value: 'Water Change Detection',
    style: {fontSize: '20px', fontWeight: 'bold'}
  }),
  ui.Label('The algorithm detects areas where the presence of water increased (erosion, artificial lakes, ...) or decreased (sedimentation, droughts, coastal infraestructure, ...). The algorithm is based on Landsat 5 and 8 Time Series (1984-2020). Due to the high amount of data the algorithm might take time to process'),
