...
var instructions= ui.Label(
  "This EE App will make an animated GIF"
  , {whiteSpace:'pre'}
);
...
var plotTheMap = function(){
  ...
  var gistLabel = ui.Label({
    value: 'Add year annotations with this R script',
  });
  //gistLabel.setUrl('https://gist.github.com/jdbcode/2af647876e03c76de5424e15b30b74ec');
...
ui.root.add(theMap);
theMap.setCenter(-14.617, 14.575, 8);
var emaprLabel = ui.Label({
  value: 'LandSat-8',
  style: {position:'bottom-right'} 
});
emaprLabel.setUrl('http://emapr.ceoas.oregonstate.edu/');
