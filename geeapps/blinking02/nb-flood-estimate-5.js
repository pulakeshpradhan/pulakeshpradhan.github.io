...
app.interface = {
    ...
    onClick:function(){
      print(x5); 
      result= parseFloat(x5)+ -0.1101 + 0.1039*parseFloat(x1)+0.0006*parseFloat(x2)+ 0.0257*parseFloat(x3)+ 0.00638*parseFloat(x4); 
  ...
  app.interface.panel = ui.Panel({
    widgets: [
      ...
      ui.Label('Yesterday Water Level:', app.HELPER_TEXT_STYLE), app.interface.variable5,
