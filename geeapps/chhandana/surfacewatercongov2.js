...
//This program will produce the reach scale water maps for the Congo Basin from 2015 to current
//Version-1 shared with Google Team
/*
1. Use the drawing tools in the top left corner to create your roi.
2. Press the "Done Drawing" button when finished.
3. Enter the start date in the following format: YYYY-MM-DD, then press enter.
4. Enter the end date in the following format: YYYY-MM-DD, then press enter.
5. Click a point on the chart to show the image for that date.
*/
//contact: chandana.gangodagamage@nasa.gov/chhandana@gmail.com
Map.addLayer(table,{color: 'FF0000'},'SWORD-Congo');
// 3-27-2019
//Congo_HAND
// Goal: The purpose is to classify water from SAR imagery and create
// interactive time series of water pixel count for river reaches
// Topics addressed:
//  - loading and filtering image collections
//  - prepairing and classify SAR data
//  - creating a time series of water body classification for a river reach
