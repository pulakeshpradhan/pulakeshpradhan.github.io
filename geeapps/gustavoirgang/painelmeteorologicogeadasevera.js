var region = ee.Geometry(Map.getBounds(true))
 var geometry = /* color: #d63000 */ee.Geometry.Point([-49.93474006301933,-28.746238030514576]);
...
var collection = ee.ImageCollection('NOAA/GFS0P25')
  ...
  .filterDate(today.advance(-3, 'day'), today.advance(1, 'day'))
...
var quality = function(image){ 
  var mask1 = image.select("temperature_2m_above_ground").lte(5);
...
var panel = ui.Panel({layout: ui.Panel.Layout.flow('vertical'),style: {width: '65%', height: '100%'}})
    .add(ui.Label('Painel Meteorológico ')).add(ui.Label('Clique no mapa para consultar os períodos com potencial de Geadas Severas previsão 16 dias. Os resutados são apresentados em dois conjuntos temporais, de 0 a 120 horas de hora em hora e de 120 a 384 horas de previsão de 3 por 3 horas conforme padrão original do modelo. É considerado período com potencial de desenvolvimento de geada quando a temperatura do ar no abrigo meteorológico esta menor do que 5°C o que significa que no solo a temperatura esteja próxima a 0°C. OBS.:Caso não hajam ocorrências no ponto clicado os gráficos não aparecem'));
...
inspector00.widgets().set(1, ui.Label('Painel Meteorológico, consulta realizada em: '+ date100 ));
  ...
  var location = 'Consulta ao potencial de ocorrencência de Geada Severa por hora na coordenada lon: ' + coords.lon.toFixed(2) + ' ' +
...
var Grafico50 = ui.Chart.image.series({
  ...
  scale: 100,
   xProperty:'system:index'
          ...
          title: 'Contagem de horas por dia com potencial de desenvolvimento de Geada Severa',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '092e6e',format: 'short'}
          },
...
var chart0 = ui.Chart.image.series({
  ...
  scale: 100,
   xProperty:'system:index'
          ...
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '092e6e'}
          },
          vAxis: {title: 'Horas por dia'},
        legend: 'true',
        trendlines: {
...
var chart = ui.Chart.image.series({
  ...
  //xProperty: 'date'
          ...
          title: 'Potencial de desenvolvimento de Geadas Severa por hora',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '092e6e'}
          },
          vAxis: {title: 'Teperatura abaixo de 0°C por hora'},
        legend: 'true',
        trendlines: {
      0: {
        type: 'polynomial',
...
var chart1 = ui.Chart.image.series({
  ...
  xProperty: 'date'
          ...
          title: 'Teperatura abaixo de 0°C por hora',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '092e6e'}
...
var chart10 = ui.Chart.image.series({
  ...
  scale: 100,
   xProperty:'system:index'
          ...
          title: 'Contagem de horas por dia com potencial de desenvolvimento de Geadas Severas',
          curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '092e6e'}
...
var chart100 = ui.Chart.image.series({
  ...
  xProperty: 'date'
          ...
          title: 'Potencial de desenvolvimento de Geadas Severas a cada 3 horas',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '092e6e'}
          },
          vAxis: {title: 'Umidade relativa 3 horas'},
        legend: 'true',
        trendlines: {
      0: {
        type: 'polynomial',
...
var chart11 = ui.Chart.image.series({
  ...
  xProperty: 'date'
          ...
          title: 'Teperatura abaixo de 0°C a cada 3 horas',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '092e6e'}
...
var Grafico5 = ui.Chart.image.series({
  ...
  scale: 100,
   xProperty:'system:index'
          ...
          title: 'Contagem de horas por dia com potencial de desenvolvimento de Gedas Severas',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '092e6e'}
...
var panel2 = ui.Panel({style: {width: '65%'}})
    .add(ui.Label('Fontes:  GFS: Sistema de previsão global de dados de atmosfera de 384 horas. Caso apareça uma mensagem de erro no lugar do gráfico é porque não tem período com potencial de Geadas Severas nesse ponto' )); 
...
var geometryyy = /* color: #d63000 */ee.Geometry.Point([-49.93474006301933,-28.746238030514576]);
Map.layers().set(3, ui.Map.Layer(geometryyy, {color: 'FFFF00'},'Fazenda')); 
Map.setCenter(-49.93474006301933,-28.746238030514576, 5);  
