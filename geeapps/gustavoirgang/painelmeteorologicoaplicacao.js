...
var quality = function(image){ 
  var mask1 = image.select("temperature_2m_above_ground").lte(30).selfMask()
 ...
 .sqrt().multiply(3.6).rename('velocidade').lte(10).selfMask()
   var mask3 = image.select("relative_humidity_2m_above_ground").gte(55).selfMask()
...
var panel = ui.Panel({layout: ui.Panel.Layout.flow('vertical'),style: {width: '65%', height: '100%'}})
    .add(ui.Label('Painel Meteorológico ')).add(ui.Label('Clique no mapa para consultar os períodos com condições meteorológicas para aplicação de produtos agrotóxicos à base de ácido 2,4-diclorofenoxiacético (2,4-D). Os resutados são apresentados em dois conjuntos temporais, de 0 a 120 horas de hora em hora e de 120 a 384 horas de previsão de 3 por 3 horas conforme padrão original do modelo. É considerado apto para aplicação quando respeitado condições meteorológicas como velocidade do vento menor do que 10km/h, umidade relativa do ar superior a 55% e temperatura ambiente menor que 30°C. . OBS.:Caso não hajam ocorrências no ponto clicado os gráficos não aparecem'));
...
inspector00.widgets().set(1, ui.Label('Painel Meteorológico, consulta realizada em: '+ date100 ));
  ...
  var location = 'Consulta ao potencial de aplicação de produtos agrotóxicos por hora na coordenada lon: ' + coords.lon.toFixed(2) + ' ' +
...
var Grafico50 = ui.Chart.image.series({
  ...
  scale: 100,
   xProperty:'system:index'
          ...
          title: 'Contagem de horas por dia com potencial aplicação de produtos agrotóxicos',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '000000',format: 'short'}
          },
...
var chart0 = ui.Chart.image.series({
  ...
  scale: 100,
   xProperty:'system:index'
          ...
          title: 'Contagem de horas por dia com potencial para aplicação de produtos agrotóxicos',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '000000'}
          },
          vAxis: {title: 'Horas por dia'},
        legend: 'true',
        trendlines: {
...
var chart = ui.Chart.image.series({
  ...
  xProperty: 'date'
          ...
          title: 'Potencial de aplicação de produtos agrotóxicos por hora',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '000000'}
...
var chart1 = ui.Chart.image.series({
  ...
  xProperty: 'date'
          ...
          title: 'aplicação de produtos agrotóxicos por hora',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '000000'}
...
var chart10 = ui.Chart.image.series({
  ...
  scale: 100,
   xProperty:'system:index'
          ...
          title: 'Contagem de horas por dia com potencial de aplicação de produtos agrotóxicos',
          curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '000000'}
...
var chart100 = ui.Chart.image.series({
  ...
  xProperty: 'date'
          ...
          title: 'Potencial de aplicação de produtos agrotóxicos a cada 3 horas',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '000000'}
          },
          vAxis: {title: 'aplicação de produtos agrotóxicos 3 horas'},
        legend: 'true',
        trendlines: {
      0: {
        type: 'polynomial',
...
var chart11 = ui.Chart.image.series({
  ...
  xProperty: 'date'
          ...
          title: 'aplicação de produtos agrotóxicos a cada 3 horas',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: '000000'}
          },
          vAxis: {title: 'aplicação de produtos agrotóxicos'},
        legend: 'true',
        trendlines: {
      0: {
        type: 'polynomial',
...
var panel2 = ui.Panel({style: {width: '65%'}})
    .add(ui.Label('Fontes:  GFS: Sistema de previsão global de dados de atmosfera de 384 horas.períodos com condições meteorológicas para aplicação de produtos agrotóxicos à base de ácido 2,4-diclorofenoxiacético (2,4-D). Os resutados são apresentados em dois conjuntos temporais, de 0 a 120 horas de hora em hora e de 120 a 384 horas de previsão de 3 por 3 horas conforme padrão original do modelo. É considerado apto para aplicação quando respeitado condições meteorológicas como velocidade do vento menor do que 10km/h, umidade relativa do ar superior a 55% e temperatura ambiente menor que 30°C. . OBS.:Caso não hajam ocorrências no ponto clicado os gráficos não aparecem' )); 
