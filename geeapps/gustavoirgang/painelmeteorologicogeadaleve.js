...
var quality = function(image){ 
  var mask1 = image.select("temperature_2m_above_ground").lte(3);
...
var panel = ui.Panel({layout: ui.Panel.Layout.flow('vertical'),style: {width: '65%', height: '100%'}})
    .add(ui.Label('Painel Meteorológico ')).add(ui.Label('Clique no mapa para consultar os períodos com potencial de Geadas levas previsão 16 dias. Os resutados são apresentados em dois conjuntos temporais, de 0 a 120 horas de hora em hora e de 120 a 384 horas de previsão de 3 por 3 horas conforme padrão original do modelo. É considerado período com potencial de desenvolvimento de geada quando a temperatura do ar esta menor do que 3°C. OBS.:Caso não hajam ocorrências no ponto clicado os gráficos não aparecem'));
...
inspector00.widgets().set(1, ui.Label('Painel Meteorológico, consulta realizada em: '+ date100 ));
  ...
  var location = 'Consulta ao potencial de ocorrencência de Geada Leve por hora na coordenada lon: ' + coords.lon.toFixed(2) + ' ' +
...
var Grafico50 = ui.Chart.image.series({
  ...
  scale: 100,
   xProperty:'system:index'
          ...
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: 'red',format: 'short'}
          },
...
var chart = ui.Chart.image.series({
  ...
  //xProperty: 'date'
          ...
          title: 'Potencial de desenvolvimento de Geadas Leves por hora',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: 'red'}
...
var chart1 = ui.Chart.image.series({
  ...
  xProperty: 'date'
          ...
          title: 'Teperatura abaixo de 3°C por hora',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: 'red'}
...
var chart10 = ui.Chart.image.series({
  ...
  scale: 100,
   xProperty:'system:index'
          ...
          title: 'Contagem de horas por dia com potencial de desenvolvimento de Geadas Leves',
          curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: 'red'}
...
var chart100 = ui.Chart.image.series({
  ...
  xProperty: 'date'
          ...
          title: 'Potencial de desenvolvimento de Geadas Leves a cada 3 horas',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: 'red'}
...
var chart11 = ui.Chart.image.series({
  ...
  xProperty: 'date'
          ...
          title: 'Teperatura abaixo de 3°C a cada 3 horas',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: 'red'}
...
var Grafico5 = ui.Chart.image.series({
  ...
  scale: 100,
   xProperty:'system:index'
          ...
          title: 'Contagem de horas por dia com potencial de desenvolvimento de Gedas Leves',
          //curveType:'function',
          series: {
          // Gives each series an axis name that matches the Y-axis below.
          0: {axis:  'temperature_2m_above_ground' , setChartType:'ColumnChart', color: 'red'}
