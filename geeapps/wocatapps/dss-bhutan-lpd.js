//Load Features 
var ftc0 = ee.FeatureCollection('users/wocatapps/Bhutan/International_BND'),
//ftc0 = ee.FeatureCollection("users/projectgeffao/World/Borders/UN_Res0_ADM0_BNDA_CTY"),
    ftc1 = ee.FeatureCollection("users/projectgeffao/World/Borders/UN_Res0_ADM1_BNDA_A1");
// Filter vectors to target country 
var filter = ee.Filter.inList('ISO3CD', ['BTN']);
//var ftc0 = ftc0.filter(filter);
var ftc1 = ftc1.filter(filter);    
// Load Trend index
...
// Load LPD
var lp_01_15_jrc = ee.Image("users/geflanddegradation/toolbox_datasets/lpd_jrc_baseline_2000_2015_1km").unmask()//.selfMask()
var lp_05_19_jrc = ee.Image("users/geflanddegradation/toolbox_datasets/lpd_jrc_reporting_2004_2019_1km").unmask()//.selfMask()
var lp_01_15_te = ee.Image('users/geflanddegradation/global_ld_analysis/lp5cl_globe_2001_2015_modis_gpg').unmask()//.selfMask()
var lp_05_19_te = ee.Image('users/geflanddegradation/global_ld_analysis/lp5cl_globe_2005_2019_modis_gpg').unmask()//.selfMask()
var lp_01_15_fao = ee.Image("users/projectgeffao/World/LPD_world_2001_2015_v3").unmask()//.selfMask()
var lp_05_19_fao = ee.Image("users/projectgeffao/World/LPD_world_2005_2019_v3").unmask()//.selfMask()
var lp_01_15_faoWocat = ee.Image("users/wocatapps/World/LPD_2001_2015_World_MK_MTDI3_Des025").unmask()//.selfMask()
var lp_05_19_faoWocat = ee.Image("users/wocatapps/World/LPD_2005_2019_World_MK_MTDI3_Des025").unmask()//.selfMask()
var lp_01_15_mk = ee.Image("users/projectgeffao/World/LPD_2001_2015_World_onlyMK_Des025").unmask()//.selfMask()
var lp_05_19_mk = ee.Image("users/projectgeffao/World/LPD_2005_2019_World_onlyMK_Des025").unmask()//.selfMask()
var lp_01_15_bio = ee.Image("users/wocatapps/World/LPD_2001_2015_World_MK_MTDI3_BIO36_Des025").unmask()//.selfMask()
var lp_05_19_bio = ee.Image("users/wocatapps/World/LPD_2005_2019_World_MK_MTDI3_BIO36_Des025").unmask()//.selfMask()
/*
...
var lstYears = ee.List.sequence(2005, 2019);
var imcMODISMonthYear = ee.ImageCollection('MODIS/006/MOD13Q1')
    .filterDate('2005-01-01', '2019-12-31')
    .select('NDVI');
...
var lstCompleteYears = ee.List.sequence(2005, 2019);
...
//    m.countryName = lan === mdlLocalization.languages[0] ? ftc0.first().get('ADM1_NAME').getInfo() : ftc0.first().get('ADM1_NAME').getInfo();// first inglish second other
    m.countryName = lan === mdlLocalization.languages[0] ? ftc0.first().get('ADM1NM').getInfo() : ftc0.first().get('ADM1NM').getInfo();// first inglish second other
    // More info & contact
    m.info = {
    ...
    m.lp_01_15_jrc = lp_01_15_jrc.clip(ftc0);
    m.lp_05_19_jrc = lp_05_19_jrc.clip(ftc0);
    m.lp_01_15_te = lp_01_15_te.clip(ftc0);
    m.lp_05_19_te = lp_05_19_te.clip(ftc0);
    m.lp_01_15_fao = lp_01_15_fao.clip(ftc0);
    m.lp_05_19_fao = lp_05_19_fao.clip(ftc0);
    m.lp_01_15_faoWocat = lp_01_15_faoWocat.clip(ftc0);
    m.lp_05_19_faoWocat = lp_05_19_faoWocat.clip(ftc0);
    m.lp_01_15_mk = lp_01_15_mk.clip(ftc0);
    m.lp_05_19_mk = lp_05_19_mk.clip(ftc0);
    m.lp_01_15_bio = lp_01_15_bio.clip(ftc0);
    m.lp_05_19_bio = lp_05_19_bio.clip(ftc0);
...
//    m.names1= lan === mdlLocalization.languages[0] ?  ftc1.aggregate_array('ADM1_NAME').getInfo() : ftc1.aggregate_array('ADM1_NAME').getInfo();
    m.names1= lan === mdlLocalization.languages[0] ?  ftc1.aggregate_array('ADM1NM').getInfo() : ftc1.aggregate_array('ADM1NM').getInfo();
   //m.names1 = ftc1.aggregate_array('ADM1_RU').getInfo();
//    m.codes1 = ftc1.aggregate_array('ADM1_CODE').getInfo();
    m.codes1 = ftc1.aggregate_array('ADM1CD').getInfo();
    m.siLevel1 = [];
...
*/
        'Map LPD 1':
        {
            imgMap: m.lp_05_19_faoWocat,
            lv: m.lv.lpd,
            scale: 250,
        },
        'Map LPD 2':
        {
            imgMap: m.lp_05_19_jrc,
            lv: m.lv.lpd,
            scale: 250,
        },
        'Map LPD 3':
        {
            imgMap: m.lp_05_19_te,
//            imgMap: m.imgLPDmkmtdi,
        ...
        'Map LPD 4':
        {
            imgMap: m.lp_05_19_bio,
            lv: m.lv.lpd,
            scale: 250,
        },
         'Map LPD 5':
        {
            imgMap: m.lp_05_19_fao,
            lv: m.lv.lpd,
            scale: 250,
        },
 /*        'Map LPD 6':
...
*/
    ...
    ******************************************************************************/
    ...
    //c.pnlOutput.add(c.lblForm); //Agregar Google form
