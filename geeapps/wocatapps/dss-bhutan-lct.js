var ftc0 = ee.FeatureCollection("users/wocatapps/Bhutan/LCTBTN_Precal_Level0_v4_NBe"),
ftc1 = ee.FeatureCollection("users/wocatapps/Bhutan/LCTBTN_Precal_Level1_v4_NBe"),
ftc2 = ee.FeatureCollection("users/wocatapps/Bhutan/LCTBTN_Precal_Level2_v4_NBe")
;
 var    imgLastLC = ee.Image('users/wocatapps/Bhutan/imgLULC2016_7cat')
/** 
...
var mdlPrecalculation = require('users/wocatapps/Bhutan:AppLCT/precalculation.js');
var mdlLocalization = require('users/wocatapps/Bhutan:AppLCT/localization.js');
/** Assets */
var a = {};
...
m.layerEntries = [
        {
            ...
            name: m.labels.lblLandCover + ' (National 2016) ',
            visible: false,
            legend: mdlLegends.createDiscreteLegendPanel(m.labels.lblLandCover + ' (National 2016) ', m.lv.lcNational.names, m.lv.lcNational.vis.palette, false, false),
            group: 'RASTER',
//            citation: 'https://drive.google.com/file/d/18WcDHGPGXJv1VjFt_-gNFLxTym1k-h8X/view?usp=share_link'
            citation: ''
        },
        {
        asset: ftc2,
