var ftcPA = ee.FeatureCollection("users/angelini_hernan/Panama/Vector/sinap"),
    ...
    imgTerrain = ee.Image("users/angelini_hernan/Panama/Raster/PAN_Terrain_rgb3bm"),
/*    ftc0 = ee.FeatureCollection("users/projectgeffao/Panama/PanamaPAN_Precal_Level0_v4_Be"),
    ftc1 = ee.FeatureCollection("users/projectgeffao/Panama/PanamaPAN_Precal_Level1_v4_NoBe"),
    ftc2 = ee.FeatureCollection("users/projectgeffao/Panama/PanamaPAN_Precal_Level2_v4_NoBe"),
    ftc3 = ee.FeatureCollection("users/projectgeffao/Panama/PanamaPAN_Precal_Level3_v4_NoBe"),
    ftcBasinsL8_View = ee.FeatureCollection("users/projectgeffao/Panama/PanamaPAN_Precal_Basin8c_v4_NoBe"),*/
    ftc0 = ee.FeatureCollection("users/angelini_hernan/Panama/Precal/PAN_Precal_Level0_v7_NBE"),
    ftc1 = ee.FeatureCollection("users/angelini_hernan/Panama/Precal/PAN_Precal_Level1_v7_NBE"),
    ftc2 = ee.FeatureCollection("users/angelini_hernan/Panama/Precal/PAN_Precal_Level2_v7_NBE"),
    ftc3 = ee.FeatureCollection("users/angelini_hernan/Panama/Precal/PAN_Precal_Level3_v7_NBE"),
    ftcBasinsL8_View = ee.FeatureCollection("users/projectgeffao/Panama/PanamaPAN_Precal_Basin8c_v4_NoBe"),
//    ftcBasinsL11_View = ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_11"),
    ftcBasinsL8_Country = ee.FeatureCollection("users/angelini_hernan/Panama/Precal/PAN_Precal_Basin8c_v7_BE"),
    ftcBasinsProject = ee.FeatureCollection("users/wocatapps/Panama/PAN_Precal_BasinsProject_v7_NBE"),
//    ftcBasinsL11_Country = ee.FeatureCollection("users/angelini_hernan/Panama/PAN_Precal_Basin11c_v1_NoBe");
    ftcQM = ee.FeatureCollection("users/angelini_hernan/Panama/Vector/PAN_REGxLUSm_PRECAL_v7_BE"),
//    ftcQM = ui.Map.FeatureViewLayer("users/angelini_hernan/Panama/Vector/PANfv_REGxLUSm_PRECAL_v7_BE", null, "PANfv_REGxLUSm_PRECAL_v7_BE"),
    imgQM = ee.Image("users/projectgeffao/Panama/QM_REGxLUS"),
    imgLUS = ee.Image("users/angelini_hernan/Panama/Raster/PAN_imgLUS_reclass");
var lp_01_15 = ee.Image("users/geflanddegradation/global_ld_analysis/lp5cl_globe_2001_2015_modis_gpg").toByte().clip(ftc0).selfMask()
var lp_01_15 = lp_01_15.remap([ 1, 2, 3, 4, 5],[ 1, 1, 2, 2, 3])
var lp_05_19 = ee.Image("users/geflanddegradation/global_ld_analysis/lp5cl_globe_2005_2019_modis_gpg").toByte().clip(ftc0).selfMask()
var lp_05_19 = lp_05_19.remap([ 1, 2, 3, 4, 5],[ 1, 1, 2, 2, 3])
var sc_01_15 = ee.Image("users/projectgeffao/Panama/SOC/SOC_National_Deg_Baseline_10m").toByte().clip(ftc0).selfMask()
var sc_15_19 = ee.Image("users/projectgeffao/Panama/SOC/SOC_National_Deg_Reporting_10m").toByte().clip(ftc0).selfMask()
var imgBaseDeg = ee.Image('users/projectgeffao/Panama/LandCover/Nat_LC_BaselineLayers_Panamaversion3')
              .select('lc_degradation_2000_2012')
var imgRepoDeg = ee.Image('users/projectgeffao/Panama/LandCover/Nat_LC_ReportingLayers_Panamaversion3')
              .select('lc_degradation_2012_2021')
// from import              
//var gradoDeg= ee.Image('users/projectgeffao/Panama/QM_GradoDegradacion')
//var tipoDeg= ee.Image('users/projectgeffao/Panama/QM_TipoDegradacion_6cat')
//var causaDir= ee.Image('users/projectgeffao/Panama/QM_CausaDirecta_8cat')
ftcQM = ftcQM.map(function (f) {
    return f.set('name', ee.String(f.get('name')).cat('_').cat(f.get('TXT_LUS')));
});
 ...
 */
/** Modules */
var mdlLegends = require('users/projectgeffao/Panama:Apps/Legends.js');
var mdlPrecalculation = require('users/projectgeffao/Panama:Apps/Precalculation_Panama.js');
var mdlLocalization = require('users/projectgeffao/Panama:Apps/Localization_Panama.js');
/** Assets */
var a = {};
...
/*
a.imgSDGBaselineNATbis = mdlPrecalculation.imgSDGBaselineNATbis.unmask().clip(ftc0);
a.imgSDGReportNATbis = mdlPrecalculation.imgSDGReportNATbis.unmask().clip(ftc0);
a.imgSDGStatusNATbis = mdlPrecalculation.imgSDGStatusNATbis.unmask().clip(ftc0);
a.imgSDGComparisonNATbis = mdlPrecalculation.imgSDGComparisonNATbis.unmask().clip(ftc0);
*/
/*
// JRC
...
a.gradoDeg =  mdlPrecalculation.imgQMGD.unmask().clip(ftc0);
a.tipoDeg = mdlPrecalculation.imgQMTD.unmask().clip(ftc0);
a.causaDir = mdlPrecalculation.imgQMCD.unmask().clip(ftc0);
// For multicriteria calculation
a.imgCustom = ee.Image(0).selfMask();
a.imgMask = ee.Image(0).selfMask();
// Filter global assets
a.ftcKBA = ftcKBA.filter(ee.Filter.eq('ISO3', 'PAN'));
a.ftcPA = ftcPA//.filter(ee.Filter.eq('ISO3', 'PAN')).filterMetadata('DESIG_TYPE', 'equals', 'National');
...
function initApp(lan) {
    ...
    ******************************************************************************/
    ...
    m.info = {
        referenceDocUrl: '',
        contactEmail1: 'jjjaramillo@miambiente.gob.pa',
        contactEmail2: 'cesar.garcia@fao.org',
        contactEmail3: 'wocat.cde@unibe.ch',
        contactEmail4: '',
    ...
    m.assetsClick[m.labels.lblLevel3] = ftc3;
    m.assetsClick[m.labels.lblBasins] = ftcBasins;
    m.assetsClick[m.labels.lblBasinsProject] = ftcBasinsProject;
    m.assetsClick[m.labels.lblQMMappingUnit] = ftcQM;
    ...
    m.lv = {
        lcNational: {
            vis: {
                ...
                palette:  ['#377e3f','#fc75eb','#83e70b', '#c19511', '#fcdb00', '#18eebe', '#d7191c', '#cfdad2', '#4458eb'],
            },
            names: [
                m.labels.lblTreeCovered,
                m.labels.lblMangrove,
                m.labels.lblRastrojo,
        ...
        gradoDeg: {
            vis: {
                ...
                palette: ['white','#ffdf84', '#ffb716', '#ff662c', '#c6492c',],
            },
            names: [
                m.labels.lblNoData,
                m.labels.lblLight,
            ...
            tipoDeg: {
            vis: {
                min: 0, max: 6, opacity: 1,
                palette: ['white','#1EC2EE', '#E715D6', '#02F994', '#CBF25E','#A74FBA', '#1ab675',],
            },
            names: [
                m.labels.lblNoData,
        ...
        causaDir: {
            vis: {
                min: 0, max: 8, opacity: 1,
                palette: ['white','#dcbc04', '#874e3c', '#327644', '#e46723','#9c9c9c', '#a035be','#0f187e','#e8e0a2'],
            },
            names: [
                m.labels.lblNoData,
        ...
        npp: {
            vis: { min: 0, max: 1, opacity: 1, 
                   palette: ['#d1442e', '#d17534', '#feb532', '#fef622', '#cee40d', '#b7cb0c', '#09db16', '#07a811', '#05800d'] },
        },
        lcTransitions: {
            vis: {
                min: 0, max: 9, opacity: 1,
                palette:  ['#FEFFE5','#377e3f','#fc75eb','#83e70b', '#c19511', '#fcdb00', '#18eebe', '#d7191c', '#cfdad2', '#4458eb'],
            },
            names: [
                m.labels.lblNoData,
                m.labels.lblTreeCovered,
        ...
        lus: {
            vis:{
                min: 1, max: 15, opacity: 1,
                palette: ['darkgreen', 'green', 'limegreen','#94D900','#00FFA6','#6800B5','#eec60a',
                          '#FFDCB8','gold','#6800B5','#A87900','blue','red','#A600CC','#D2D2FF'],
                },
            names: [//'NoData',
                m.labels.lbl_lc2021_1,
                m.labels.lbl_lc2021_2,
                m.labels.lbl_lc2021_3,
                m.labels.lbl_lc2021_4,
                m.labels.lbl_lc2021_5,
                m.labels.lbl_lc2021_6,
                m.labels.lbl_lc2021_7,
                m.labels.lbl_lc2021_8,
                m.labels.lbl_lc2021_9,
                m.labels.lbl_lc2021_10,
                m.labels.lbl_lc2021_11,
                m.labels.lbl_lc2021_12,
                m.labels.lbl_lc2021_13,
                m.labels.lbl_lc2021_14,
                m.labels.lbl_lc2021_15,]
        },
        borderLevel1: { vis: { color: 'black', fillColor: '00000000' } },
        borderLevel2: { vis: { color: '#2c3e50 ', fillColor: '00000000', width: 1.2 } },
        borderLevel3: { vis: { color: '#abb2b9', fillColor: '00000000', width: 0.5 } },
        borderLevelQM: { vis: { color: 'darkgreen', fillColor: '00000000', width: 0.8 } },
        borderBasins: { vis: { color: 'blue', fillColor: '00000000', width: 1.5 } },
        borderBasinsProject: { vis: { color: 'darkred', fillColor: '00000000', width: 1.5 } },
    ...
    m.layerEntries = [
        ...
        },
        {
            ...
            visible: false,
            legend: mdlLegends.createDiscreteLegendPanel(m.labels.lblLUS, m.lv.lus.names, m.lv.lus.vis.palette, false, false),
            group: 'RASTER',
            citation: 'https://drive.google.com/file/d/1g2hCcyRngNOZfyhQf7ErNMXna5qKKiwm/view?usp=share_link'
        },
        {
            asset: a.imgLastLC,
            style: m.lv.lcNational.vis,
            name: m.labels.lblLandCoverUNCCD,// + ' (' + mdlPrecalculation.baseLC.name + ') ' + mdlPrecalculation.baseLC.year,
            visible: false,
            legend: mdlLegends.createDiscreteLegendPanel(m.labels.lblLandCoverUNCCD, m.lv.lcNational.names, m.lv.lcNational.vis.palette, false, false),
            group: 'RASTER',
            citation: 'https://drive.google.com/file/d/1NDorWQyJWi-B5gXR_n63DU1c_ut-z988/view?usp=share_link'
        },
        {
            asset: a.imgLPD,
            style: m.lv.lpd.vis,
            ...
            group: 'RASTER',
            citation: 'https://drive.google.com/file/d/14qJPXIh0G8g0OoHXAAmws1jBsIt7ClXJ/view?usp=sharing'
        },
        {
            asset: a.imgSOC,
            style: m.lv.soc.vis,
            ...
            group: 'RASTER',
            citation: 'https://drive.google.com/file/d/1llxPOv-jU4Xbp5Z3uytoYkVWr55toiLm/view?usp=sharing'
        },
        {
            ...
            group: 'RASTER',
            citation: 'https://drive.google.com/file/d/1qlIsvlQrPmMmjXWJhlGMBdK-LATEECM0/view?usp=sharing'
        },
        {
            ...
            group: 'RASTER',
            citation: 'https://drive.google.com/file/d/13ZUAevT3TpO60kjkC2kdU7OtbfGp17vs/view?usp=sharing'
        },
         {
            asset: a.gradoDeg,
            style: m.lv.gradoDeg.vis,
            name: m.labels.lblQMDegradationDegree,
            visible: false,
            legend: mdlLegends.createDiscreteLegendPanel(m.labels.lblQMDegradationDegree, m.lv.gradoDeg.names, m.lv.gradoDeg.vis.palette, false, false),
            group: 'RASTER',
            citation: ''
        },
             {
            asset: a.tipoDeg,
            style: m.lv.tipoDeg.vis,
            name: m.labels.lblQMDegradationTypes,
            visible: false,
            legend: mdlLegends.createDiscreteLegendPanel(m.labels.lblQMDegradationTypes, m.lv.tipoDeg.names, m.lv.tipoDeg.vis.palette, false, false),
            group: 'RASTER',
            citation: ''
        },
        {
            asset: a.causaDir,
            style: m.lv.causaDir.vis,
            name: m.labels.lblQMDirectCauses,
            visible: false,
            legend: mdlLegends.createDiscreteLegendPanel(m.labels.lblQMDirectCauses, m.lv.causaDir.names, m.lv.causaDir.vis.palette, false, false),
            group: 'RASTER',
            citation: ''
        },
        {
            ...
            group: 'RASTER',
            citation: 'https://drive.google.com/file/d/1E3oAuEQyScNlRA89jfoEFJGK62ORq-ys/view?usp=sharing'
        },
        {
            ...
            group: 'RASTER',
            citation: 'https://drive.google.com/file/d/1eNcmAi2CxIaRviaKQqo8-iwfmQITb4Ku/view?usp=sharing'
        },
        {
            asset: ftc1,
        ...
        {
            asset: imgQM.randomVisualizer(),
            style: {},
            name: m.labels.lblQMMappingUnit,
            visible: false,
            legend: null,
            group: 'RASTER',
            //singleColor: 'SQUARE',
        ...
        {
            asset: ftcBasinsProject,
            style: m.lv.borderBasinsProject.vis,
            name: m.labels.lblBasinsProject,
            visible: false,
            legend: null,
            group: 'FEATURES',
            singleColor: 'SQUARE',
        ...
        },*/
        {
            ...
            group: 'FEATURES',
            singleColor: 'SQUARE',
            citation: 'https://drive.google.com/file/d/1GxC__tsbfAQl15dOCorGN62dJ7L0O1rR/view?usp=sharing'
        },
        {
            asset: a.ftcPA,
            style: m.lv.pa.vis,
            ...
            group: 'FEATURES',
            singleColor: 'SQUARE',
            citation: 'https://drive.google.com/file/d/15gVnNIqIZywwGCzFJoWrGycZse7j4U3R/view?usp=sharing'
        },
    ];
    // SDG
    m.SDGLayerEntries = [
...
// NAT
        ...
        },
  {
            ...
            visible: false,
            legend: mdlLegends.createDiscreteLegendPanel(m.labels.lblLPDBas, m.lv.lcDeg.names, m.lv.lcDeg.vis.palette, false, false),
            group: 'RASTER',
            citation: ''
        },
        {
            ...
            visible: false,
            legend: mdlLegends.createDiscreteLegendPanel(m.labels.lblLPDRep, m.lv.lcDeg.names, m.lv.lcDeg.vis.palette, false, false),
            group: 'RASTER',
            citation: ''
        },
 {
...
/*
        // FAO WOCAT
        {
            asset: a.imgSDGBaselineNATbis,
            style: m.lv.sdg1531.vis,
            name: m.labels.lblSDG1531BasNATbis,
            visible: false,
            legend: mdlLegends.createDiscreteLegendPanel(m.labels.lblSDG1531BasNATbis, m.lv.sdg1531.names, m.lv.sdg1531.vis.palette, false, false),
            group: 'RASTER',
            citation: ''
        },
        {
            asset: a.imgSDGReportNATbis,
            style: m.lv.sdg1531.vis,
            name: m.labels.lblSDG1531RepNATbis,
            visible: false,
            legend: mdlLegends.createDiscreteLegendPanel(m.labels.lblSDG1531RepNATbis, m.lv.sdg1531.names, m.lv.sdg1531.vis.palette, false, false),
            group: 'RASTER',
            citation: ''
        },
        {
            asset: a.imgSDGStatusNATbis,
            style: m.lv.sdg1531.vis,
            name: m.labels.lblSDG1531StaNATbis,
            visible: false,
            legend: mdlLegends.createDiscreteLegendPanel(m.labels.lblSDG1531StaNATbis, m.lv.sdg1531.names, m.lv.sdg1531.vis.palette, false, false),
            group: 'RASTER',
            citation: ''
        },
        {
            asset: a.imgSDGComparisonNATbis,
            style: m.lv.sdg1531.vis,
            name: m.labels.lblSDG1531ComNATbis,
            visible: false,
            legend: mdlLegends.createDiscreteLegendPanel(m.labels.lblSDG1531ComNATbis, m.lv.sdg1531.names, m.lv.sdg1531.vis.palette, false, false),
            group: 'RASTER',
            citation: ''
        },
 */  
...
*/
    ...
    m.mcEntries = [
        ...
        {
            title: m.labels.lblLUS,
            palette: m.lv.lus.vis.palette,
            names: m.lv.lus.names,
            image: imgLUS,
        ...
        {
            title: m.labels.lblQMDegradationDegree,
            palette: m.lv.gradoDeg.vis.palette.slice(1),
            names: m.lv.gradoDeg.names.slice(1),
            image: a.tipoDeg,
            categories: [1, 2, 3, 4],
        },
        {
            title: m.labels.lblQMDegradationTypes,
            palette: m.lv.tipoDeg.vis.palette.slice(1),
            names: m.lv.tipoDeg.names.slice(1),
            image: a.tipoDeg,
            categories: [1, 2, 3, 4, 5, 6],
        },
        {
            title: m.labels.lblQMDirectCauses,
            palette: m.lv.causaDir.vis.palette.slice(1),
            names: m.lv.causaDir.names.slice(1),
            image: a.causaDir,
        ...
        },
        {
            ...
            palette: m.lv.sdg1531.vis.palette,
            names: m.lv.sdg1531.names,
        ...
        {
            title: m.labels.lblSDG1531StaNAT,
            palette: m.lv.sdg1531.vis.palette,
            names: m.lv.sdg1531.names,
            image: a.imgSDGStatusNAT,
            categories: [1, 2, 3, 4, 5],
        },
    ];
    /*******************************************************************************
    ...
    ******************************************************************************/
    ...
    c.lp.levels.selLevel3 = ui.Select({
        items: [],
        placeholder: m.labels.lblSelectLevel2First,
    });
    ...
    ******************************************************************************/
    ...
    c.lp.pnlControl.add(c.lp.levels.selLevel3);
...
//    c.lp.pnlControl.add(c.lp.sdg.lblGlobalAppSDG);
    ...
    ******************************************************************************/
    ...
    c.lp.info.lblEmail2.style().set(s.styleWarning);
    c.lp.info.lblEmail3.style().set(s.styleWarning);
    ...
    c.lp.levels.selLevel3.style().set({ width: "90%", });
    ...
    ******************************************************************************/
    ...
    var showInfoSelectedAoi = function () {
        ...
        if (m.precalculated) { // aoi from precalculated assets
            ...
            var statslCols = [
                ...
                'soc_mean',
                'npp_sum',  
                'p_ilus', 'pro_kba', 'p_qmgd', 'p_qmtd', 'p_qmcd'
            ];
    ...
    var handleChangeLevel3 = function (level3Code) {
        m.levelAoi = m.labels.lblLevel3;
        m.ftcAoi = ftc3.filter(ee.Filter.eq('ADM3_CODE', level3Code));
    ...
    var handleChangeLevel2 = function (level2Code) {
        if (level2Code !== null) {
            ...
            showInfoSelectedAoi();
        // load level 3
            c.lp.levels.selLevel3.setPlaceholder(m.labels.lblLoadingLevel3);
            c.lp.levels.selLevel3.items().reset([]);
            var namesLevel3 = m.ftcLelvel3.filter(ee.Filter.eq('ADM2_CODE', level2Code)).aggregate_array('ADM3_NAME');
            var codesLevel3 = m.ftcLelvel3.filter(ee.Filter.eq('ADM2_CODE', level2Code)).aggregate_array('ADM3_CODE');
            namesLevel3.getInfo(function (names3) {
                codesLevel3.getInfo(function (codes3) {
                    var siLevel3 = [];
                    ...
                    siLevel3.sort(sortByLabel);
                    c.lp.levels.selLevel3.unlisten();
                    c.lp.levels.selLevel3.setValue(null);
                    c.lp.levels.selLevel3.items().reset(siLevel3);
                    c.lp.levels.selLevel3.setPlaceholder(m.labels.lblSelectLevel3);
                    c.lp.levels.selLevel3.onChange(handleChangeLevel3);
                });
            });
        }
    };
    ...
    var resetLevelsSelects = function () {
        ...
        c.lp.levels.selLevel2.setValue(null);
        c.lp.levels.selLevel3.items().reset([]);
        c.lp.levels.selLevel3.setPlaceholder(m.labels.lblSelectLevel1First);
        c.lp.levels.selLevel3.setValue(null);
    ...
    var handleEvaluating = function (disable) {
        ...
        c.lp.levels.selLevel3.setDisabled(disable);
    ...
    var setupGeneralCharts = function () {
        ...
        var ftc = m.precalculated ? m.ftcAoi : mdlPrecalculation.precalculate(
            m.ftcAoi,
            m.bestEffort,
            ['p_lc', 'p_lpd', 'p_hansen', 'p_ndvi_annual', 'p_x2','pro_kba',  'p_qmgd', 'p_qmtd', 'p_qmcd', 'p_ilus']);
        ...
        //  LUS PIE CHART
        var lstFeatLUS = mdlPrecalculation.namesiLUSColumns.map(function (pName, i) {
            var lstValues = ee.List([m.lv.lus.names[i], ftc.first().get(pName)]);
            return ee.Feature(null, { row: lstValues });
        });
        var lstHeaderLUS = ee.List([
            [
                { label: 'LUS', role: 'domain', type: 'string' },
                { label: 'Value', role: 'data', type: 'number' },
            ],
        ]);
        var optionsLUS = {
            ...
            height: 350,
            legend: { position: 'top', maxLines: 1 },
            colors: m.lv.lus.vis.palette,
            pieHole: 0.4
        };
        createChart(lstHeaderLUS.cat(ee.FeatureCollection(lstFeatLUS).aggregate_array('row')), optionsLUS, 'PieChart', createChartPanel(c.rp.charts.pnlGeneralCharts));
        //  LPD PIE CHART       
        ...
        //  QM's PIE CHART     
        //  QMGD
        var lstFeatQMGD = mdlPrecalculation.namesQMGDColumns.slice(1).map(function (pName, i) { // slice(1)=QMGD_0
            var lstValues = ee.List([m.lv.gradoDeg.names[i + 1], ftc.first().get(pName)]);
            return ee.Feature(null, { row: lstValues });
        });
        var lstHeaderQMGD = ee.List([
            [
                { label: 'QMGD', role: 'domain', type: 'string' },
                { label: 'Value', role: 'data', type: 'number' },
            ],
        ]);
        var optionsQMGD = {
            ...
            height: 350,
            legend: { position: 'top', maxLines: 1 },
            colors: m.lv.gradoDeg.vis.palette.slice(1),
            pieHole: 0.4
        };
        createChart(lstHeaderQMGD.cat(ee.FeatureCollection(lstFeatQMGD).aggregate_array('row')), optionsQMGD, 'PieChart', createChartPanel(c.rp.charts.pnlGeneralCharts));
        //  QMTD
        var lstFeatQMTD = mdlPrecalculation.namesQMTDColumns.slice(1).map(function (pName, i) { // slice(1)=QMGD_0
            var lstValues = ee.List([m.lv.tipoDeg.names[i + 1], ftc.first().get(pName)]);
            return ee.Feature(null, { row: lstValues });
        });
        var lstHeaderQMTD = ee.List([
            [
                { label: 'QMTD', role: 'domain', type: 'string' },
                { label: 'Value', role: 'data', type: 'number' },
            ],
        ]);
        var optionsQMTD = {
            ...
            height: 350,
            legend: { position: 'top', maxLines: 1 },
            colors: m.lv.tipoDeg.vis.palette.slice(1),
            pieHole: 0.4
        };
        createChart(lstHeaderQMTD.cat(ee.FeatureCollection(lstFeatQMTD).aggregate_array('row')), optionsQMTD, 'PieChart', createChartPanel(c.rp.charts.pnlGeneralCharts));
        //  QMCD
        var lstFeatQMCD = mdlPrecalculation.namesQMCDColumns.slice(1).map(function (pName, i) { // slice(1)=QMGD_0
            var lstValues = ee.List([m.lv.causaDir.names[i + 1], ftc.first().get(pName)]);
            return ee.Feature(null, { row: lstValues });
        });
        var lstHeaderQMCD = ee.List([
            [
                { label: 'QMCD', role: 'domain', type: 'string' },
                { label: 'Value', role: 'data', type: 'number' },
            ],
        ]);
        var optionsQMCD = {
            ...
            height: 350,
            legend: { position: 'top', maxLines: 1 },
            colors: m.lv.causaDir.vis.palette.slice(1),
            pieHole: 0.4
        };
        createChart(lstHeaderQMCD.cat(ee.FeatureCollection(lstFeatQMCD).aggregate_array('row')), optionsQMCD, 'PieChart', createChartPanel(c.rp.charts.pnlGeneralCharts));
        // SDG Trends Earth
...
//               'p_SDG_Baseline_NATbis', 'p_SDG_Report_NATbis', 'p_SDG_Status_NATbis', 'p_SDG_Comparison_NATbis',
...
//               'p_SDG_Baseline_TE', 'p_SDG_Report_TE', 'p_SDG_Status_TE', 'p_SDG_Comparison_FAO_TE'
        ...
        var columnsPrefix = ['SDG_Bas', 'SDG_Rep', 'SDG_Sta',];
        var layerTypes = [m.labels.lblBaseline, m.labels.lblReport, m.labels.lblStatus, m.labels.lblComparison];
// SDG NAT
        var lstFeatCombinedNAT = columnsPrefix.map(function (cat, i) {
        ...
        var lstHeaderCombinedNAT = ee.List([
            [
                { label: 'Nacional', role: 'domain', type: 'string' },
                { label: m.lv.sdg1531.names[0], role: 'data', type: 'number' },
                { label: m.lv.sdg1531.names[1], role: 'data', type: 'number' },
                { label: m.lv.sdg1531.names[2], role: 'data', type: 'number' },
                { label: m.lv.sdg1531.names[3], role: 'data', type: 'number' },
        ...
        createChart(lstHeaderCombinedNAT.cat(ee.FeatureCollection(lstFeatCombinedNAT).aggregate_array('row')), optionsCombinedNAT, 'BarChart', createChartPanel(c.rp.charts.pnlSDGCharts));
 //NATbis
/* 
        var lstFeatCombinedNATbis = columnsPrefix.map(function (cat, i) {
            var v0 = ftc.first().get(cat + '_NATbis_0');
            var v1 = ftc.first().get(cat + '_NATbis_1');
            var v2 = ftc.first().get(cat + '_NATbis_2');
            var v3 = ftc.first().get(cat + '_NATbis_3');
            var lstValues = ee.List([layerTypes[i], v0, v1, v2, v3]);
            return ee.Feature(null, { row: lstValues });
        });
        var lstHeaderCombinedNATbis = ee.List([
            [
                { label: 'Nacional bis', role: 'domain', type: 'string' },
                { label: m.lv.sdg1531.names[0], role: 'data', type: 'number' },
                { label: m.lv.sdg1531.names[1], role: 'data', type: 'number' },
                { label: m.lv.sdg1531.names[2], role: 'data', type: 'number' },
                { label: m.lv.sdg1531.names[3], role: 'data', type: 'number' },
        ...
        var optionsCombinedNATbis = {
            title: m.labels.lblSDG1531NATbis,
            width: 600,
            height: 400,
            legend: { position: 'top', maxLines: 3 },
            bar: { groupWidth: '75%' },
        ...
        createChart(lstHeaderCombinedNATbis.cat(ee.FeatureCollection(lstFeatCombinedNATbis).aggregate_array('row')), optionsCombinedNATbis, 'BarChart', createChartPanel(c.rp.charts.pnlSDGCharts));
*/
/*
        // SDG JRC
...
*/
    ...
    var setupTransitionsCharts = function () {
        ...
        var ftc = m.precalculated ? m.ftcAoi : mdlPrecalculation.precalculate(
            ...
            'p_lc_degradation_' + m.selectedSource.initials + '_' + fromYear + '_' + m.selectedSource.lastYear //+ '_' + ee.List[1,2,3],
            ]);
