...
var ftc1 = ee.FeatureCollection('users/projectgeffao/World/Borders/UN_Res0_ADM1_BNDA_A1').filter(ee.Filter.eq('ISO3CD', 'COL'));
var ftc2 = ee.FeatureCollection('users/projectgeffao/World/Borders/UN_Res0_ADM2_BNDA_A2').filter(ee.Filter.eq('ISO3CD', 'COL'));
// Load Trend index
