...
var AI = ee.FeatureCollection("users/cristhiancordoba/Nocaimani");
/*
...
var locationDict = {
  'Deforestación en Jamundí': {lon: -72.7164, lat: -0.9218, zoom: 13},
...
var chart = ui.Chart.array.values({
  ...
  .setOptions({
    title: 'Pérdida de Bosque en la cuenca de río Nocaimani',
