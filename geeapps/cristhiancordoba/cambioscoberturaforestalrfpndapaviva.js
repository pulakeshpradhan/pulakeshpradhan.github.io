...
var AI = ee.FeatureCollection("users/cristhiancordoba/DapaViva/rfpn_v03");
...
var locationDict = {
  'Deforestación en la RFPN': {lon: -76.55711, lat: 3.5838, zoom: 13},
...
// Center the map
var defaultLocation = locationDict['Deforestación en la RFPN'];
mapPanel.setCenter(
...
var chart = ui.Chart.array.values({
  ...
  .setOptions({
    title: 'Pérdida de Bosque en la RFPN',
