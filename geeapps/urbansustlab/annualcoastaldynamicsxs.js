var annualmaps = ee.Image("users/cwt3100101983/XSharbor/CoastalCoverTypeStackV2");
...
// Center the map
mapPanel.setCenter(121.8, 29.6, 10);
...
var text = ui.Label(
    'Results from analysis of Landsat images characterizing coastal dynamics in Xiangshan Harbor, East China.',
    {fontSize: '14px'});
