var area1 = ui.import && ui.import("area1", "image", {
      "id": "users/nkeikon/myanmar_sr/area1_map"
    }) || ee.Image("users/nkeikon/myanmar_sr/area1_map"),
    area2 = ui.import && ui.import("area2", "image", {
      "id": "users/nkeikon/myanmar_sr/area2_map"
    }) || ee.Image("users/nkeikon/myanmar_sr/area2_map"),
    roi = ui.import && ui.import("roi", "table", {
      "id": "users/nkeikon/myanmar_sr/TNI"
    }) || ee.FeatureCollection("users/nkeikon/myanmar_sr/TNI"),
...
function chartAreaByClass() {
  ...
  // Chart area size by class for the selected area of interest.
