var Indonesia = ui.import && ui.import("Indonesia", "table", {
    ...
    geometry = ui.import && ui.import("geometry", "geometry", {
      ...
      "shown": true,
      "locked": false
    }) || /* color: #23cba7 */ee.Geometry.Point([119.86918168048297, -0.9506084228557159]);
//####################### Import SHP #######################
var countries =Indonesia //Import SHP DIVA GIS
var Nama_Kabupaten = ['Palu'] //Mendefinisikan Area Studi
var geometry = countries.filter(ee.Filter.inList('NAME_2', Nama_Kabupaten));//Memilih Area Studi Terkait dalam skala kabupaten atau kota (skala urban)
var area = ee.FeatureCollection(geometry);// mendefinisikan atau memilih area
Map.addLayer(geometry,{color:"green" },"Provinsi");// menambah layer
