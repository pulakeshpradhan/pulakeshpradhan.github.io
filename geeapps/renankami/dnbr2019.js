var geometry = ui.import && ui.import("geometry", "geometry", {
    ...
    ee.Geometry.Polygon(
        [[[-69.82907160554495, -9.553834228452066],
          [-69.82907160554495, -10.740701032921365],
          [-66.96987971101372, -10.740701032921365],
          [-66.96987971101372, -9.553834228452066]]], null, false),
    ...
    geometry2 = ui.import && ui.import("geometry2", "geometry", {
      ...
      "shown": true,
      "locked": false
    }) || /* color: #2550ff */ee.Geometry.MultiPoint(
        [[-68.63513586199207, -9.655416213083578],
         [-67.85601628399209, -9.760968334818138],
         [-68.90769795402717, -10.045141255062964],
         [-69.00314167961311, -10.003219122805282],
         [-68.50382436321229, -9.79058632501539],
         [-68.0181943278119, -10.085640269748918],
         [-67.77786840007752, -9.936878431536236],
         [-68.00892461345643, -10.01464880773818],
         [-67.86163915203065, -9.821203102657185],
         [-68.20599187419862, -9.928424012695752],
         [-68.00377477214784, -9.77519229232931],
         [-68.37319005535096, -10.6891002581944],
         [-67.67075170085877, -10.48188762857128],
         [-67.75520909831971, -10.281292534610332],
         [-69.04408563182801, -9.961606351455801],
         [-68.77615232903108, -10.092592020840282]]);
...
var prefire_start = '2019-04-30';   
var prefire_end = '2019-05-10';
// 2) SET TIME FRAME - TEMPORAL WINDOW - EX POST FIRE
var postfire_start = '2019-08-01';
var postfire_end = '2019-09-30';
// 3) SHOW IN CONSOLE WINDOW START / END DATE OF FIRE EVENTS
print(ee.String('Fire period ').cat(prefire_end).cat(' and ').cat(postfire_start));
// 4) ADD STUDY AREA BOUDARIES WITH SHAPEFILE - BRAZILIAN BIOME OF PANTANAL (TROPICAL WETLAND)
...
// 7) TIME AND AREA FILTERS TO SEARCH IMAGES - LESS 10% CLOUD COVER - FILTERING IMAGENS FROM PERIODS: MAY-JUNE (PRE FIRE) & SEP-NOV (POST FIRE)
...
// 8) SELECT IMAGES OVERLAPING IN STUDY AREA - LESS 10% CLOUD COVER - FILTERING IMAGENS FROM PERIODS: MAY-JUNE (PRE FIRE) & SEP-NOV (POST FIRE)
...
Map.addLayer(pre_cm_mos, vis,'Pre-fire False Color Image 2019');
Map.addLayer(post_cm_mos, vis,'Post-fire False Color Image 2019');
