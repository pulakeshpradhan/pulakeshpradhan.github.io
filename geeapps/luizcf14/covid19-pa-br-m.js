...
var panelChildren_firstBar = ui.Panel([panelChildren_Map,panelChildren_Map_Graph], ui.Panel.Layout.flow('vertical'), {
                                                              'width':'100%', 
                                                              'height':'50%',
                                                              'border':'2px solid black', 
...
var panelChildren_secondBar = ui.Panel([panelChildren_Confirmed_1,panelChildren_Confirmed_2,panelChildren_Confirmados, panelChildren_Obito], ui.Panel.Layout.flow('horizontal'), {
                                                              'width':'100%', 
                                                              'height':'10%',
                                                              'border':'2px solid black', 
                                                              'background-color':'green',
...
var panelChildren_thirdBar = ui.Panel([panelChildren_Counties,panelChildren_Counties2], ui.Panel.Layout.flow('horizontal'), {
                                                              'width':'100%', 
                                                              'height':'40%',
                                                              'border':'2px solid black', 
                                                              'background-color':'green',
...
var panelMaster = ui.Panel([panelChildren_firstBar,panelChildren_secondBar,panelChildren_thirdBar], ui.Panel.Layout.flow('vertical'), {
                                                              'width':'100%', 
                                                              'height':'100%',
                                                              'border':'2px solid black', 
...
//Atualizado heimm
var label_Update = ui.Label('Atualizado em: 03-04-2020 às 13:37', {
                                                              'width':'95%', 
                                                              'height':'7%',
                                                              'border':'0px solid black', 
                                                              'background-color': esquemaCores.gray,
