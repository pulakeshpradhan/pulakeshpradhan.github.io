// Load Shapefile
//var fc = ee.FeatureCollection('users/farda/Kakao_Koltim');
var fc = ee.FeatureCollection('ft:1FvgpYn1Q8u2TOnM0IVyqyXL6R4XSgd5VUGIhk56F');
...
maps[0].setCenter(121.89,-4.26, 15);
maps[0].addLayer(fc, {color: 'red'}, 'Kakao');
maps[1].addLayer(fc, {color: 'green'}, 'Kakao');
maps[2].addLayer(fc, {color: 'black'}, 'Kakao');
maps[3].addLayer(fc, {color: 'blue'}, 'Kakao');
/*
 * Add a title and initialize
 */
// Create a title.
var title = ui.Label('Perkebunan Kakao, Kolaka Timur, Sentinel-2 2018', {
  stretch: 'horizontal',
  textAlign: 'center',
  fontWeight: 'bold',
  fontSize: '24px'
