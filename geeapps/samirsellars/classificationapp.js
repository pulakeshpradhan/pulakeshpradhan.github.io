...
var feature_class_5 = null;
var land_class_5_button_click = 0;
var feature_class_6 = null;
var land_class_6_button_click = 0;
...
function null_checker(){
  ...
  else if (feature_class_6 === null){
    series_names = [land_class_1_name.getValue(), land_class_2_name.getValue(), land_class_3_name.getValue(), land_class_4_name.getValue(), land_class_5_name.getValue()]
    color_list = [land_class_1_color_selector.getValue(), land_class_2_color_selector.getValue(), land_class_3_color_selector.getValue(), land_class_4_color_selector.getValue(), land_class_5_color_selector.getValue()]
    testing_features = [feature_class_1 , feature_class_2 , feature_class_3 , feature_class_4, feature_class_5]
  }
  else if (feature_class_6 !== null){
    series_names = [land_class_1_name.getValue(), land_class_2_name.getValue(), land_class_3_name.getValue(), land_class_4_name.getValue(), land_class_5_name.getValue(), land_class_6_name.getValue()]
    color_list = [land_class_1_color_selector.getValue(), land_class_2_color_selector.getValue(), land_class_3_color_selector.getValue(), land_class_4_color_selector.getValue(), land_class_5_color_selector.getValue(), land_class_6_color_selector.getValue()]
    testing_features = [feature_class_1 , feature_class_2 , feature_class_3 , feature_class_4, feature_class_5, feature_class_6]
  }
...
function spec_chart(){
  ...
  side_panel_control.widgets().set(32, comparison_chart)
}
...
function delete_training_data() {
  ...
  land_class_5_button_click = 0;
  land_class_6_button_click = 0;
  ...
  remove_landclass(land_class_5_name.getValue())
  remove_landclass(land_class_6_name.getValue())
  ...
  land_class_5_button.setDisabled(true);
  land_class_5_button.setLabel("Land Class 5")
  land_class_5_name.setDisabled(true)
  land_class_6_button.setDisabled(true);
  land_class_6_button.setLabel("Land Class 6")
  land_class_6_name.setDisabled(true)
}
...
function train_classify() {
  ...
  var features_list = [feature_class_1, feature_class_2,
      feature_class_3, feature_class_4, feature_class_5, feature_class_6];
  ...
  var land_class_5_color = land_class_5_color_selector.getValue();
  var land_class_6_color = land_class_6_color_selector.getValue();
  ...
  if (feature_class_3 === null) {
    ...
    style_colors = [land_class_1_color, land_class_2_color,
      land_class_3_color, land_class_4_color, land_class_5_color]
    vis_params = {min: 1, max: 5, palette: style_colors}
    land_class_legend_list = [land_class_1_name.getValue(), land_class_2_name.getValue(), land_class_3_name.getValue(), land_class_4_name.getValue(), land_class_5_name.getValue()]
  }
  else if (feature_class_6 !== null) {
    style_colors = [land_class_1_color, land_class_2_color,
      land_class_3_color, land_class_4_color, land_class_5_color, land_class_6_color]
    vis_params = {min: 1, max: 6, palette: style_colors}
    land_class_legend_list = [land_class_1_name.getValue(), land_class_2_name.getValue(), land_class_3_name.getValue(), land_class_4_name.getValue(), land_class_5_name.getValue(), land_class_6_name.getValue()]
  }
...
function land_class_4(){
  ...
  if (land_class_4_button_click === 0){
    ...
    land_class_5_name.setDisabled(false)
    land_class_5_button.setDisabled(false)
    clear_all_geometry()
    Map.addLayer(feature_class_4, {color: land_class_4_color}, land_class_4_name.getValue());
  }
}
// Function to handle land class 5 on button click
function land_class_5(){
  var land_class_5_color = land_class_5_color_selector.getValue()
  if (land_class_5_button_click === 0){
    current_draw_option = "point_class_5"
    drawing_tools.setShape('point');
    var feature = drawing_tools.draw();
    land_class_5_button_click = land_class_5_button_click + 1
  }
  else {
    point_logic()
    drawing_tools.setShape(null);
    land_class_5_name.setDisabled(true)
    land_class_5_button.setDisabled(true)
    land_class_5_button.setLabel("Finished")
    land_class_6_name.setDisabled(false)
    land_class_6_button.setDisabled(false)
    clear_all_geometry()
    print(feature_class_5)
    Map.addLayer(feature_class_5, {color: land_class_5_color}, land_class_5_name.getValue());
  }
}
// Function to handle land class 6 on button click
function land_class_6(){
  var land_class_6_color = land_class_6_color_selector.getValue()
  if (land_class_6_button_click === 0){
    current_draw_option = "point_class_6"
    drawing_tools.setShape('point');
    var feature = drawing_tools.draw();
    land_class_6_button_click = land_class_6_button_click + 1
  }
  else {
    point_logic()
    drawing_tools.setShape(null);
    land_class_6_name.setDisabled(true)
    land_class_6_button.setDisabled(true)
    land_class_6_button.setLabel("Finished")
    clear_all_geometry()
    Map.addLayer(feature_class_6, {color: land_class_6_color}, land_class_6_name.getValue());
  }
}
...
function point_logic(){
    ...
    else if (current_draw_option == "point_class_5"){
      var class_5 = drawing_tools.layers().get(0).getEeObject(); // Grab current layer
      feature_class_5 = ee.Feature(class_5).set('classID', 5);
    }
    else if (current_draw_option == "point_class_6"){
      var class_6 = drawing_tools.layers().get(0).getEeObject(); // Grab current layer
      feature_class_6 = ee.Feature(class_6).set('classID', 6);
    }
}
...
var land_class_1_color_selector = ui.Select({
  items: ["Blue", "Green", "Yellow", "Purple", "White", "Orange", "Red", "Pink", "Grey"],
  value: "Blue",
  style: {
    width: "85px"
  }
...
// Land class 4 button
var land_class_5_button = ui.Button({
  label: "Land Class 5",
  disabled: true,
  style: {
    width: "180px"
...
// Color selector for landclass 5
var land_class_5_color_selector = ui.Select({
  items: ["Blue", "Green", "Yellow", "Purple", "White", "Orange", "Red", "Pink", "Grey"],
  value: "Red",
  style: {
    width: "85px"
...
// Text box to name land class 5
var land_class_5_name = ui.Textbox({
  placeholder: "Name",
  value: "Land Class 5",
  disabled: true,
  style: {
...
// Land class 6 button
var land_class_6_button = ui.Button({
  label: "Land Class 6",
  disabled: true,
  style: {
    width: "180px"
...
// Color selector for landclass 6
var land_class_6_color_selector = ui.Select({
  items: ["Blue", "Green", "Yellow", "Purple", "White", "Orange", "Red", "Pink", "Grey"],
  value: "Grey",
  style: {
    width: "85px"
...
// Text box to name land class 6
var land_class_6_name = ui.Textbox({
  placeholder: "Name",
  value: "Land Class 6",
  disabled: true,
  style: {
...
land_class_5_button.onClick(land_class_5);
land_class_6_button.onClick(land_class_6);
...
side_panel_control.add(land_class_5_button);
side_panel_control.add(land_class_5_color_selector);
side_panel_control.add(land_class_5_name);
side_panel_control.add(land_class_6_button);
side_panel_control.add(land_class_6_color_selector);
side_panel_control.add(land_class_6_name);
