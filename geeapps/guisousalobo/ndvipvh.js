//Inspector Tools
//2021-17-03- Versão 00
//Autor: Christhian Santana Cunha
//Contato: christhianscunha@gmail.com
//Gestor Ambiental, Msc Eng.Civil - Recursos Hídricos e Saneamento Ambiental 
//Doutorando Sensoriamento Remoto - UFRGS
//Definição da Área de Estudo
/*************************************DEFINIÇÃO DA ÁREA DE ESTUDO****************************************/
var area_estudo = ee.FeatureCollection ('projects/mapbiomas-workspace/AUXILIAR/MUNICIPIOS/municipios-RO').filterMetadata('NM_MUN','equals', 'Porto Velho');
...
Map.addLayer(outline, {palette: 'FF0000'}, 'Rio Grande do Sul');
...
Map.addLayer(NDVI.reduce(ee.Reducer.mean()).clip(area_estudo), {palette: ['white','red','orange','yellow','green'],min: -0.4, max: 1}, 'NDVI',0);
...
var intro = ui.Panel([
  ...
  ui.Label('Clique em um ponto no mapa para inspecionar.')
]);
panel.add(intro);
...
Map.addLayer(NDVI.reduce(ee.Reducer.mean()).clip(area_estudo), {palette: ['white','red','orange','yellow','green'],min: -0.4, max: 1}, 'NDVI');