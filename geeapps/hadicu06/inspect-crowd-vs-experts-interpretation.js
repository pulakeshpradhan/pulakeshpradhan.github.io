// To do:
// Upon changing the sample, set layer checkboxes to default, or display layers according to the state of the layer checkboxes
// https://code.earthengine.google.com/8527e660b417b49c46acf00c9f1bb4a6
// DONE? No
// Add info // 'uncertaintyLeast', 'numAnnotationsAllLabelsAdjusted'
// Make ui.select for minimum number of annotations = [2,3,4,5,6,7,8,9,10]
// Make ui.slider for maximum uncertainty score between 0 and 0.6
// Also, print as pop-up text 'uncertaintyLeast', 'numAnnotationsAllLabelsAdjusted'
// Show crowd annotation percent simple majority...wait, 1 - uncertaintyLeast will already give the weighted majority label score...
// Previous versions:
// 2021-04-13 / before adding filter of crowd number of annotations: https://code.earthengine.google.com/2451395e280a343dfeaa3c40b02d3153
// 
////////////////////////////////////////////////////////////
...
// b) VHR chips
/////////////////////////////////////////////////////////////////////////////////////////////
var crowdVsExperts_chips = ee.ImageCollection("users/hadicu06/IIASA/chips/crowdVsExperts")
/////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////
var planetQuads = ee.ImageCollection("users/hadicu06/fun/planet/crowd_vs_experts_2018_noRelax")
...
// g) OSM + RBI roads
/////////////////////////////////////////////////////////////////////////////////////////////
var roads_osm = ee.FeatureCollection("users/OlhaDanylo/restoreplus/osm/gis_osm_roads");
var roads_rbi = ee.FeatureCollection("users/hadicu06/IIASA/vector/road_simpl_tol15m")
...
//////////////////////////////////////////////////////////////////
var intactForest = ee.FeatureCollection("users/hadicu06/IIASA/vector/ifl_2016_clip")
// Convert to image
...
//////////////////////////////////////////////////////////////////
var protectedArea = ee.FeatureCollection("users/hadicu06/IIASA/vector/WDPA_Jan2020_IDN_shapefile_polygons_select")
// Convert to image
