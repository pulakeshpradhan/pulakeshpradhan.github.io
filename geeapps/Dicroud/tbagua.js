...
var dicobj = {
  ...
  label1: ui.Label('Turbidez Da Agua', {fontSize: '27px', color: 'red', fontWeight: 'bold', backgroundColor: '00000000'}),
  label2: ui.Label('Ingrese Intervalo de Data', { backgroundColor: '00000000', fontWeight: 'bold'}),
...
var Boton = ui.Button({label:  'Calcular',
