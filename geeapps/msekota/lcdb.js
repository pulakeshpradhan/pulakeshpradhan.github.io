...
//                              .rename('constant');
var classification_baseline = ee.Image('projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2017_'+VERSION_NO+'_harmonized_postproc')
                              .rename('constant');
...
//                              .rename('constant');
var classification_postproc = ee.Image('projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2022_'+VERSION_NO+'_harmonized_postproc')
                              .rename('constant');
...
var years = {//'2015': 'users/ocsgeospatial/Lesotho/LCDB_Lesotho_v2_2',
             ...
             '2017': 'projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2017_'+VERSION_NO+'_harmonized_postproc',
             '2018': 'projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2018_'+VERSION_NO+'_harmonized_postproc',
             '2019': 'projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2019_'+VERSION_NO+'_harmonized_postproc',
             '2020': 'projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2020_'+VERSION_NO+'_harmonized_postproc',
             '2021': 'projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2021_'+VERSION_NO+'_harmonized_postproc',
             '2022': 'projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2022_'+VERSION_NO+'_harmonized_postproc'
                          };
// ****************************************************************************************************************** //
...
var load_layers = require('users/vivianne35kerubo/Lesotho:7-Layers.js');
var legend_utils = require('users/vivianne35kerubo/Lesotho:8-LegendUtils.js');
...
var counties = ee.FeatureCollection("projects/ee-vivianne35kerubo/assets/Lesotho_catchments").map(function(feat){return feat.set('division_unit', 'Sub-Catchments')});
//var counties = ee.FeatureCollection("projects/ee-vivianne35kerubo/assets/Lesotho_catchments").map(function(feat){return feat.set({'Catch_ID':feat.get('Main_C'), 'division_unit': 'Sub-Catchments'})});
...
//var aez = ee.FeatureCollection("users/ocsgeospatial/Lesotho/lesotho_aez").map(function(feat){return feat.set({'Catch_ID': feat.get('ZONE_NAME'), 'division_unit': 'Agro-Ecological Zones'})});
var aez = ee.FeatureCollection("projects/ee-vivianne35kerubo/assets/Agro_Ecological_Zones").map(function(feat){return feat.set({'Catch_ID': feat.get('CLASS'), 'division_unit': 'Agro-Ecological Zones'})});
...
//print(aez,"agro-ecological zones")
print(counties,"subcatchments")
...
//                          );
var years_fc = ee.FeatureCollection(
             [ee.Feature(null, {year: '2017', asset: ee.Image('projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2017_'+VERSION_NO+'_harmonized_postproc')}),
             ee.Feature(null, {year: '2018', asset: ee.Image('projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2018_'+VERSION_NO+'_harmonized_postproc')}),
             ee.Feature(null, {year: '2019', asset: ee.Image('projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2019_'+VERSION_NO+'_harmonized_postproc')}),
             //ee.Feature(null, {year: '2020', asset: ee.Image('projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2020_'+VERSION_NO+'_harmonized_postproc')}),
             ee.Feature(null, {year: '2020', asset: ee.Image('projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2020_'+VERSION_NO+'_harmonized_postproc')}),
             ee.Feature(null, {year: '2021', asset: ee.Image('projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2021_'+VERSION_NO+'_harmonized_postproc')}),
             ee.Feature(null, {year: '2022', asset: ee.Image('projects/ee-vivianne35kerubo/assets/Lesotho/'+ALGO.toLowerCase()+'_lesotho_s2_60_10bands_kfold_2022_'+VERSION_NO+'_harmonized_postproc')}),
             ]
                          );
