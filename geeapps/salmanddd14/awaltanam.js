...
var ChgEVIMax_Kls = EVIMax_Kls.expression(
  ...
  'be == af ? 2 : 4' ,  // "tetap" : "lainnya"
  {
    be : be_af.select('EVIMaxMT1_2019_Kls'),
    af : be_af.select('EVIMaxMT1_2020_Kls')
  }).rename('Perubahan').focal_mode(); // Filter Rank/Mayority  
...
//Map.addLayer(ChgEVIMax_Kls.mask(LBS_JwBl19), VisGeser, "Perubahan EVI Max");  
