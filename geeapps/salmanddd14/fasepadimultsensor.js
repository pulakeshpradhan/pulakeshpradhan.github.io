...
S1_3 =[],S2_3 =[],L8_3 =[],TglPrd3,Trend,RPISlop,Bts_Plu=BtsPlu(),AOI,Pilih,L8
;
...
print('Ketersediaan Data Sentinel-2 di Jawa Barat dari 01-01-'+ Thn + ' : ',ExDatS2);
 Thn = 2019; Thn1 = Thn-1; Pd = 15;  // Pd bisa diganti : 5,10,15,30 
...
; Judul = 'MULTISENSOR for AGRICULTURAL CROP';
var TB_Thn = GUI.TxtBnm(Thn,'Tgl Awal',10,'red',200,55,''),
    TB_Prd = GUI.TxtB(16,'Tgl Awal',10,'red','-33px 0 0 210px',200,40,''),
...
for (k=0; k < 3; k++) {
Idx = IdxPrd-k; 
if (Idx >= 0) TglPrd3 = PrdList[Idx]; else TglPrd3 = PrdList1[36 + Idx];
...
Map.addLayer(S1.clip(ft).mask(Mask),VisRGB_S1,'RGB S1 '+ Tgl_Fase[1],1);
