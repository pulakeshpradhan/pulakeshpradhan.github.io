var L8_SR = ui.import && ui.import("L8_SR", "imageCollection", {
    ...
    LBS_MALUKU = ui.import && ui.import("LBS_MALUKU", "image", {
      "id": "users/salmanddd14/Img/LBS_MALUKU"
    }) || ee.Image("users/salmanddd14/Img/LBS_MALUKU"),
    LBS_PAPUA = ui.import && ui.import("LBS_PAPUA", "image", {
      "id": "users/salmanddd14/Img/LBS_PAPUA"
    }) || ee.Image("users/salmanddd14/Img/LBS_PAPUA");
...
S1_3 =[],TglPrd3,Trend,RPISlop,Bts_Plu=BtsPlu(),AOI,Pilih,MaxPd
;
...
print('Ketersediaan Data Sentinel-2 di Jawa Barat dari 01-01-'+ Thn + ' : ',ExDatS2);
 Thn = 2020; Thn1 = Thn-1; Pd = 15; MaxPd = Math.floor(365/Pd);  // Pd bisa diganti : 5,10,15,30 harian  // Pd bisa diganti : 5,10,15,30 
...
// Buat UI
var Judul = 'SENTINEL for AGRICULTURAL CROP MONITORING',
...
var Idx,Tgl_Fase,Pil,p1; Tgl_Prd[0]= ['2020-01-11','2020-01-20']; Tgl_Prd[1]= ['2020-01-21','2020-01-31'];
...
for (k=p1; k < 3+p1; k++) {
TglPrd3 = Tgl_Prd[k];
S1_3[k-p1]= (Pilih_S1(TglPrd3,'','VH-VV','MeanMed','RPI',Bts1Prv)).rename('RPI_' + (k+1));   
*/
for (k=0; k < 3; k++) {
Idx = IdxPrd-k; 
...
//Map.addLayer(S2.select('SCL').clip(ft).mask(Mask),Vis_SCL,'Land Cover S2 '+ Tgl_Fase[1],0);
