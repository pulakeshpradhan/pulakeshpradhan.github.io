var Area = ui.import && ui.import("Area", "table", {
      "id": "users/masitamanessa/palms"
    }) || ee.FeatureCollection("users/masitamanessa/palms");
...
var select = ui.Select({
  ...
  onChange: function(key) {
    var pois = Area.filter(ee.Filter.eq('Name', places[key][0]));
    var geometries = pois.geometry();
    var poi = geometries.buffer(10);
