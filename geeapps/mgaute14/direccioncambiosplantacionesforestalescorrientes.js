var pie_anterior_pie_actual = ui.import && ui.import("pie_anterior_pie_actual", "geometry", {
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [
    ...
    ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.957143268595686, -27.938822542563585],
                  [-55.95903154374217, -27.936737280447105],
                  [-55.960662326823225, -27.937760959606237],
                  [-55.9583878135786, -27.93931541681942]]]),
            {
              "estado": 1,
              "system:index": "0"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.948946437846175, -27.943827007427227],
                  [-55.948946437846175, -27.944888530773973],
                  [-55.94787355424022, -27.944888530773973],
                  [-55.94787355424022, -27.943827007427227]]], null, false),
            {
              "estado": 1,
              "system:index": "1"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.96297975541209, -27.938632974943392],
                  [-55.96297975541209, -27.939808288826637],
                  [-55.961692295084944, -27.939808288826637],
                  [-55.961692295084944, -27.938632974943392]]], null, false),
            {
              "estado": 1,
              "system:index": "2"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.9552549934492, -27.937154336090167],
                  [-55.9552549934492, -27.937988442546665],
                  [-55.95422502518748, -27.937988442546665],
                  [-55.95422502518748, -27.937154336090167]]], null, false),
            {
              "estado": 1,
              "system:index": "3"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.95259424210643, -27.939467069984225],
                  [-55.95259424210643, -27.94011159355958],
                  [-55.951907596598616, -27.94011159355958],
                  [-55.951907596598616, -27.939467069984225]]], null, false),
            {
              "estado": 1,
              "system:index": "4"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.9448265647993, -27.9464428854231],
                  [-55.9448265647993, -27.947011546169016],
                  [-55.944440326701155, -27.947011546169016],
                  [-55.944440326701155, -27.9464428854231]]], null, false),
            {
              "estado": 1,
              "system:index": "5"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.97104784012889, -27.940263245606722],
                  [-55.97104784012889, -27.940718200470787],
                  [-55.97023244858836, -27.940718200470787],
                  [-55.97023244858836, -27.940263245606722]]], null, false),
            {
              "estado": 1,
              "system:index": "6"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.920236072550765, -27.937002679678944],
                  [-55.920236072550765, -27.937533476186857],
                  [-55.91954942704295, -27.937533476186857],
                  [-55.91954942704295, -27.937002679678944]]], null, false),
            {
              "estado": 1,
              "system:index": "7"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.9173607444868, -27.942651737267184],
                  [-55.9173607444868, -27.94375118393182],
                  [-55.91615911484813, -27.94375118393182],
                  [-55.91615911484813, -27.942651737267184]]], null, false),
            {
              "estado": 1,
              "system:index": "8"
            })]),
    pie_anterior_incipiente_actual = ui.import && ui.import("pie_anterior_incipiente_actual", "geometry", {
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [
    ...
    ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.96751805306529, -27.94141484639317],
                  [-55.96751805306529, -27.941737102851075],
                  [-55.967153272639266, -27.941737102851075],
                  [-55.967153272639266, -27.94141484639317]]], null, false),
            {
              "estado": 2,
              "system:index": "0"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.969181022654524, -27.9422110076604],
                  [-55.969181022654524, -27.942523783695627],
                  [-55.96873041154002, -27.942523783695627],
                  [-55.96873041154002, -27.9422110076604]]], null, false),
            {
              "estado": 2,
              "system:index": "1"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.96510406495189, -27.94226787609781],
                  [-55.96510406495189, -27.942514305647258],
                  [-55.96475001336192, -27.942514305647258],
                  [-55.96475001336192, -27.94226787609781]]], null, false),
            {
              "estado": 2,
              "system:index": "2"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.966134033213606, -27.942092531652992],
                  [-55.966134033213606, -27.942092531652992],
                  [-55.96600528718089, -27.942092531652992],
                  [-55.96600528718089, -27.942092531652992]]], null, false),
            {
              "estado": 2,
              "system:index": "3"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.962525775648885, -27.9451023877631],
                  [-55.962525775648885, -27.94535828864541],
                  [-55.962032249190145, -27.94535828864541],
                  [-55.962032249190145, -27.9451023877631]]], null, false),
            {
              "estado": 2,
              "system:index": "4"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.96135633251839, -27.944647451364165],
                  [-55.96135633251839, -27.94496969817802],
                  [-55.96113102696114, -27.94496969817802],
                  [-55.96113102696114, -27.944647451364165]]], null, false),
            {
              "estado": 2,
              "system:index": "5"
            })]),
    pie_anterior_no_pie_actual = ui.import && ui.import("pie_anterior_no_pie_actual", "geometry", {
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [
    ...
    ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.97179246375674, -27.947768336463803],
                  [-55.97179246375674, -27.947938932908233],
                  [-55.971438412166776, -27.947938932908233],
                  [-55.971438412166776, -27.947768336463803]]], null, false),
            {
              "estado": 3,
              "system:index": "0"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.9714062256586, -27.9472281126119],
                  [-55.9714062256586, -27.947436620383733],
                  [-55.971191648937406, -27.947436620383733],
                  [-55.971191648937406, -27.9472281126119]]], null, false),
            {
              "estado": 3,
              "system:index": "1"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.975281611813784, -27.944432174055013],
                  [-55.975281611813784, -27.9449439783892],
                  [-55.974294558896304, -27.9449439783892],
                  [-55.974294558896304, -27.944432174055013]]], null, false),
            {
              "estado": 3,
              "system:index": "2"
            })]),
    incipiente_anterior_incipiente_actual = ui.import && ui.import("incipiente_anterior_incipiente_actual", "geometry", {
      "geometries": [],
      "displayProperties": [],
      "properties": {},
      "color": "#68ff12",
    ...
    /* shown: false */
    ee.FeatureCollection([]),
    no_pie_anterior_no_pie_actual = ui.import && ui.import("no_pie_anterior_no_pie_actual", "geometry", {
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [
    ...
    ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.91485502467512, -27.980973844752672],
                  [-55.91485502467512, -27.981921307795],
                  [-55.91335298762678, -27.981921307795],
                  [-55.91335298762678, -27.980973844752672]]], null, false),
            {
              "estado": 5,
              "system:index": "0"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.91253759608625, -27.98385410658956],
                  [-55.91253759608625, -27.984649954847416],
                  [-55.91133596644758, -27.984649954847416],
                  [-55.91133596644758, -27.98385410658956]]], null, false),
            {
              "estado": 5,
              "system:index": "1"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.91069223628401, -27.98468785223698],
                  [-55.91069223628401, -27.985000505192744],
                  [-55.91008069262861, -27.985000505192744],
                  [-55.91008069262861, -27.98468785223698]]], null, false),
            {
              "estado": 5,
              "system:index": "2"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-55.906218311647166, -27.982532417041252],
                  [-55.906218311647166, -27.98358408531038],
                  [-55.906207582811106, -27.98358408531038],
                  [-55.906207582811106, -27.982532417041252]]], null, false),
            {
              "estado": 5,
              "system:index": "3"
            })]),
    no_pie_anterior_incipiente_actual = ui.import && ui.import("no_pie_anterior_incipiente_actual", "geometry", {
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [
    ...
    ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
                [[[-56.050253060287574, -28.034709499719813],
                  [-56.050253060287574, -28.035523912072446],
                  [-56.04939475340281, -28.035523912072446],
                  [-56.04939475340281, -28.034709499719813]]], null, false),
            {
              "estado": 6,
              "system:index": "0"
            })]);
...
/////////////////// clasificacion 
var names = ['pie_anterior_pie_actual', 'pie_anterior_incipiente_actual','pie_anterior_no_pie_actual', 'incipiente_anterior_incipiente_actual', 'no_pie_anterior_no_pie_actual', 'no_pie_anterior_pie_actual' ];
var newfc = pie_anterior_pie_actual.merge(pie_anterior_incipiente_actual).merge (pie_anterior_no_pie_actual).merge(incipiente_anterior_incipiente_actual).merge(no_pie_anterior_no_pie_actual).merge(no_pie_anterior_incipiente_actual );
...
var cambio = imagen_estado_dos_años.sampleRegions({
  collection: newfc,
  properties: ['estado'],
  scale: 10,
  tileScale:10
...
var classifierS2 = ee.Classifier.randomForest().train({
  features: cambio,
  classProperty: 'estado',
  //inputProperties: bandasS2
});
//Run the Classification
var classifiedS2 = imagen_estado_dos_años.classify(classifierS2);
print  ( classifiedS2)
///////////////VISUALIZACIONES//////////////////77
var palette_clasificacion =
['green',// 1 pie anterior pie actual: sin cambio " neutro"
              'orange',//2 pie_anterior_ incipiente actual  "decrecimiento"
               'red',// 3 pie_anterior No pie actual " cosecha"
              '008056',//4 incipiente_anterior incipiente actual (" neutro"
              'd71aee',//  5 no_pie_anterior_no_pie_actual " neutro"
             'blue'// 6 no_pie_anterior_incipiente_actual "ganancia"
];
//var viz = {min:1,max:5,palette:palette_clasificacion};
Map.addLayer(classifiedS2, 
{ min: 1, max: 6, palette:palette_clasificacion },
'Clasificacion  Direccion del cambio de estados',false);
...
*/
////////////////////////////////////////// cálculo clasificacion
var stats = classifiedS2.reduceRegion({
  reducer: ee.Reducer.sum(), //Gives you the count it has other variable like sum()
  geometry: geometry,
  scale: 10,
  maxPixels: 1e2
});
print(stats, "estadistica clasificacion");
/*
//////////////////////cálculo pérdida 
////////////////////////////////////////////// calculo ganancia 
