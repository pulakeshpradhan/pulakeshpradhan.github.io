...
var altura_clase_4 =canopy_height_clip_mascara.mask(canopy_height_clip_mascara.gte(30).and (canopy_height_clip.lte (45)))
// Mapas alturas 
...
var volumen_clase_4 =volumen_estimado_lang.mask(volumen_estimado_lang.gte(300).and (canopy_height_clip.lte (400)))
var volumen_clase_5 =volumen_estimado_lang.mask(volumen_estimado_lang.gte(400).and (canopy_height_clip.lte (539)))
// Mapas alturas 
...
var panel = ui.Panel({style: {width: '500px'}})
    .add(ui.Label('Click sobre el rodal para ver evolución del NDVI ( VIIRS)'));
...
var notesPanel = ui.Panel({
  widgets: [
    ...
    ui.Label({value: '• Ver más información de la Dirección Nacional de Desarrollo Foresto Industrial', style: noteStyle, targetUrl: 'https://www.magyp.gob.ar/sitio/areas/desarrollo-foresto-industrial/'}),
