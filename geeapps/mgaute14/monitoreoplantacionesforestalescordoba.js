...
var carto_prov = cartografia_plantaciones.filter(ee.Filter.stringStartsWith('prov',"CÓRDOBA"))
...
var geometry = region.filter(ee.Filter.stringStartsWith('nombre',"CÓRDOBA"))
