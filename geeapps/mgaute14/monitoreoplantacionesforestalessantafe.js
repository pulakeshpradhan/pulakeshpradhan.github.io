var geometry = ui.import && ui.import("geometry", "geometry", {
      ...
      "shown": true,
      "locked": false
    }) || /* color: #d63000 */ee.Geometry.Point([-60.08347558232605, -30.862033437945943]);
Map.setCenter (  -60.08, -30.86 ,12)
...
var carto_prov = cartografia_plantaciones.filter(ee.Filter.stringStartsWith('prov',"SANTA FE"))
...
var geometry = region.filter(ee.Filter.stringStartsWith('nombre',"SANTA FE"))
