...
Map.setCenter (  -55.803437, -28.314475,10)
...
Map.addLayer(occurrence_clic, VIS_OCCURRENCE,  'Global Surface Water (1984-2019) ', false);
/////////////// BurnedArea
...
var maxBA_plantaciones = burnedArea.max().clip(cartografia_plantaciones) 
//Map.setCenter(0, 18, 2.1);
Map.addLayer(maxBA, baVis, 'Áreas quemadas  2019 - FireCCI51',false);
Map.addLayer(maxBA_plantaciones, baVis, 'Plantaciones afectadas por Incendios  2019');
/*Map.addLayer({
...
*/
//////////////////sentinel 2 ACTUAL //////////////////////7
var START_actual = ee.Date("2020-01-01");
var END_actual = ee.Date("2020-03-20");
...
var imagen_S2_anterior= imagen2_anterior.addBands(ndviS2_anterior.rename('NDVIS2')).clip(cartografia_plantaciones);
...
Map.addLayer(imagen_S2_actual,  NDVIVisParam, 'Índice de Vegetación 2020 - 1 trimestre  ',false );
Map.addLayer(imagen_S2_anterior,  NDVIVisParam, 'Índice de Vegetación 2019 - 1 trimestre  ',false );
...
Map.add(ui.Panel(
    ...
    ui.Label(
          'Recursos: https://jotefa.com/storage/presentaciones/2019/Gaute%20M..pdf,  GJean-Francois Pekel, Andrew Cottam, Noel Gorelick, Alan S. Belward, High-resolution mapping of global surface water and its long-term changes. Nature 540, 418-422 (2016). (doi:10.1038/nature20584), High-Resolution Global Maps of 21st-Century Forest Cover Change https://science.sciencemag.org/content/342/6160/850; https://github.com/nkeikon/earthengine-apps, FireCCI51 Chuvieco, E.; Pettinari, M.L.; Lizundia-Loiola, J.; Storm, T.; Padilla Parellada, M. (2018): ESA Fire Climate Change Initiative (Fire_cci): MODIS Fire_cci Burned Area Pixel product, version 5.1. Centre for Environmental Data Analysis, 01 November 20 https://doi.org/10.5285/58f00d8814064b79a0c49662ad3af537.', TEXT_LINK),
    ],
...
var vishansen  = {min: 0, max: 19, palette: ['blue', 'green', 'yellow', 'orange', 'red']}
function makeColorBarParams(palette) {
  return {
    bbox: [0, 0, 1, 0.1],
    dimensions: '100x10',
...
var legendTitle_hansen = ui.Label({
  value: ' Año de pérdida de cobertura arbórea o aprovechamiento forestal período  ( 2000 -2019) ',
  style: {textAlign: 'center',fontWeight: 'bold'}
});
// Add the legendPanel to the map.
...
//////////////////////////////////////////////////////////////7
Map.addLayer(outline, {palette: '00ffff'}, 'Plantaciones Forestales', true);
