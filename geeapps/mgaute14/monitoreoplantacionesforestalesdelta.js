...
var END_actual = ee.Date("2020-11-10");
...
var START_anterior = ee.Date("2020-01-01");
var END_anterior = ee.Date("2020-01-26");
...
Map.addLayer(diferencia ,{ min:-0.25, max: 0.4238, palette: [ 'blue', 'green', 'red']}, "Cambios en plantaciones Forestales ", false );
...
var perdida  = diferencia.mask( diferencia.gt(0.2))
var  ganancia = diferencia.mask(diferencia.lt (0.3))
...
Map.addLayer (perdida, {palette: 'red'} , "Cosechas", false ) ;
Map.addLayer (imagen_ndvi_actual, NDVIVisParam , "Estado plantación  actual", true ) ;
Map.addLayer(outline, {palette: '0000FF'}, 'Cartografía Plantaciones Forestales - vectorial', false);
Map.addLayer(outline_geometry, {palette: '0000FF'}, 'Región Forestal Delta del Río Paraná', false);
/////////////////////////////////////////////estadistica cambios
...
var ndvi_en_pie =imagen_ndvi.mask(imagen_ndvi.gt (0.68))
