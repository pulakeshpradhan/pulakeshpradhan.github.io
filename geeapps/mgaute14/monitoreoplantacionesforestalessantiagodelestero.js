Map.setCenter (  -63.85, -27.7315 ,12)
...
var carto_prov = cartografia_plantaciones.filter(ee.Filter.stringStartsWith('prov',"SANTIAGO DEL ESTERO"))
...
var geometry = region.filter(ee.Filter.stringStartsWith('nombre',"SANTIAGO DEL ESTERO"))
