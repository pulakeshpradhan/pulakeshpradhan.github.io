...
Map.addLayer(perdida_clic, treeLossVisParam, 'Año de Aprovechamiento 2019', true) ;
////////////////////////////////////////////////////////////////
////////////////// estilo GFCH///////////////////7
var GFCHVisParam = {
  bands: ['b1'],
...
, "Mosaico Sentinel 2 marzo - abril 2019 ", true ) ;
/////////////////////// productoS2_2S2//////////////
...
//////////////////////////////////////////////////////////////7
*/
Map.addLayer(outline, {palette: '0000FF'}, 'Plantaciones Forestales 2019', true);
...
Export.image.toDrive({
  image: perdida_clic,
  description: 'perdida_2019_hansen',
  scale: 30,
  region: region,
  maxPixels: 1e9,
  fileFormat: 'GeoTIFF',
