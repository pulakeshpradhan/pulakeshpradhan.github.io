Map.setCenter ( -58.48843519738538, -25.26428525005692,14)
...
var carto_prov = cartografia_plantaciones.filter(ee.Filter.stringStartsWith('prov',"FORMOSA")) 
//AGREGADO DE SUP 
...
var geometry = region.filter(ee.Filter.stringStartsWith('nombre',"FORMOSA"))
