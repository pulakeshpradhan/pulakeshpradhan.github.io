var AOI = ui.import && ui.import("AOI", "table", {
      "id": "users/lcsruiz/Extent_area_Agua_Negra_Tapado"
    }) || ee.FeatureCollection("users/lcsruiz/Extent_area_Agua_Negra_Tapado");
//////////////////////////////////////////////////////////
// Objetivos
...
var ChartYear = 
  ui.Chart.image.series({
    ...
    title: 'Cobertura de nieve promedio anual 2000-2021 en Agua Negra-Tapado, usando MODIS',
...
var ChartMonth = 
  ui.Chart.image.series({
    ...
    title: 'Cobertura de nieve promedio Mensual 2000-2021 en Agua Negra-Tapado, usando MODIS',
    vAxis: {title:'Cobertura Nieve (%)'},
    hAxis: {title:'Meses'}, 
  });
...
var ROI = ee.Geometry.Rectangle([-69.9479, -30.095,
                                -69.7735, -30.1948]);
