var table = ui.import && ui.import("table", "table", {
    ...
    table2 = ui.import && ui.import("table2", "table", {
      "id": "projects/ee-ogordienko112/assets/Existing_Farming"
    }) || ee.FeatureCollection("projects/ee-ogordienko112/assets/Existing_Farming");
var styleParams = {
  fillColor: 'FF000000',
  color: '00ff00', 
  width: 1.0,
};
var OSM_forest_vis = table.style(styleParams);
Map.addLayer(OSM_forest_vis,{}, 'OSM forest'); 
Map.addLayer(table2)
Map.style().set('cursor', 'crosshair');
var countriesUSDOS  = ee.FeatureCollection("USDOS/LSIB_SIMPLE/2017").filter(ee.Filter.eq('country_na','Cyprus'));
...
var intro = ui.Panel([
  ui.Label({
    value: 'Click on the map to view NDVI',
...
Map.setCenter(32.944, 34.7805,10)
