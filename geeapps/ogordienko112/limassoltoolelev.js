...
right.setCenter(32.7364,34.7753, 12);
left.setCenter(32.7364,34.7753, 12);
left.addLayer(table,{},"border",false);
right.addLayer(table,{},"border",false);
var UA  = table;
var srtm = ee.Image('USGS/SRTMGL1_003');
//left.addLayer(srtm.clip(table),{min: 0, max: 2200, palette: ['ffffd4', 'fee391','fec44f','fe9929','d95f0e','993404']}, 'SRTM');
left.style().set('cursor', 'crosshair');
right.style().set('cursor', 'crosshair');
var inspector_srtm = ui.Panel([ui.Label('Get the height')]);
...
computedValue.evaluate(function(result) {
    inspector_srtm.widgets().set(0, ui.Label({
      value: 'Height: ' + result.toFixed(2),
    }));
  });
});
var ls = ee.ImageCollection('LANDSAT/LC8_L1T_8DAY_NDVI')
    .filterDate('2015-01-01', '2023-06-01')
...
var inspector_ndvi = ui.Panel([ui.Label('Get NDVI')]);
