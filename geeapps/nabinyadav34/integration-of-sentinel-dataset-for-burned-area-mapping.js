...
var Header = ui.Label('Forest Canopy Disturbance Monitoring (FCDM)',{fontWeight: 'bold', fontSize: '20px', textAlign: 'center'});
...
var Index_select = ui.Select({
  items: [
    {label: 'NBR (optimal for evergreen forest)', value: 'NBR'},{label: 'NDII (SWIR 1)', value: 'NDII'},{label: 'NDVI', value: 'NDVI'},{label: 'NDVI (atmosphere)', value: 'NDVI_atmosphere'},{label: 'NDWI (green)', value: 'NDWI_green'},
...
var cloudmasking = ui.Label('Parameter for cloud masking:',{fontWeight: 'bold'});
...
var forest_mask_selection  = ui.Select({
  items: [
    ...
    {label: 'Global Forest Cover (2012 - 2018)', value: 'Hansen_map'}],
  value: 'Hansen_map',
  onChange: function(value) {
...
var label_forest_mask_year_selection = ui.Label('Year of forest map (2000 - 2018):');
