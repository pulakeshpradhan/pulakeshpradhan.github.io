...
///////////-------------------------------------------
var Header = ui.Label('Automated Forest  Monitoring Tool',{fontWeight: 'bold',color:'Green', fontSize: '20px', textAlign: 'center'});
var Subheader0 = ui.Label('Author: Nabin Kr. Yadav(Forest Officer)' ,{fontWeight: 'bold', fontSize: '10px', textAlign: 'right'});
//var Subheadera = ui.Label('Supervisor: Dr. Hitendra Padalia & Prof. Binod Prasad Heyojoo',{fontWeight: 'bold', fontSize: '10px', textAlign: 'right'});
...
var label_modis_select = ui.Label('Check it to get MODIS active fire details',{fontWeight: 'bold'});
...
var button1 = ui.Button('Click to Run');
button1.style().set({
  position: 'bottom-left',
  border : '1px solid #000000',
  color:'Green'
...
button1.onClick(function() {
    ...
    //var country = ee.FeatureCollection("USDOS/LSIB/2013").filterMetadata('cc','equals',countryname); // Country border polygons of high accuracy
     ...
     var display1= ee.Image(0).updateMask(0).paint(geometry, '000000',1);
     Map.addLayer(display1,{palette: '#000000'},'Boundary');
     var studyarea = geometry  // The study area is set to above selection
    // if (AOI_select === true){
    //   var AOI = geometry;
