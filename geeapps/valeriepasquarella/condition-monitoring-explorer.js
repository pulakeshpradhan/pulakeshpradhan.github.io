var GSW = ui.import && ui.import("GSW", "image", {
    ...
    v10_1 = ui.import && ui.import("v10_1", "imageCollection", {
      "id": "projects/sites-project/condition_monitoring/products_v10-1_by_state_0501-1001_1x1"
    }) || ee.ImageCollection("projects/sites-project/condition_monitoring/products_v10-1_by_state_0501-1001_1x1"),
    v10_1_gs = ui.import && ui.import("v10_1_gs", "imageCollection", {
      "id": "projects/sites-project/condition_monitoring/products_v10-1_by_state_0601-0901_1x1"
    }) || ee.ImageCollection("projects/sites-project/condition_monitoring/products_v10-1_by_state_0601-0901_1x1");
// -----------------------------
...
// -----------------------------
//  Rescale (new for C2 assessments).
...
function rescale(img) {
  var scaled = img
      .select(['score_mean', 'score_stddev', 
               'tcg_mean', 'tcg_stddev'])
      .divide(OUTPUT_SCALE)
      .addBands(img.select('total_nobs'));
  return scaled
      .copyProperties(img)
...
var chart_collection = images
    .map(get_range_fn_factory('tcg'))
...
var docs_link = ui.Label({
    ...
    style: {
        ...
        .setUrl('https://valpasq.github.io/condition_monitoring/');
