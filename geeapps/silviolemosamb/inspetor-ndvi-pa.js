//NDVI Inspector Tool
var area_estudo = ee.FeatureCollection('users/silviolemosamb/ESTADO_PA').union ();
...
Map.addLayer(outline, {palette: 'FF0000'}, 'Estado do Pará');
Map.centerObject(area_estudo,5.5); 
