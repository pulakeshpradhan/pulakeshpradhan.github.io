...
var gauge_q = ee.FeatureCollection("users/rriggs/qRODEO")
var gauge_w = ee.FeatureCollection("users/rriggs/wRODEO")
var missSD = ee.FeatureCollection("users/rriggs/eRODEO")
...
var L1 = ui.Label('Click on a river reach (yellow) to calculate river discharge time series;', textStyle);
...
var L5 = ui.Label('Riggs, R., Allen, G.H., David, C.H., Lin, P., Pan, M., Yang, X., Gleason, C., "RODEO: An algorithm and Google Earth Engine application for river discharge retrieval from Landsat."', {margin: '1px 15px 10px 15px'}, 'https://doi.org/10.1016/j.envsoft.2021.105254');
var L6 = ui.Label('Validation rating curves',{}, 'https://rriggs.users.earthengine.app/view/rodeo-validation')
var instructionPanel = ui.Panel([instructionTitle, L1, L12, L3, L4], ui.Panel.Layout.flow('vertical'));
var citationPanel = ui.Panel([citeTitle, L5, L6], ui.Panel.Layout.flow('vertical'));
