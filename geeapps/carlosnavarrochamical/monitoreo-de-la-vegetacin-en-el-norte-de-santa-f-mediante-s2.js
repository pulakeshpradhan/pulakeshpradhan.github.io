...
var VIZ_PARAMS = {bands: ['B11', 'B8', 'B4'], min: 1200, max: 8000};
...
function makeSidePanel() {
  ...
  var titleLabel = ui.Label('Colección de Imagenes Sentinel 2', TITLE_STYLE);
  mainPanel.add(titleLabel);
  // Add the app description to the main panel
  var descriptionText =
      'Esta aplicación es creada para analizar las imagenes del sensor del Satélite Sentinel 2. ' +
      'Se muestran deferentes imagenes Sentinel al hacer click en el mapa. ' +
      'Todas las imagenes mostradas con un filtro a un 50% de nubes. '
...
var initGeometry = ee.Geometry.Point([-60.3534762475005,-28.937500473974313]);
