...
var layerProperties = {
  ...
  'Tipo': {
    ...
    legend:
        [{'Minimamente mecanizado': 'red'}, {'Altamente mecanizado': 'yellow'}],
...
inspector.add(ui.Label('Click para ver año de deforestación'));
...
mapPanel.onClick(function(coords) {
  ...
  // Compute the year of deforestation of a pixel
  ...
  computedValue.evaluate(function(result) {
    ...
    inspector.add(ui.Label({
      value: 'Año de deforestación: ' + result,
...
var header = ui.Label('Deforestación por Minería de Oro', {fontSize: '36px', color: 'Gold', textAlign: 'center'});
var text = ui.Label(
    'Resultados del análisis de imágenes satelitales Landsat para mapear la extensión de la minería de oro en la región Amazónica suroriental del Perú.',
    {fontSize: '12px'});
var toolPanel = ui.Panel([header, text], 'flow', {width: '300px'});
ui.root.widgets().add(toolPanel);
// Create a hyperlink to an external reference.
var link = ui.Label(
    'Artículo de Investigación por Caballero, Messinger, Roman, Ascorra, Fernandez & Silman', {},
    'https://doi.org/10.3390/rs10121903');
var linkPanel = ui.Panel(
    [ui.Label('Para más información', {fontWeight: 'bold'}), link]);
...
var linkPanel = ui.Panel(
    [ui.Label('Descargar data', {fontWeight: 'bold'}), link]);
toolPanel.add(linkPanel);
...
var locationPanel = ui.Panel([
  ui.Label('Localidades Importantes', {'font-size': '24px'}), locationSelect
]);
