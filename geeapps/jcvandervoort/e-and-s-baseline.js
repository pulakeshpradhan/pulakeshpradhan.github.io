...
var ProtectedAreas = ee.FeatureCollection("WCMC/WDPA/current/polygons"),
    NativeLands = ee.FeatureCollection("projects/ee-jcvandervoort/assets/NativeLands"),
    modisOceanColor = ee.ImageCollection("NASA/OCEANDATA/MODIS-Aqua/L3SMI"),
    bathymetry = ee.Image("NOAA/NGDC/ETOPO1"),
    population = ee.ImageCollection("WorldPop/GP/100m/pop"),
    fishing_activity = ee.ImageCollection("GFW/GFF/V1/fishing_hours"),
    vessel_activity = ee.ImageCollection("GFW/GFF/V1/vessel_hours"),
    salinity = ee.ImageCollection("HYCOM/sea_temp_salinity"),
    land_cover = ee.ImageCollection("COPERNICUS/Landcover/100m/Proba-V-C3/Global"),
    coral_reef = ee.FeatureCollection("projects/ee-jcvandervoort/assets/CoralReef"),
    reefs_at_risk = ee.FeatureCollection("projects/ee-jcvandervoort/assets/reefs_at_risk"),
    tidal_flat_eco = ee.Image("projects/ee-jcvandervoort/assets/tidal_flat_ecosystems"),
    sea_grasses = ee.FeatureCollection("projects/ee-jcvandervoort/assets/seagrasses"),
    salt_marshes = ee.FeatureCollection("projects/ee-jcvandervoort/assets/saltmarshes"),
    benthic_habitat = ee.Image("ACA/reef_habitat/v1_0"),
    mangroves = ee.FeatureCollection("projects/ee-jcvandervoort/assets/mangrove_USGS"),
    seagrass_biome = ee.FeatureCollection("projects/ee-jcvandervoort/assets/seagrasses_biome"),
    kelp = ee.FeatureCollection("projects/ee-jcvandervoort/assets/Kelp"),
    minerals = ee.FeatureCollection("projects/ee-jcvandervoort/assets/minerals"),
    power_plants = ee.FeatureCollection("projects/ee-jcvandervoort/assets/power_plants"),
    human_set = ee.Image("JRC/GHSL/P2016/BUILT_LDSMT_GLOBE_V1");
////////////////////////////////////////////////////////////////////
// Adding a Legend
////////////////////////////////////////////////////////////////////
