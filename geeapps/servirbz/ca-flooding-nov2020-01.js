...
// Domain: Belize / Guatemala / Honduras
...
var ctr = ee.Geometry.Point([-88.2688, 15.4418]);
var roi = c.bz;
...
var s1 = ee.ImageCollection("COPERNICUS/S1_GRD_FLOAT").filter(ee.Filter.eq('orbitProperties_pass', 'ASCENDING'))
    ...
    .filter(ee.Filter.eq('relativeOrbitNumber_start', 63)).filter(ee.Filter.inList('sliceNumber', [4,5,6]))
    .select(['VH'])
    //.filterBounds(roi)
    ; // MODIFY GEOGRAPHY *FOR VISUALIZATION* HERE
...
map1.addLayer(c.bnds_w1,{palette: "blue"},"Int'l borders", true);
var map2 = ui.Map();
...
map2.addLayer(c.bnds_w1,{palette: "blue"},"Int'l borders", true);
var map3 = ui.Map();
...
map3.addLayer(c.bnds_w2,{palette: "black"},"Int'l borders", true);
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var title = ui.Label('Satellite-based mapping of flooding in Central America during Tropical Storm Eta (Nov. 2020)', {stretch:'horizontal',textAlign:'center',fontWeight:'bold',fontSize:'24px'});
