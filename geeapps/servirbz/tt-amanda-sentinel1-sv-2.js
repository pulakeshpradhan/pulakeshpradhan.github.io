...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var ctr = ee.Geometry.Point([-88.7848, 13.7813]);
var roi = c.sv_box;
...
map2.addLayer(image, {min:-19.84,max:-10.1, bands: ["VH"]}, "VH_después_2020-06-04", false);
...
var title = ui.Label("Imágenes radar Sentinel-1 después de Tormenta Tropical Amanda (El Salvador)", {stretch:'horizontal',textAlign:'left',fontWeight:'bold',fontSize:'22px'});
