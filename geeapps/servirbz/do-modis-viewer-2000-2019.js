...
//Map.addLayer(c.bnds_global.clip(aoi),{palette: "white"},"Int'l Borders");
////////////////////////////////////////////////////////////////////////////////////////////////
// UI PANEL
var main = ui.Panel({style: {width: '320px', padding: '8px'}});
var title = ui.Label('Dominican Republic MODIS image mosaics: 2000-2019*', {fontWeight: 'bold', fontSize: '20px', color: 'darkgreen'});
