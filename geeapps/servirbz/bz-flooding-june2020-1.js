...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var t1_date = "2020-05-15";
var t2_date = "2020-05-27";
var t3_date = "2020-06-08";
...
//////
var s1 = ee.ImageCollection("COPERNICUS/S1_GRD_FLOAT").filter(ee.Filter.eq('orbitProperties_pass', 'DESCENDING'))
...
map1.add(ui.Label("pre: 2020-05-24 / 2020-05-27", {color: "lightseagreen"}));
map1.addLayer(image, pal_multi, "S1 VH pre & post", false);
map1.addLayer(image, {min:0.0132,max:0.0804, bands: ["VH_1"]}, "S1_VH_2020-05-27", false);
map1.addLayer(image, {min:0.0132,max:0.0804, bands: ["VH"]}, "S1_VH_2020-06-08", false);
...
map2.addLayer(image, {min:0.0132,max:0.0804, bands: ["VH_1"]}, "S1_VH_2020-05-27", false);
map2.addLayer(image, {min:0.0132,max:0.0804, bands: ["VH"]}, "S1_VH_2020-06-08", false);
...
map3.addLayer(image, {min:0.0132,max:0.0804, bands: ["VH_1"]}, "S1_VH_2020-05-27", false);
map3.addLayer(image, {min:0.0132,max:0.0804, bands: ["VH"]}, "S1_VH_2020-06-08", false);
...
map3.addLayer(s1_diff, {palette: ['mediumblue']}, 'S1_change_2020-05-27_2020-06-08_blue', false);
map3.addLayer(s1_diff, {palette: ['red']}, 'S1_change_2020-05-27_2020-06-08_red', true);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var title = ui.Label('Satellite-based mapping of flooding in Belize (June 2020)', {stretch:'horizontal',textAlign:'center',fontWeight:'bold',fontSize:'24px'});
