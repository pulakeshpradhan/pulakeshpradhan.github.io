...
function makeSidePanel() {
  ...
  var titleLabel = ui.Label('Sentinel-2 Mosaic Editor', TITLE_STYLE);
  mainPanel.add(titleLabel);
  // Add the app description to the main panel
  var descriptionText =
      'This app allows you to interactively explore the effects of ' +
      'mosaicking different Harmonized Sentinel-2 MSI images. ' +
      ...
      'The maximum cloud cover percentage here is 50%';
...
function makeThumbnail(id, onChangeFunc) {
  ...
  var checkbox = ui.Checkbox('Include', false, onChangeFunc, false, LABEL_STYLE);
...
var initGeometry = ee.Geometry.Point([9.9133, 59.2854]);
