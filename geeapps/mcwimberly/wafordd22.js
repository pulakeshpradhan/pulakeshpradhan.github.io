...
var cc_lt = ee.ImageCollection("projects/servir-wa/WAForDD/Canopy_LT_v2_2_1");
//var cc_lt = ee.ImageCollection("projects/servir-wa/WAForDD/Canopy_Cover_LT_2001St");
//print('cc_lt', cc_lt);
// Predicted canopy cover from Random Forests
var ann_cc1yr = ee.ImageCollection("projects/servir-wa/WAForDD/Canopy_v2_2_1");
...
function init() {
  ...
  sidePanel = makeSidePanel(
    ...
    'The West Africa Forest Degradation Data System (WAForDD 2.2) uses all available Landsat data to monitor the forest reserve network in Ghana. '+
  ...
  {padding: '10px'},
  'https://code.earthengine.google.com/?scriptPath=users%2Fmcwimberly%2FWAForDD_2_2%3AWAForDD_4_AnnualForestDegradation_GUI');
