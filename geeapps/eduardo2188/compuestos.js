...
var showLayer = function() {
 ...
 Map.addLayer(showmedoide(bare_soil,['blue', 'green', 'red', 'nir', 'swir1', 'swir2']).clip(cuadrante), rgbVis, 'Mediode'); 
...
app.createPanels = function(){
  app.intro = {
   ...
   start_date_label_row : ui.Label({value: 'Row',style: {color:'red', fontWeight: 'bold', fontSize:'12px', margin: '15px 15px 0px 220px'}}),
    ...
    text_sd: ui.Textbox({placeholder: 'YYYY-MM-DD',value: '2000-01-01',style: {margin: '15px 15px 0px 190px',fontWeight: 'bold',border: '1px solid black', fontSize: '12px', color: 'black',width:'90px'}}),
    end_date_label: ui.Label({value: 'Fin',style: {color:'red', fontWeight: 'bold', fontSize:'12px', margin: '15px 15px 0px 220px'}}),
    text_ed: ui.Textbox({placeholder: 'YYYY-MM-DD',value: '2000-12-31',style: {margin: '15px 15px 0px 190px',fontWeight: 'bold',border: '1px solid black', fontSize: '12px', color: 'black',width:'90px'}}),
    ...
    points_ejemplo: ui.Label ({value: 'a = Promedio, b = Maximo, c = Minimo, d = Mediana, f = Maximo NBR , g = Mediode ',style: {color:'green',fontWeight: 'bold',fontSize:'12px', margin: '0px 0px 5px 10px'}}),
...
app.boot();
  ...
  function addPointToTable(){
    ...
    if (checked) {
       app.intro.download_label.setValue('DESCARGAR').style().set({
  fontWeight: 'bold',  
  fontSize: '15px',
  color: "white", padding: '10px 10px 10px 10px', margin: '10px 15px 0px 120px',border: "thick double #312D2C", backgroundColor: "#F3EBE9",});
