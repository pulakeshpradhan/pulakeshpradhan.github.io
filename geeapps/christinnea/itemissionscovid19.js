...
Map.setOptions('TERRAIN',{'Lighter': mapStyle});
...
linkedMap.setOptions('TERRAIN',{'Lighter':mapStyle});
...
var location_selector = ui.Panel([
  ui.Label('Explore other locations:', {'font-size': '15px', 'fontWeight':'bold' }), locationSelect]);
toolPanel.add(location_selector);
