...
// Security
// Insights
// ee-rgb-timeseries/landsat-timeseries-explorer.js /
// @jdbcode
// jdbcode Update landsat-timeseries-explorer.js
// Latest commit 5876959 6 hours ago
// History
// 1 contributor
// 480 lines (401 sloc)  13.6 KB
/**
 * @license
...
// Drone Image
var varsovia = ee.Image("users/hagen/keyra/AP_Varsovia_"); 
// #############################################################################
// ### DEFINE UI ELEMENTS ###
// #############################################################################
// Style.
var CONTROL_PANEL_WIDTH = '540px';
var CONTROL_PANEL_WIDTH_HIDE = '180px';
...
var lon = ui.Label();
var lat = ui.Label();
var coordinatesLonLat = ui.Panel([lon, lat], ui.Panel.Layout.flow('vertical'));
...
var appCodeLink = ui.Label({
  ...
  targetUrl: 'https://www.geospatialcode.cloud/'
});
// Date panel.
...
var imgCardPanel = ui.Panel({
  ...
  style: {width: '700px', backgroundColor: '#d3d3d3'}
});
// Map widget.
var map = ui.Map();
// Map/chart panel
...
function handleMapClick(coords) {
  ...
  var dot = ui.Map.Layer(geometry, {color: 'red'},"Point");
  map.addLayer(varsovia);
...
controlPanel.add(coordinatesLonLat);
...
map.centerObject(varsovia,14);//ee.Geometry.Point([-122.91966, 44.24135]), 14);
ui.root.clear();
