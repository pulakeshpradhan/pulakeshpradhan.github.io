...
var images = {
  'AFTER': getWeeklySentinelComposite('2016-11-02'),
  'BEFORE': getWeeklySentinelComposite('2016-09-15'),
};
...
function getWeeklySentinelComposite(date) {
  ...
  var sentinel1 = ee.ImageCollection('LANDSAT/LC08/C01/T1_SR')
                      .filterDate(date, date.advance(1, 'week'))
                      .mean();
  return sentinel1.visualize({bands: ['B4','B3','B2'] ,min: 0, max: 3000});
}
/*
...
leftMap.setCenter(33.069827, 28.357393, 12);