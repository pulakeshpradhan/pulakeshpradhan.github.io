...
var nightlight_1992 = landcover2000
var nightlight_2014 = landcover2019
// Filter the data by year range
var night_vis= {
  bands:['b1'],
  min:1,
  max:11,
  palette:['0046c7','B5E2F4','729DC8','3A4928','556061','fa0000','f096ff','E6DEB9','008000','447741','907A48']
}
// Component section //
var c={};
//empty panel
...
var info2 = ui.Label({
  value: ' Land cover 2000 produce by ICIMOD',
  style: {
    fontSize: '16px',
    margin: '0 0 3px 0',
    padding: '0'
...
var info3 = ui.Label({
  value: ' Land cover 2019 produce by ICIMOD',
  style: {
    fontSize: '16px',
    margin: '0 0 3px 0',
    padding: '0'
...
//  Set legend colours
var classColour = ['0046c7','B5E2F4','729DC8','3A4928','556061','fa0000','f096ff','E6DEB9','FF5733','008000','907A48'];
// Set legend labels
