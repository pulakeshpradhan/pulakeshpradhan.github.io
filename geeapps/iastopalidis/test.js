...
var sarg_bound = ee.FeatureCollection("users/iastopalidis/sargodha");
/***** End of imports. If edited, may not auto-convert in the playground. *****/
var sarg = ee.FeatureCollection("users/iastopalidis/koont");
...
// create text on top of legend
 ...
 var lon = ee.Image.pixelLonLat().select('longitude');
  ...
  legend.add(panel);
///
Map.setCenter(73.01495372498925,33.11658910649128, 16);
