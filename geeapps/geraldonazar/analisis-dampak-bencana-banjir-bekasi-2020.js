var Bekasi = ui.import && ui.import("Bekasi", "table", {
      "id": "users/geraldonazar/Bekasi"
    }) || ee.FeatureCollection("users/geraldonazar/Bekasi");
//Menginput data SHP wilayah penelitian
var Geomer = Bekasi;
Map.addLayer(Geomer, {}, 'My table');
//Menentukan periode sebelum banjir
var before_start= '2020-01-01';
var before_end='2020-01-31';
//Menentukan waktu setelah banjir
var after_start='2020-02-01';
var after_end='2020-02-28';
...
var aoi = ee.FeatureCollection(Bekasi);
...
//Membuat Judul
var title = ui.Label({
  value: 'Analisis Dampak Bencana Banjir Bekasi 2020',
  style:{
  fontWeight: 'bold',
  fontSize: '25px'
  }});
...
var number1 = ui.Label(after_start.concat(" hingga ",after_end),numberVIS);
...
// Diolah oleh...
var text7 = ui.Label('Script dasar dibuat oleh: UN-SPIDER pada Desember 2019 dan dimodifikasi oleh Geraldo Nazar Prakarsa pada November 2021 untuk Analisis Banjir Bekasi', subTextVis)
