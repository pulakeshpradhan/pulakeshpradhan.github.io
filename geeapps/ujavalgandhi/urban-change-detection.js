var bangalore = ui.import && ui.import("bangalore", "table", {
      "id": "users/ujavalgandhi/public/bangalore_boundary"
    }) || ee.FeatureCollection("users/ujavalgandhi/public/bangalore_boundary"),
    change = ui.import && ui.import("change", "geometry", {
      "geometries": [
        {
          "type": "Point",
          "coordinates": [
    ...
    nochange = ui.import && ui.import("nochange", "geometry", {
      "geometries": [
        {
          "type": "Point",
          "coordinates": [
