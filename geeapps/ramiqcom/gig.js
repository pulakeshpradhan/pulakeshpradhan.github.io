...
function calculate(){
  ...
  infoLayout(countryName, provinceName, regencyName, areaSize, maxElevationName, minElevationName, maxTempName, minTempName, rain);
}
function infoLayout(a, b, c, d, e, f, g, h, i){
