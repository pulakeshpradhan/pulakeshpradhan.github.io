var lote = ee.FeatureCollection("users/fernandotentor/granizo_sancor");
// Define geometría
//Define fechas
var fecha_1 = '2019-11-28';
var fecha_2 = '2019-12-03';
...
// genera thumbnail
// var thumb_path_tasa = tasa_res.visualize(vis_tasa).reproject({crs:'EPSG:3857',scale:10}).getThumbURL({dimensions:500,region:lote})
// print (thumb_path_tasa,'tasa de cambio')
// var thumb_path_fecha1 = ndvi1.visualize(vis_ndvi).reproject({crs:'EPSG:3857',scale:10}).getThumbURL({dimensions:500,region:lote})
// print (thumb_path_fecha1,'fecha 1')
// var thumb_path_fecha2 = ndvi2.visualize(vis_ndvi).reproject({crs:'EPSG:3857',scale:10}).getThumbURL({dimensions:500,region:lote})
...
*/
// Mapas
Map.addLayer(ndvi1,vis_ndvi,'NDVI fecha 2019-11-28',false);
Map.addLayer(ndvi2,vis_ndvi, 'NDVI fecha 2019-12-03',false);
