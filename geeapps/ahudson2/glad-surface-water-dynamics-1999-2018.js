...
var Nyears = 2020-1999+1;
var monthArray = ['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'];
var years = ee.List.sequence(1999,2020).getInfo();
var list = ee.List([]);
...
var indmonthlyr = ui.Map.Layer(indMonthI,{bands:['2020-Jan'],min:0,max:100},'individual month')
...
var Smonths = ee.ImageCollection('projects/glad/water/monthMeans').toBands().rename(monthArray).updateMask(mask);// loadSingleMonths();//.where(landmask,0);//singlemonthmean
...
var prergb19 = ee.Image("projects/glad/water/dynamics19/rgb");
var prergb = ee.Image("projects/glad/water/dynamics20/rgb");
var datamask = prergb18.mask();
var rgb18 = prergb18.updateMask(prergb18.neq(255)).rename(['1_Red','2_Green','3_Blue']);
var rgb19 = prergb19.updateMask(datamask).updateMask(prergb19.neq(255)).rename(['1_Red','2_Green','3_Blue']);
...
var interannuallyr19 = ui.Map.Layer(rgb19,{min:0,max:100},'interannual19');
var interannuallyr20 = ui.Map.Layer(rgb,{min:0,max:100},'interannual20');
...
//annual percent
var all = ee.ImageCollection('projects/glad/water/annual').toBands().rename(years);
var annual = all;
var annuallyr = ui.Map.Layer(annual,{bands:['2020'],min:0,max:100},'annual')
...
//annual classes
var classes18 = ee.Image("projects/glad/water/dynamics18/classes");
var classes18lyr = ui.Map.Layer(classes18.selfMask(),
  {palette:['292929','ffffff','007dff','ff7d00','f000f0','00f000','999999','ad7d52','000000','404040','ebebeb'],min:1,max:11},'classes 99-18')
var classes19 = ee.Image("projects/glad/water/dynamics19/classes");
var classes19lyr = ui.Map.Layer(classes19.selfMask(),
  {palette:['292929','ffffff','007dff','ff7d00','f000f0','00f000','999999','ad7d52','000000','404040','ebebeb'],min:1,max:11},'classes 99-19')
var classes20 = ee.Image("projects/glad/water/dynamics20/classes");
var classes20lyr = ui.Map.Layer(classes20.selfMask(),
  {palette:['292929','ffffff','007dff','ff7d00','f000f0','00f000','999999','ad7d52','000000','404040','ebebeb'],min:1,max:11},'classes 99-20')
...
classLegend.add(makeRow('404040','Probable land    10'))
classLegend.add(makeRow('ebebeb','Probable water   11'))
classLegend.add(makeRow('000000','Sparse data      9'))
...
var title = ui.Panel([//ui.Thumbnail(ee.Image('users/ahudson2/gladLogo'),{dimensions:'50', bands:['b1','b2','b3']}),
  ui.Label({
    value: 'GLAD global surface water dynamics 1999-2020',
  ...
  ui.Panel([ui.Label("Global maps derived from all Landsat 5, 7, and 8 scenes 1999-2020 highlight the changes in surface water extent during this period. Maps include the interannual dynamics 1999-2020, discrete dynamics classes, annual water percent, mean monthly water percent, and the water percent for individual months. Water percent is calculated from only the land and water observations. All maps are publically available within Earth Engine and for download. Asset IDs are displayed below for the selected layer. A probability sample-based assessment provides unbiased estimators of the area of permanent water, seasonal water, water loss, water gain, temporary land, temporary water, and high-frequency change 1999-2018."
...
var images = {
  'Interannual dynamics 1999-2020': interannuallyr20,
  'Interannual dynamics 1999-2019': interannuallyr19,
  'Interannual dynamics 1999-2018': interannuallyr18,
  'Interannual dynamics classes 1999-2020':classes20lyr,
  'Interannual dynamics classes 1999-2019':classes19lyr,
...
var layerAssets = {
  'Interannual dynamics 1999-2020': ui.Panel([ui.Label("Earth Engine image ID: 'projects/glad/water/dynamics20/rgb'",{margin: '8px 4px 8px 8px'})]),
  'Interannual dynamics 1999-2019': ui.Panel([ui.Label("Earth Engine image ID: 'projects/glad/water/dynamics19/rgb'",{margin: '8px 4px 8px 8px'})]),
  ...
  'Interannual dynamics classes 1999-2020': ui.Panel([ui.Label("Earth Engine image ID: 'projects/glad/water/dynamics20/classes'",{margin: '8px 4px 8px 8px'})]),
  'Interannual dynamics classes 1999-2019': ui.Panel([ui.Label("Earth Engine image ID: 'projects/glad/water/dynamics19/classes'",{margin: '8px 4px 8px 8px'})]),
...
var layerOptions = {
  'Interannual dynamics 1999-2020': interannualpanel,
  'Interannual dynamics 1999-2019': interannualpanel,
  'Interannual dynamics 1999-2018': interannualpanel,
  'Interannual dynamics classes 1999-2020': classLegend,
  'Interannual dynamics classes 1999-2019': classLegend,
  'Interannual dynamics classes 1999-2018': classLegend,
  'Month R-G-B': ui.Panel([ui.Label('1999-2019 Monthly means. Select months to display in R-G-B:'),panelMonth]),
  'Year': ui.Panel([
...
var selLayer = ui.Select({items: ['Interannual dynamics 1999-2020','Interannual dynamics 1999-2018','Interannual dynamics classes 1999-2020','Interannual dynamics classes 1999-2018','Month R-G-B','Year','Individual month'],//], 
      placeholder: 'Interannual dynamics 1999-2020',
      onChange: function(lyr){
...
layerOptionsPanel.add(layerOptions['Interannual dynamics 1999-2020']);
layerOptionsPanel.add(layerAssets['Interannual dynamics 1999-2020']);
//side panel
var panel2 = ui.Panel();
panel2.style().set({
  width: '455px',
...
var mapIds = ['Interannual dynamics 1999-2019','Interannual dynamics 1999-2018','Interannual dynamics classes 1999-2019','Interannual dynamics classes 1999-2018','Month R-G-B','Year','Individual month'];
