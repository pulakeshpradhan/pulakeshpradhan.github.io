var ftcPA = ee.FeatureCollection("WCMC/WDPA/current/polygons"),
    ...
    //ftc0 = ee.FeatureCollection("users/angelini_hernan/LDN_REU/Precal/REU_Precal_Level0_v3_BE"),
    ftc0 = ee.FeatureCollection("users/angelini_hernan/LDN_REU/Precal/REU_Precal_Level0_v5_NBE50"),
    ftc1 = ee.FeatureCollection("users/angelini_hernan/LDN_REU/Precal/REU_Precal_Level1_v3_NBE"),
    ftc2 = ee.FeatureCollection("users/angelini_hernan/LDN_REU/Precal/REU_Precal_Level2_v3_NBE"),
    ftcSLM = ee.FeatureCollection("users/angelini_hernan/LDN_REU/SLM_LDN_REU"),
    ftcBasinsL6_View = ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_6"),
    ftcBasinsL6_Country = ee.FeatureCollection("users/angelini_hernan/LDN_REU/Precal/REU_Precal_Basin6_v3_NBE"),
    ftcBasinsL8_View = ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_8"),
    ftcBasinsL8_Country = ee.FeatureCollection("users/angelini_hernan/LDN_REU/Precal/REU_Precal_Basin8_v3_NBE"),
    ftcBiome_REU = ee.FeatureCollection("users/angelini_hernan/LDN_REU/Precal/REU_ftcBiome_REU_v3_NBE"),
    ftcEcoregions_REU = ee.FeatureCollection("users/angelini_hernan/LDN_REU/Precal/REU_ftcEcoregions_REU_v4_NBE");
var ftcBasins = ftcBasinsL6_Country;
var ftcSubbasins = ftcBasinsL8_Country;
var ftcLinks = ee.FeatureCollection('users/projectgeffao/LDN_REU/LDN_REU_AditionalInfo');
...
var imgLandForm = ee.Image("users/wocatapps/World/SRTM_LandForms_5cat"); 
...
//task users/wocatapps/World/Biomes100m_RasterBiomeUsedinApp
//     users/wocatapps/World/Biome1000m_Vectorversion
// globales 
// users/wocatapps/World/Ecoregions2017_corrected_geomCorr
// users/wocatapps/World/Ecorregion100m_RasterEcoUsedinApp
//
/**
 * App: LDN Brazil Amazon
 *
...
var mdlPrecalculation = require('users/projectgeffao/LDN-REU:Apps_v2/precalculation.js');
var mdlLocalization = require('users/projectgeffao/LDN-REU:Apps_v2/localization.js');
...
var LISO = ee.List(['ALB', 'ARM', 'AZE', 'BLR', 'BIH', 'GEO', 'KAZ', 'KGZ', 'MDA', 'MNE', 'MKD','SRB','TJK','TUR','TKM','UKR','UZB']);
a.ftcKBA = ftcKBA.filter(ee.Filter.inList('ISO3', LISO));
a.ftcPA = ftcPA.filter(ee.Filter.inList('ISO3', LISO));
a.ftcBasinsL6_View = ftcBasinsL6_View.filterBounds(ftc0);    // edit line ~359
a.ftcBasinsL8_View = ftcBasinsL8_View.filterBounds(ftc0);  // edit line ~368
...
function initApp(lan) {
    ...
    ******************************************************************************/
    ...
    // More info & contact
    m.info = {
        referenceDocUrl: 'https://www.fao.org/documents/card/en/c/cb7986en',
        contactEmail1: 'Carolina.Starr@fao.org',
        contactEmail2: 'Hernan.Gonzalez@fao.org',
        contactEmail3: '',
        contactEmail4: '',
    ...
    m.assetsClick[m.labels.lblBiomes] = ftcBiome_REU;
    m.assetsClick[m.labels.lblEcoregions] = ftcEcoregions_REU;
    ...
    m.lv = {
        lcBase: {
            vis: {
                ...
                palette: ['#377e3f','#A7D282','#c19511', '#fcdb00', '#d7191c','#cfdad2', '#18eebe', '#4458eb'],
            },
            names: [
    ...
    m.generalLayerEntries = [
        {
            ...
            group: 'RASTER',  
            citation: 'https://drive.google.com/file/d/1x-U7C1gDDDiHbK8aEqZUBH7lQEq_Dm9Z/view?usp=sharing'
        },
        {
            asset: a.imgLastLC,
            ...
            group: 'RASTER',
            citation: 'https://drive.google.com/file/d/1aZTQXVWXE7WO9fo-Pel0rHaOndr9cPH3/view?usp=share_link'
        },
        {
            asset: a.imgLPD,
            style: m.lv.lpd.vis,
            ...
            group: 'RASTER',
            citation: 'https://drive.google.com/file/d/1y8bxwGD5OlzAix8LTFIv67pNPp_0D6TX/view?usp=share_link'
        },
        {
            asset: a.imgNPP,
            style: m.lv.npp.vis,
            ...
            group: 'RASTER', 
            citation: 'https://drive.google.com/file/d/10607sJX1SyXpIMlTDe6q6TO7-Ec_tQVK/view?usp=share_link'
        },
        {
            asset: a.imgSOC,
            style: m.lv.soc.vis,
            ...
            group: 'RASTER',
            citation: 'https://drive.google.com/file/d/13jM4AXvatYPkrjxnxvQV4KlZGR6v1rKU/view?usp=share_link'
        },
        {
            ...
            group: 'RASTER',
            citation: 'https://drive.google.com/file/d/1qBpSkfcIXjZvk_VaEyNjknahr-pLj2i9/view?usp=share_link'
        },
        {
            ...
            group: 'RASTER',
            citation: 'https://drive.google.com/file/d/1ozrDaVoqXLaRl62SknNz7APTFYUMEmpH/view?usp=share_link'
        },
        {
...
*/ 
        {
            ...
            group: 'RASTER',
            citation: 'https://drive.google.com/file/d/1stbRsh3TIo4nehOzN5tS-Zf-50lNBHLN/view?usp=share_link'
        },
        {
            asset: a.imgWorldPop,
        ...
        },
        {
            ...
            group: 'FEATURES',
            citation: 'https://drive.google.com/file/d/1NHrVeDIOHMln0lq_eXgfv6hMwoqPpmc2/view?usp=share_link'
        },
        {
            asset: a.ftcKBA,
            style: m.lv.kba.vis,
            ...
            group: 'FEATURES',
            singleColor: 'SQUARE',
            citation: 'https://drive.google.com/file/d/14ms7IuJFjbH0J9496dzdlW-CLMPVrcox/view?usp=share_link'
        },
        {
            asset: a.ftcPA,
            style: m.lv.pa.vis,
            ...
            group: 'FEATURES',
            singleColor: 'SQUARE',
            citation: 'https://drive.google.com/file/d/1p-3Iapc24ASgFAitoRq5yY3VSCUM-oLz/view?usp=share_link'
        },
    ];
    ...
    ******************************************************************************/
    ...
    c.lp.lan.selLanguage = ui.Select({
        items: ['English', 'Spanish', 'Russian', 'French'],
        value: lan
    });
    // AOI Mask
    c.lp.mask = {};
    ...
    ******************************************************************************/
    ...
    var setupAdditionalInfoChart = function () {
        ...
        ftrLinks.evaluate(function (elf) {
            ...
            ['FactSheet', 'AppLink', 'WocatLin','Wocatslm','UNCCDweb', 'PRAIS3r','PRAIS4r', 
            'P4base','P4repo', 'LDNtargets', 'TSPreport', 'DroPlanLink', 'WB_link']
                .map(function (l) {
    ...
    var setupGeneralCharts = function () {
        ...
        var ftc = m.precalculated ? m.ftcAoi : mdlPrecalculation.precalculate(m.ftcAoi
            , m.bestEffort,
            ['p_lc', 'p_lpd', 'p_hansen', 'p_ndvi_annual', 'p_aridity_index', 'p_pro_kba',
//            'p_landform'
            ]);
