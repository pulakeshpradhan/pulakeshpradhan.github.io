var imgSoc = ui.import && ui.import("imgSoc", "image", {
    ...
    ftcOttoHurricane = ui.import && ui.import("ftcOttoHurricane", "table", {
      "id": "users/projectgeffao/Nicaragua/HuracanOtto_bufferWGS"
    }) || ee.FeatureCollection("users/projectgeffao/Nicaragua/HuracanOtto_bufferWGS"),
    ...
    ftcVillages = ui.import && ui.import("ftcVillages", "table", {
      "id": "users/projectgeffao/Nicaragua/RBIM/Poblados_MAG"
    }) || ee.FeatureCollection("users/projectgeffao/Nicaragua/RBIM/Poblados_MAG"),
    ...
    ftcMainRivers = ui.import && ui.import("ftcMainRivers", "table", {
      "id": "users/projectgeffao/Nicaragua/RBIM/RBIM_MainRivers"
    }) || ee.FeatureCollection("users/projectgeffao/Nicaragua/RBIM/RBIM_MainRivers"),
    imgPriori = ui.import && ui.import("imgPriori", "image", {
      "id": "users/projectgeffao/Nicaragua/RBIM/RBIM_3CategoriasInd"
    }) || ee.Image("users/projectgeffao/Nicaragua/RBIM/RBIM_3CategoriasInd"),
    geometry = ui.import && ui.import("geometry", "geometry", {
      ...
      "shown": true,
      "locked": false
    }) || /* color: #cde16e */ee.Geometry.MultiPoint(),
    ftc0 = ui.import && ui.import("ftc0", "table", {
      "id": "users/projectgeffao/Nicaragua/RBIM/PreCalLevel0_RBIM_2018v4_Fix"
    }) || ee.FeatureCollection("users/projectgeffao/Nicaragua/RBIM/PreCalLevel0_RBIM_2018v4_Fix"),
    ftc1 = ui.import && ui.import("ftc1", "table", {
      "id": "users/projectgeffao/Nicaragua/RBIM/PreCalLevel1_RBIM_2018v4_Fix"
    }) || ee.FeatureCollection("users/projectgeffao/Nicaragua/RBIM/PreCalLevel1_RBIM_2018v4_Fix"),
    ftc2 = ui.import && ui.import("ftc2", "table", {
      "id": "users/projectgeffao/Nicaragua/RBIM/PreCalLevel2_RBIM_2018v4_Fix"
    }) || ee.FeatureCollection("users/projectgeffao/Nicaragua/RBIM/PreCalLevel2_RBIM_2018v4_Fix"),
    ftcProjects = ui.import && ui.import("ftcProjects", "table", {
      "id": "users/projectgeffao/Nicaragua/RBIM/PreCalProjectBasin_RBIM_2018v4_Fix"
    }) || ee.FeatureCollection("users/projectgeffao/Nicaragua/RBIM/PreCalProjectBasin_RBIM_2018v4_Fix"),
    ftcContainer = ui.import && ui.import("ftcContainer", "table", {
      "id": "users/projectgeffao/Nicaragua/RBIM/PreCalProjectContainer_RBIM_2018v4_Fix"
    }) || ee.FeatureCollection("users/projectgeffao/Nicaragua/RBIM/PreCalProjectContainer_RBIM_2018v4_Fix");
...
var mdlLocalization = require('users/projectgeffao/Nicaragua:Apps/localization_RBIM.js');
/** Global variables */
...
var referenceDocUrl = 'https://docs.google.com/document/d/e/2PACX-1vRsvsFDbvkKPubySOyNmk-vBIlwNZxtB5rAbzr4se_ovqM_gexP-1gpCY5c1wt67GYhI0Mo4WO0arsV/pub';
...
var palettePriori = ["#cde16e", "#ed9337","#d63000"];
var vis = {
    ...
    borderLevel1: { color: '#00ffff', fillColor: '00000000' },
    borderLevel2: { color: 'black', fillColor: '00000000', width: 1 },
    ...
    rivers: { color: 'blue' },
    priori: { min: 1, max: 3, opacity: 1, palette: palettePriori },
}
...
function initApp(lan) {
    ...
    namesPriori = [
        labels.lblCriterioUno,
        labels.lblCriterioDos,
        labels.lblCriterioTres,
    ];
    ...
    layerEntries = [
        ...
        },
        {
            image: imgPriori,
            style: vis.priori,
            name: labels.lblZonaPrio,
            visible: false,
            legend: mdlLegends.createDiscreteLegendPanel(labels.lblZonaPrio, namesPriori, vis.priori.palette, false, false),
            group: 'GENERAL',
        },        {
            image: imgLpd,
            style: vis.lpd,
        ...
        {
            image: ftcOttoHurricane,
            style: vis.otto,
            name: labels.lblOttoHurricane,
            visible: false,
            legend: null,
            group: 'AREAS',
        },
