var corredores = ui.import && ui.import("corredores", "table", {
      "id": "users/projectgeffao/Peru/corredores_union"
    }) || ee.FeatureCollection("users/projectgeffao/Peru/corredores_union");
// Adapted By cesarnon@gmail.com
// Taken from:
//https://github.com/nkeikon/earthengine-apps
...
function clearResults() {
  ...
  var instructionsLabel = ui.Label(
    'Desforestacion Anual en el Corredor'
    );
...
var chartTypeToggleButton =
  ToggleButton(
    [{
        label: 'Muestra resultados en Grafico',
...
inspector.add(ui.Label(
  'Click para seleccionar el Corredor', {
    fontWeight: 'bold',
    fontSize: '20px'
  }));
...
var labels = [
  'Deforestacion (Global Forest Change v1.7)',
  'Corredores con Paisajes del Proyecto'
];
