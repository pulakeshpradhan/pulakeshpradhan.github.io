var imgSoc = ui.import && ui.import("imgSoc", "image", {
    ...
    imgTerrain = ui.import && ui.import("imgTerrain", "image", {
      "id": "users/projectgeffao/Nicaragua/Terrain_rgb3_Nicaragua"
    }) || ee.Image("users/projectgeffao/Nicaragua/Terrain_rgb3_Nicaragua"),
    imgLcAll = ui.import && ui.import("imgLcAll", "image", {
      "id": "users/projectgeffao/Nicaragua/MapaUso_Nicaragua_2000_2018_UNCCDcat"
    }) || ee.Image("users/projectgeffao/Nicaragua/MapaUso_Nicaragua_2000_2018_UNCCDcat"),
    imgTransitions = ui.import && ui.import("imgTransitions", "image", {
      "id": "users/projectgeffao/Nicaragua/MapaUso_Nicaragua_Transitions_2018"
    }) || ee.Image("users/projectgeffao/Nicaragua/MapaUso_Nicaragua_Transitions_2018"),
    imgCombined2 = ui.import && ui.import("imgCombined2", "image", {
      "id": "users/projectgeffao/Nicaragua/MapaUso_LC2018x10_plus_LPD2020"
    }) || ee.Image("users/projectgeffao/Nicaragua/MapaUso_LC2018x10_plus_LPD2020"),
    imgCombined3 = ui.import && ui.import("imgCombined3", "image", {
      "id": "users/projectgeffao/Nicaragua/MapaUso_LC2018x100_plus_LPD2020x10_plus_Mont1_bin"
    }) || ee.Image("users/projectgeffao/Nicaragua/MapaUso_LC2018x100_plus_LPD2020x10_plus_Mont1_bin"),
    imgForestChange = ui.import && ui.import("imgForestChange", "image", {
      "id": "users/projectgeffao/Nicaragua/ForestChange00_18_loss1_gain2"
    }) || ee.Image("users/projectgeffao/Nicaragua/ForestChange00_18_loss1_gain2"),
    ftcIndTerritories = ui.import && ui.import("ftcIndTerritories", "table", {
      "id": "users/projectgeffao/Nicaragua/TerritoriosIndigenas"
    }) || ee.FeatureCollection("users/projectgeffao/Nicaragua/TerritoriosIndigenas"),
    imgFireIndex = ui.import && ui.import("imgFireIndex", "image", {
      "id": "users/projectgeffao/World/FireRecurrenceIndex_MCD64_2001_2020_World"
    }) || ee.Image("users/projectgeffao/World/FireRecurrenceIndex_MCD64_2001_2020_World"),
    geometry = ui.import && ui.import("geometry", "geometry", {
      ...
      "shown": true,
      "locked": false
    }) || /* color: #515057 */ee.Geometry.MultiPoint(),
    ftc0 = ui.import && ui.import("ftc0", "table", {
      "id": "users/projectgeffao/Nicaragua/FOLUR/PreCalLevel0_FOLUR_v1"
    }) || ee.FeatureCollection("users/projectgeffao/Nicaragua/FOLUR/PreCalLevel0_FOLUR_v1"),
    ftc1 = ui.import && ui.import("ftc1", "table", {
      "id": "users/projectgeffao/Nicaragua/FOLUR/PreCalLevel1_FOLUR_v1"
    }) || ee.FeatureCollection("users/projectgeffao/Nicaragua/FOLUR/PreCalLevel1_FOLUR_v1"),
    ftc2 = ui.import && ui.import("ftc2", "table", {
      "id": "users/projectgeffao/Nicaragua/FOLUR/PreCalLevel2_FOLUR_v1"
    }) || ee.FeatureCollection("users/projectgeffao/Nicaragua/FOLUR/PreCalLevel2_FOLUR_v1"),
    ftcContainer = ui.import && ui.import("ftcContainer", "table", {
      "id": "users/projectgeffao/Nicaragua/FOLUR/PreCalProjectContainer_FOLUR_v1"
    }) || ee.FeatureCollection("users/projectgeffao/Nicaragua/FOLUR/PreCalProjectContainer_FOLUR_v1"),
    ftcProjectLandscapes = ui.import && ui.import("ftcProjectLandscapes", "table", {
      "id": "users/projectgeffao/Nicaragua/FOLUR/PreCalProjectSitios_FOLUR_v1"
    }) || ee.FeatureCollection("users/projectgeffao/Nicaragua/FOLUR/PreCalProjectSitios_FOLUR_v1"),
    imgInterventions = ui.import && ui.import("imgInterventions", "image", {
      "id": "users/projectgeffao/Nicaragua/Intervencion"
    }) || ee.Image("users/projectgeffao/Nicaragua/Intervencion");
...
var mdlLocalization = require('users/projectgeffao/Nicaragua:Apps/localization_FOLUR.js');
/** Global variables */
...
ftcKba = ftcKba.filterMetadata("ISO3", "equals", "NIC");
ftcPa = ftcPa.filterMetadata("ISO3", "equals", "NIC").filterMetadata('DESIG_TYPE', 'equals', 'National');
...
var defaultInitialLCYear = '2000';
var defaultFinalLCYear = '2018';
var lcInitialYears = ['2000', '2005', '2010', '2015'];
var referenceDocUrl = 'https://drive.google.com/file/d/1LbGMT0AZjC7RezybsfdI_ntvUGiyts9Z/view?usp=sharing';
var contactEmail = 'cesar.garcia@fao.org';
var contactEmail1 = 'Denis.FuentesOrtega@fao.org';
var logoAssetId = 'users/projectgeffao/Nicaragua/RBIM/logos_RBIM';
var ftcAoi = null; // holds selected area ftc 
// Project areas of interest Level1/Level2
var level1fcProject = ftc1.filterMetadata('Project', 'equals', 1);
...
var namesFGL;
var namesProjectAreas;
var namesInterventions;
// Visualization
...
var paletteLPD = ['#f23c46', '#e9a358', '#e5e6b3', '#bcc3c2', '#267300'];
...
var paletteProjectAreas = ['#8c5cdb', '#116d68'];
var paletteInterventions = ['#95652f', '#05880e', '#56e14d', '#ede7bd'];
var ftcProjectLandscapesStyled = ftcProjectLandscapes.map(function (f) {
    return ee.Algorithms.If(ee.Number(f.get('Best')).eq(1),
        f.set({ style: { color: paletteProjectAreas[0], fillColor: "8c5cdb30" } }),
        f.set({ style: { color: paletteProjectAreas[1], fillColor: "116d6830" } }));
});
var vis = {
    ...
    borderLevel1: { color: 'black', fillColor: '00000000', width: 2  },
    borderLevel2: { color: '#515057', fillColor: '00000000', width: 1 },
    projectAreas: { palette: paletteProjectAreas },
    highlight: { color: '#FF0000', fillColor: '00000000' }, // '#a422ff'
    ...
    otto: { color: "black", fillColor: "11ece130", width: 2 },
    villages: { color: 'purple' },
    rivers: { color: 'blue' },
    interventions: { min: 1, max: 4, palette: paletteInterventions }
}
...
var namesIntColumns = ['int_1','int_2','int_3','int_4'];
// Control panel 
...
function initApp(lan) {
    ...
    namesProjectAreas = [
        labels.lblProjectPrioritizedLandscapes,
        labels.lblProjectLandscapes,
    ];
    ...
    namesInterventions = [
        labels.lblAgroforestry,
        labels.lblForestProt,
        labels.lblRestoration,
        labels.lblSilvo
    ];
    ...
    layerEntries = [
        ...
        {
            image: imgInterventions,
            style: vis.interventions,
            name: labels.lblInterventions,
            visible: false,
            legend: mdlLegends.createDiscreteLegendPanel(labels.lblInterventions, namesInterventions, vis.interventions.palette, false, false),
            group: 'GENERAL',
        }, {
            image: imgLpd,
            style: vis.lpd,
        ...
        {
            image: ftcProjectLandscapesStyled,
            style: { styleProperty: "style" },
            name: labels.lblProjectAreas,
            visible: true,
            legend: mdlLegends.createDiscreteLegendPanel(labels.lblProjectAreas, namesProjectAreas, paletteProjectAreas, false, false),
            group: 'AREAS',
        },
        {
            image: ftcKba,
        ...
        {
            image: ftcIndTerritories,
            style: vis.terr,
            name: labels.lblTerrInd,
            visible: false,
            legend: null,
            group: 'AREAS',
            singleColor: 'SQUARE',
    ...
    var initControlPanelWelcome = function () {
        ...
        var pnlWelcome = ui.Panel({
            ...
            widgets: [
                ...
                ui.Label(contactEmail1, { fontSize: '12px' }).setUrl('mailto:' + contactEmail1),
                ui.Button({
                ...
                ui.Label(labels.lblCloseWarning, { fontSize: '12px', color: 'grey' }),
            ]
        });
        map.add(pnlWelcome);
...
function initOutputPanel(pnlOutput) {
    ...
    infoEntries = {
        ...
        indTerritory: { lblHeader: ui.Label(labels.lblIndigenousTerritory + ': ', styleHeaderInfo), lblValue: ui.Label(labels.lblLoading, styleInfo) },
    }
...
function initMapPanel(pnlMap) {
    ...
    var handleClickMap = function (coords) {
        map.widgets().remove(pnlCombinedLegend);
        var ftcCheck = ftcProjectLandscapes.filterBounds(ee.Geometry.Point(coords.lon, coords.lat));
    ...
    var selectContainer = function (ftc) {
        resetNamesLevel1();
        ftcAoi = ftc;
    ...
    var btnSelectContainer = ui.Button({
        ...
        onClick: function () {
            selectContainer(ftcContainer);
        },
    });
     var btnSelectCountry = ui.Button({
        label: labels.lblSelectCountry,
        style: {
            position: "bottom-right",
        },
        onClick: function () {
            selectContainer(ftc0);
        },
    });
    map.add(btnSelectContainer);
    map.add(btnSelectCountry);
...
function showInfoSelectedAoi() {
    ...
    selectedArea.get('areaHa').getInfo(function (pArea) {
        ...
        selectedArea.get('Tindi_Ha').getInfo(function (pValue) {
            var aux = pArea > 0 ? (pValue * 100 / pArea) : 0;
            infoEntries['indTerritory'].lblValue.setValue(formatNumber(pValue, 0) + " ha. (" + aux.toFixed(1) + "%)");
        });
    });
...
function setupCombined(pImage, pLegendTitle, pLegendText, pFromChart) {
    ...
    pImage.getDownloadURL(options, function (url) {
        if (url !== null) {
            lblDownloadText.setValue(labels.lblDownload);
...
function setupGeneralCharts(pPnlContainer, pLCFinalYear) {
    ...
    if (true) {
     ...
     // INTERVENTIONS    
    if (true) {
        var lstFeatInt = namesIntColumns.map(function (pName, i) {
            var lstValues = ee.List([namesInterventions[i], ftcAoi.first().get(pName)]);
            return ee.Feature(null, { row: lstValues });
        });
        var lstHeaderInt = ee.List([
            [
                { label: 'LC', role: 'domain', type: 'string' },
                { label: 'Value', role: 'data', type: 'number' },
            ],
        ...
        var optionsInt = {
            title: labels.lblInterventions + ' - ' + labels.lblProjectAreas,
            height: 350,
            legend: { position: 'top', maxLines: 1 },
            colors: paletteInterventions,
            pieHole: 0.4
        };
        createChart(lstHeaderInt.cat(ee.FeatureCollection(lstFeatInt).aggregate_array('row')), optionsInt, 'PieChart', createChartPanel(pPnlContainer));
    }
}
    ...
    if (true) {
        var handleClickFromChart = function (xValue, yValue, seriesName) {
            ...
            if (xValue) { // lpdxlc
                ...
                var legendTitle = 'From chart: ' + labels.lblCombinedCategoriesArea + ' ' + formatNumber(yValue, 2) + ' ha.';
