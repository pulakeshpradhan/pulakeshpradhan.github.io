...
var roi=  geometry_roi;//geometry_korea;//geometry_roi3;//geometry_roi2;
...
var label5 = ui.Label({
 ...
 var instructions = ui.Label({
  value: 'Click on the map (ROI) to show MODIS NDWI chart',
  style: {
    fontSize: '16px',
    color: 'black',
   // fontWeight: 'bold',
...
Map.addLayer( display_bound, {palette: '0000FF'}, 'boundary',1); var display_bound = ee.Image(0).updateMask(0).paint(paddy_roi, '000000', 1);
Map.addLayer( display_bound, {palette: '0000FF'}, 'boundary',1);
/**
...
//Map.addLayer(img_class.updateMask(img_paddy_modis),{min:1,max:4,palette:['red','green','blue','yellow']},'Phenology')
/*
