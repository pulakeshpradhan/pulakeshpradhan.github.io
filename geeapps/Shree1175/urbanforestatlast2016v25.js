var treeViz = ui.import && ui.import("treeViz", "imageVisParam", {
      "params": {
        "opacity": 1,
        "bands": [
          "classification"
    ...
    }) || {"opacity":1,"bands":["classification"],"palette":["3daf3e"]},
    tempViz = ui.import && ui.import("tempViz", "imageVisParam", {
      "params": {
        "opacity": 1,
        "bands": [
          "temp"
        ],
        "min": 293.0870062255859,
        "max": 309.78039489746095,
        "palette": [
          "104aff",
          "7a8eff",
          "ffece7",
    ...
    }) || {"opacity":1,"bands":["temp"],"min":293.0870062255859,"max":309.78039489746095,"palette":["104aff","7a8eff","ffece7","ff9685","e2470c"]},
    table_new = ui.import && ui.import("table_new", "table", {
      "id": "users/Shree1175/CODA_assets/Block_summary_all_fc"
    }) || ee.FeatureCollection("users/Shree1175/CODA_assets/Block_summary_all_fc"),
    ...
    tc_NE = ui.import && ui.import("tc_NE", "table", {
      "id": "users/charlotteks/TreeCanopy_NE"
    }) || ee.FeatureCollection("users/charlotteks/TreeCanopy_NE"),
    tc_W = ui.import && ui.import("tc_W", "table", {
      "id": "users/charlotteks/TreeCanopy_W"
    }) || ee.FeatureCollection("users/charlotteks/TreeCanopy_W"),
    tc_SE = ui.import && ui.import("tc_SE", "table", {
      "id": "users/charlotteks/TreeCanopy_SE"
    }) || ee.FeatureCollection("users/charlotteks/TreeCanopy_SE"),
    treeGap = ui.import && ui.import("treeGap", "table", {
      "id": "users/charlotteks/TreeGap_Block"
    }) || ee.FeatureCollection("users/charlotteks/TreeGap_Block"),
    ...
    imageVisParam = ui.import && ui.import("imageVisParam", "imageVisParam", {
      "params": {
        ...
        "min": 0.21429048551670934,
        "max": 0.23488689030492635,
        "palette": [
          "c47512",
          "fff6f1",
          "86c16f"
    ...
    }) || {"opacity":0.79,"bands":["Tree gap"],"min":0.21429048551670934,"max":0.23488689030492635,"palette":["c47512","fff6f1","86c16f"]},
    imageVisParam2 = ui.import && ui.import("imageVisParam2", "imageVisParam", {
      "params": {
        ...
        "min": 0.6714880751138371,
        "max": 0.6714884450861628,
        "palette": [
          "c47512",
          "fff6f1",
          "86c16f"
    ...
    }) || {"opacity":0.79,"bands":["Tree target"],"min":0.6714880751138371,"max":0.6714884450861628,"palette":["c47512","fff6f1","86c16f"]},
    viz_Target = ui.import && ui.import("viz_Target", "imageVisParam", {
      "params": {
        "opacity": 0.79,
        "bands": [
          "Tree target"
        ],
        "min": 0.27238161079986023,
        "max": 0.4693206558003941,
        "palette": [
          "65cfda",
          "ffe10c",
          "635999"
    ...
    }) || {"opacity":0.79,"bands":["Tree target"],"min":0.27238161079986023,"max":0.4693206558003941,"palette":["65cfda","ffe10c","635999"]},
    us_summ = ui.import && ui.import("us_summ", "table", {
      "id": "users/Shree1175/UrbanForest/US_TreeInEquity_MSA_Mean_FC_Temp"
    }) || ee.FeatureCollection("users/Shree1175/UrbanForest/US_TreeInEquity_MSA_Mean_FC_Temp"),
    TIGER_cities = ui.import && ui.import("TIGER_cities", "table", {
      "id": "users/charlotteks/tl_2017_us_uac10"
    }) || ee.FeatureCollection("users/charlotteks/tl_2017_us_uac10"),
    Table_S6_Clean = ui.import && ui.import("Table_S6_Clean", "table", {
      "id": "users/charlotteks/UrbanAtlas_TABLE_S6"
    }) || ee.FeatureCollection("users/charlotteks/UrbanAtlas_TABLE_S6"),
    Table_s4 = ui.import && ui.import("Table_s4", "table", {
      "id": "users/Shree1175/UrbanForest/Table_s4"
    }) || ee.FeatureCollection("users/Shree1175/UrbanForest/Table_s4"),
    raster_temp = ui.import && ui.import("raster_temp", "imageCollection", {
      "id": "users/Shree1175/UrbanForest/TempCollection"
    }) || ee.ImageCollection("users/Shree1175/UrbanForest/TempCollection"),
    bloc_temp_new = ui.import && ui.import("bloc_temp_new", "imageCollection", {
      "id": "users/Shree1175/UrbanForest/Block_Temp"
    }) || ee.ImageCollection("users/Shree1175/UrbanForest/Block_Temp"),
    table2 = ui.import && ui.import("table2", "table", {
      "id": "users/Shree1175/CODA_assets/CODA_MSA_with_FC_per_summary"
    }) || ee.FeatureCollection("users/Shree1175/CODA_assets/CODA_MSA_with_FC_per_summary");
// -------------------------------------------------------------
...
var label_url = ui.Label({
    value:'Link to view the classified urban tree cover.',
...
var label_github = ui.Label({
    value:'Link to github code',
    style: {fontSize: '14px', fontWeight: 'bold'}
  });
...
label_github.setUrl('https://github.com/tnc-ca-geo/urban-tree-inequality/blob/main/README.md');
// write description text
var description = ui.Panel([
  ui.Label({
  value: 'The Urban Tree Cover Inequality Atlas (version 2016.9) maps the disparity in urban tree canopy across 5,723 US cities by income and population at census block level. The data was developed from high-resolution aerial imagery, summer temperatures, and census demographics. In 92% of urban areas surveyed, low-income census blocks on average have 15.2% lower canopy cover and are 1.5 degrees C hotter than high-income blocks (McDonald et al., PLOSone April 2021). A manuscript with a full description of the methods used to make these layers and results is available here.',
  style: {fontSize: '16px' }
  }),
  // add paper and github links
  label_paper,
  label_url,
  label_github,
  ui.Label({
...
leftMap.onClick(function(coords) {
  ...
  var point = ee.Geometry.Point(coords.lon, coords.lat);
  // Zoom in on clicked location 
  rightMap.centerObject(point, 10);
  leftMap.centerObject(point, 10);
////////////////////////////////////////
// After click -- Select data for location clicked on
////////////////////////////////////////
  // filter for city and biome clicked 
