...
var modisOceanColor = ee.ImageCollection("LANDSAT/LE07/C01/T1_RT");
...
var sst=modisOceanColor.map(addNDSI).map(fmask).select(['NDSI']).filterDate('2017-01-01', '2018-01-01');
var vis = {min: -0.2, max: 1, palette:  ' CE7E45, DF923D, F1B555, FCD163, a2a2a2, aaa, b3b3b3, bbb,' +
   'c4c4c4, ccc, d5d5d5, ddd, e6e6e6, eee, f7f7f7, FFFFFF'};
...
var intro = ui.Panel([
  ui.Label({
    value: 'NDSI - Time Series Inspector',
    style: {fontSize: '20px', fontWeight: 'bold'}
  }),
  ui.Label('Click a location to see its time series of NDSI.')
]);
...
var initialPoint = ee.Geometry.Point(75, 35.79);
