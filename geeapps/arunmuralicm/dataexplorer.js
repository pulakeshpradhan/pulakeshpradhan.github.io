var viirs_mask_unproj = ee.Image("users/arunmuralicm/VIRRS_mask_464m"),
    districts = ee.FeatureCollection("users/arunmuralicm/district_v1");
...
var toolPanel = ui.Panel([header], 'flow', {width: '350px',shown: true});
  toolPanel.style().set({
  width: '280px',
  position: 'top-right'
});
var toolPanel1 = ui.Panel([header1], 'flow', {width: '310px',shown: false});
...
/*print(lab13);
var location5 = lab6.evaluate(function(result){
  toolPanel1.widgets().set(7,ui.Label({
    value: 'Cropland: '+ result.toFixed(0)
  }))
})
var location6 = lab7.evaluate(function(result){
  toolPanel1.widgets().set(8,ui.Label({
    value: 'Forest: '+ result.toFixed(0)
  }))
})
var location7 = lab8.evaluate(function(result){
  toolPanel1.widgets().set(9,ui.Label({
    value: 'Grassland: '+ result.toFixed(0)
  }))
})
var location8 = lab9.evaluate(function(result){
  toolPanel1.widgets().set(10,ui.Label({
    value: 'Shrubland: '+ result.toFixed(0)
  }))
})
var location9 = lab10.evaluate(function(result){
  toolPanel1.widgets().set(11,ui.Label({
    value: 'Urban: '+ result.toFixed(0)
  }))
})
var location10 = lab11.evaluate(function(result){
  toolPanel1.widgets().set(12,ui.Label({
    value: 'Bare land: '+ result.toFixed(0)
  }))
})
var location11 = lab12.evaluate(function(result){
  toolPanel1.widgets().set(13,ui.Label({
    value: 'Water bodies: '+ result.toFixed(0)
  }))
})
var location12 = lab13.evaluate(function(result){
  toolPanel1.widgets().set(14,ui.Label({
    value: 'Permanent Snow and ice: '+ result.toFixed(2)
  }))
})*/
