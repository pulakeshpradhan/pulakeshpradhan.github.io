...
var subheader = ui.Label('Natural Language Processing (NLP) application to the Magdalena River Basin: Lakes', {fontSize: '14px'});
...
// CARGAR DATOS
// Import Features
var river = ee.FeatureCollection('users/santiagoduarte09/lasantamaria/LagunasMagdalena');
// Import Basin
