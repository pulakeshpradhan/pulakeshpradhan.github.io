...
var subheader = ui.Label('Natural Language Processing (NLP) application to the Magdalena River Basin: Reservoirs', {fontSize: '14px'});
...
// CARGAR DATOS
// Import Features
var river = ee.FeatureCollection('users/santiagoduarte09/lasantamaria/EmbalsesMagdalena');
// Import Basin
    ...
    topic.evaluate(function(result) {
     inspector.widgets().set(3, ui.Label({
      value: 'Key Topics: ' + result,
       style: {stretch: 'horizontal',width: '200px',fontSize: '12px'}
      }));
    });
