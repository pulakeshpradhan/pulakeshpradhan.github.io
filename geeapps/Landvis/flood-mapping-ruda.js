var river = ui.import && ui.import("river", "table", {
      "id": "projects/ee-landvis/assets/pak_rivers"
    }) || ee.FeatureCollection("projects/ee-landvis/assets/pak_rivers"),
    geometry = ui.import && ui.import("geometry", "table", {
      "id": "projects/ee-landvis/assets/Lahore_ruda"
    }) || ee.FeatureCollection("projects/ee-landvis/assets/Lahore_ruda");
...
var before_end='2023-06-15';
// Now set the same parameters for AFTER the flood.
var after_start='2023-06-16';
var after_end='2023-07-06';
/********************************************************************************************
...
var difference_threshold = 1.40; /*threshodl to be applied on the difference image (after flood
...
var roiStyle = {
  fillColor: 'red',
  fillOpacity: 0.9,  // Adjust the opacity as desired
  color: 'Black'
};
Map.addLayer(geometry, roiStyle, 'Area', 0)
...
// Produced by...
var text7 = ui.Label('Developed by: PITB, Govt of Punjab, PAK. (JULY,2023) Refrence: UN-SPIDER December 2019', subTextVis)
...
Map.addLayer(river, riverStyle, 'Rivers');
*/