...
var lt_de = lt_de.select(['yod']).updateMask(lt_de.select(['yod']).neq(0)).updateMask(forest18.neq(0));
var treespecies_disturbed = treespecies_de.updateMask(lt_de.gt(2020))
// add legend
...
var entry; for (var x = 0; x<11; x++){   
 ...
 Map.add(legend);
 Map.addLayer(treespecies_disturbed, specVizParms, 'Disturbance 2021 - Tree Species ', true);