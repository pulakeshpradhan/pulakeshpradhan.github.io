var table = ui.import && ui.import("table", "table", {
    ...
    image = ui.import && ui.import("image", "image", {
      "id": "users/cesarnon/FAO_GEF/LPD_Nicaragua"
    }) || ee.Image("users/cesarnon/FAO_GEF/LPD_Nicaragua");
//Map.addLayer(table)
var muni= table.filterMetadata('ADM0_NAME','equals','Nicaragua')
// Taken from:
...
function clearResults() {
  ...
  var instructionsLabel = ui.Label(
    'Deforestacion Anual en el municipio'
    );
...
var labels = [
  'Deforestacion Acumulada al 2019(Global Forest Change v1.7)',
  'Municipios'
];
