var class7 = ui.import && ui.import("class7", "imageVisParam", {
      "params": {
        "opacity": 1,
        "bands": [
          "constant"
    ...
    CACILMarea = ui.import && ui.import("CACILMarea", "table", {
      "id": "users/cesarnon/CACILM/CACILM_area"
    }) || ee.FeatureCollection("users/cesarnon/CACILM/CACILM_area"),
    ecorregion = ui.import && ui.import("ecorregion", "table", {
      "id": "users/cesarnon/CACILM/Cacilm_ecorregions_engRus"
    }) || ee.FeatureCollection("users/cesarnon/CACILM/Cacilm_ecorregions_engRus"),
    VisCV = ui.import && ui.import("VisCV", "imageVisParam", {
      "params": {
        "opacity": 1,
        "bands": [
          "constant"
    ...
    }) || {"opacity":1,"bands":["constant"],"min":0.01,"max":0.49,"palette":["018323","fff706","ff0a20","a108ab"]},
    ...
    LTT_AM_NDVI_2001_2018_cal_CACILM = ui.import && ui.import("LTT_AM_NDVI_2001_2018_cal_CACILM", "image", {
    ...
    LTT_ESPI_NDVI_2001_2018_cal_CACILM = ui.import && ui.import("LTT_ESPI_NDVI_2001_2018_cal_CACILM", "image", {
    ...
    SWATI_AM_2001_2018_cal_CACILM = ui.import && ui.import("SWATI_AM_2001_2018_cal_CACILM", "image", {
    ...
    SWATI_ESPI_2001_2018_cal_CACILM = ui.import && ui.import("SWATI_ESPI_2001_2018_cal_CACILM", "image", {
    ...
    SWATISlope_AM_2001_2018_cal_CACILM = ui.import && ui.import("SWATISlope_AM_2001_2018_cal_CACILM", "image", {
    ...
    SWATISlope_ESPI_2001_2018_cal_CACILM = ui.import && ui.import("SWATISlope_ESPI_2001_2018_cal_CACILM", "image", {
    ...
    LSIB2017 = ui.import && ui.import("LSIB2017", "table", {
      "id": "USDOS/LSIB/2017"
    }) || ee.FeatureCollection("USDOS/LSIB/2017"),
    LSIB2017s = ui.import && ui.import("LSIB2017s", "table", {
      "id": "USDOS/LSIB_SIMPLE/2017"
    }) || ee.FeatureCollection("USDOS/LSIB_SIMPLE/2017");
// Display as default and with a custom color.
//Map.addLayer(ecorregion, {}, 'default display',false);
//Map.addLayer(ecoregions, {color: 'FF0000'}, 'colored');
Map.addLayer(LTT_AM_NDVI_2001_2018_cal_CACILM,class7,'LTT_AM_NDVI_2001_2018_cal_CACILM')
Map.addLayer(LTT_ESPI_NDVI_2001_2018_cal_CACILM,class7,'LTT_ESPI_NDVI_2001_2018_cal_CACILM',false)
Map.addLayer(SWATISlope_AM_2001_2018_cal_CACILM,class7,'SWATISlope_AM_2001_2018_cal_CACILM',false)
Map.addLayer(SWATISlope_ESPI_2001_2018_cal_CACILM,class7,'SWATISlope_ESPI_2001_2018_cal_CACILM',false)
Map.addLayer(SWATI_AM_2001_2018_cal_CACILM,class7,'SWATI_AM_2001_2018_cal_CACILM',false)
Map.addLayer(SWATI_ESPI_2001_2018_cal_CACILM,class7,'SWATI_ESPI_2001_2018_cal_CACILM',false)
var modcoll = ee.ImageCollection.fromImages([LTT_AM_NDVI_2001_2018_cal_CACILM,
              LTT_ESPI_NDVI_2001_2018_cal_CACILM,
              SWATISlope_AM_2001_2018_cal_CACILM,
              SWATISlope_ESPI_2001_2018_cal_CACILM,
              SWATI_AM_2001_2018_cal_CACILM,
              SWATI_ESPI_2001_2018_cal_CACILM
              ])
//print (modcoll)
var collMean = modcoll.mean().round()
Map.addLayer(collMean,class7,'Consensus Model',false)
//var collMedian = modcoll.median().round()
//Map.addLayer(collMedian,class7,'collMedian')
//var collstdDev = modcoll.reduce(ee.Reducer.stdDev()).rename('constant')//.round()
//Map.addLayer(collstdDev,class7,'collstdDev')
//var collCV = collstdDev.divide(collMean)
//Map.addLayer(collCV,VisCV,'Coefficient of variation',false)
//
var yrStart = 2000;
var yrEnd = 2018; 
...
Map.centerObject(ecorregion,4)
    // Create an empty image into which to paint the features, cast to byte.
var empty = ee.Image().byte();
// Paint all the polygon edges with the same number and width, display.
var outline = empty.paint({
  featureCollection: LSIB2017,
  color: 1,
  width: 1
});
Map.addLayer(outline, {palette: '#0409b1'}, 'Simplified Limits');
/*
Export.image.toDrive({
  image: LTT_AM_NDVI_2001_2018_cal_CACILM,
  description: 'LTT_AM_NDVI_2001_2018_cal_CACILM',
  scale: 250,
  region: CACILMarea,
  folder: 'LDN_CACILM',
  crs:'SR-ORG:6974',
...
Export.image.toAsset({
  image: ave,
  description: 'All6Models_Ave_2001_2018_cal_CACILM',
  assetId:'All6Models_Ave_2001_2018_cal_CACILM',
  scale: 250,
  region:CACILM,
  //region: World.geometry().bounds(),
  crs:'SR-ORG:6974',
