var imageCollection = ui.import && ui.import("imageCollection", "imageCollection", {
      "id": "users/kkraoj/lfm-mapper/lfmc_col_25_may_2021"
    }) || ee.ImageCollection("users/kkraoj/lfm-mapper/lfmc_col_25_may_2021"),
    initialPoint = ui.import && ui.import("initialPoint", "geometry", {
      "geometries": [
        {
          "type": "Point",
          "coordinates": [
      ...
      "shown": true,
      "locked": false
    }) || /* color: #d63000 */ee.Geometry.Point([-121.62, 39.74]);
/*
