...
var sebelum = ee.ImageCollection("COPERNICUS/S5P/NRTI/L3_AER_AI")
  .select('absorbing_aerosol_index')
  .filterDate('2019-11-01', '2020-03-15')
  .filterBounds(geometry);
var selama = ee.ImageCollection("COPERNICUS/S5P/NRTI/L3_AER_AI")
  .select('absorbing_aerosol_index')
...
'Peta Absorbing Aerosol Index (AAI)', {fontWeight: 'bold', fontSize: '20px', position: 'top-center', color: 'black'}));
...
//Membuat grafis AAI sebelum PSBB (Kota Medan)
...
grafSebelum.setOptions({
  title: 'AAI di Kota Medan dan Sekitarnya sebelum PSBB',
  vAxis: {title: 'Kadar AAI'},
  lineWidth: 1,
  pointSize: 4,
  }
);
print(grafSebelum);
//Membuat grafis AAI selama PSBB (Kota Medan)
...
grafSelama.setOptions({
  title: 'AAI di Kota Medan dan Sekitarnya selama PSBB',
  vAxis: {title: 'Kadar AAI'},
  lineWidth: 1,
  pointSize: 4,
  }
...
print(grafSelama);
//Membuat grafis AAI sebelum PSBB (Kota Jakarta)
var grafSebelum = ui.Chart.image.seriesByRegion({
  imageCollection: sebelum,
...
grafSebelum.setChartType('ColumnChart');
grafSebelum.setOptions({
  title: 'AAI di Kota Jakarta dan Sekitarnya sebelum PSBB',
  vAxis: {title: 'Kadar AAI'},
  lineWidth: 1,
  pointSize: 4,
  }
...
print(grafSebelum);
//Membuat grafis AAI selama PSBB (Kota Jakarta)
var grafSelama = ui.Chart.image.seriesByRegion({
  imageCollection: selama,
  regions: buffer_Jakarta,
  reducer: ee.Reducer.mean(),
...
grafSelama.setChartType('ColumnChart');
grafSelama.setOptions({
  title: 'AAI di Kota Jakarta dan Sekitarnya selama PSBB',
  vAxis: {title: 'Kadar AAI'},
  lineWidth: 1,
  pointSize: 4,
  }
...
print(grafSelama);
//Membuat grafis AAI sebelum PSBB (Kota Balikpapan)
var grafSebelum = ui.Chart.image.seriesByRegion({
  imageCollection: sebelum,
...
grafSebelum.setChartType('ColumnChart');
grafSebelum.setOptions({
  title: 'AAI di Kota Balikpapan dan Sekitarnya sebelum PSBB',
  vAxis: {title: 'Kadar AAI'},
  lineWidth: 1,
  pointSize: 4,
  }
...
print(grafSebelum);
//Membuat grafis AAI selama PSBB (Kota Balikpapan)
var grafSelama = ui.Chart.image.seriesByRegion({
  imageCollection: selama,
  regions: buffer_Balikpapan,
  reducer: ee.Reducer.mean(),
...
grafSelama.setChartType('ColumnChart');
grafSelama.setOptions({
  title: 'AAI di Kota Balikpapan dan Sekitarnya selama PSBB',
  vAxis: {title: 'Kadar AAI'},
  lineWidth: 1,
  pointSize: 4,
  }
...
print(grafSelama);
//Membuat grafis AAI sebelum PSBB (Kota Makassar)
var grafSebelum = ui.Chart.image.seriesByRegion({
  imageCollection: sebelum,
...
grafSebelum.setChartType('ColumnChart');
grafSebelum.setOptions({
  title: 'AAI di Kota Makassar dan Sekitarnya sebelum PSBB',
  vAxis: {title: 'Kadar AAI'},
  lineWidth: 1,
  pointSize: 4,
  }
...
print(grafSebelum);
//Membuat grafis AAI selama PSBB (Kota Makassar)
var grafSelama = ui.Chart.image.seriesByRegion({
  imageCollection: selama,
  regions: buffer_Makassar,
  reducer: ee.Reducer.mean(),
...
grafSelama.setChartType('ColumnChart');
grafSelama.setOptions({
  title: 'AAI di Kota Makassar dan Sekitarnya selama PSBB',
  vAxis: {title: 'Kadar AAI'},
  lineWidth: 1,
  pointSize: 4,
  }
...
print(grafSelama);
//Membuat grafis AAI sebelum PSBB (Kota Jayapura)
var grafSebelum = ui.Chart.image.seriesByRegion({
  imageCollection: sebelum,
...
grafSebelum.setChartType('ColumnChart');
grafSebelum.setOptions({
  title: 'AAI di Kota Jayapura dan Sekitarnya sebelum PSBB',
  vAxis: {title: 'Kadar AAI'},
  lineWidth: 1,
  pointSize: 4,
  }
...
print(grafSebelum);
//Membuat grafis AAI selama PSBB (Kota Jayapura)
var grafSelama = ui.Chart.image.seriesByRegion({
  imageCollection: selama,
  regions: buffer_Jayapura,
  reducer: ee.Reducer.mean(),
...
grafSelama.setChartType('ColumnChart');
grafSelama.setOptions({
  title: 'AAI di Kota Jayapura dan Sekitarnya selama PSBB',
  vAxis: {title: 'Kadar AAI'},
  lineWidth: 1,
  pointSize: 4,
  }
...
var header = ui.Label('Peta Absorbing Aerosol Index (AAI) Sebelum dan Selama Regulasi PSBB COVID-19 di Kota-kota Besar di Indonesia', {fontSize: '25px', color: 'darkSlateGrey'});
var text_1 = ui.Label(
'Peta Absorbing Aerosol Index (AAI) di kota-kota besar di Indonesia selama PSBB dimonitor melalui satelit Sentinel-5. Diasumsikan bahwa kebijakan PSBB diterapkan serentak pada tanggal 1 April 2020.',
{fontSize: '15px'});
var text_2 = ui.Label(
...
var legendLabels = ui.Panel({
  widgets: [
    ui.Label(-3.3, {margin: '4px 8px'}),
    ui.Label(
        (-0.9),
        {margin: '4px 8px', textAlign: 'center', stretch: 'horizontal'}),
    ui.Label(1.5, {margin: '4px 8px'})
  ],
