var c0 = ee.ImageCollection('COPERNICUS/S5P/NRTI/L3_NO2')
var c = c0.select('NO2_column_number_density');
var start = ee.Date('2020-02-15');
var start2019 = start.advance(-1,'year');
var now = ee.Date('2020-03-15');
...
var vis={min:20, max:200, palette:p};
var m1 = im1.gt(5);
var m2 = im2.gt(5);
var mapStyle = [
    {
