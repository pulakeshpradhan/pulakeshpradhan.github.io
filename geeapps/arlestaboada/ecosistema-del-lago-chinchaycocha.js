var app={};
 var recorte=ee.Geometry.Polygon([[
  ...
  var bounds=ee.Geometry.Polygon([[
    [-76.13358253399196,-11.02623822950539],
    [-76.13838905254664,-11.038369436034303],
    [-76.12122291485133,-11.043086992180053],
  ]])
//cuenca
var cuenca_junin_sanjuan = ee.FeatureCollection('users/arlestaboada/cuenca_junin_san_juan');
var mantaro=ee.FeatureCollection('users/arlestaboada/Mantaro_Otras')
...
var area_de_lago=ee.FeatureCollection('users/arlestaboada/Area_de_embalse_chinchaycocha');
var pasivos_ambientales_chinchaycocha=ee.FeatureCollection('users/arlestaboada/Pasivos_Ambientales_identificados_chinchaycocha');
   ...
   imageId = app.picker.select.getValue();
    if (imageId) {
      ...
      // If an image id is found, create an image.
       image = ee.Image(COLLECTION_ID + '/' + imageId).clip(cuenca_junin_sanjuan);
     ...
     Map.addLayer(area_de_lago,{},'Area de embalse de lago',false)
    Map.addLayer(pasivos_ambientales_chinchaycocha,{},'Pasivos ambientales',false)
  };
