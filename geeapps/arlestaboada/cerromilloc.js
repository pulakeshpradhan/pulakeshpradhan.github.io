...
var bounds=ee.Geometry.Polygon([[
    [-76.6831023227179,-11.513011954554578],
    [-76.4578825961554,-11.908354648833361],
    [-75.7932097445929,-11.596430447454463],
    [-76.2216765414679,-11.246446092080905],
  ]])
 ...
 var zech6=ee.FeatureCollection('users/arlestaboada/zona_de_extraccion_de_champa_6-polygon-cerro-milloc').geometry();
 var zechb1=ee.FeatureCollection('users/arlestaboada/zonas_de_extraccion_de_champa_bofedal1-polygon').geometry();
 var zech2=ee.FeatureCollection('users/arlestaboada/zona_de_extraccion_de_champa_2-polygon').geometry();
 var cuenca=ee.FeatureCollection('users/arlestaboada/Milloc').geometry();
var ICfilter;
var ndwi;
var mascara_sst;
var selectYr;
...
var slope;
var srtm;
 srtm=ee.Image('USGS/SRTMGL1_003').clip(cuenca);
...
app.createHelpers = function() {
  ...
  /** Applies the selection filters currently selected in the UI. */
   ...
   app.refreshMapLayer = function() {
    ...
    if (imageId) {
      ...
      image = ee.Image(COLLECTION_ID + '/' + imageId).clip(cuenca);
     ...
     app.picker.fecha_ad.setValue(date_ad.getInfo())
      if(opcion_vis.valor<2){
         ...
         Map.addLayer(zech6,null,'Zona de extracción de champa 6');
         Map.addLayer(zechb1,null,'Zona de extracción de champa de bofedal 1');
         Map.addLayer(zech2,null,'Zona de extracción de champa 2');
      }else if( opcion_vis.valor===2){
        if(menor_2012){
  ...
  app.aplicarClasificacion=function(){
    ...
    var legend=ui.Panel({
        ...
        Map.add(legend)
       // var punto=ee.Geometry.Point(-70.3781,-13.0916);
        //Map.addLayer(punto)
  }
};
///crear constantes
