...
function get_MODIS_composite(dat) {
  ...
  var mcd43a4_ = mcd43a4.filterDate(date, date.advance(1, 'week')).mean().clip(roi).updateMask(msk);
  return mcd43a4_.visualize({min:0, max:4500, bands:['b6','b4','b3']});}
// Forest cover maps
var images2 = {
...
function addLayerSelector(mapToChange, defaultValue, position) {
  var label = ui.Label('Choose forest cover map to view');
  function updateMap(selection) {
    ...
    mapToChange.layers().set(4, ui.Map.Layer(hill, {opacity:0.3,bands:["constant"],min:0.47,max:0.53}, "hillshade"));
    mapToChange.layers().set(5, ui.Map.Layer(bzr1, {palette: "blue"},'rivers'));
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var title = ui.Label('Belize River Watershed forest cover change, 2001-2020 (option 1)', {fontWeight: 'bold', fontSize: '22px', color: 'darkgreen'});
var descr = ui.Label("instructions: swipe to change the display of forest cover maps", {color: 'gray'});
...
var link1 = ui.Chart(
    [
      ...
      ['<a target="_blank" href=https://bzgeo.users.earthengine.app/view/bzr-forest-cover-pt2>' +
       'Option 2: compare MODIS image and forest cover map</a>'],
      ['<a target="_blank" href=https://bzgeo.users.earthengine.app/view/bzr-forest-cover-pt3>' +
       'Option 3: compare 2 MODIS images</a>']
    ],
