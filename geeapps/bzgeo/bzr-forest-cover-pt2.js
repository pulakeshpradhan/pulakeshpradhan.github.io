...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var title = ui.Label('Belize River Watershed forest cover change, 2001-2020 (option 2)', {fontWeight: 'bold', fontSize: '22px', color: 'darkgreen'});
var descr = ui.Label("instructions: swipe left to display forest cover maps; swipe right for source spectrally unmixed MODIS images", {color: 'gray'});
...
var link1 = ui.Chart(
    [
      ...
      ['<a target="_blank" href=https://bzgeo.users.earthengine.app/view/bzr-forest-cover-pt1>' +
