...
// List Kecamatan
var List_NamProv=Admin.NamProv(1),Prv1,Prv2,
...
Img_Prv = YieldPadi(Met_EVI.select('EVI_Max')).focal_median().toFloat();
...
var Shp_Pilih_Prv = Shp_Adm[0].filter(ee.Filter.eq('NAMA_PROV',List_NamProv[Idx]));
var Nama_Prov = List_NamProv[Idx];
...
Prv1 = StkImgGeom(Img_Prv,'Kw/Ha',Point,Sc,0)[0]; Prv2= Prv1/1.11;
...
function List_ProFeat(Feat,Pro,Opsi) {
