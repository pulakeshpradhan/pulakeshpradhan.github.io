var Bounds = /* color: #00ffff */ee.Geometry.Polygon(
    ...
    imageVisParam = {"opacity":1,"bands":["NDVI"],"min":-0.6637395670637488,"max":-0.09261505361646415,"palette":["fff81d","3bd61f"]},
    imageVisParam2 = {"opacity":1,"bands":["NDVI"],"min":-0.5980840060859919,"max":-0.08620435036718846,"palette":["fff81d","3bd61f","208559"]},
    imageVisParam3 = {"opacity":1,"bands":["NDVI"],"min":-0.19918118329140727,"max":0.3829391572124588,"palette":["1123ff","3bd61f","208559"]},
    ...
    imageVisParam4 = {"opacity":1,"bands":["B3","B2","B1"],"min":0.11564180925488472,"max":0.30654355958104135,"gamma":1},
    imageCollection = ee.ImageCollection("LANDSAT/LC08/C01/T1_RT_TOA"),
    L15 = {"opacity":1,"bands":["B3","B2","B1"],"min":0.07688283345343074,"max":0.21964119886895228,"gamma":2},
    L2005 = {"opacity":1,"bands":["B3","B2","B1"],"min":0.03825215483150446,"max":0.25711349632018193,"gamma":2},
    L1990 = {"opacity":1,"bands":["B3","B2","B1"],"min":0.11564180925488472,"max":0.30654355958104135,"gamma":1.7750000000000001},
    point = /* color: #d63000 */ee.Geometry.Point([63.81405650260581, 38.96018732361036]),
    point1 = /* color: #98ff00 */ee.Geometry.Point([64.71493540885581, 38.16990127571026]),
    aoi_NDVI = 
    /* color: #0b4a8b */
    /* displayProperties: [
      {
    ...
    kunduz = /* color: #98ff00 */ee.Geometry.Polygon(
    ...
    kafernegon = /* color: #6f258b */ee.Geometry.Polygon(
    ...
    amu_darya = /* color: #ffc82d */ee.Geometry.Polygon(
    ...
    NDVI5 = ee.ImageCollection("LANDSAT/LT5_L1T_8DAY_NDVI"),
    NDVI7 = ee.ImageCollection("LANDSAT/LE7_L1T_8DAY_NDVI"),
    NDVI8 = ee.ImageCollection("LANDSAT/LC8_L1T_8DAY_NDVI"),
    kyzyl_suu = ee.FeatureCollection("ft:1TUJTFbvblxhUzRh_-uRt6AMFZkYVMxPdg2zVk0Tt");
