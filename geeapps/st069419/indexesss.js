...
// //панель заголовка
// var panel_main = ui.Panel({style: {height:'70px' ,  width: '400px' ,  position :'top-left'}});
// map.add(panel_main)
...
var modis_date = date()
panel = panel.add(main_name).add(name_data).add(lblstartDate).add(startDate).add(lblendDate).add(endDate).add(button)
