var erhai = ee.FeatureCollection('users/fqqwxc123/Vector_bounds/erhai')
...
app.createPanels = function() {
  ...
  app.intro = {
    panel: ui.Panel([
      ui.Label({
        value: 'Erhai Sentinel 2 Explorer',
        style: {fontWeight: 'bold', fontSize: '24px', margin: '10px 5px'}
      }),
      ui.Label('This app allows you to filter and export images in erhai ' +
  ...
  app.filters = {
    ...
    endDate: ui.Textbox('YYYY-MM-DD', '2021-07-21'),
  ...
  app.picker = {
    ...
    centerButton: ui.Button('Center on Erhai', function() {
      Map.centerObject(erhai,11);
    })
  };
  ...
  app.vis.select.setValue(app.vis.select.items().get(1));
  /* The export section. */
  app.export = {
    button: ui.Button({
...
app.createConstants = function() {
  ...
  app.VIS_OPTIONS = {
    ...
    'Atmospheric (B7/B6/B5)': {
      ...
      visParams: {gamma: 1.3, min: 0, max: 30000, bands: ['B7', 'B6', 'B5']}
    }
  };
};
