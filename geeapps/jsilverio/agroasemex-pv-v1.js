...
//print('Predios', Predios.limit(100));     
...
Map.addLayer(Predios.style(Predios_STYLE), {}, 'PV 2021/2021 AGROASEMEX', 0); //PrediosVigentes
Map.addLayer(PrediosVigentes.style(PrediosVigentes_STYLE), {}, 'PV 2021/2021 AGROASEMEX VIGENTES', 1);
...
panel.filters = {
    ...
    endDate: ui.Textbox('YYYY-MM-DD', '2021-06-11'),
...
function ValoresSuperficie() {
  ...
  SuperficiesTotales = ui.Panel({
    widgets: [
      ...
      ui.Label('Predios Vigentes: ' + PrediosVigentes.size().format("%,.2f").getInfo(0), panel.SECTION_PREDIOS_STYLE),
