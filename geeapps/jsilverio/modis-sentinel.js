...
var S2_Layer = ee.ImageCollection('COPERNICUS/S2_SR')
                .filterDate('2021-01-01', '2021-03-26')   //'2021-03-01', '2021-03-18'    //
...
var S_2 = ee.ImageCollection('COPERNICUS/S2_SR')
                .filterDate('2021-01-01', '2021-03-26')
...
panel.filters = {
    ...
    endDate: ui.Textbox('YYYY-MM-DD', '2021-03-26'),
 ...
 function ValoresPredio() {
  ...
  DatosPredio = ui.Panel({
    widgets: [
      ...
      ui.Label('Predio: ' + ID_AGROASE.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ...
      ui.Label('ClaveTipoP: ' + ClaveTipoP.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ...
      ui.Label('EstadoPred: ' + EstadoPred.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('FechaAcept: ' + FechaAcept.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('FinVigenci: ' + FinVigenci.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('HAS_POLY: ' + HAS_POLY.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ...
      ui.Label('InicioVige: ' + InicioVige.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('MunicipioP: ' + MunicipioP.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('NomTipoCon: ' + NomTipoCon.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('NombreCult: ' + NombreCult.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('NombreFond: ' + NombreFond.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('NombreMone: ' + NombreMone.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('NombreSoci: ' + NombreSoci.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('NombreSubR: ' + NombreSubR.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('PRIMA_FOND: ' + PRIMA_FOND.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('PRIMA_REAS: ' + PRIMA_REAS.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('PRIMA_TOTA: ' + PRIMA_TOTA.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('Ramo: ' + Ramo.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('RegionPred: ' + RegionPred.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('SEPERFICIE: ' + SEPERFICIE.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('SUMAASEGTO: ' + SUMAASEGTO.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ...
      ui.Label('UnidadRies: ' + UnidadRies.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('VERT: ' + VERT.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Label('fechaPago: ' + fechaPago.getInfo(0), panel.SECTION_PREDIOS_STYLE),
      ui.Panel([
      ], ui.Panel.Layout.flow('horizontal'))
    ],
