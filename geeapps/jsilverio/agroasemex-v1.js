var table = ui.import && ui.import("table", "table", {
      "id": "users/jsilverio/VERSION_FINAL_16_03_ACTUAL"
    }) || ee.FeatureCollection("users/jsilverio/VERSION_FINAL_16_03_ACTUAL");
...
function getSelectedPredios() {
  ...
  //print('propertyNames', predio.propertyNames());   //im1.getInfo()
  //print('getInfo', predio.getInfo());
  return predio;
}
