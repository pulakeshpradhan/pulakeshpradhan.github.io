...
panel.filters = {
    ...
    endDate: ui.Textbox('YYYY-MM-DD', '2021-07-01'),
...
function updateOverlay() {
  ...
  Map.layers().set(8, ui.Map.Layer(overlay, {}, 'Predio seleccionado'));
}
...
function clearResults() {
  ...
  DatosPredio = '';
  Map.layers().remove(Map.layers().get(8));
