...
var legendTitle = ui.Label({
  value: 'Tipo de fuente de Energía',
...
var notesPanel2 = ui.Panel({
  ...
  ui.Label({value:'Desarrollo: Fabio Casco', style: noteStyle}),
  ui.Label({value:'E-mail: leofabiop120@hotmail.com', style: noteStyle}),
  ui.Label({value:'Cel: (504) 3285-2656', style: noteStyle}),
...
var panelTitle = ui.Label({
  value: 'Global Power Plant Database',
  ...
  var placeHolder = ui.Label({
    value: 'GPPD: es un prototipo de aplicación para facilitar el uso de datos sobre energía a nivel mudial',
