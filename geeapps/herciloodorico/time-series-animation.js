...
var firms = ee.ImageCollection("COPERNICUS/S2_SR"),
    countries = 
    /* color: #d63000 */
    /* displayProperties: [
      {
    ...
    ee.Geometry.Polygon(
        [[[33.46250401190552, -18.664060438153324],
          [33.46250401190552, -19.040949058140157],
          [33.91843662909302, -19.040949058140157],
          [33.91843662909302, -18.664060438153324]]], null, false);
/***** End of imports. If edited, may not auto-convert in the playground. *****/
var geometry = countries;
Map.centerObject(geometry, 9);
firms = firms.filterBounds(geometry).filterDate('2020-05-01', '2020-05-15').sort('system:time_start', false);
...
firms = firms.sort('system:time_start', true);
...
function addAnimationControls(layers, position, timeStep, width, compact) {
  ...
  var widgets = [ui.Label('Time-Series'), buttonPlayPause, slider, label];
...
function animate(images, options) {
  ...
  var vis = (options && options.vis) || {bands: ['B4', 'B3', 'B2'], max: 3000};
