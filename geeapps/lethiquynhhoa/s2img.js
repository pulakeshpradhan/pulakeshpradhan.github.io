var trainingPoint = ee.FeatureCollection("users/lethiquynhhoa/Myanma/Pyapon_March2018");
//*** GET SENTINEL-2 IMAGEs. CREATED BY HOA LE****/
//Kho sưu tập ảnh Sentinel 2
var S2 = ee.ImageCollection("COPERNICUS/S2") 
var bound_vn = ee.FeatureCollection('ft:1Q1djL_TtPupHG_Q7kqZkRsYkLud5PHD_7ahPgXdw','geometry')
//Add ranh giới Quảng nam vào phần hiển thị bản đồ
Map.addLayer(bound_vn,{},'RG Quang Nam',false)
