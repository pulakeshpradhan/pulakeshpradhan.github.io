var geometry = ui.import && ui.import("geometry", "table", {
      "id": "projects/euphoric-truth-269211/assets/Awash_Basin"
    }) || ee.FeatureCollection("projects/euphoric-truth-269211/assets/Awash_Basin");
/*===========================================================================================
                       SAR-FLOOD MAPPING USING A CHANGE DETECTION APPROACH
  ===========================================================================================
  Credits to https://www.un-spider.org/
  ...
  :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
                                     ABOUT THE SCRIPT
   The flood extent mapping script is modified from United Nations Platform for Space-based Information for Disaster Management and Emergency Response (UN-SPIDER). 
   Please check the original script and tutorial at: https://www.un-spider.org/advisory-support/recommended-practices/recommended-practice-google-earth-engine-flood-mapping/step-by-step
   The code will take you to Chikwawa and Nsanje districts in Malawi, which was affected tropical cyclone Ana in January 2022. 
   Please note, the Chikwawa and Nsanje districts were downloaded from the "https://data.humdata.org/dataset/cod-ab-mwi" webiste.
/* 
   :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
                                       SET TIME FRAME
...
var before_end='2021-12-31';
// Now set the same parameters for AFTER the flood.
var after_start='2021-05-01';
var after_end='2021-08-31';
/********************************************************************************************
...
var title = ui.Label('Awash Basin Results', titleTextVis);
...
var text2 = ui.Label('Estimated flood extent in Awash Basin:',textVis);
...
var text5 = ui.Label('Estimated affected urban areas in Awash Basin:',textVis);
...
// Disclaimer
var text6 = ui.Label('Disclaimer: This product has been derived automatically without validation data. All geographic information has limitations due to the scale, resolution, date and interpretation of the original source materials. No liability concerning the content or the use thereof is assumed by the producer (afotesfaye@gmail.com) .',subTextVis)
// Produced by...
var text7 = ui.Label(' Produced by Afework Mekeberiaw ,GIS and Remote sensing(Geo_spatial) consultant - Addis Ababa, Ethiopia Script produced by: UN-SPIDER December 2019 and Mr Courafe Kamusoko adopted his AOI. Floods in Addis Ababa happend during this season could be a supportive on this link https://floodlist.com/africa/ethiopia-floods-addis-ababa-august-2021' , subTextVis)
...
value: 'Exposed population density in Awash Basin',
style: {
fontWeight: 'bold',
fontSize: '15px',
margin: '10px 0 0 0',
