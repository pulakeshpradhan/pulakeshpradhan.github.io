var poligono = ui.import && ui.import("poligono", "table", {
...
var dataset99 = ee.ImageCollection("LANDSAT/LT05/C02/T1_TOA")
  ...
  .filter(ee.Filter.lt('CLOUD_COVER', 15))
            ...
            // var mndwi = bandas_op.normalizedDifference(["SR_B3", "SR_B6"])
                          return imagen.addBands(ndvi).clip(poligono)
             .copyProperties(imagen, ["system:time_start", "system:index"])
           })
Map.centerObject(poligono,11);
...
var dataset09 = ee.ImageCollection("LANDSAT/LT05/C02/T1_TOA")
  .filterDate('2009-01-01', '2010-05-30')
  .filterBounds(poligono)
...
var cuenca_etiqueta_99 = ui.Label("Janamora Watershed  LANDSAT-5 in 1999")
cuenca_etiqueta_99.style().set("position", "bottom-left")
var cuenca_etiqueta_09 = ui.Label("Janamora Watershed LANDSAT-5  in 2009")
...
derecha.setCenter(38.1415, 13.047,11)