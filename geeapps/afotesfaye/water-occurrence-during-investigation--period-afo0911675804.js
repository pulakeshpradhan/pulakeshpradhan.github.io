var aoi = ui.import && ui.import("aoi", "geometry", {
    ...
    ee.Geometry.Polygon(
        [[[37.21585196952613, 11.64438915326405],
          [37.21585196952613, 11.497742649498159],
          [37.57840079765113, 11.497742649498159],
          [37.57840079765113, 11.64438915326405]]], null, false);
...
.filterDate('2015-11-01','2022-10-31')
...
function makeLegend(lowLine, midLine, highLine,lowText, midText, highText, palette) {
  var  labelheader = ui.Label('Water occurrence during investigation period in Tana',{margin: '5px 17px', textAlign: 'center', stretch: 'horizontal', fontWeight: 'bold'});
