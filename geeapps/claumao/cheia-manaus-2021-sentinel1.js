...
var images = {
  'Seca-11/20': getWeeklySentinelComposite('2020-11-01'),
  'Cheia-07/21': getWeeklySentinelComposite('2021-07-01')
};
...
function getWeeklySentinelComposite(date) {
  ...
  var sentinel1 = ee.ImageCollection('COPERNICUS/S1_GRD')
                      ...
                      .select(polarization)
                      .mean();
  return sentinel1.visualize({min: -25, max: 0, palette: ['2348ff','25f5ff','31ff4a','249b27','ff7d0e','ff2806']});
}
/*
...
function addLayerSelector(mapToChange, defaultValue, position) {
  var label = ui.Label('Escolha o Período');
...
leftMap.setCenter(-60.0085, -3.1418, 12);