...
var header = ui.Label('CONUS Land Disturbance', {fontSize: '36px', color: 'red'});
var text = ui.Label(
    'Land disturbance products over CONUS between 1985 and 2020 based on the COLD and ODACA algotithems and the Landsat time series.',
    {fontSize: '11px'});
