var geometry = ui.import && ui.import("geometry", "geometry", {
    ...
    ee.Geometry.Polygon(
        [[[35.97172708667898, 0.7550999838577104],
          [35.97172708667898, 0.49419042250432205],
          [36.18596048511648, 0.49419042250432205],
          [36.18596048511648, 0.7550999838577104]]], null, false);
/*===========================================================================================
...
//var geometry = ee.Geometry.Polygon([[[35.97172708667898,0.49419042250432205],[36.18596048511648,0.49419042250432205],[36.18596048511648,0.7550999838577104],[35.97172708667898,0.7550999838577104],[35.97172708667898,0.49419042250432205]]]);
...
var before_end='2020-06-01';
// Now set the same parameters for AFTER the flood.
var after_start='2020-07-01';
var after_end='2020-08-11';
/********************************************************************************************
...
//Export.image.toDrive({
  ...
  //description: 'Flood_before',
  //fileNamePrefix: 'floodedbefore',
  //region: aoi, 
  //maxPixels: 1e10
//});
//Export.image.toDrive({
  //image: after_filtered, 
  //description: 'Flood_after',
  //fileNamePrefix: 'floodedafter',
  //region: aoi, 
  //maxPixels: 1e10
//});
Export.image.toDrive({
...
// Disclaimer
var text6 = ui.Label('The maps used do not imply the expression of any opinion on the part of the Kenya Red Cross Society concerning the legal status of a territory or of its authorities.',subTextVis)
// Produced by...
var text7 = ui.Label('Script produced by: UN-SPIDER December 2019 - Implemented by Geda', subTextVis)
