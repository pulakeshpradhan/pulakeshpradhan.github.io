...
var layerProperties = {
  'Year of Loss': {
    name: 'lossyear',
    visParams: {min: 0, max: 17, palette: ['blue','white','yellow', 'orange', 'red']},
    legend: [
      {'2016': 'red'}, {'...': 'orange'}, {'2008':'yellow'},{'..':'white'},{'2000': 'blue'},
  ...
  'Gain':{
    ...
    legend:
         [{'Gain': 'green'}, {'No Gain': 'white'}, {'Water or no data': 'grey'}],
    defaultVisibility:true
  }
};
...
var locationDict = {
  ...
  'California':{lon:-119.413, lat: 34.450, zoom: 9}
};
/*
...
var linkPanel2 = ui.Panel(
    [ui.Label('Hansen Global Forest Change v1.8 (2000-2020)', {fontWeight: 'bold'}), link2]);
