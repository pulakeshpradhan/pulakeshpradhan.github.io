...
app.createPanels = function() {
  ...
  app.filters = {
    ...
    endDate: ui.Textbox('YYYY-MM-DD', '2020-10-01'),
    cloud: ui.Textbox('50'),
  ...
  app.filters.panel = ui.Panel({
    widgets: [
      ...
      ui.Label('Cloud  <', app.HELPER_TEXT_STYLE), app.filters.cloud,
...
app.createHelpers = function() {
  ...
  app.applyFilters = function() {
    ...
    var cloud = app.filters.cloud.getValue();
    if (cloud) cloud = ee.Number.parse(cloud);
    if (cloud) filtered = filtered.filter(ee.Filter.lte('CLOUD_COVER', cloud));
...
app.createConstants = function() {
  ...
  app.VIS_OPTIONS = {
    'False color (B7/B6/B4)': {
      ...
      visParams: {gamma: 1.3, min: 0, max: 3000, bands: ['B7', 'B6', 'B4']}
    },
...
app.boot = function() {
  ...
  Map.setCenter(109.844, 21.461, 9);
