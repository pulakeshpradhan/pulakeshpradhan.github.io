var geometry = ui.import && ui.import("geometry", "geometry", {
      ...
      "locked": false
        ...
        [[[-122.02973943973412, 36.97193170394595],
          [-122.13960272098412, 37.278516931694234],
          [-122.30165106082787, 37.30692251135359],
          [-122.40602117801537, 37.217299264141104],
          [-122.18629461551537, 37.004839497408156],
          [-122.10939031864037, 36.96315388815612]]]);
//===========================================================================================
...
var prefire_start = '2020-08-01';   
var prefire_end = '2020-08-15';
// Now set the same parameters for AFTER the fire.
var postfire_start = '2020-09-20';
var postfire_end = '2020-09-25';
//*******************************************************************************************
...
Map.addLayer(pre_cm_mos, vis);
Map.addLayer(post_cm_mos, vis);
var leftMap = ui.Map()
var rightMap = ui.Map()
var before = ui.Map.Layer(pre_cm_mos, vis)
var after = ui.Map.Layer(post_cm_mos, vis)
var beforelayer = leftMap.layers()
var afterlayer = rightMap.layers()
beforelayer.add(before)
afterlayer.add(after)
