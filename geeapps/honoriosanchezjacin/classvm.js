...
var trained_svm = ee.Classifier.svm().train({
  features: training, 
  classProperty: 'clase', 
  inputProperties: bands
});    
var trained_RF = ee.Classifier.randomForest().train({
  features: training, 
  classProperty: 'clase', 
  inputProperties: bands
});    
...
Map.addLayer(classified_svm, imaParam, 'clasificacion RF');
Map.addLayer(classified_RF, imaParam,'clasificacion SVM');
var trainAccuracy = trained_svm.confusionMatrix();
print('Matriz de confusión RF: ', trainAccuracy);
print('Entrenamiento de precisión general RF: ', trainAccuracy.accuracy());
var trainAccuracy2 = trained_RF.confusionMatrix();
...
var trainedClassifier_RF = ee.Classifier.randomForest().train({
  features: trainingPartition,
 classProperty: 'clase',
  inputProperties: bands
});
var trainedClassifier_SVM = ee.Classifier.svm().train({
  features: trainingPartition,
 classProperty: 'clase',
  inputProperties: bands
});
