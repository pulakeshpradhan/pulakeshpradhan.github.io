var table = ui.import && ui.import("table", "table", {
      "id": "users/alfirdazahra/Prov_JKT"
    }) || ee.FeatureCollection("users/alfirdazahra/Prov_JKT");
...
var aoi = ee.FeatureCollection("users/alfirdazahra/Prov_JKT");
...
//Membuat Judul
var title = ui.Label({
  value: 'Analisis Dampak Bencana Banjir Provinsi DKI Jakarta 2020',
  style:{
  fontWeight: 'bold',
  fontSize: '25px'
  }});
...
// Diolah oleh...
var text7 = ui.Label('Script dasar dibuat oleh: UN-SPIDER pada Desember 2019 dan dimodifikasi oleh by ALFIRDA ZAHRA CESARAH pada November 2021 untuk Analisis Banjir Provinsi DKI Jakarta', subTextVis)
