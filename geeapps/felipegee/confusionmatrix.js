var table = ui.import && ui.import("table", "table", {
      "id": "users/felipegee/poligonos_entrenamiento/prueba"
    }) || ee.FeatureCollection("users/felipegee/poligonos_entrenamiento/prueba"),
    image = ui.import && ui.import("image", "image", {
      "id": "users/felipegee/imagenes_prueba/2019-03-16__2019-04-01_rgb"
    }) || ee.Image("users/felipegee/imagenes_prueba/2019-03-16__2019-04-01_rgb"),
    ...
    vegetation = ui.import && ui.import("vegetation", "geometry", {
      ...
      "shown": true,
      "locked": false
    }) || /* color: #3b8b00 */ee.FeatureCollection(
        [ee.Feature(
    ...
    water = ui.import && ui.import("water", "geometry", {
      ...
      "shown": true,
      "locked": false
    }) || /* color: #0300ff */ee.FeatureCollection(
        [ee.Feature(
    ...
    fcollection = ui.import && ui.import("fcollection", "table", {
      "id": "users/felipegee/poligonos_entrenamiento/prueba"
    }) || ee.FeatureCollection("users/felipegee/poligonos_entrenamiento/prueba"),
    pastizales = ui.import && ui.import("pastizales", "geometry", {
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [
      ...
      "shown": true,
      "locked": false
    }) || /* color: #8b1536 */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
                [[[-95.76282728033553, 18.779811436729716],
                  [-95.76295066195021, 18.779671768814186],
                  [-95.76259929256926, 18.77955749497902]]]),
            {
              "LandCover": 3,
              "system:index": "0"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-95.76216209249984, 18.779826673222576],
                  [-95.76227474527846, 18.779615901615557],
                  [-95.76199579554091, 18.77950670658294],
                  [-95.76198506670485, 18.77975049074444]]]),
            {
              "LandCover": 3,
              "system:index": "1"
            })]);
//Map.addLayer(image);
//Map.addLayer(table);
Map.addLayer(fcollection,{},'poligonos');
// Landsat 8 scaled radiance image collection.
...
var split = 0.7;  //70% entrenamiento , 30% testing
var trainingPartition = withRandom.filter(ee.Filter.lt('random', split));
var testingPartition = withRandom.filter(ee.Filter.gte('random', split));
// Se entrena con el 70% de los datos.
var trainedClassifier = ee.Classifier.smileRandomForest(8).train({
...
Map.addLayer(classified, {min: 0, max: 2, palette: ['red', 'green', 'blue']},'clasificada');
// Clasifica el FeatureCollection de test. 30%
var test = testingPartition.classify(trainedClassifier);
// Matriz de confusion
var confusionMatrix = test.errorMatrix(classProperty, 'classification');
print('Confusion Matrix', confusionMatrix);
print('Accuracy:', confusionMatrix.accuracy());
//Para exportar los resultados finales
