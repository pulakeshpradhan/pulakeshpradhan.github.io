...
var Nama_KotaKabupaten = ['Kota Bandung', 'Cimahi']
...
Map.addLayer(LST_View.clip(KotaKabupaten), imageVisParam,'Land Surface Temperature'); 
var LST = MOD11A1
.filter(ee.Filter.date('2018-01-01', '2019-12-30'))
.select('LST_Day_1km');
var MOD11A1TimeSeries = ui.Chart.image.seriesByRegion(LST, KotaKabupaten, ee.Reducer.mean(),'',
