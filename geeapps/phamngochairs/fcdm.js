// *********************************************************************************************************************************************************
//              Forest Canopy Disturbance Monitoring (FCDM Tool) (former Delta-rNBR, Version 2.4)
//              Công cụ theo dõi nhiễu động tán rừng từ dữ liệu viễn thám đa thời gian
// *********************************************************************************************************************************************************
// 
...
//  * Modify: Pham Ngoc Hai, FIPI, 2019, phamngochairs@gmail,com
//
//**********************************************************************************************************************************************************
// *********************************************************************************************************************************************************
...
var Header = ui.Label('Forest Canopy Disturbance Monitoring (FCDM) - Công cụ theo dõi nhiễu động tán rừng từ dữ liệu viễn thám đa thời gian',{fontWeight: 'bold', fontSize: '20px', textAlign: 'center'});
var Subheader1 = ui.Label('Thờ kỳ theo dõi:',{fontWeight: 'bold'});
...
var Subheader2 = ui.Label('Thời kỳ tham chiếu:',{fontWeight: 'bold'});
...
var label_Index_select = ui.Label('Chỉ số theo dõi:',{fontWeight: 'bold'});
var Index_select = ui.Select({
  items: [
    {label: 'NBR (Cho rừng thường xanh)', value: 'NBR'},{label: 'NDII (SWIR 1)', value: 'NDII'},{label: 'NDVI', value: 'NDVI'},{label: 'NDVI (atmosphere)', value: 'NDVI_atmosphere'},{label: 'NDWI (green)', value: 'NDWI_green'},
...
var label_Sensor_select = ui.Label('Loại ảnh viễn thám:',{fontWeight: 'bold'});
...
var label_countryname_select = ui.Label('Tỉnh, hoặc vùng quan tâm:',{fontWeight: 'bold'});
var countryname_select = ui.Select({
items: [{label:'Hà Giang', value:'ha giang'},{label:'Cao Bằng', value:'cao bang'},{label:'Lạng Sơn', value:'lang son'}, {label:'Quảng Ninh', value:'quang ninh'},
{label:'Lào Cai', value:'lao cai'},{label:'Bắc Kạn', value:'bac can'},{label:'Tuyên Quang', value:'tuyen quang'},{label:'Yên Bái', value:'yen bai'}, 
{label:'Phú Thọ', value:'phu tho'},{label:'Thái Nguyên', value:'thai nguyen'},{label:'Vĩnh Phúc', value:'vinh phuc'},{label:'Bắc Giang', value:'bac giang'},
{label:'Tp. Hà Nội', value:'ha noi'},{label:'Thái Bình', value:'thai binh'},{label:'Bắc Ninh', value:'bac ninh'},{label:'Hải Dương', value:'hai duong'},{label:'Hải Phòng', value:'hai phong'},{label:'Nam Định', value:'nam dinh'}, 
{label:'Hà Nam', value:'ha nam'},{label:'Ninh Bình', value:'ninh binh'},{label:'Lai Châu', value:'lai chau'},{label:'Điện Biên', value:'dien bien'}, 
{label:'Sơn La', value:'son la'},{label:'Hòa Bình', value:'hoa binh'},{label:'Thanh Hóa', value:'thanh hoa'},{label:'Nghệ An', value:'nghe an'}, 
{label:'Hà Tĩnh', value:'ha tinh'},{label:'Quảng Bình', value:'quang binh'},{label:'Quảng Trị', value:'quang tri'},{label:'Thừa Thiên Huế', value:'thua thien hue'}, 
{label:'Đà Nẵng', value:'da nang'},{label:'Quảng Nam', value:'quang nam'},{label:'Quảng Ngãi', value:'quang ngai'},{label:'Bình Định', value:'binh dinh'}, 
{label:'Phú Yên', value:'phu yen'},{label:'Khánh Hòa', value:'khanh hoa'},{label:'Ninh Thuận', value:'ninh thuan'},{label:'Bình Thuận', value:'binh thuan'}, 
{label:'Kon Tum', value:'kon tum'},{label:'Gia Lai', value:'gia lai'},{label:'Đăk Lăk', value:'dak lak'},{label:'Đăk Nông', value:'dak nong'}, 
{label:'Lâm Đồng', value:'lam dong'},{label:'Bình Phước', value:'binh phuoc'},{label:'Tây Ninh', value:'tay ninh'},{label:'Bình Dương', value:'binh duong'}, 
{label:'Đồng Nai', value:'dong nai'},{label:'Bà Rịa Vũng Tàu', value:'ban ria vung tau'},{label:'Tp. Hồ Chí Minh', value:'ho chi minh'},{label:'Long An', value:'long an'}, 
{label:'Đồng Tháp', value:'dong thap'},{label:'An Giang', value:'an giang'},{label:'Tiền Giang', value:'tien giang'},{label:'Hậu Giang', value:'hau giang'}, 
{label:'Bến Tre', value:'ben tre'},{label:'Trà Vinh', value:'tra vinh'},{label:'Sóc Trăng', value:'soc trang'},{label:'Bạc Liêu', value:'bac lieu'}, 
{label:'Cà Mau', value:'ca mau'},{label:'Kiên Giang', value:'kien giang'}],
	value: 'quang ninh',
  onChange: function(value) {
...
var label_zoomlevel_select = ui.Label('Mức độ thu phóng (1 - 24):');
...
var cloudmasking = ui.Label('Tham số cho lọc mây:',{fontWeight: 'bold'});
...
var Label_forest_mask_selection = ui.Label('Lựa chọn bản đồ rừng:',{fontWeight: 'bold'});
var forest_mask_selection  = ui.Select({
  items: [
    ...
    {label: 'Bản đồ Hansen(2010 - 2020)', value: 'Hansen_map'}],
  value: 'Hansen_map',
  onChange: function(value) {
...
var label_forest_mask_year_selection = ui.Label('Năm có bản đồ Hansen (2010-2018):');
...
var label_hansen_treecover_selection = ui.Label('Lựa chọn độ che phủ (0 - 100%):');
...
var label_exporting = ui.Label('Tùy chọn xuất dữ liệu:',{fontWeight: 'bold'});
var export_selection = ui.Checkbox({
  label: 'Xuất dữ liệu Delta-rNBR', 
  value: false,
  onChange: function(value) {
...
var export_selection_singleNBRs = ui.Checkbox({
  label: '... Xuất thêm chỉ số rNBRs riêng lẻ', 
  value: false,
  onChange: function(value) {
...
var export_selection_singleNBRdates = ui.Checkbox({
  label: '... Xuất thêm ngày có chỉ số rNBRs riêng lẻ', 
  value: false,
  onChange: function(value) {
...
var runFCDM = function(){
    ...
    // *********************************************************************************************************************************************************    
    // Masking Step S2_1: Masking for clouds and cloud shadows (Sentinel-2) ************************************************************************************
    ...
    var Masking_2 = function(image,forest_mask,hansen_treecover,forest_mask_year_select,forest_mask_select,band_1,band_2) {
      ...
      if (forest_mask_select === 'No_forest_map'){
        var OUT = image.updateMask(forest_mask.eq(1));
      }
      if (forest_mask_select === 'Roadless_map'){
        var forest_mask_year_select_inc = forest_mask_year_select+1;
        var OUT = image.updateMask((forest_mask.select(ee.String('Jan'+forest_mask_year_select_inc)).eq(1)).
      ...
      if (forest_mask_select === 'Hansen_map'){
        var OUT = image.updateMask(forest_mask.gte(hansen_treecover));
      }
      return OUT;
    };
    ...
    // *********************************************************************************************************************************************************
    var country = ee.FeatureCollection("users/phamngochairs/VN_vec/VN_province").filterMetadata('name','equals',countryname); // Country border polygons of high accuracy
    ...
    if (Sensor === 'L8' || Sensor === 'L78'){
      ...
      buffer(-500)),forest_mask,hansen_treecover,forest_mask_year_select,forest_mask_select,BANDS,band_1,band_2)});
    ...
    if (Sensor === 'S2'){
     ...
     var AnnualMedian1618 = ee.ImageCollection('COPERNICUS/S2').filterDate(start_date,end_date)  //
      ...
      buffer(-50)),forest_mask,hansen_treecover,forest_mask_year_select,forest_mask_select,BANDS,band_1,band_2)});
    ...
    // ORIGINAL
      var Imagecollection_base_2 = Imagecollection_base
      .map(function(image){return IFORCE_PINO_step2(image.clip(image.geometry()),AnnualMedian1618,true,cloud_buffer,false)}).select([band_1,band_2],['Band_1','Band_2']);
      var Imagecollection_second_2 = Imagecollection_second
      .map(function(image){return IFORCE_PINO_step2(image.clip(image.geometry()),AnnualMedian1618,true,cloud_buffer,false)}).select([band_1,band_2],['Band_1','Band_2']);
      // Calculation of single scenes of Base-NBR **************************************************************************************************************
      var NBR_Imagecollection_base = Imagecollection_base_2.map(NBR);
        ...
        fileFormat: 'CSV'
            ...
            if (Sensor === 'L8' || Sensor === 'L78'){
              Export.image.toDrive({
                ...
                description: 'Delta-r'+Index+'_L8_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                scale: resolution,
                maxPixels: 1e13,
                skipEmptyTiles: true,
              ...
              if (export_select_singleNBRs === true){
                Export.image.toDrive({
                  ...
                  description: 'r'+Index+'_reference_L8_'+countryname.replace(/ /g,'')+'_'+Start_base+'--'+End_base,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo()
                ...
                Export.image.toDrive({
                  ...
                  description: 'r'+Index+'_analysis_L8_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo()
              ...
              if (export_select_singleNBRdates === true){
                Export.image.toDrive({
                  ...
                  description: 'Date_reference_L8_'+countryname.replace(/ /g,'')+'_'+Start_base+'--'+End_base,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo()
                ...
                Export.image.toDrive({
                  ...
                  description: 'Date_analysis_L8_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo()
            ...
            if (Sensor === 'L7' || Sensor === 'L78' || Sensor === 'L57'){
              Export.image.toDrive({
                ...
                description: 'Delta-r'+Index+'_L7_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                scale: resolution,
                maxPixels: 1e13,
                skipEmptyTiles: true,
                region: studyarea.geometry().bounds().getInfo() 
              ...
              if (export_select_singleNBRs === true){
                Export.image.toDrive({
                  ...
                  description: 'r'+Index+'_reference_L7_'+countryname.replace(/ /g,'')+'_'+Start_base+'--'+End_base,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo()
                ...
                Export.image.toDrive({
                  ...
                  description: 'r'+Index+'_analysis_L7_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo()
              ...
              if (export_select_singleNBRdates === true){
                Export.image.toDrive({
                  ...
                  description: 'Date_reference_L7_'+countryname.replace(/ /g,'')+'_'+Start_base+'--'+End_base,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo()
                ...
                Export.image.toDrive({
                  ...
                  description: 'Date_analysis_L7_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo()
            ...
            if (Sensor === 'L5' || Sensor === 'L57'){
              Export.image.toDrive({
                ...
                description: 'Delta-r'+Index+'_L5_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                scale: resolution,
                maxPixels: 1e13,
                skipEmptyTiles: true,
                region: studyarea.geometry().bounds().getInfo() 
              ...
              if (export_select_singleNBRs === true){
                Export.image.toDrive({
                  ...
                  description: 'r'+Index+'_reference_L5_'+countryname.replace(/ /g,'')+'_'+Start_base+'--'+End_base,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo() 
                ...
                Export.image.toDrive({
                  ...
                  description: 'r'+Index+'_analysis_L5_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo() 
              ...
              if (export_select_singleNBRdates === true){
                Export.image.toDrive({
                  ...
                  description: 'Date_reference_L5_'+countryname.replace(/ /g,'')+'_'+Start_base+'--'+End_base,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo() 
                ...
                Export.image.toDrive({
                  ...
                  description: 'Date_analysis_L5_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo() 
            ...
            if (Sensor === 'L4' || Sensor === 'L45'){
              Export.image.toDrive({
                ...
                description: 'Delta-r'+Index+'_L4_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                scale: resolution,
                maxPixels: 1e13,
                skipEmptyTiles: true,
                region: studyarea.geometry().bounds().getInfo()  
              ...
              if (export_select_singleNBRs === true){
                Export.image.toDrive({
                  ...
                  description: 'r'+Index+'_reference_L4_'+countryname.replace(/ /g,'')+'_'+Start_base+'--'+End_base,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo()  
                ...
                Export.image.toDrive({
                  ...
                  description: 'r'+Index+'_analysis_L4_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo()  
              ...
              if (export_select_singleNBRdates === true){
                Export.image.toDrive({
                  ...
                  description: 'Date_reference_L4_'+countryname.replace(/ /g,'')+'_'+Start_base+'--'+End_base,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo()  
                ...
                Export.image.toDrive({
                  ...
                  description: 'Date_analysis_L4_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                  scale: resolution,
                  maxPixels: 1e13,
                  skipEmptyTiles: true,
                  region: studyarea.geometry().bounds().getInfo()  
            ...
            if (Sensor === 'L78'){
              Export.image.toDrive({
                ...
                description: 'Delta-r'+Index+'_L78_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                scale: resolution,
                maxPixels: 1e13,
                skipEmptyTiles: true,
                region: studyarea.geometry().bounds().getInfo()   
            ...
            if (Sensor === 'L57'){
                ...
                description: 'Delta-r'+Index+'_L57_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                scale: resolution,
                maxPixels: 1e13,
                skipEmptyTiles: true,
                region: studyarea.geometry().bounds().getInfo()   
            ...
            if (Sensor === 'L45'){
                ...
                description: 'Delta-r'+Index+'_L45_'+countryname.replace(/ /g,'')+'_'+Start_second+'--'+End_second,
                scale: resolution,
                maxPixels: 1e13,
                skipEmptyTiles: true,
                region: studyarea.geometry().bounds().getInfo()   
