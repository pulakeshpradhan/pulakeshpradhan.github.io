var polygon = ui.import && ui.import("polygon", "table", {
      "id": "users/deka/KABUPATEN_DEMAK"
    }) || ee.FeatureCollection("users/deka/KABUPATEN_DEMAK");
...
var after_start='2021-02-01';
var after_end='2021-02-28';
//Menentukan parameter
var polarization = "VH";
var pass_direction = "DESCENDING";
var difference_threshold = 1.1;
//Mengubah nama polygon 
...
//Membuat Judul
var title = ui.Label({
  value: 'Analisis Dampak Bencana Banjir Kabupaten Demak 2021',
  style:{
  fontWeight: 'bold',
  fontSize: '25px'
  }});
...
// Diolah oleh...
var text7 = ui.Label('Script dasar dibuat oleh: UN-SPIDER pada Desember 2019 dan dimodifikasi oleh Deka Alif Renaldy pada Juni 2021 untuk Analisis Banjir Kabupaten Demak', subTextVis)
