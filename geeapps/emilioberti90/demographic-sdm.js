Map.setCenter(-100, 40, 4.2);
// BIO 06
var visParsTemp = {
  min: 1,
  max: 1.2,
  palette: ['#d53e4f','#f46d43','#fdae61', 
            '#fee08b','#ffffbf','#e6f598',
            '#abdda4','#66c2a5','#3288bd']
};
var sp1_const = ee.Image('users/emilioberti90/species-bio06-constant');
var sp1_var = ee.Image('users/emilioberti90/species-bio06-variable');
...
var sp2_const = ee.Image('users/emilioberti90/species-bio12-constant');
var sp2_var = ee.Image('users/emilioberti90/species-bio12-variable');
...
var choice = ui.Select({
  ...
  if (value == 'Species 1') {
    ...
    var sp1_map_var = ui.Map.Layer(sp1_var, visParsTemp, 'LTSGR - variable environment', true);
    ...
    var sp3_map_noac = ui.Map.Layer(two_noac, visParsTwo, 'LTSGR - without autocorrelation', true);
