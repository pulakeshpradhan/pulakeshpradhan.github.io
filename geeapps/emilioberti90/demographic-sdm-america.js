...
var sp1_const = ee.Image('users/emilioberti90/demography/species-1-constant-america').mask(water);
var sp1_var = ee.Image('users/emilioberti90/demography/species-1-variable-america').mask(water);
...
var sp2_const = ee.Image('users/emilioberti90/demography/species-2-constant-america').mask(water);
var sp2_var = ee.Image('users/emilioberti90/demography/species-2-variable-america').mask(water);
...
var choice = ui.Select({
  ...
  if (value == 'Species 1') {
    ...
    var sp3_map_nocovar = ui.Map.Layer(two_nocovar, visParsTwo, 'LTSGR - without covariance', true);
    var sp3_map_noac = ui.Map.Layer(two_noac, visParsTwo, 'LTSGR - without autocorrelation', false, 0.75);
    var sp3_map_var = ui.Map.Layer(two_var, visParsTwo, 'LTSGR - variable environment', false, 0.75);
