...
var cuenca = ee.FeatureCollection("users/jorgerdzuaslp11/Cuenca_26296")
...
var cuenca_etiqueta_99 = ui.Label({
    value:"Imagen LANDSAT 5 de 1999 para la cuenca 26296",
    style:{
      fontSize: "18px",
      color: "indigo",
...
var cuenca_etiqueta_09 = ui.Label({
  value: "Imagen LANDSAT 5 de 2009 para la cuenca 26296",
      style:{
      fontSize: "18px",
      color: "indigo",
      backgroundColor: "yellow"  }
...
derecha.setCenter(-100.2686, 22.0312,12)