var geometry = ui.import && ui.import("geometry", "geometry", {
    ...
    /* shown: false */
    ee.Geometry.Polygon(
        [[[-47.776940643519254, -0.3217419647261326],
          [-48.139489471644254, -0.7062472549924746],
          [-47.183678924769254, -1.0138294182321916],
          [-46.579430877894254, -1.200562042884434],
          [-46.041100799769254, -1.3653155972647892],
          [-45.623620331019254, -1.6398790926064726],
          [-45.206139862269254, -1.8155803609025827],
          [-44.887536346644254, -1.9034246941511086],
          [-44.700768768519254, -2.254755208802064],
          [-44.492028534144254, -2.4633184230930216],
          [-44.217370331019254, -2.331597912430249],
          [-44.360192596644254, -1.8595030740916376],
          [-44.678796112269254, -1.4092480278093757],
          [-45.019372284144254, -1.1785941223974163],
          [-45.316003143519254, -1.200562042884434],
          [-45.645592987269254, -1.0577675488022906],
          [-46.205895721644254, -0.8051155959941269],
          [-46.952966034144254, -0.5085045581017459],
          [-47.513268768519254, -0.34371425034418956],
          [-47.776940643519254, -0.3217419647261326]]]);
...
var ext2009 = ui.Map.Layer(extent2009, {palette:['34BFDE'], min:1, max:1}, 'Extent 2009',false)
var ext2019 = ui.Map.Layer(extent2019, {palette:['71F4B7'], min:1, max:1}, 'Extent 2019',false)
...
//Titulo de la APP
var header = ui.Label('Altura, Extensión, Y cambio de Manglares en el litoral Norte Brasileño', 
            {fontSize: '25px', fontWeight: 'bold', color: '4A997E'});
//Resumen de la APP
var text = ui.Label(
  'Esta herramienta mapea la extensión de los manglares en el litoral norte Brasileño en 2000, 2009, y 2020 usando una clasificación Random Forest a partir de imagenes Landsat. ' +
