var geometrya = ui.import && ui.import("geometrya", "table", {
      "id": "users/auliarahma/jaktim"
    }) || ee.FeatureCollection("users/auliarahma/jaktim"),
    ...
    ee.Geometry.Polygon(
        [[[108.81224933537096, -6.701707254963438],
          [108.81224933537096, -7.090263032908284],
          [109.28603473576159, -7.090263032908284],
          [109.28603473576159, -6.701707254963438]]], null, false);
/*===========================================================================================
  ...
  ===========================================================================================
*/
var before_start= '2020-12-20';
var before_end='2020-12-30';
// Now set the same parameters for AFTER the flood.
var after_start='2020-12-31';
var after_end='2021-01-10';
//********************************************************************************************
var polarization = "VV"; 
var pass_direction = "ASCENDING";
var difference_threshold = 1.2;
...
var palette =['#0000FF', '#30b21c', '#8d35d6'];
// name of the legend
