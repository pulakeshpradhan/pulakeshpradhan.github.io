var Punjab_roi = ee.FeatureCollection("users/prakhar/Shapefiles/punjab_admin");
...
firms = firms.filterBounds(geometry).filterDate('2019-10-01', '2019-11-30').sort('system:time_start', false);
...
var labeltext = "Punjab residue Fire 2019";
