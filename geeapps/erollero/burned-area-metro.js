var table2 = ui.import && ui.import("table2", "table", {
    ...
    image27 = ui.import && ui.import("image27", "image", {
      "id": "users/erollero/HDIChile/Santiago/lulcsantiago"
    }) || ee.Image("users/erollero/HDIChile/Santiago/lulcsantiago"),
    table7 = ui.import && ui.import("table7", "table", {
      "id": "users/erollero/HDIChile/Santiago/comunas"
    }) || ee.FeatureCollection("users/erollero/HDIChile/Santiago/comunas"),
    image25 = ui.import && ui.import("image25", "image", {
      "id": "users/erollero/HDIChile/Santiago/hidricosmetro"
    }) || ee.Image("users/erollero/HDIChile/Santiago/hidricosmetro"),
    redvial = ui.import && ui.import("redvial", "table", {
      "id": "users/erollero/HDIChile/Santiago/redvialmet"
    }) || ee.FeatureCollection("users/erollero/HDIChile/Santiago/redvialmet"),
    image5 = ui.import && ui.import("image5", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet01"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet01"),
    image6 = ui.import && ui.import("image6", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet02"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet02"),
    image7 = ui.import && ui.import("image7", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet03"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet03"),
    image8 = ui.import && ui.import("image8", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet04"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet04"),
    image9 = ui.import && ui.import("image9", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet05"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet05"),
    image10 = ui.import && ui.import("image10", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet06"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet06"),
    image11 = ui.import && ui.import("image11", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet07"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet07"),
    image12 = ui.import && ui.import("image12", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet08"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet08"),
    image13 = ui.import && ui.import("image13", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet09"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet09"),
    image14 = ui.import && ui.import("image14", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet10"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet10"),
    image15 = ui.import && ui.import("image15", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet11"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet11"),
    image16 = ui.import && ui.import("image16", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet12"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet12"),
    image17 = ui.import && ui.import("image17", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet13"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet13"),
    image18 = ui.import && ui.import("image18", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet14"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet14"),
    image19 = ui.import && ui.import("image19", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet15"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet15"),
    image20 = ui.import && ui.import("image20", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet16"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet16"),
    image21 = ui.import && ui.import("image21", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet17"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet17"),
    image22 = ui.import && ui.import("image22", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet18"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet18"),
    image23 = ui.import && ui.import("image23", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet19"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet19"),
    image24 = ui.import && ui.import("image24", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmet20"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmet20"),
    image4 = ui.import && ui.import("image4", "image", {
      "id": "users/erollero/HDIChile/Santiago/burnmetroto0021"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burnmetroto0021"),
    image3 = ui.import && ui.import("image3", "image", {
      "id": "users/erollero/HDIChile/Santiago/frecmetroval0021"
    }) || ee.Image("users/erollero/HDIChile/Santiago/frecmetroval0021"),
    image = ui.import && ui.import("image", "image", {
      "id": "users/erollero/HDIChile/Santiago/frecmetroval1021"
    }) || ee.Image("users/erollero/HDIChile/Santiago/frecmetroval1021"),
    image26 = ui.import && ui.import("image26", "image", {
      "id": "users/erollero/HDIChile/Santiago/burn2122metV"
    }) || ee.Image("users/erollero/HDIChile/Santiago/burn2122metV");
var roi1 = table5.filterMetadata("REGION","equals","Metropolitana de Santiago");
var roi2 = table5.filterMetadata("REGION","equals","Libertador General Bernardo O'Higgins");
var roi3 = table5.filterMetadata("REGION","equals","Valparaíso");
var roi = roi1.merge(roi2).merge(roi3);
Map.setCenter(-70.9492, -33.7474, 8);
...
Map.add(ui.Label(
    'Región Metropolitana, Valparaíso y O_Higgins - Frecuencia de Quemado en B. Implantado 2001-2010-2021' 
...
var places = {
  Algarrobo: [-71.609334, -33.338012],
  Alhué: [-71.093514, -34.033990],
  Cartagena: [-71.446896, -33.536936],
  Casablanca: [-71.425536, -33.319889],
  Chépica: [-71.352721, -34.773614],
  Chimbarongo: [-70.980952, -34.753572],
  Codegua: [-70.611582, -34.080724],
  Concón: [-71.473656, -32.952049],
  Curacaví: [-71.103102, -33.368921],
  Santo_Domingo: [-71.674852, -33.822576],
  Valparaíso: [-71.583747, -33.131434]
};
