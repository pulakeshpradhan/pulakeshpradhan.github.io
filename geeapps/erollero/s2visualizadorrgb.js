 ...
 */
// Landsat 8 TOA
var COLLECTION_ID = 'COPERNICUS/S2_SR';
var START_DATE = '2021-07-01';
var END_DATE = '2022-07-01';
var VIZ_PARAMS = {bands: ['B8', 'B11', 'B4'],gamma: [0.80, 1.2, 1.0], min: 500, max: 4500};
...
function makeSidePanel() {
  ...
  var titleLabel = ui.Label('Imagenes Sentinel 2 SR', TITLE_STYLE);
  mainPanel.add(titleLabel);
  // Add the app description to the main panel
  var descriptionText =
      'Apps para analizar visualmente la calidad de las imágenes Sentinel 2 SR ' +
      'Se observan las distintas fechas de la campaña 21/22 al hacer click en el visor ' +
      'Tiene aplicado un filtro de nubes del 30% '
...
function makeThumbnail(id, onChangeFunc) {
  ...
  var thumbnail = ui.Thumbnail({
    ...
    params: {dimensions: THUMBNAIL_WIDTH, crs: 'EPSG:4326', format: 'jpg'},
    style: {
  ...
  var checkbox = ui.Checkbox('Visualizar', false, onChangeFunc, false, LABEL_STYLE);
...
function makeMapPanel() {
  ...
  map.add(ui.Label('Haga clic en el mapa para calcular un mosaico en esa ubicación'));
...
var initGeometry = ee.Geometry.Point([-63.58793178427644,-35.78397038583653]);
