var geometry = /* color: #d63000 */ee.Geometry.Point([-60.931282152904316, -24.948001433901126]),
    departamentos = ee.FeatureCollection("users/erollero/Departamentos_INDEC_2015"),
    roi = ee.FeatureCollection("users/erollero/bsas"),
...
Map.addLayer(highNDVI,{palette: '#ff00ee'},"highNDVI")
