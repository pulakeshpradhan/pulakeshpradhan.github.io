//DIMAR v3.0_The following sections provide an example of the object-based method applied to the detection of buildings
...
var point = ee.Geometry.Point(-77.9721, 2.6884);
...
var image = ee.ImageCollection('COPERNICUS/S2_SR')
                .filterBounds(ee.Geometry.Point(-77.9721, 2.6884))
...
var hotspots = (BSI.gt(0.32).and(BSI.lt(0.40)))
...
var objectSize = objectId.select('labels')
  .connectedPixelCount({
    maxSize: 6, eightConnected: false
  });
...
var areaMask = objectArea.lt(100);
...
//Map.addLayer(result,false, "botes");
// set styling
var styling = {color: 'red', fillColor: '00000000'};
Map.addLayer(result.style(styling), {}, 'Go fast');
////////////
////////////////////////////////////////////
// Compute a buffer of the polygon.
//var buffer = result.buffer(100);
