var cox = ui.import && ui.import("cox", "table", {
      "id": "users/salitchakma/CoxsBazar_District"
    }) || ee.FeatureCollection("users/salitchakma/CoxsBazar_District"),
    ukhiyaTeknaf = ui.import && ui.import("ukhiyaTeknaf", "table", {
      "id": "users/salitchakma/admin_Teknaf_Ukhia"
    }) || ee.FeatureCollection("users/salitchakma/admin_Teknaf_Ukhia"),
    kutupalong = ui.import && ui.import("kutupalong", "table", {
      "id": "users/salitchakma/BangabandhuChair/KutupalongRC_boundary"
    }) || ee.FeatureCollection("users/salitchakma/BangabandhuChair/KutupalongRC_boundary"),
    ukhiyaCamp = ui.import && ui.import("ukhiyaCamp", "table", {
      "id": "users/salitchakma/BangabandhuChair/RC_campsUkhiya"
    }) || ee.FeatureCollection("users/salitchakma/BangabandhuChair/RC_campsUkhiya");
 ///////////////////////////////////////////////////////////////////////////
//// --------------------    GEOMETRY USED    ----------------------------
...
var ndvi_viz =  newImages.map(function(image){
  ...
  return image.select('NDVI_max').visualize({
    forceRgbOutput: true,
    palette: ['black', 'red', 'a1d76a', 'green','999999'],
    min: 0,
    max: 4
...
var palette =['ffffff00','black', 'red', 'a1d76a', 'green','999999'];
...
var falsChk = ui.Checkbox('Spectrozonal time series', false); 
...
// NDVI checkbox
var ndviChk = ui.Checkbox('Forest cover time series', false);
