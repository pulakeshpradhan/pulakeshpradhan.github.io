...
// compute mean across dates in µmol for both periods
...
var m1 = im1.gt(50);
var m2 = im2.gt(50);
// print latest available product (to check NRT)
//print(c.filterDate(start,now).sort('system:time_start',false).first());
// color palette 
