...
// linker.get(0).setCenter(-90.30849,15.5554, 14);
linker.get(0).setCenter(-90.047, 15.63403, 14);
...
var legendTitle2 = ui.Label({
  value: 'Comparacion de imagenes Sentinel 2 (bandas 2-8-4) del 25 de noviembre (izquierda) y 10 de diciembre (derecha)',
  style: {
    fontWeight: 'bold',
    fontSize: '10px',
    margin: '0 0 4px 0',
...
var flowAccumulation = dataset.select('upg');
var flowAccumulationVis = {palette: ['blue']};
Map.addLayer(flowAccumulation.mask(flowAccumulation.gt(100)), flowAccumulationVis, 'Flow Accumulation');
var dataset = ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_7");
// Map.setCenter(-91, 15, 9);
...
Map.addLayer(outline, {palette: 'magenta'}, 'edges');