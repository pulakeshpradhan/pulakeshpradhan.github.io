...
var intro = ui.Label('NDVI & Greenness Trend GUI ',
  {fontWeight: 'bold', fontSize: '24px', margin: '10px 5px'}
);
var subtitle = ui.Label('Use 30 m Landsat 5,7,8 imagery to'+
  ' visualize changes in vegetation patterns over time.'+
...
var medan = 
    ...
    ee.Geometry.Polygon(
        [[[98.55540697728112, 3.9449333736320087],
          [98.55540697728112, 3.4515796608513245],
          [98.82182543431237, 3.4515796608513245],
          [98.82182543431237, 3.9449333736320087]]], null, false),
    nias = 
    /* color: #ffc82d */
    /* displayProperties: [
      {
    ...
    ee.Geometry.Polygon(
        [[[97.01058602500692, 1.5645046086543424],
          [97.01058602500692, 0.8450639291227735],
          [98.08724618125692, 0.8450639291227735],
          [98.08724618125692, 1.5645046086543424]]], null, false),
    samosir = ee.Geometry.Polygon(
        [[[98.41377012467491, 2.92725452445085],
          [98.41377012467491, 2.2660115832392798],
          [99.27894346451866, 2.2660115832392798],
          [99.27894346451866, 2.92725452445085]]], null, false);
// Define labels for each study region.
var MEDAN = 'Kota Medan',
    NIAS = 'Kabupaten Nias',
...
var constructLSDict = function(geometry)
  ...
  */
  ...
  var y_list = ee.List.sequence(2013, 2020)
  ...
  var y_list7 = ee.List.sequence(2000, 2012)
  ...
  var y_list5 = ee.List.sequence(1988,1999)
...
var durpanel = ui.Label({
  ...
  style:{fontSize: '18px', fontWeight: 'bold'}});
var selectYr1 = ui.Textbox({placeholder: 'Year',  value: '2020',
  style: {width: '100px'}});
var datasetRange_label = ui.Label('Choose year from 1988 - 2020      ',
...
var selectYr2 = ui.Textbox({placeholder: 'Year',  value: '1988',
  style: {width: '100px'}});
var selectYr3 = ui.Textbox({placeholder: 'Year',  value: '2020',
  style: {width: '100px'}});
// define the labels needed for GUI
var changepanel = ui.Label({
  value:'Select Years for Landsat 30m Change Map',
  style:{fontSize: '18px', fontWeight: 'bold'}});
var datasetRange_label2 = ui.Label('Start Year (1988 - )          ',
  {margin: '0 0 0 10px',fontSize: '12px',color: 'gray'});
