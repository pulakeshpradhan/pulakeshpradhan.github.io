...
var t1 = ee.ImageCollection('LANDSAT/LC08/C01/T1_TOA')
                  .filterDate('2015-03-01', '2015-03-25')  //2015-03-08
                  .filterBounds(roi)
                  .map(panSharpenL8);
var t2 = ee.ImageCollection('LANDSAT/LC08/C01/T1_TOA')
                  .filterDate('2015-05-25', '2015-06-15')  //2015-05-27
                  .filterBounds(roi)
                  .map(panSharpenL8);
print(t2)
...
leftMap.add(ui.Label("08 Marzo 2015", {position: "bottom-left", 
                                              fontSize: "30px", 
                                              color: "black", 
...
rightMap.add(ui.Label("27 Mayo 2015", {position: "bottom-right", 
                                              fontSize: "30px", 
                                              color: "white", 
