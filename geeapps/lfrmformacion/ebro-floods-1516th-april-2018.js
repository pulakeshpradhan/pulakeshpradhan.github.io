...
//Center Map
var centro=ee.Geometry.Point (-0.8941, 41.6606);
...
var ebro = ee.FeatureCollection("users/lfrmformacion/ebro");
var geometry = ebro.geometry()
Map.addLayer(geometry, {color: '#e4dedb'})
...
var before_start= '2017-08-01';
var before_end='2017-08-12';
// Now set the same parameters for AFTER the flood.
var after_start='2018-04-08';
var after_end='2018-04-18';
/********************************************************************************************
...
//------------------------------  DISPLAY PRODUCTS  ----------------------------------//
// Flooded areas
Map.addLayer(flooded,{palette:"#439fff"},'Flooded areas');
// Population Density
...
// Produced by...
var text7 = ui.Label('Script produced by: Luciano Martins', subTextVis)
...
var palette =['#439fff', '#30b21c', '#ff1800'];
// name of the legend
