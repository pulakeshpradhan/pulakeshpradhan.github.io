var toh = ui.import && ui.import("toh", "image", {
    ...
    riskH = ui.import && ui.import("riskH", "table", {
      "id": "users/ieco/slf_maxent/transport/combined_hires_17Sep2020"
    }) || ee.FeatureCollection("users/ieco/slf_maxent/transport/combined_hires_17Sep2020"),
    risk_old = ui.import && ui.import("risk_old", "table", {
      "id": "users/ieco/slf_maxent/transport/combined_lores_01Oct2020"
    }) || ee.FeatureCollection("users/ieco/slf_maxent/transport/combined_lores_01Oct2020"),
    ...
    risk = ui.import && ui.import("risk", "table", {
      "id": "users/ieco/slf_maxent/transport/combined_lores_16Nov2020"
    }) || ee.FeatureCollection("users/ieco/slf_maxent/transport/combined_lores_16Nov2020"),
    ...
    prodrisk = ui.import && ui.import("prodrisk", "image", {
      "id": "users/ieco/slf_maxent/impact/impact_risk_16Nov2020_v4"
    }) || ee.Image("users/ieco/slf_maxent/impact/impact_risk_16Nov2020_v4"),
    trapot = ui.import && ui.import("trapot", "image", {
      "id": "users/ieco/slf_maxent/transport/transport_16Nov2020_v4"
    }) || ee.Image("users/ieco/slf_maxent/transport/transport_16Nov2020_v4");
/*
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ><><>< 
var MapParam = {lon:0, lat:42, zoom:2}, // lat: 39.8333333,lon: -98.585522, Erie center -79.516, 42.354, 
...
var dict = {iw: 1, // Choose layers to show, wine regions
            iu: 0, // us vineyards
            ie: 0, // eu vineyards
            es: 1, // establishment
            tr: 1, // transport
  ...
  dictTERRAIN = {
    iw: 1, // Choose layers to show, wine regions
    iu: 0, // us vineyards
    ie: 0, // eu vineyards
    es: 1, // establish
    tr: 0, // transport
...
Map.addLayer(establiz, estabVisParam, "establishment potential", dict.es); ///// 
// Plot Impact
