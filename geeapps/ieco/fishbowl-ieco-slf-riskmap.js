...
/* Establishment */
///////////////////////
// make a mean of the three SLF models
...
if(0){
var risk_ = risk.filter(ee.Filter.greaterThan('risk', 0));
...
var risk_ = risk.filter(ee.Filter.greaterThan('transport', 0));
//Map.addLayer(risk,{},"risk original");
