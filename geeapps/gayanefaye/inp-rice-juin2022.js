var S2 = ui.import && ui.import("S2", "image", {
      "id": "projects/ee-tensorflow-servir/assets/LTA/SenegalS2"
    }) || ee.Image("projects/ee-tensorflow-servir/assets/LTA/SenegalS2"),
    EstSudCentre = ui.import && ui.import("EstSudCentre", "image", {
      "id": "users/chaponda/Classied_Jullet_allSud_Gayane"
    }) || ee.Image("users/chaponda/Classied_Jullet_allSud_Gayane"),
    Nord = ui.import && ui.import("Nord", "image", {
      "id": "users/chaponda/Classied_juillet2_SL_Gayane"
    }) || ee.Image("users/chaponda/Classied_juillet2_SL_Gayane"),
...
var total=ee.ImageCollection([EstSudCentre,Nord]).mosaic()
var vizp={
bands: ["B11","B8","B3"],
gamma: 1,
max: 0.50,
...
var mixtecultureVis = total.eq(0).selfMask().visualize({palette: '#b9c4c4'});
var riceVis = total.eq(1).selfMask().visualize({palette: '#15c412'});
/*******************************************************************************************************l
...
function redraw() {
  ...
  if (layer == MAIN) {
    image = mainVis;
  } else if (layer ==NOT_RICE ) {
    image = mixtecultureVis;
  } else if (layer == RICE) {
    image = riceVis;
  }      
