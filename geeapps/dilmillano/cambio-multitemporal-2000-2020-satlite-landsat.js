...
var ndvi2001= Ocaso2001.select('ndvi');  
Map.addLayer(ndvi2001.clip(Ocaso),ndviParameters, 'NDVI 2001');
var urban = ndvi2001.lte(0.5);
var urbanDis = ndvi2001.gt(0.5).and(ndvi2001.lte(0.65));
var cropland = ndvi2001.gt(0.65).and(ndvi2001.lte(0.7));
var vegetation = ndvi2001.gt(0.7).and(ndvi2001.lte(0.75));
var forest = ndvi2001.gt(0.75);
//Mascaras
...
Map.addLayer(mosaic.clip(Ocaso),{},'Clasificación de coberturas 2000');
Map.centerObject( Ocaso,15);
//Calculo de área
...
var Etiquetas = [
  'Tejido Urbano=(8.356 Ha)',
  'Tejido Urbano Discontinuo=(60.424 Ha) ',  
  'Mosaico de cultivos, pastos y espacios naturales=(87.668 Ha)',
  'Bosque Fragmentado con vegetación secundaria=(194.671 Ha)',
  'Bosque Denso Bajo=(248.272 Ha)', 
  ];
var Etiquetas2 = [
...
var Titulo = ui.Label({
  value: 'Coberturas para el año 2000', // Titulo de la leyenda
...
var panel = ui.Panel({style: {width: '400px'}})
  ...
  targetUrl: 'https://code.earthengine.google.com/e9231ce95154bae258721f8e83929d44', 
  style: {fontWeight: '100', fontSize: '13px', fontFamily: 'Cambria', margin: '0px 0px 15px 5px',textAlign: 'left', color: 'black'  }}))
    .add(ui.Label({
