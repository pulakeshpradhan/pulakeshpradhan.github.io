...
infoPanel.add(ui.Label('Perbedaan Objek Air Keruh dan Air Jernih (Implementasi)', TITLE_STYLE));
...
var runGraph = ui.Button({label: 'Menampilkan Grafik', onClick: function(){
                          ...
                          series: {
                            ...
                            4: {color: '19fbf6'}  // untuk objek air keruh laut dangkal
    }
};
                          // Add dataset
                          var start = sDate.getValue();
                          ...
                          var spectraChart = ui.Chart.image.regions(
                            ...
                            .setSeriesNames(['Air Jernih Laut','Air Jernih Danau','Air Keruh Waduk',
                                            'Air Keruh Muara Sungai', 'Air Keruh Laut Dangkal'])
                            .setOptions(options);
...
var classDesc2 = ui.Label({
  value: '0: Air Jernih Laut, ' +
  '1: Air Jernih Danau, ' + 
  '2: Air Keruh Waduk, ' + 
  '3: Air Keruh Muara Sungai, ' +
  '4: Air Keruh Laut Dangkal',
  style: {
    fontWeight: '50',
    fontSize  : '14px',
    color     : '#eeeeee',
...
var txb_Class = ui.Textbox({placeholder: 'Contoh: Air Jernih Laut'});
...
lbl_desc4.style().set({fontSize: '16px',padding: '0px 10px', color: '#eeeeee', backgroundColor: colors.transparent});
var lbl_desc5 = ui.Label('Langkah 2: Menampilkan grafik spektral');	
lbl_desc5.style().set({fontSize: '16px',padding: '0px 10px', color: '#eeeeee', backgroundColor: colors.transparent});
