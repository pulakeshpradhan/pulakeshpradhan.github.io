...
app.createVariables = function() {
  app.targetCrop = 1;
  app.yearList = {
    _2022: -1, _2021: -1, _2020: -1, _2019: -1, _2018: -1, _2017: -1, _2016: -1, _2015: -1, _2014: -1, _2013: -1, _2012: -1, _2011: -1, _2010: -1,
...
app.createPanels = function() {
  ...
  app.yearFilter = {
    checkbox2022: ui.Checkbox({
      label: '2022', 
      value: false,
      onChange: function() {
        if(app.yearFilter.checkbox2022.getValue()===true) {
          app.yearList._2022 = '2022';
        }
        else {
          app.yearList._2022 = -1;
        }
        app.refreshLayer();
      }
    }),
    checkbox2021: ui.Checkbox({
      label: '2021', 
      value: false,
      onChange: function() {
        if(app.yearFilter.checkbox2021.getValue()===true) {
          app.yearList._2021 = '2021';
        }
        else {
          app.yearList._2021 = -1;
        }
        app.refreshLayer();
      }
    }),
    checkbox2020: ui.Checkbox({
      label: '2020', 
      value: false,
      onChange: function() {
        if(app.yearFilter.checkbox2020.getValue()===true) {
          app.yearList._2020 = '2020';
        }
        else {
          app.yearList._2020 = -1;
        }
        app.refreshLayer();
      }
    }),
    checkbox2019: ui.Checkbox({
      label: '2019', 
      value: false,
      onChange: function() {
        if(app.yearFilter.checkbox2019.getValue()===true) {
          app.yearList._2019 = '2019';
        }
        else {
          app.yearList._2019 = -1;
        }
        app.refreshLayer();
      }
    }),
  ...
  app.yearFilter.panel = ui.Panel({
    widgets: [
      ...
      app.yearFilter.checkbox2022,
      app.yearFilter.checkbox2021,
      app.yearFilter.checkbox2020,
      app.yearFilter.checkbox2019,
...
app.refreshLayer = function() {
  ...
  app.updateYears = function(remapList) {
    if (Math.max.apply(Math, remapList)==-1) {
      app.years = ['2022','2021','2020','2019','2018','2017','2016','2015','2014','2013','2012','2011','2010',
  ...
  var yearList = [app.yearList._2022,
                  app.yearList._2021,
                  app.yearList._2020,
                  app.yearList._2019, 
                  app.yearList._2018, 
  ...
  function updateCdlLayers() {
    ...
    Map.addLayer(app.currentMap, {min: 0, max: 23, palette: _getCdl.getFrequencyPalette()}, 'Frequency Map');
  }
