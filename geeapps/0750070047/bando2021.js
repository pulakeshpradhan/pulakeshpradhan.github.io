...
Map.addLayer(anh2021,{},'ảnh giải đoán có kiểm định 2021')   ; 
//-------------- chen thumbnail vao panel--------------------
var name_1 = ui.Label('Bản đồ lớp phủ huyện Vĩnh Cửu tỉnh Đồng Nai năm 2021',{
  stretch: 'horizontal',
  textAlign: 'center',
  fontWeight:'bold',
  fontSize:'18px',
...
// Map.add(thumbmail);
  panel.add(thumbmail);
// 
var name_2 = ui.Label('Diện tích lớp phủ năm 2021',
{
  stretch: 'horizontal',
  textAlign: 'center',
  fontWeight:'bold',
...
table2.add(kc); 
table2.add(ui.Label({value: '74278.722',style: {margin:'0px 0px 0px 2px'}}));
panel.add(table2)
// dong 3
var line3=ui.Label({
  value: '______________________________________________________',
...
table3.add(kc); 
table3.add(ui.Label({value: '11183.749',style: {margin:'0px 0px 0px 2px'}}));
panel.add(table3)
//dong 4
var line4=ui.Label({
  value: '______________________________________________________',
...
table4.add(kc); 
table4.add(ui.Label({value: '479.4623',style: {margin:'0px 0px 0px 2px'}}));
panel.add(table4)
//dong 5
var line5=ui.Label({
  value: '______________________________________________________',
...
table5.add(kc); 
table5.add(ui.Label({value: '23495.106',style: {margin:'0px 0px 0px 2px'}}));
panel.add(table5)
var line6=ui.Label({
  value: '______________________________________________________',
  style: { 
...
anh2021.toDictionary().evaluate(function(result) {
...
Map.addLayer(classify_img,viz,'ảnh giải đoán có kiểm định năm 2021',1);
...
var title = ui.Label(' Bản đồ lớp phủ huyện Vĩnh Cửu tỉnh Đồng Nai năm 2021', {
  stretch: 'horizontal',
  textAlign: 'center',
  fontWeight: 'bold',
  fontSize: '25px',
