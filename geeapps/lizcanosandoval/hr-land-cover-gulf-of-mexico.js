var tile_coverage = ui.import && ui.import("tile_coverage", "table", {
      "id": "users/lizcanosandoval/wv-regions/tile_coverage"
    }) || ee.FeatureCollection("users/lizcanosandoval/wv-regions/tile_coverage"),
    density = ui.import && ui.import("density", "image", {
      "id": "users/lizcanosandoval/wv-regions/Region_Density"
    }) || ee.Image("users/lizcanosandoval/wv-regions/Region_Density"),
    regions = ui.import && ui.import("regions", "table", {
      "id": "users/lizcanosandoval/wv-regions/wv_counties_buffer"
    }) || ee.FeatureCollection("users/lizcanosandoval/wv-regions/wv_counties_buffer");
//////////////////////////////////////////////////////////////////////////////////////////////////////////
...
var clearSelectionL = ui.Button('Clear Selection', clearResults, false, 
    {width:'10%',stretch:'vertical',padding:'0px 0px 0px 0px',color: 'red',position:'top-center'});
var clearSelectionR = ui.Button('Clear Selection', clearResults, false, 
    {width:'10%',stretch:'vertical',padding:'0px 0px 0px 0px',color: 'red',position:'top-center'});
leftMap.add(clearSelectionL);
rightMap.add(clearSelectionR);
clearSelectionL.style().set({shown: false});
clearSelectionR.style().set({shown: false});
...
function handleMapClick(location) {
  ...
  updateOverlay();
  updateTable();
  clickTitleL.style().set({shown: false});
  clickTitleR.style().set({shown: false});
  clearSelectionL.style().set({shown: true});
  clearSelectionR.style().set({shown: true});
  startMonth.setDisabled(0);
}
...
var startMonth = ui.Select({
  ...
  onChange: function(){return startYear.setDisabled(0)}
});
startMonth.setDisabled(1);
var startYear = ui.Select({
  items: year,
  placeholder: 'Choose Year...',
  style: {width: '35%', stretch: 'horizontal',padding:'0px 0px 0px 10px'},
  onChange: function(){return endMonth.setDisabled(0)}
});
...
var endMonth = ui.Select({
  ...
  placeholder: 'Choose Month...',
  style: {width: '35%', stretch: 'horizontal',padding:'0px 0px 0px 10px'},
  onChange: function(){return endYear.setDisabled(0)}
});
endMonth.setDisabled(1);
var endYear = ui.Select({
  items: year,
  placeholder: 'Choose Year...',
  style: {width: '35%', stretch: 'horizontal',padding:'0px 0px 0px 10px'},
  onChange: function(){return startMonthR.setDisabled(0)}
});
...
var startMonthR = ui.Select({
  ...
  placeholder: 'Choose Month...',
  style: {width: '35%', stretch: 'horizontal',padding:'0px 0px 0px 10px'},
  onChange: function(){return startYearR.setDisabled(0)}
});
startMonthR.setDisabled(1);
var startYearR = ui.Select({
  items: year,
  placeholder: 'Choose Year...',
  style: {width: '35%', stretch: 'horizontal',padding:'0px 0px 0px 10px'},
  onChange: function(){return endMonthR.setDisabled(0)}
});
startYearR.setDisabled(1);
...
var endMonthR = ui.Select({
  ...
  placeholder: 'Choose Month...',
  style: {width: '35%', stretch: 'horizontal',padding:'0px 0px 0px 10px'},
  onChange: function(){return endYearR.setDisabled(0)}
});
endMonthR.setDisabled(1);
var endYearR = ui.Select({
  items: year,
  placeholder: 'Choose Year...',
  style: {width: '35%', stretch: 'horizontal',padding:'0px 0px 0px 10px'},
  onChange: function(){return classSelector.setDisabled(0)}
});
endYearR.setDisabled(1);
// Add widgets to panel
...
var classSelector = ui.Select({
  ...
  style: {width: '40%', stretch: 'horizontal',padding:'0px 0px 0px 10px'},
  onChange: function(){return mosaicButton.setDisabled(0)}
});
classSelector.setDisabled(1);
// Add widget to panel
...
function clearResults() {
  ...
  //Disable Mosaic Button
  buttonPanel.widgets().get(0).setValue(null, false)
  buttonPanel.widgets().get(1).setDisabled(1);
  //Hide items again.
...
var downloadText = ui.Label({
  value: 'Left Map', style: {color:'blue',padding:'0px 0px 0px 20px'}
});
var downloadTextR = ui.Label({
  value: 'Right Map', style: {color:'blue',padding:'0px 0px 0px 20px'}
});
var downloadTextDEM = ui.Label({
  value: 'DEM', style: {color:'blue',padding:'0px 0px 0px 20px'}
});
//Hide items
textDownload.style().set({shown: false});
textDownloadInfo.style().set({shown: false});
...
Link.setUrl('https://code.earthengine.google.com/419da8603aa8d148eb4c805d9ee3a7c9');
