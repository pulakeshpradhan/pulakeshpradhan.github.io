var box = ui.import && ui.import("box", "geometry", {
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [
      ...
      "locked": false
        ...
        [[[-53.16827407913484, -8.209595105783073],
          [-53.16827407913484, -16.80270799308366],
          [-48.53204361038484, -16.80270799308366],
          [-48.53204361038484, -8.209595105783073]]], null, false);
/**
 * 
...
function setThumbs (){
  ...
  var yearsList = ee.List.sequence(2021,1985,-1).getInfo();
...
function init (){
  ...
  options.geometry = ee.FeatureCollection("users/wallacesilva/UNB/Planicie_Bananal").geometry();
...
options.panel.insert(0,
  ui.Panel(
  [
    ui.Label({
    value:'clique nos mapas para ligar e desligar as layers || ',
    style:{fontSize:'9px'},
  ...
  value:'clique aqui para acessar o código',
    style:{fontSize:'9px'},
  targetUrl:'https://code.earthengine.google.com/03dccbb4f51f2bd56b31b108b09ae625?noload=1'
})
  ],
...
Export.table.toDrive({
    collection: areas,
    description: 'cobertura-do-solo-planicie-do-bananal-v2',
    folder: 'exports',
    fileNamePrefix: 'cobertura-do-solo-planicie-do-bananal-v2',
    fileFormat: 'CSV'
});