...
function getLandcover(year){
  return ee.Image('projects/mapbiomas-workspace/public/collection6/mapbiomas-fire-collection1-annual-burned-coverage-1')
    .select('burned_coverage_' + year);
}
...
function init (){
  ...
  options.geometry = ee.FeatureCollection("users/Merino/caiman_pol_certo")
    .geometry();
...
options.title.add(
  ...
  value:'clique aqui para acessar o código',
    style:{fontSize:'10px'},
  targetUrl:'https://code.earthengine.google.com/a9b2043dadbe4a1a3b6d308ad436c20e?noload=1'
})
  ],
