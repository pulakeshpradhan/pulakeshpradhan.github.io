...
function getLandcover(year){
  return ee.Image('projects/mapbiomas-workspace/public/collection6/mapbiomas_collection60_integration_v1')
...
options.title.add(
  ...
  value:'clique aqui para acessar o código',
    style:{fontSize:'10px'},
  targetUrl:'https://code.earthengine.google.com/e2a3ec8e2dad6ec3017b658c03834c1c?noload=1'
})
  ],
