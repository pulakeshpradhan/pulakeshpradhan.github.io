...
var grids = ee.FeatureCollection('users/410093033/Marksordgrids').sort('floodsum', false);
...
maps[0].setCenter(116.186, 29.005,8).setControlVisibility({layerList:true});
var china = ee.FeatureCollection('users/410093033/China');
var gridIdList = china
  .reduceColumns(ee.Reducer.toList(), ["OBJECTID"])
  .get("list")
  .getInfo();
var floodedpro = ee.ImageCollection("users/410093033/FloodingMark");
