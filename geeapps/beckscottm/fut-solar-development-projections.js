...
var sld_intervals =
  '<RasterSymbolizer>' +
    '<ColorMap type="intervals" extended="false" >' +
      '<ColorMapEntry color="#b2b2b2" quantity="0" label="0"/>' +
      '<ColorMapEntry color="#cff4d2" quantity="0.2" label="1-20" />' +
      '<ColorMapEntry color="#7be495" quantity="0.4" label="20-40" />' +
      '<ColorMapEntry color="#56c596" quantity="0.6" label="40-60" />' +
      '<ColorMapEntry color="#329d9c" quantity="0.8" label="60-80" />' +
      '<ColorMapEntry color="#205072" quantity="1" label="80-100" />' +
    '</ColorMap>' +
  '</RasterSymbolizer>';
Map.addLayer(neSuitability.sldStyle(sld_intervals), {}, 'Solar Siting Suitability', false);
Map.addLayer(neSolarFP2016,{min: 0, max: 1, palette: ['000000', 'ff0000']}, 'NE Solar Footprints 2016', false);
Map.addLayer(neSolarFP2001,{min: 0, max: 1, palette: ['000000', 'ff0000']}, 'NE Solar Footprints 2001', false);
Map.addLayer(ct2030,{min: 0, max: 1, palette: ['000000', 'ff8c00']}, 'CT_Solar_2030', false);
Map.addLayer(ct2040,{min: 0, max: 1, palette: ['000000', 'ff4500']}, 'CT_Solar_2040', false);
Map.addLayer(ma2030,{min: 0, max: 1, palette: ['000000', 'ff8c00']}, 'MA_Solar_2030', false);
Map.addLayer(ma2040,{min: 0, max: 1, palette: ['000000', 'ff4500']}, 'MA_Solar_2040', false);
Map.addLayer(me2030,{min: 0, max: 1, palette: ['000000', 'ff8c00']}, 'ME_Solar_2030', false);
Map.addLayer(me2040,{min: 0, max: 1, palette: ['000000', 'ff4500']}, 'ME_Solar_2040', false);
Map.addLayer(nh2030,{min: 0, max: 1, palette: ['000000', 'ff8c00']}, 'NH_Solar_2030', false);
Map.addLayer(nh2040,{min: 0, max: 1, palette: ['000000', 'ff4500']}, 'NH_Solar_2040', false);
Map.addLayer(ny2030,{min: 0, max: 1, palette: ['000000', 'ff8c00']}, 'NY_Solar_2030', false);
Map.addLayer(ny2040,{min: 0, max: 1, palette: ['000000', 'ff4500']}, 'NY_Solar_2040', false);
Map.addLayer(ri2030,{min: 0, max: 1, palette: ['000000', 'ff8c00']}, 'RI_Solar_2030', false);
Map.addLayer(ri2040,{min: 0, max: 1, palette: ['000000', 'ff4500']}, 'RI_Solar_2040', false);
Map.addLayer(vt2030,{min: 0, max: 1, palette: ['000000', 'ff8c00']}, 'VT_Solar_2030', false);
Map.addLayer(vt2040,{min: 0, max: 1, palette: ['000000', 'ff4500']}, 'VT_Solar_2040', false);
//////////////////////////////////////////
...
///////////////////////////////////
//Checkbox label
var suit = ui.Label({value:'Solar Siting Probability',
...
var namesa = ['no prob','>20%','20-40%', '40-60%','60-80%','80-100%']; 
// // Add color and names to legend
for (var i = 0; i < 6; i++) {
  extentLegend.add(makeRowa(paletteMAPa[i], namesa[i]));
  }  
////////////////////////////////////////LEGEND END//////////////////////////////////////////
var suitCheck = ui.Checkbox('Solar Probability').setValue(false);
