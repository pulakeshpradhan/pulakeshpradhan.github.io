...
var Pueblos_Indigenas = ee.FeatureCollection("users/sigcica/CLIMA/Pueblos_Indigenas_gee_Disolve");        //Capa de PI con nombre de etnia y país (96 polígonos)
...
var admin2Select = ui.Select({
  placeholder: 'Seleccione un Territorio Indígena',
}).setDisabled(true)
...
var admin0Selected = function(admin0Selection) {
  ...
  admin1Names.evaluate(function(items){
    admin1Select.setPlaceholder('Seleccione un Territorio Indígena')
...
//********************************************VISUALIZAR PAÍS, PI**********************************************//
//--------------------------------------------*******************----------------------------------------------//
Map.addLayer(ee.Image().paint(studyarea,1,1), {'palette': 'DarkBlue'},'País:'+country_names);
Map.addLayer(ee.Image().paint(studyarea2,1,1), {'palette': 'Yellow'},"Pueblos Indígenas de" +" "+country_names);
