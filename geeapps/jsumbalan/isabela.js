...
var cover = ee.Image('UMD/hansen/global_forest_change_2021_v1_9').select(['treecover2000']).gte(85);
var loss = ee.Image('UMD/hansen/global_forest_change_2021_v1_9').select(['lossyear']);
Map.centerObject(lanao,10.7);
...
var opacityshd = ui.Slider({
           ...
           max: 1,
           value: 1,
           step: 0.01,style: {stretch: 'horizontal', width:'130px' }
         });
       ...
       var waterdesc = ui.Label({value: 'Forest Cover Boundary'});
       ...
       coverbox.onChange(function(checked) {
         ...
         var opacitycover = ui.Slider({
           ...
           max: 1,
           value: 1,
           step: 0.01,style: {stretch: 'horizontal', width:'100px' }
         });
         opacitycover.onSlide(function(value) {
           cover.setOpacity(value);
         });       
       var coverdesc = ui.Label({value: 'NAMRIA 2010 Forest Cover'});
