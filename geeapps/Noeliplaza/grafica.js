...
var n2 = parseFloat(prompt("Inserta longitud en grados decimales"));
var n1 = parseFloat(prompt("Inserta latitud en grados decimales"));
...
var chart = ui.Chart.image.series({
  ...
  scale: 30
          ...
          vAxis:
              {title: 'Valor del NDVI', titleTextStyle: {italic: false, bold: true}}
        });
