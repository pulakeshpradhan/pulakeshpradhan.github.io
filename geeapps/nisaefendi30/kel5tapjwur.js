var table = ui.import && ui.import("table", "table", {
      "id": "users/nisaefendi30/Kalsel_Kabkot"
    }) || ee.FeatureCollection("users/nisaefendi30/Kalsel_Kabkot");
//Menentukan periode sebelum banjir
var before_start= '2020-12-01';
var before_end='2020-12-31';
//Menentukan waktu setelah banjir
var after_start='2021-01-01';
var after_end='2021-01-31';
...
var before = before_collection.mosaic().clip(table);
var after = after_collection.mosaic().clip(table);
...
//Area banjir
Map.addLayer(flooded,{palette:"216fff"},'Flooded areas');
//Kepadatan populasi
...
//Membuat Judul
var title = ui.Label({
  value: 'Analisis Dampak Bencana Banjir Kalimantan Selatan 2021',
  style:{
  fontWeight: 'bold',
  fontSize: '15px'
  }});
...
MODIS_date.evaluate(function(val){text4_2.setValue('Berdasarkan data MODIS Land Cover 2020 + (500m)')}), subTextVis;
...
MODIS_date.evaluate(function(val){text5_2.setValue('Berdasarkan data MODIS Land Cover 2020 + (500m)')}), subTextVis;
var number5 = ui.Label('Dalam proses...',numberVIS);
urban_area_ha.evaluate(function(val){number5.setValue(val+' hektar')}),numberVIS;
// Disclaimer
var text6 = ui.Label('Oleh : Kelompok 5 (Anindya Pratisamara, Chairun Nisa Efendi, Rania Fajriati Tazkia) Pernyataan: Penelitian ini digunakan sebagai Tugas Akhir Mata Kuliah Penginderaan Jauh Dinamika Wilayah Urban dan Rural 2021/2022. Informasi ini diperoleh melalui analisis data citra satelit saja tanpa didukung informasi validasi dari lapangan. Semua informasi geografis yang tersaji memiliki keterbatasan skala, resolusi, tanggal, dan interpretasi dari data primer.',titleTextVisper)
// Diolah oleh...
var text7 = ui.Label('Script dasar dibuat oleh: UN-SPIDER pada Desember 2019 dan dimodifikasi oleh Kelompok 5 MK PJ Dinamika Wilayah Urban dan Rural pada Desember 2021 untuk Analisis Banjir Kalimantan Selatan 2021', titleTextVisper)
...
var palette =['#216fff', '#1abf00', '#e69602'];
//Nama legenda
