var JKT = ui.import && ui.import("JKT", "table", {
      "id": "users/nisaefendi30/Kota_Jakarta"
    }) || ee.FeatureCollection("users/nisaefendi30/Kota_Jakarta");
//Menentukan periode sebelum banjir
var before_start= '2019-12-01';
var before_end='2019-12-30';
//Menentukan waktu setelah banjir
var after_start='2020-01-01';
var after_end='2020-01-30';
...
var aoi = ee.FeatureCollection(JKT);
...
//Membuat Judul
var title = ui.Label({
  value: 'Analisis Dampak Bencana Banjir Kota Jakarta 2020',
  style:{
  fontWeight: 'bold',
  fontSize: '25px'
  }});
...
// Diolah oleh...
var text7 = ui.Label('Script dasar dibuat oleh: UN-SPIDER pada Desember 2019 dan dimodifikasi oleh Chairun Nisa Efendi (1906288625) pada November 2021 untuk Analisis Banjir Kota Jakarta Tahun 2020', subTextVis)
