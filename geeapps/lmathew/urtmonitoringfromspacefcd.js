...
{
  var img_bound = ee.Geometry.Polygon(eneo.geometry().coordinates());
  //var img_bound = eneo.geometry().dissolve();
...
var vidakio = urt_wards.aggregate_array('Region_Nam').distinct();
...
var chora_sasa_a  = ui.Button({label: '==-> Ward FCD <-==', style: { margin:'5px', stretch:'horizontal'},  onClick: bonyezoa,});
//==============================================================================================================================================
...
//==============================================================================================================================================
var title = ui.Label('Tanzania Administrative - Forest Canopy Density', {
