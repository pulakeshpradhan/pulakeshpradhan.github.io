...
var mradi_paint = empty.paint({featureCollection: mradi, color: 1, width: 2 });
//JRC Water
...
var miradi_buffer_10km = miradi.map(bafa); //10Km\\
// ===========================================================================================
...
mito = mito.filterBounds(miradi_buffer_10km);
map.addLayer(mito, {palette: '0000CC'}, 'Free flowing rivers', 0);
// ===========================================================================================
...
majengo = majengo.filterBounds(miradi_buffer_10km);
...
//=====================================================================================================
function downloadImg(eneo,fcdscale,landsat_comp)
{
}
//=====================================================================================================
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
var chora_sasa_a  = ui.Button({label: '==-> Project FCD <-==', style: { margin:'5px', stretch:'horizontal'},  onClick: bonyezoa,});
var chora_sasa_b  = ui.Button({label: '==-> Village FCD <-==', style: { margin:'5px', stretch:'horizontal'},  onClick: bonyezob,});
//==============================================================================================================================================
...
function bonyezoa()
{
  ...
  if(mwaka === "2015") { URT_FCD(mwaka_mwanzo,mwaka_mwisho,geom,geomjina);  }
  if(mwaka === "2016") { URT_FCD(mwaka_mwanzo,mwaka_mwisho,geom,geomjina);  }
  if(mwaka === "2017") { URT_FCD(mwaka_mwanzo,mwaka_mwisho,geom,geomjina);  }
  if(mwaka === "2018") { URT_FCD(mwaka_mwanzo,mwaka_mwisho,geom,geomjina);  }
  if(mwaka === "2019") { URT_FCD(mwaka_mwanzo,mwaka_mwisho,geom,geomjina);  }
  if(mwaka === "2020") { URT_FCD(mwaka_mwanzo,mwaka_mwisho,geom,geomjina);  }
  if(mwaka === "2021") { URT_FCD(mwaka_mwanzo,mwaka_mwisho,geom,geomjina);  }
  if(mwaka === "2022") { URT_FCD(mwaka_mwanzo,mwaka_mwisho,geom,geomjina);  }
  if(mwaka === "2023") { URT_FCD(mwaka_mwanzo,mwaka_mwisho,geom,geomjina);  }
}
//--------------------------------------------------------------------------
function bonyezob()
{
...
//==============================================================================================================================================
var title = ui.Label('Project Areas - Forest Canopy Density', {
