...
var aoi = ee.FeatureCollection("users/juntakut37/Basin_TH/bang_pakong_lv7"), 
  s2 = ee.ImageCollection("COPERNICUS/S2"),
  str = ee.FeatureCollection("users/juntakut37/Basin_TH/bang_pakong_stream"); 
...
var title_text2 = ui.Label("------ BOOG-FAG ------", {width: '280px','background-color':'darkgreen', 'fontSize': '27px', 'font-weight':'bold', 'color': 'yellow', 'textAlign': 'center', 'border': '4px solid grey'});
var title_text3 = ui.Label("~~ BANG PAKONG BASIN ~~", {width: '280px','background-color':'darkblue', 'fontSize': '20px', 'font-weight':'bold', 'color': 'white', 'textAlign': 'center', 'border': '4px solid grey'});
...
ee.List(aoi.distinct('NAME_EN').aggregate_array('NAME_EN'))
     .sort()
...
var footer_text5 = ui.Label("3) Dr.Ann Kambu (แอน กำภู) | Kasetsart University (KU)", {'background-color':'333333', fontSize: '8pt', color:'aqua'});
...
chartPanel.add(ui.Label("Bang Pakong River Basin", {color: "black", fontWeight: "bold", fontSize: "16px", backgroundColor: "white"}, 
...
//--------------------------------------------------------------
var panel = ui.Panel(
  [title_panel, selector_panel, area_panel, description_panel, chartPanel, footer_panel],
...
function showFloodMap(amphoe) {
  ...
  Map.drawingTools().setShown(false);
  var amphoe = aoi.filterMetadata('NAME_EN', 'equals', amphoe);
...
chartPanel.add(
    ui.Label(SL_meaned.getInfo()+" t/hac/year", {'background-color':'white', fontSize: '20px', color:'brown', 'font-weight':'bold'}));
chartPanel.add(
    ui.Label("or", {'background-color':'white', fontSize: '11px', color:'grey'}));
chartPanel.add(
    ui.Label(SL_mean_rai.getInfo()+" t/rai/year", {'background-color':'white', fontSize: '20px', color:'brown', 'font-weight':'bold'}));
chartPanel.add(
  ui.Label("----------------------------------------------", {color: "black", fontWeight: "bold", fontSize: "16px", backgroundColor: "white"}));
//chartPanel.add(
...
var legendTitle = ui.Label({
  value: 'Soil Erosion Class (t/hac/year)',
  style: {
    fontWeight: 'bold',
    fontSize: '18px',
    margin: '0 0 4px 0',
