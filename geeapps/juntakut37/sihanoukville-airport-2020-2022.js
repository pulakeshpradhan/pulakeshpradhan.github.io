var image = ui.import && ui.import("image", "image", {
      "id": "users/juntakut37/change_detect_airport/Sihanoukville_airport_S1SAR_20-22"
    }) || ee.Image("users/juntakut37/change_detect_airport/Sihanoukville_airport_S1SAR_20-22");
/////////////////////////////////////////////////////
// **************************************************
// Viewer for Exported Sequential Omnibus Change Maps
// **************************************************
var util = require('users/juntakut37/military:utilities_000');
...
chartPanel.add(ui.Label("Klintsy Base in Russia", {color: "black", fontWeight: "bold", fontSize: "16px", backgroundColor: "white"}, 
                        "https://twitter.com/ChristopherJM/status/1488776410378514432"));  
/////////////////////////////////////////
