var image = ui.import && ui.import("image", "image", {
      "id": "users/juntakut37/change_detect_pier/ream_naval_base_21-23"
    }) || ee.Image("users/juntakut37/change_detect_pier/ream_naval_base_21-23");
/////////////////////////////////////////////////////
// **************************************************
...
chartPanel.add(ui.Label("Ream Naval Base in Cambodia", {color: "black", fontWeight: "bold", fontSize: "16px", backgroundColor: "white"}, 
