...
var before_start= '2020-01-10';
var before_end='2020-01-15';
// Now set the same parameters for AFTER the flood.
var after_start='2020-09-05';
var after_end='2020-09-09';
/********************************************************************************************
...
var geometry = ee.FeatureCollection("users/juntakut37/nakhonnayok");
...
// Refine flood result using additional datasets
      ...
      var flooded = flooded.updateMask(connections.gte(5));
...
var LC = ee.ImageCollection('MODIS/006/MCD12Q1')
  .filterDate('2019-01-01',after_end)
...
var title = ui.Label('แสดงผลจากสถานการณ์น้ำท่วมขัง', titleTextVis);
var text1 = ui.Label('ช่วงเวลาสถานการณ์ที่เกิดน้ำท่วมขัง:',textVis);
var number1 = ui.Label(after_start.concat(" ถึง ",after_end),numberVIS);
...
var text2 = ui.Label('คาดการณ์พื้นที่น้ำท่วมขัง:',textVis);
...
flood_area_km2.evaluate(function(val){number2.setValue(val+' ตร.กม.')}),numberVIS;
// Estimated number of exposed people
var text3 = ui.Label('คาดการณ์จำนวนคนที่ถูกผลกระทบจากน้ำท่วมขัง: ',textVis);
var text3_2 = ui.Label('based on GHSL 2015 (250m)',subTextVis);
var number3 = ui.Label('Please wait...',numberVIS);
number_pp_exposed.evaluate(function(val){number3.setValue(val+'คน')}),numberVIS;
// Estimated area of affected cropland 
var MODIS_date = ee.String(LC.get('system:index')).slice(0,4);
var text4 = ui.Label('คาดการณ์พื้นที่เพาะปลูกที่ถูกผลกระทบจากน้ำท่วมขัง:',textVis);
...
crop_area_km2.evaluate(function(val){number4.setValue(val+' ตร.กม.')}),numberVIS;
// Estimated area of affected urban
var text5 = ui.Label('คาดการณ์พื้นที่ชุมชนที่ถูกผลกระทบจากน้ำท่วมขัง:',textVis);
...
urban_area_km2.evaluate(function(val){number5.setValue(val+' ตร.กม.')}),numberVIS;
// Disclaimer
...
// Produced by...
var text7 = ui.Label('Script modified by Col.Dr.Pongpun Juntakut based on UN-SPIDER', subTextVis)
...
// name of the legend
var names = ['พื้นที่น้ำท่วมขัง','พื้นที่เพาะปลกที่ถูกผลกระทบจากน้ำท่วมขัง','พื้นที่ชุมชนที่ถูกผลกระทบจากน้ำท่วมขัง'];
...
value: 'ความหนาแน่นของประชากรที่ถูกผลกระทบจากน้ำท่วมขัง',
style: {
fontWeight: 'bold',
fontSize: '15px',
margin: '10px 0 0 0',
