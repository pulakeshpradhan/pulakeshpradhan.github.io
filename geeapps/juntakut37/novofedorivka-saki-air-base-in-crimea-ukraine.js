var image = ui.import && ui.import("image", "image", {
      "id": "users/juntakut37/ukraine_war/novofedorivka_saki_air_base_21-22"
    }) || ee.Image("users/juntakut37/ukraine_war/novofedorivka_saki_air_base_21-22");
/////////////////////////////////////////////////////
// **************************************************
...
chartPanel.add(ui.Label("Novofedorivka Saki Air Base in Crimea", {color: "black", fontWeight: "bold", fontSize: "16px", backgroundColor: "white"}, 
