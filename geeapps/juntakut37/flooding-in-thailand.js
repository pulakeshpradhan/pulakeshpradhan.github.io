...
// Add the title
var mapTitle = ui.Label('Flooding Status in Thailand during Monsoon Seasons (May - October)');
...
// Add description
var mapDesc = ui.Label("The status of flooding in Thailand during Monsoon seasons (May - October) based on Sentinel-1 satellite image. \
                       The SAR images are capable to see through cloud and measure the extent of surface water. Normally the optical satellite cannot see through cloud such as Landsat 8. The script was modified by PJ based on SUNBEAM June, 2020");
