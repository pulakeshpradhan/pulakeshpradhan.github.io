var image = ui.import && ui.import("image", "image", {
      "id": "users/juntakut37/ukraine_war/machulishchy_perarus_21-22"
    }) || ee.Image("users/juntakut37/ukraine_war/machulishchy_perarus_21-22");
/////////////////////////////////////////////////////
// **************************************************
...
chartPanel.add(ui.Label("Machulishchy Air Base in Perarus", {color: "black", fontWeight: "bold", fontSize: "16px", backgroundColor: "white"}, 
