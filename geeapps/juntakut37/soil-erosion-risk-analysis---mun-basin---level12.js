...
var aoi = ee.FeatureCollection("users/juntakut37/Basin_TH/moon_basin_lv12"), 
...
var title_text3 = ui.Label("~~ MUN BASIN ~~", {width: '280px','background-color':'darkblue', 'fontSize': '20px', 'font-weight':'bold', 'color': 'white', 'textAlign': 'center', 'border': '4px solid grey'});
...
chartPanel.add(ui.Label("Mun River Basin", {color: "black", fontWeight: "bold", fontSize: "16px", backgroundColor: "white"}, 
                        "https://en.wikipedia.org/wiki/Mun_River"));  
