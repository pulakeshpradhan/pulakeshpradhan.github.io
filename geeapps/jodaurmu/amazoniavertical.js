var image = ui.import && ui.import("image", "image", {
    ...
    peru = ui.import && ui.import("peru", "table", {
      "id": "users/jodaurmu/DISTRITOS"
    }) || ee.FeatureCollection("users/jodaurmu/DISTRITOS"),
...
//visualization 
Map.centerObject(peru,6); // carretera 
...
legendpp.add(panel2);
Map.add(legendpp);
var header = ui.Label('Amazonia Vertical (En desarrollo)', {fontSize: '25px', color: 'darkgreen',fontWeight: 'bold'});
var text = ui.Label('Facultad de Ciencias Forestales-Proyecto Forest Data Connect ',
    {fontSize: '22px',fontWeight: 'bold'});
var text2 = ui.Label(' J. David Urquiza-Muñoz,Jose Jibaja Aspajo, Jorge Solignac Ruiz, Richer Rios Zumaeta, Rodil Tello Espinoza, Tedi Pacheco Gomez',
...
var logoAll=ui.Chart(
  [['<img src=https://www.unapiquitos.edu.pe/images/escudo.png width=180px heigth=250px>']],
  'Table',{allowHtml:true});
var toolPanel = ui.Panel([header,logoAll,text,text2,text3], 'flow', {width: '350px', padding:'1px'});
