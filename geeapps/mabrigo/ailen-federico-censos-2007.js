...
var potreros = ee.FeatureCollection('users/mabrigo/ailen-federico/buffer-censos-poggio2007')	
var fechafin= ee.Date(Date.now())	 
//var fechaini = ('2017-07-01')	
var fechaini = fechafin.advance(-365,'day')	
print (fechaini)	
print (fechafin)	
...
Map.addLayer(NDVIn, {bands:'q'}, 'q')	
Map.addLayer(NDVIn, vis, 'ndvi')	
...
var intro = ui.Panel([	
  ui.Label({	
value: 'Ailen-Federico - Censos Poggio 2007',	
style: {fontSize: '20px', fontWeight: 'bold'}	
  }),	
])	
panel.add(intro)	
/* var tempTimeSeries = ui.Chart.image.seriesByRegion(	
NDVIp,potreros, ee.Reducer.mean(), 'NDVI', 1, 'system:time_start', '')	
          .setOptions({	
          title: 'NDVI',	
          vAxis: {title: 'NDVI'},	
lineWidth: 1,	
...
/* var tempTimeSeries = ui.Chart.image.seriesByRegion(	
NDVIp,potreros, ee.Reducer.mean(), 'q', 1, 'system:time_start', 'LOTE')	
          .setOptions({	
          title: 'Calidad',	
...
var ndviChart = ui.Chart.image.series(NDVIp.select(['fPAR']), point, ee.Reducer.mean(), 30)	
  ndviChart.setOptions({	
title: 'NDVI ' + coords.lon.toFixed(2) + ' ' +  coords.lat.toFixed(2),	
    vAxis: {title: 'NDVI'},	
