...
var potreros = ee.FeatureCollection('users/mabrigo/gyc-extension/omar-muniz-banado-medina');
...
var filtro1 = ee.Filter.date('2018-12-01', '2022-03-20');//filtra por fechas inicio y fin
var filtro2 = ee.Filter.date('2022-03-22', '2022-04-30');//filtro extra por nubosidad
...
var filtro4 = ee.Filter.date('2017-11-17', '2018-03-06');//filtro extra por nubosidad
var filtro5 = ee.Filter.date('2018-03-08', '2018-11-30');//filtro extra por nubosidad
var allfilter2 = ee.Filter.or(filtro3, filtro4,filtro5); // Create joint Filter
