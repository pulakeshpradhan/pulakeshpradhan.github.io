...
var potreros = ee.FeatureCollection('users/mabrigo/gyc-extension/nardy-schol-la-zeta');
...
var filtro2 = ee.Filter.date('2019-02-26', '2022-03-30');//filtro extra por nubosidad
...
var f = image.expression('((PAR*fPAR*pendiente_eur)+ordenada_eur)*10', {	
