...
var panelChildren_sexoObito                 = ui.Panel([], ui.Panel.Layout.flow('vertical'), {
                                                              ...
                                                              'background-color':'#313131',
                                                              'padding':'0px'}) 
var panelChildren_Map_Graph_Buttons         = ui.Panel([], ui.Panel.Layout.flow('horizontal'), {
                                                              'width':'100%', 
                                                              'height':'15%',
...
var panelChildren_Map_Graph                 = ui.Panel([panelChildren_Map_Graph_Buttons], ui.Panel.Layout.flow('vertical'), {
                                                              ...
                                                              'background-color':'#313131',
                                                              'padding':'0px'})
var panelChildren_Map_Box_Tests             = ui.Label('Testes Rápidos Totais', {
                                                              'width':'95%', 
                                                              'height':'10%',
                                                              'border':'0px solid black', 
...
var panelChildren_Map_Box_TestsQTD          = ui.Label(totalTestes, {
                                                              'width':'95%', 
                                                              'height':'10%',
                                                              'border':'0px solid black', 
                                                              'background-color': esquemaCores.gray,
...
var panelChildren_Tests                     = ui.Panel([panelChildren_Map_Box_Tests, panelChildren_Map_Box_TestsQTD], ui.Panel.Layout.flow('vertical'), {
                                                              'width':'100%', 
                                                              'height':'60%',
                                                              'border':'1px solid black', 
                                                              'background-color':'#313131',
...
var panelChildren_firstColumn               = ui.Panel([panelChildren_Confirmados, panelChildren_Recuperados, panelChildren_Obito, panelChildren_Descartados, panelChildren_EmAnalise], ui.Panel.Layout.flow('vertical'), {
                                                              'width':'11%', 
                                                              'height':'100%',
                                                              'border':'2px solid black', 
                                                              'background-color':'#313131',
...
var panelChildren_secondColumn              = ui.Panel([panelChildren_Tests,panelChildren_Map, panelChildren_Map_Graph], ui.Panel.Layout.flow('vertical'), {
                                                              'width':'45%', 
                                                              'height':'100%',
                                                              'border':'2px solid black', 
                                                              'background-color':'#313131',
...
var panelChildren_thirdColumn               = ui.Panel([panelChildren_rankConfirmado, panelChildren_rankObito], ui.Panel.Layout.flow('vertical'), {
                                                              'width':'16%', 
                                                              'height':'100%',
                                                              'border':'2px solid black', 
                                                              'background-color':'#313131',
...
var panelChildren_fourthColumn              = ui.Panel([panelChildren_etariaConfirmado, panelChildren_etariaObito], ui.Panel.Layout.flow('vertical'), {
                                                              'width':'14%', 
                                                              'height':'100%',
                                                              'border':'2px solid black', 
                                                              'background-color':'#313131',
...
var panelChildren_fifthColumn               = ui.Panel([panelChildren_sexoConfirmado, panelChildren_sexoObito], ui.Panel.Layout.flow('vertical'), {
                                                              'width':'14%', 
                                                              'height':'100%',
                                                              'border':'2px solid black', 
                                                              'background-color':'#313131',
...
var panelMaster                             = ui.Panel([panelChildren_firstColumn,panelChildren_secondColumn,panelChildren_thirdColumn,panelChildren_fourthColumn, panelChildren_fifthColumn], ui.Panel.Layout.flow('horizontal'), {
                                                              'width':'100%', 
                                                              'height':'94%',
                                                              'border':'0px solid black', 
...
//CASOS
var optionsCasos = {
  title: 'Curva Acumulada de Casos Confirmados no Estado do Pará',
  'width':'98%', 
  'height':'75%',
  titleColor: '#FFFFFF',
  titleTextStyle: {
...
var optionsCasosDaily = {
  title: 'Curva Diária de Casos Confirmados no Estado do Pará',
  'width':'98%', 
  'height':'75%',
  titleColor: '#FFFFFF',
  titleTextStyle: {
...
// var cssClassNames = {'headerRow': {'color': esquemaCores.gray},
// 'hoverTableRow': 'highlightClass'} nao funciona
var options = {
  text: 'Ocorrências',
  'width':'95%', 
  'height':'50%',
  ...
  // 'cssClassNames': cssClassNames, //nao funciona
  // 'headerRow': {'color': esquemaCores.green},
};
//FEATURE COLLECTIONS
...
var leitos_FeatureCollection        = coronaTable.filterMetadata('Tipo','equals','Tipo_Leito').sort('id',true)
...
var charLeitos      = new ui.Chart.feature.byFeature(leitos_FeatureCollection,'Desc',['Total_leitos','Disponivel_leitos','Ocupacao_leitos']).setChartType('Table').setOptions(options)
// print(charLeitos)
...
charcovidDaily.style().set({backgroundColor: esquemaCores.gray,'shown': false})
charLeitos.style().set({backgroundColor: esquemaCores.gray,
                        'color': esquemaCores.red,
                        'shown': false,
                        border: '3px solid #313131',
                        'font-size':'15px', // nao funciona como deveria
})
...
var buttonTot = ui.Button({
  ...
  onClick: function() {
    ee.Algorithms.If(
      charcovidDaily.style().set('shown', true),
      charcovidDaily.style().set('shown', false)
    )
    charcovid.style().set('shown', true)
  }
});
var buttonDaily = ui.Button({
  ...
  onClick: function() {
    ee.Algorithms.If(
      charcovid.style().set('shown', true),
      charcovid.style().set('shown', false)
    )
    charcovidDaily.style().set('shown', true)
  }
});
...
//ADD TO PAINELS
panelChildren_Map_Graph_Buttons.add(buttonTot)
panelChildren_Map_Graph_Buttons.add(buttonDaily)
...
panelChildren_Map_Graph.add(charcovidDaily)
...
panelChildren_Tests.add(charLeitos)
//Atualizado heimm
