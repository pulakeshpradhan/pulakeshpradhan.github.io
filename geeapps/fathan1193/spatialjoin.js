...
// print(multi);
// Map.addLayer(multi);
// var lineStr = ee.Geometry.LineString([[0, 0], [45, 0], [0, -45], [0, 0]]);
// print(lineStr);
// Map.addLayer(lineStr);
// var linLen = lineStr.length();
// print(linLen);
//keliling setengah bumi
// var lineStr = ee.Geometry.LineString([[0, 0], [180, 0], ]);
// print(lineStr);
// Map.addLayer(lineStr);
// var linLen = lineStr.length();
// print(linLen);
...
// print(lineStr);
// Map.addLayer(lineStr);
//Panjang bujur & lintang Indonesia
// var Lintangindo = ee.Geometry.LineString([[118, 6], [118, -11], ]);
// print(Lintangindo);
// Map.addLayer(Lintangindo);
// var linLen = Lintangindo.length();
// print(linLen);
// var bujurindo = ee.Geometry.LineString([[95, 0], [141, 0], ]);
// print(bujurindo);
// Map.addLayer(bujurindo);
// var linLen2 = bujurindo.length();
// print(linLen2);
//Indonesia
...
//Latihan Indonesia Warna Buffer
...
Map.addLayer(centrGeo_ina_kiri, {color: 'red'}, 'poly_kiri');
Map.addLayer(centrGeo_ina_kanan, {color: 'blue'}, 'poly_kanan');
//Geomatrik calculation
var intersection =
centrGeo_ina_kiri.intersection(centrGeo_ina_kanan);
...
Map.addLayer(symDiff, {color: 'black'}, 'symmetricdifference');
var Ina_border = table.filter(ee.Filter.eq('country_na', 'Indonesia'));
print(Ina_border);
// Map.addLayer(Ina_border, {color: 'red'}, 'Batas Indonesia');
...
Map.centerObject(intersection, 4);
