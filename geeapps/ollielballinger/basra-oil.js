var swamp = ui.import && ui.import("swamp", "geometry", {
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [
    ...
    oil = ui.import && ui.import("oil", "geometry", {
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [
    ...
    desert = ui.import && ui.import("desert", "geometry", {
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [
    ...
    rumaila = ui.import && ui.import("rumaila", "geometry", {
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [
    ...
    zubayr = ui.import && ui.import("zubayr", "geometry", {
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [
    ...
    qurna = ui.import && ui.import("qurna", "geometry", {
      "geometries": [
        {
          "type": "Polygon",
          "coordinates": [
    ...
    Pipeline = ui.import && ui.import("Pipeline", "geometry", {
      "geometries": [
        {
          "type": "LineString",
          "coordinates": [
    ...
    points = ui.import && ui.import("points", "table", {
      "id": "users/ollielballinger/Basra_Oil_Points"
    }) || ee.FeatureCollection("users/ollielballinger/Basra_Oil_Points");
