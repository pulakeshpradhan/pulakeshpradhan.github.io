var geometry = ui.import && ui.import("geometry", "geometry", {
    ...
    ee.Geometry.Polygon(
        [[[-40.16974436888991, -8.543371892998344],
          [-40.16974436888991, -8.543753845087917],
          [-40.16937958846388, -8.543753845087917],
          [-40.16937958846388, -8.543371892998344]]], null, false);
Map.setCenter(-51.43, -15.83, 4)
///////////////////// Botões FAKE ////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
Map.add(buttonFake)
////// Reservoirs
var RS = ee.FeatureCollection('projects/ee-felipellobo/assets/RS_UY') 
var ugrhs = ee.FeatureCollection('users/gustavoonagel/UGRHI') 
var reservatorio = ee.FeatureCollection('projects/ee-felipellobo/assets/Reservatorios_SP_2019_Tiet') 
var reservatorio1 = ee.FeatureCollection('projects/ee-felipellobo/assets/massa_dagua_ANA_777_BaciasEstados')
var reservatorio2 = ee.FeatureCollection('projects/ee-felipellobo/assets/massa_dagua_ANA_BH_CAxias_UY')
var reservatorio3 = ee.FeatureCollection('projects/ee-felipellobo/assets/BOLIVIA_lakes1')
var Bacia = ee.FeatureCollection('projects/ee-felipellobo/assets/Sub_bacias_17_all')
var cordoba = ee.FeatureCollection('projects/ee-felipellobo/assets/Cordoba_Arg')
var Titicaca = ee.FeatureCollection('projects/ee-felipellobo/assets/lago_titicaca_FINAL')
var Patos_rec = ee.FeatureCollection('projects/ee-felipellobo/assets/patos_rec')
var Mirim_rec = ee.FeatureCollection('projects/ee-felipellobo/assets/Mirim_rec')
var Arequipa = ee.FeatureCollection('projects/ee-felipellobo/assets/arequipa_lakes_poly')
...
// RS
var LagosdosPatos1 = Patos_rec.filter(ee.Filter.inList('esp_cd', ee.List([21679])));
var LagosdosPatos2 = Patos_rec.filter(ee.Filter.inList('esp_cd', ee.List([21678])));
var LagosdosPatos3 = Patos_rec.filter(ee.Filter.inList('esp_cd', ee.List([21672])));
var LagosdosPatos4 = Patos_rec.filter(ee.Filter.inList('esp_cd', ee.List([21673])));
var LagosdosPatos5 = Patos_rec.filter(ee.Filter.inList('esp_cd', ee.List([21675])));
var LagoaMirimNorte = Mirim_rec.filter(ee.Filter.inList('gid', ee.List([412])));
var LagoaMirimSul = Mirim_rec.filter(ee.Filter.inList('gid', ee.List([413])));
...
var Cruz = reservatorio1.filter(ee.Filter.inList('gid', ee.List([49832])));
var Serrinha = reservatorio1.filter(ee.Filter.inList('gid', ee.List([61802])));
var Nilo = reservatorio1.filter(ee.Filter.inList('gid', ee.List([61629])));
var Entremontes = reservatorio1.filter(ee.Filter.inList('gid', ee.List([47285])));
var Saco2 = reservatorio1.filter(ee.Filter.inList('gid', ee.List([27351])));
var Chapeu = reservatorio1.filter(ee.Filter.inList('gid', ee.List([734])));
var Jucazinho = reservatorio1.filter(ee.Filter.inList('gid', ee.List([62003])));
var BeloJardim = reservatorio1.filter(ee.Filter.inList('gid', ee.List([13092])));
...
var GenSampaio = reservatorio1.filter(ee.Filter.inList('gid', ee.List([6711])));
var Pacoti = reservatorio1.filter(ee.Filter.inList('gid', ee.List([29773])));
var Aracoiaba = reservatorio1.filter(ee.Filter.inList('gid', ee.List([41262])));
var SitiosNovos = reservatorio1.filter(ee.Filter.inList('gid', ee.List([42644])));
var Pacajus = reservatorio1.filter(ee.Filter.inList('gid', ee.List([46457])));
var PedrasBrancas = reservatorio1.filter(ee.Filter.inList('gid', ee.List([47385])));
...
var Titi1 = Titicaca.filter(ee.Filter.inList('gid', ee.List([235])));
var Titi2 = Titicaca.filter(ee.Filter.inList('gid', ee.List([234])));
var Pillones = Arequipa.filter(ee.Filter.inList('fid', ee.List([1829])));
var Aguada = Arequipa.filter(ee.Filter.inList('fid', ee.List([2785])));
var Espanoles = Arequipa.filter(ee.Filter.inList('fid', ee.List([1698])));
var Frayle = Arequipa.filter(ee.Filter.inList('fid', ee.List([2712])));
var Pane = Arequipa.filter(ee.Filter.inList('fid', ee.List([995])));
var Condorama = Arequipa.filter(ee.Filter.inList('fid', ee.List([1158])));
var List = {
  ...
  'BRA/PE/Açude Eng.Saboia(Cruz)': Cruz,
  'BRA/PE/Açude Serrinha': Serrinha,
  'BRA/PE/Açude Nilo Coelho': Nilo,
  'BRA/PE/Açude Entremontes': Entremontes,
  'BRA/PE/Açude Saco II': Saco2,
  'BRA/PE/Açude Chapéu': Chapeu,
  'BRA/PE/Açude Jucazinho': Jucazinho,
  'BRA/PE/Açude Belo Jardim': BeloJardim,
  ...
  'BRA/CE/Açude Gen.Sampaio': GenSampaio,
  'BRA/CE/Açude Pacoti': Pacoti,
  'BRA/CE/Açude Aracoiaba': Aracoiaba,
  'BRA/CE/Açude Sítios Novos': SitiosNovos,
  'BRA/CE/Açude Pacajus': Pacajus,
  'BRA/CE/Açude Pedras Brancas': PedrasBrancas,
  ...
  'BRA/RS/Rio Guaíba': LagosdosPatos5,
  'BRA/RS/Lagoa dos Patos/Estuário': LagosdosPatos1,
  'BRA/RS/Lagoa dos Patos/SLS': LagosdosPatos2,
  'BRA/RS/Lagoa dos Patos/Tapes': LagosdosPatos3,
  'BRA/RS/Lagoa dos Patos/Norte': LagosdosPatos4,
  'BRA/RS/Reservatório Santa Bárbara': SantaBárbara,
  'BRA/RS/Reservatório Chasqueiro': Chasqueiro,
  'BRA & URU/Lagoa Mirim (N)': LagoaMirimNorte,
  'BRA & URU/Lagoa Mirim (S)': LagoaMirimSul,
  ...
  'PER/Titicaca/Puno': Titi1,
  //'PER/Titicaca/Koasía': Titi2,
  //'PER/Titicaca': Titicaca,
  'PER/Arequipa/Pillones': Pillones,
  'PER/Arequipa/Aguada Blanca': Aguada,
  'PER/Arequipa/Condorama': Condorama,
  'PER/Arequipa/El Pañe': Pane,
  'PER/Arequipa/El Frayle': Frayle,
  'PER/Arequipa/Los Españoles': Espanoles
};
////////////////////////////////////////////////////// Get the NDCI ////////////////////////// ///////////////////////////////////////
...
var Reservatorios = ee.FeatureCollection(reservatorio.merge(reservatorio1).merge(reservatorio2).merge(reservatorio3).merge(cordoba).merge(Titicaca).merge(Arequipa));
...
function updateMap(BB_mask, region3, selection, fromDate, toDate, Month1, Month2) {
  ...
  var s2Clouds = ee.ImageCollection('COPERNICUS/S2_CLOUD_PROBABILITY').filterBounds(region3).filterDate('2023-08-01', eeNow);
  var s2_orig = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterBounds(region3).filterDate('2023-08-01', eeNow);
  ...
  var BuracoLagosdosPatos2 = ee.Geometry.Rectangle([-51.87, -31.42,  -51.65, -31.67]);
  var LagoadosPatos = ee.FeatureCollection([BuracoLagosdosPatos, BuracoLagosdosPatos1, BuracoLagosdosPatos2])
  var Piaui = ee.FeatureCollection('projects/ee-felipellobo/assets/Reservatorios_Piaui')
  var background = 1;
  ...
  function updateMap1(BB_mask, region1, selection1, fromDate1Year, fromDate1Month, fromDate1Day, fcGeom, GRAYMAP) {
      ...
      var now = Date.now();       //getting time at UTC
      var eeNow = ee.Date(now)
      var s2Clouds = ee.ImageCollection('COPERNICUS/S2_CLOUD_PROBABILITY').filterBounds(region1).filterDate('2023-08-01', eeNow);
      var s2_orig = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterBounds(region1).filterDate('2023-08-01', eeNow);
      var MAX_CLOUD_PROBABILITY = 10;
      function maskClouds(img) {
        var clouds = ee.Image(img.get('cloud_mask')).select('probability');
        var isNotCloud = clouds.lt(MAX_CLOUD_PROBABILITY);
...
ui.root.add(panel.add(link).add(Region_interest_label)
