...
var locationDict = {
  'Deforestation in Kalimantan Utara': {lon: 116.514474, lat:  -1.292532, zoom: 8},
  'Kupang, NTT': {lon: 123.913146, lat: -10.145542, zoom: 11}
};
/*
...
// Center the map
var defaultLocation = locationDict['Deforestation in Kalimantan Utara'];
mapPanel.setCenter(
...
var header = ui.Label('Forest Change in Indonesia', {fontSize: '36px', color: 'red'});
var text = ui.Label(
...
var locationPanel = ui.Panel([
  ui.Label('Locations', {'font-size': '24px'}), locationSelect
]);
toolPanel.add(locationPanel);
Export.image.toAsset(hansen )