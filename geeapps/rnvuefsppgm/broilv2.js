...
//print(
    var ChartSVV= ui.Chart.image.series(
      ...
      fittedHarmonicSVV.select('VV'), point, ee.Reducer.mean(), 30)
...
//print(
    var ChartSVH= ui.Chart.image.series(
      ...
      fittedHarmonicSVH.select('VH'), point, ee.Reducer.mean(), 30)
...
//print(
    var ChartWVEL= ui.Chart.image.series(
      ...
      fittedHarmonicWVEL.select('WVEL'), point, ee.Reducer.mean(), 30)
...
//print(
    var ChartTEMP= ui.Chart.image.series(
      ...
      fittedHarmonicTEMP.select('TEMP'), point, ee.Reducer.mean(), 30)
...
//print(
    var ChartSAL= ui.Chart.image.series(
      ...
      fittedHarmonicSAL.select('SAL'), point, ee.Reducer.mean(), 10)
...
panel.widgets().set(6, ChartSAL);
    var ChartCHLORA= ui.Chart.image.series(
      ...
      fittedHarmonicCHLORA.select('chlor_a'), point, ee.Reducer.mean(), 10)
...
Map.addLayer(SVix.first(), {min: -30, max: -0.3}, 'Image', true);