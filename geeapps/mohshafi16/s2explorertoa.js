  ...
  app.intro = {
    panel: ui.Panel([
      ...
      ui.Label('This app allows you to filter and export images ' +
               'from the Sentinel-2 collection (TOA)/ Level 1C.')
    ])
  };
...
app.createConstants = function() {
  ...
  app.VIS_OPTIONS = {
    'Shortwave IR (B12/B11/B8A)': {
      description: 'Burn scars are highlighted in brown.' +
                    'Vegetation is shades of blue. Water bodies appears dark. ',
      visParams: {gamma: 1.3, min: 0, max: 4000, bands: ['B12', 'B11', 'B8A']}
    },
